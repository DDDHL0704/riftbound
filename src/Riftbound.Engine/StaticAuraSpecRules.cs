...
internal static class StaticAuraSpecRules
{
    ...
    public static bool IsFriendlyUnitsPowerStaticAura(StaticAuraSpec aura)
    {
        return IsPublicFieldFriendlyPowerStaticAura(aura)
            && string.Equals(
                aura.TargetScope,
    ...
    public static bool IsOtherFriendlyUnitsPowerStaticAura(StaticAuraSpec aura)
    {
        return IsPublicFieldFriendlyPowerStaticAura(aura)
            && string.Equals(
                aura.TargetScope,
    ...
    public static bool IsFriendlyFilteredUnitsPowerStaticAura(StaticAuraSpec aura)
    {
        return IsPublicFieldFriendlyPowerStaticAura(aura)
            && string.Equals(
                aura.TargetScope,
    ...
    public static bool IsSourceObjectPowerStaticAura(StaticAuraSpec aura)
    {
        return string.Equals(aura.Layer, ContinuousEffectLayers.StaticAura, StringComparison.Ordinal)
            && aura.PowerDeltaPerParticipant != 0
    ...
    public static bool IsSourceBattleStatePowerStaticAura(StaticAuraSpec aura)
    {
        if (!string.Equals(aura.Layer, ContinuousEffectLayers.StaticAura, StringComparison.Ordinal)
            || aura.PowerDeltaPerParticipant == 0
            || !string.Equals(aura.TargetScope, StaticAuraTargetScopes.SourceObject, StringComparison.Ordinal))
