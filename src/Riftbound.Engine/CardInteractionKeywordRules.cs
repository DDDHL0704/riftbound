        ...
        return new CardInteractionKeywordProfile(
            ...
            status switch
            {
                ...
                InteractionKeywordProfileStatuses.RecognizedDeferred =>
                    "P4.9 recognizes interaction keyword surfaces; P4.70/P4.71/P4.76/P4.386 cover narrow Standby hide/reveal/reaction and one reaction resolution trigger, and P4.387 covers one Ambush battlefield reaction play representative, while Standby target damage, broader Ambush targets/cards, and complex Echo costs remain deferred unless a separate P2 path covers the ordinary play effect.",
                _ =>
