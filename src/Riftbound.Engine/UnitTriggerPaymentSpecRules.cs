...
internal static class UnitTriggerPaymentSpecRules
{
    ...
    public static bool IsUnitArmamentAttachedPayDrawTrigger(TriggerSpec trigger)
    {
    ...
    public static bool IsUnitControlledUnitPowerfulPayPowerReadyTrigger(TriggerSpec trigger)
    {
    ...
    public static bool IsUnitAttackPayPowerModifierTrigger(TriggerSpec trigger)
    {
