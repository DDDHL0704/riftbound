...
public static class BehaviorTemplateRegistry
{
    ...
    [
        ...
        new(BehaviorTemplateIds.Recycle, "Recycle", "Skeleton route for recycling cards to their owners' decks."),
        new(BehaviorTemplateIds.Banish, "Banish", "Skeleton route for moving cards or objects to banished zones."),
        ...
        new(BehaviorTemplateIds.Boon, "Boon", "Skeleton route for granting boon tags and permanent might."),
