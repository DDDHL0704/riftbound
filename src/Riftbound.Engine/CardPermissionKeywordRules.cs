...
public static class CardPermissionKeywordRules
{
    public static CardPermissionKeywordProfile BuildProfile(CardBehaviorDefinition behavior)
    {
        ...
        return new CardPermissionKeywordProfile(
            ...
            hasHaste
                ? hasImplementedHasteReadyBranch
                    ? "P4.13/P4.18/P4.20/P4.25/P4.26/P4.27/P4.30/P4.31/P4.32/P4.33/P4.34/P4.35/P4.36/P4.37/P4.38/P4.39/P4.40/P4.41/P4.42 implement representative HASTE_READY optional costs through the current mana + power resource model and keep other Haste cards deferred."
