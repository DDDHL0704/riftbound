...
requireText(styles, "min-height: 50%", "battlefield region must reserve half of the effective table height");
...
requireText(styles, "--wire-card-w: 64px", "desktop legend, champion, and base cards must remain readable");
requireText(styles, "--wire-fixed-pile-card-w: 60px", "desktop deck piles must remain readable");
requireText(styles, "--wire-rune-card-w: 38px", "desktop rune cards must remain readable");
