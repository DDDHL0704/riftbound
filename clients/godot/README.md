...
screenshots cannot be mixed into the final package, and it refuses an existing
`RIFTBOUND_EVIDENCE_PACKAGE` path so a previous tarball is never overwritten.
