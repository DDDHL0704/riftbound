...
rg -q 'TryReadTriggerIds' "$builder_script"
rg -q 'contains an empty trigger id' "$builder_script"
rg -q 'duplicates a trigger id' "$builder_script"
rg -q 'orderedTriggerIds and triggerIds do not exactly cover the same triggers' "$builder_script"
rg -q 'triggerChoices duplicates a trigger id' "$builder_script"
rg -q 'triggerChoices does not exactly cover server triggers' "$builder_script"
...
rg -q 'legalTargets is malformed' "$builder_script"
rg -q 'legalTargets is empty' "$builder_script"
rg -q 'legalTargets contains an empty source' "$builder_script"
rg -q 'legalTargets duplicates a source' "$builder_script"
rg -q 'legalTargets target list is malformed' "$builder_script"
rg -q 'legalTargets target list is empty' "$builder_script"
rg -q 'legalTargets contains an empty target' "$builder_script"
rg -q 'legalTargets contains a duplicate target' "$builder_script"
