...
- Selected row: `FU-bf350b5796 / UNL-146/219 辛德拉`
...
- focused `PaymentEngineCoverageAuditTests` 402/402 passed
- current-head backend full `dotnet test Riftbound.slnx --no-restore` 4973/4973 passed
