...
- This does not generalize every play-trigger representative; it removes the current Raging Drake, Poro Herder, Balanced Disciple, Crescent Guard, Ascended Believer, Sly Salamander, Rampaging Soul, Armed Assaulter, and Akshan source card-number dependencies and routes those branches through implemented catalog effect kinds / behavior rows. Poro Herder, Balanced Disciple, Crescent Guard, Armed Assaulter, and Akshan now use narrower behavior fields where available.
