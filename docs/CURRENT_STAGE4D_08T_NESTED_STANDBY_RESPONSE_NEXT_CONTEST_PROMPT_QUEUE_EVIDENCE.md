# Stage 4D-08T Nested Standby Response Next-Contest Prompt Queue Evidence
...
- `docs/CURRENT_STAGE4D_08T_NESTED_STANDBY_RESPONSE_NEXT_CONTEST_PROMPT_QUEUE_AUDIT.md`
- `docs/CURRENT_STAGE4D_08T_NESTED_STANDBY_RESPONSE_NEXT_CONTEST_PROMPT_QUEUE_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~NaturalBattleResponseActivationAllowsNestedStandbyReactionStackBeforeReturningToResponse"
```
...
Runtime changed: no. Existing nested standby battle-response close to next-contest behavior already advanced BF-NEXT into spell-duel focus.
