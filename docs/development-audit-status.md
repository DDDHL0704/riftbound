...
1. 继续 P2 preflight：迁移第二张低复杂度官方卡，先从能覆盖费用、目标、结算链和对象状态的样例开始。
2. 后续补 richer expected canonical diff，减少测试中手写断言的比例。
3. 再继续抽象费用、目标和对象状态的通用 validator。
