...
- 4D-03I 已验收；后续继续扩展 P0-005 full PaymentEngine breadth，优先处理完整 `[A]` / `[C]` family、`LEGEND_ACT` resource action、spell-duel / swift timing、reaction prohibition、payment-only lifecycle 与更多 payment window quote parity。
