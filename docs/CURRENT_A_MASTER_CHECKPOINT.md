...
状态：**focused foundation accepted；项目仍 NOT READY。**
...
- 派 Maxwell / B 服务端按 `docs/CURRENT_STAGE4D_03B_PAYMENT_ENGINE_NON_PLAY_HANDOFF.md` 扩展 non-play payment window 迁移。
