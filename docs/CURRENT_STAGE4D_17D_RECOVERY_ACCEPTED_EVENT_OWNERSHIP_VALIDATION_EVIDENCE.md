2026-05-24 Stage 4D-17D recovery accepted-command event ownership validation evidence.
...
Adjacent result: passed `609/609`.
...
Backend full result: passed `5974/5974`.
