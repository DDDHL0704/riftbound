2026-05-24 Stage 4D-17Z recovery spectator replay snapshot validation evidence.
...
Adjacent result: passed `633/633`.
...
Backend full result: passed `5998/5998`.
