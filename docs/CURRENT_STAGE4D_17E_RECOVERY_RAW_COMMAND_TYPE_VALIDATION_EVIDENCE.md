2026-05-24 Stage 4D-17E recovery raw command type consistency validation evidence.
...
Adjacent result: passed `611/611`.
...
Backend full result: passed `5976/5976`.
