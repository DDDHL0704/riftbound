# Stage 4D-08P Natural Control Cleanup Next Contest Prompt Queue Evidence
...
- `docs/CURRENT_STAGE4D_08P_NATURAL_CONTROL_CLEANUP_NEXT_CONTEST_PROMPT_QUEUE_AUDIT.md`
- `docs/CURRENT_STAGE4D_08P_NATURAL_CONTROL_CLEANUP_NEXT_CONTEST_PROMPT_QUEUE_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~NaturalBattlefieldControlCleanupRemovesIllegalStandbyBeforeAdvancingNextContestedTask"
```
...
Runtime changed: no. Existing control-cleanup / next-contest advancement behavior already removed the illegal hidden standby before advancing BF-NEXT.
