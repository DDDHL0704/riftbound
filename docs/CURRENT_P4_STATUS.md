...
2026-06-28 B0 Interaction 注记：上表的“目标伤害 deferred”当前只适用于 base 来源/防守触发/其他待命牌族等未覆盖广度；battlefield-source Teemo 同战场目标、顶五张展示、按 `待命` 数量伤害和展示牌回收已由本批 direct runtime regression 覆盖。
