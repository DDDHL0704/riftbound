...
- P4.187 提交：本提交 `test: add p4 chemtech barrel target fixture`
...
| 基础动作模板：抽牌、伤害、摧毁、眩晕、移动、召回、回收、放逐、临时战力、增益、经验 | `BehaviorTemplatePrimitiveExecutor`、`BehaviorTemplateIds.Recycle/Banish/Boon`、`CardBasicActionRules`、`P4BasicActionProfilesCoverPrimitiveDelegatedAndDeferredActions`、`P4BridgeDelegatesLowRiskTemplatesToExistingP2Behaviors`、`P4PrimitiveExecutorBuildsBasicActionPlansAndLeavesComplexRoutesDelegated`、`P4MoveUnitCommandIsExplicitlyRejectedUntilRoamMovementExists`、`P4MoveUnitCommandRejectionFixture`、`GameCommandMapperParsesMoveUnitPayload`、`p4-move-unit-command-premodel-rejected`、`P4FixedExperienceGainOnPlayUpdatesControllerExperience`、`P4DynamicExperienceGainOnPlayCountsFriendlyFieldUnits`、`P4ExperienceOptionalCostReducesManaAndSpendsExperience`、`P4LevelThresholdDrawsCardForWujiApprenticeAtSixExperience`、`P4SpiritFireTotalPowerTooHighFixture`、`P4PlayfulTentaclesTotalPowerTooHighFixture`、`P4HuntTheWeakTargetPowerTooHighFixture`、`P4GustTargetPowerTooHighFixture`、`P4HighwayRobberyOffFieldTargetRejectedFixture`、`P4DeadlyFlourishFriendlyTargetRejectedFixture`、`P4BloodMoneyTargetPowerTooHighRejectedFixture`、`P4PunishmentBaseUnitTargetRejectedFixture`、`P4KerplunkNonAttackingTargetRejectedFixture`、`P4ZenithBladeBaseUnitTargetRejectedFixture`、`P4ZenithBladeFriendlyTargetRejectedFixture`、`P4LastBreathEnemyBaseTargetRejectedFixture`、`P4LastBreathTargetOrderRejectedFixture`、`P4ConvergentMutationEnemyTargetRejectedFixture`、`P4ConvergentMutationDuplicateTargetRejectedFixture`、`P4ThunderingSkyInsufficientReducedCostRejectedFixture`、`P4MindAndBalanceInsufficientUnreducedCostRejectedFixture`、`P4PiercingLightRepeatedTargetRejectedFixture`、`P4BellowsBreathFourthTargetRejectedFixture`、`P4BellowsBreathRepeatedTargetRejectedFixture`、`P4RocketBarrageMissingModeRejectedFixture`、`P4RocketBarrageDestroyEquipmentUnitTargetRejectedFixture`、`P4EmergencyRecallUnitTargetRejectedFixture`、`P4PoroSnaxTargetRejectedFixture`、`P4ShurelyasRequiemTargetRejectedFixture`、`P4FutureForgeTargetRejectedFixture`、`P4ScrapHeapTargetRejectedFixture`、`P4SpriteLanternTargetRejectedFixture`、`P4SumpworksMapTargetRejectedFixture`、`P4ScryingBlossomTargetRejectedFixture`、`P4MagicBeansTargetRejectedFixture`、`P4SteelBallistaTargetRejectedFixture`、`P4HeartOfIceTargetRejectedFixture`、`P4RemorseOrbTargetRejectedFixture`、`P4SoulSwordTargetRejectedFixture`、`P4JaggedDirkTargetRejectedFixture`、`P4DoransShieldTargetRejectedFixture`、`P4HextechInfusedBulwarkTargetRejectedFixture`、`P4DoransBladeTargetRejectedFixture`、`P4DoransRingTargetRejectedFixture`、`P4VanguardsEyeTargetRejectedFixture`、`P4RecurveBowTargetRejectedFixture`、`P4LongSwordTargetRejectedFixture`、`P4ClothArmorTargetRejectedFixture`、`P4SteraksGageTargetRejectedFixture`、`P4SpinningAxeTargetRejectedFixture`、`P4ShepherdsHeirloomTargetRejectedFixture`、`P4BrutalizerTargetRejectedFixture`、`P4GuardianAngelTargetRejectedFixture`、`P4HexdrinkerTargetRejectedFixture`、`P4WarmogsArmorTargetRejectedFixture`、`P4TrinityForceTargetRejectedFixture`、`P4BootsOfSwiftnessTargetRejectedFixture`、`P4CullTargetRejectedFixture`、`P4SacredShearsTargetRejectedFixture`、`P4BfSwordTargetRejectedFixture`、`P4WanderersGuidebookTargetRejectedFixture`、`P4ArionsFallTargetRejectedFixture`、`P4HuntersMacheteTargetRejectedFixture`、`P4WitheredBattleaxeTargetRejectedFixture`、`P4BoneClubTargetRejectedFixture`、`P4AncientSteleTargetRejectedFixture`、`P4HextechAnomalyTargetRejectedFixture`、`P4EnergyChannelTargetRejectedFixture`、`P4TimeGateTargetRejectedFixture`、`P4RavenTomeTargetRejectedFixture`、`P4SunDiscTargetRejectedFixture`、`P4ForesightMaskTargetRejectedFixture`、`P4SolariAltarTargetRejectedFixture`、`P4ChemtechBarrelTargetRejectedFixture`、`P4MarchingOrdersEnemyBaseTargetRejectedFixture`、`P4DuelTargetOrderRejectedFixture`、`P4BattleCommandTargetOrderRejectedFixture`、`P4VoidAssaultTargetOrderRejectedFixture`、`P4FirestormExplicitUnitTargetRejectedFixture`、`P4CrescentStrikeFriendlyTargetRejectedFixture`、`P4CrescentStrikeBaseTargetRejectedFixture`、`P4SwitcherooDuplicateTargetRejectedFixture`、`P4SwitcherooBaseTargetRejectedFixture`、`p4-play-spirit-fire-total-power-too-high-rejected`、`p4-play-playful-tentacles-total-power-too-high-rejected`、`p4-play-hunt-the-weak-target-power-too-high-rejected`、`p4-play-gust-target-power-too-high-rejected`、`p4-play-highway-robbery-off-field-target-rejected`、`p4-play-deadly-flourish-friendly-target-rejected`、`p4-play-blood-money-target-power-too-high-rejected`、`p4-play-punishment-base-unit-target-rejected`、`p4-play-kerplunk-non-attacking-target-rejected`、`p4-play-zenith-blade-base-unit-target-rejected`、`p4-play-zenith-blade-friendly-target-rejected`、`p4-play-last-breath-enemy-base-target-rejected`、`p4-play-last-breath-target-order-rejected`、`p4-play-convergent-mutation-enemy-target-rejected`、`p4-play-convergent-mutation-duplicate-target-rejected`、`p4-play-thundering-sky-insufficient-reduced-cost-rejected`、`p4-play-mind-and-balance-insufficient-unreduced-cost-rejected`、`p4-play-piercing-light-repeated-target-rejected`、`p4-play-bellows-breath-fourth-target-rejected`、`p4-play-bellows-breath-repeated-target-rejected`、`p4-play-rocket-barrage-missing-mode-rejected`、`p4-play-rocket-barrage-destroy-equipment-unit-target-rejected`、`p4-play-emergency-recall-unit-target-rejected`、`p4-play-poro-snax-target-rejected`、`p4-play-shurelyas-requiem-target-rejected`、`p4-play-future-forge-target-rejected`、`p4-play-scrap-heap-target-rejected`、`p4-play-sprite-lantern-target-rejected`、`p4-play-sumpworks-map-target-rejected`、`p4-play-scrying-blossom-target-rejected`、`p4-play-magic-beans-target-rejected`、`p4-play-steel-ballista-target-rejected`、`p4-play-heart-of-ice-target-rejected`、`p4-play-remorse-orb-target-rejected`、`p4-play-soul-sword-target-rejected`、`p4-play-jagged-dirk-target-rejected`、`p4-play-dorans-shield-target-rejected`、`p4-play-hextech-infused-bulwark-target-rejected`、`p4-play-dorans-blade-target-rejected`、`p4-play-dorans-ring-target-rejected`、`p4-play-vanguards-eye-target-rejected`、`p4-play-recurve-bow-target-rejected`、`p4-play-long-sword-target-rejected`、`p4-play-cloth-armor-target-rejected`、`p4-play-steraks-gage-target-rejected`、`p4-play-spinning-axe-target-rejected`、`p4-play-shepherds-heirloom-target-rejected`、`p4-play-brutalizer-target-rejected`、`p4-play-guardian-angel-target-rejected`、`p4-play-hexdrinker-target-rejected`、`p4-play-warmogs-armor-target-rejected`、`p4-play-trinity-force-target-rejected`、`p4-play-boots-of-swiftness-target-rejected`、`p4-play-cull-target-rejected`、`p4-play-sacred-shears-target-rejected`、`p4-play-bf-sword-target-rejected`、`p4-play-wanderers-guidebook-target-rejected`、`p4-play-arions-fall-target-rejected`、`p4-play-hunters-machete-target-rejected`、`p4-play-withered-battleaxe-target-rejected`、`p4-play-bone-club-target-rejected`、`p4-play-ancient-stele-target-rejected`、`p4-play-hextech-anomaly-target-rejected`、`p4-play-energy-channel-target-rejected`、`p4-play-time-gate-target-rejected`、`p4-play-raven-tome-target-rejected`、`p4-play-sun-disc-target-rejected`、`p4-play-foresight-mask-target-rejected`、`p4-play-solari-altar-target-rejected`、`p4-play-chemtech-barrel-target-rejected`、`p4-play-marching-orders-enemy-base-target-rejected`、`p4-play-duel-target-order-rejected`、`p4-play-battle-command-target-order-rejected`、`p4-play-void-assault-target-order-rejected`、`p4-play-firestorm-explicit-unit-target-rejected`、`p4-play-crescent-strike-friendly-target-rejected`、`p4-play-crescent-strike-base-target-rejected`、`p4-play-switcheroo-duplicate-target-rejected`、`p4-play-switcheroo-base-target-rejected`、代表 fixture | Partial：draw/damage/destroy/stun/temp_might primitive；move/recall/recycle/banish/boon template skeleton 均可安全定位到 P2 代表路径；P4.65 已建立显式 `MOVE_UNIT` command envelope 但仍拒绝执行，P4.98 已补同一路径 fixture 并纳入基础动作聚合；P4.106 已补《妖异狐火》总战力上限拒绝 fixture，P4.107 已补《顽皮触手》总战力上限拒绝 fixture，P4.108 已补《狩魂》目标战力上限拒绝 fixture，P4.109 已补《罡风》目标战力上限拒绝 fixture，P4.110 已补《巧取豪夺》离场敌方目标拒绝 fixture，P4.111 已补《致命华彩》友方目标拒绝 fixture，P4.112 已补《血钱》目标战力上限拒绝 fixture，P4.113 已补《惩戒》基地单位目标拒绝 fixture，P4.114 已补《扑咚！》非进攻方目标拒绝 fixture，P4.115 已补《天顶之刃》敌方基地单位目标拒绝 fixture，P4.116 已补《天顶之刃》友方单位目标拒绝 fixture，P4.117 已补《狂风绝息斩》敌方基地单位第二目标拒绝 fixture，P4.118 已补《狂风绝息斩》目标顺序错误拒绝 fixture，P4.119 已补《聚合变异》敌方第二目标拒绝 fixture，P4.120 已补《聚合变异》重复目标拒绝 fixture，P4.122 已补《霹天雳地》费用不足拒绝 fixture，P4.123 已补《御衡守念》未满足减费条件且费用不足拒绝 fixture，P4.124 已补《透体圣光》重复目标拒绝 fixture，P4.125/P4.131 已补《风箱炎息》第四目标和重复目标拒绝 fixtures，P4.134 已补《火箭轰击》缺失模式拒绝 fixture，P4.135 已补《火箭轰击》摧毁装备模式单位目标拒绝 fixture，P4.136 已补《紧急召回》单位目标拒绝 fixture，P4.137 已补《魄罗佳肴》带目标拒绝 fixture，P4.138 已补《舒瑞娅的安魂曲》带目标拒绝 fixture，P4.139 已补《未来熔炉》带目标拒绝 fixture，P4.140 已补《废料堆》带目标拒绝 fixture，P4.141 已补《精灵提灯》带目标拒绝 fixture，P4.142 已补《地沟区地图》带目标拒绝 fixture，P4.143 已补《占卜花朵》带目标拒绝 fixture，P4.144 已补《魔法鲜豆》带目标拒绝 fixture，P4.145 已补《钢铁弩炮》带目标拒绝 fixture，P4.146 已补《玄冰之心》带目标拒绝 fixture，P4.147 已补《懊悔法球》带目标拒绝 fixture，P4.148 已补《灵魂之剑》带目标拒绝 fixture，P4.149 已补《锯齿短匕》带目标拒绝 fixture，P4.150 已补《多兰之盾》带目标拒绝 fixture，P4.151 已补《海克斯注力刚壁》带目标拒绝 fixture，P4.152 已补《多兰之刃》带目标拒绝 fixture，P4.153 已补《多兰之戒》带目标拒绝 fixture，P4.154 已补《行军号令》敌方基地第二目标拒绝 fixture，P4.155 已补《决斗》目标顺序反转拒绝 fixture，P4.156 已补《战斗号令》目标顺序反转拒绝 fixture，P4.157 已补《虚空来袭》目标顺序反转拒绝 fixture，P4.158 已补《先锋之眼》带目标拒绝 fixture，P4.159 已补《反曲之弓》带目标拒绝 fixture，P4.160 已补《长剑》带目标拒绝 fixture，P4.161 已补《布甲》带目标拒绝 fixture，P4.162 已补《斯特拉克的挑战护手》带目标拒绝 fixture，P4.163 已补《旋转飞斧》带目标拒绝 fixture，P4.164 已补《牧人的传家宝》带目标拒绝 fixture，P4.165 已补《残暴之力》带目标拒绝 fixture，P4.166 已补《守护天使》带目标拒绝 fixture，P4.167 已补《海克斯饮魔刀》带目标拒绝 fixture，P4.168 已补《狂徒铠甲》带目标拒绝 fixture，P4.169 已补《三相之力》带目标拒绝 fixture，P4.170 已补《轻灵之靴》带目标拒绝 fixture，P4.171 已补《萃取》带目标拒绝 fixture，P4.172 已补《神圣剪刀》带目标拒绝 fixture，P4.173 已补《暴风大剑》带目标拒绝 fixture，P4.174 已补《云游图鉴》带目标拒绝 fixture，P4.175 已补《阿瑞昂的陨落》带目标拒绝 fixture，P4.176 已补《猎人的宽刃刀》带目标拒绝 fixture，P4.177 已补《枯萎战斧》带目标拒绝 fixture，P4.178 已补《碎骨棒》带目标拒绝 fixture，P4.179 已补《远古簇碑》带目标拒绝 fixture，P4.180 已补《海克斯异常体》带目标拒绝 fixture，P4.181 已补《能量通道》带目标拒绝 fixture，P4.182 已补《预时之门》带目标拒绝 fixture，P4.183 已补《邪鸦魔典》带目标拒绝 fixture，P4.184 已补《太阳圆盘》带目标拒绝 fixture，P4.185 已补《远见面具》带目标拒绝 fixture，P4.186 已补《烈阳圣坛》带目标拒绝 fixture，P4.187 已补《炼金科技桶》带目标拒绝 fixture，P4.126 已补《烈火风暴》显式单位目标拒绝 fixture，P4.127/P4.130 已补《新月打击》友方目标和基地目标拒绝 fixtures，P4.128/P4.129 已补《换换乐》重复目标和基地目标拒绝 fixtures，七十九者均纳入基础动作聚合；固定打出获得经验、固定经验额外费用减费、《无极学徒》等级条件抽牌和《严厉军士》动态友方场上单位计数经验可玩；激活/条件经验和更多动态分支 deferred。 |
...
| 补测试/文档/状态文件并提交 | `CardCatalogBaselineTests`、`ConformanceFixtureRunnerTests`、README、本文件、git commit | Covered for P4.187 once committed. |
...
- `jq empty tests/Riftbound.ConformanceTests/Fixtures/p4-play-chemtech-barrel-target-rejected.fixture.json`：pass
- `source scripts/dev-env.sh && dotnet build Riftbound.slnx --no-restore`：pass，0 warnings，0 errors
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore`：pass，2071/2071
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~ConformanceFixtureRunnerTests"`：pass，1990/1990
...
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~P4ChemtechBarrelTargetRejectedFixture"`：pass，1/1
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen"`：pass，87/87
- `git diff --check`：pass

## Next Step

进入 P4.188：继续基于 completion audit 选择一个低风险、可验证的小批次。当前不能标记 P4 goal complete：更多技能目标税/通用 skill registry、待命触发/完整隐藏区/目标伤害、伏击真实反应战场打出、游走真实移动、完整战斗、完整装备装配/灵便/百炼、战斗/移动触发经验、《不死军团》废牌堆打出、德莱厄斯活跃/光环和其他急速牌彩色资源/活跃分支等仍有明确 deferred 项。
