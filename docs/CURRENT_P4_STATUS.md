...
- P4.273 提交：`17d4b3e test: add p4 mountain ape elder target fixture`
- P4.274 提交：`3e9abab test: add p4 sfd 089 rumble target fixture`
- P4.275 提交：`4b4e85a test: add p4 sfd 089a rumble target fixture`
- P4.276 提交：`ab580ca test: add p4 yordle explorer target fixture`
- P4.277 提交：`63a2f31 test: add p4 black market broker target fixture`
- P4.278 提交：`4e7e8d7 test: add p4 hunting sea crew target fixture`
- P4.279 提交：`4d37493 test: add p4 ghostly centaur target fixture`
- P4.280 提交：`514dd7c test: add p4 corrupt enforcer target fixture`
- P4.281 提交：`f752019 test: add p4 mighty faerie target fixture`
- P4.282 提交：`2c9407f test: add p4 jar meddarda target fixture`
- P4.283 提交：`5b8d9b1 test: add p4 sfd vex target fixture`
- P4.284 提交：`e3858a6 test: add p4 prominent patron target fixture`
- P4.285 提交：`1072eff test: add p4 royal attendant target fixture`
- P4.286 提交：`72834b2 test: add p4 sfd 049 aphelios target fixture`
- P4.287 提交：`3ea71c8 test: add p4 sfd 058 ornn target fixture`
- P4.288 提交：`c19b730 test: add p4 sfd 058a ornn target fixture`
- P4.289 提交：`a379775 test: add p4 sfd 079 bard target fixture`
- P4.290 提交：`d294a30 test: add p4 big swindler target fixture`
- P4.291 提交：`87ce764 test: add p4 sfd jayce target fixture`
- P4.292 提交：`b8a0f76 test: add p4 zaunite thug target fixture`
- P4.293 提交：`13322db test: add p4 glasc bartender target fixture`
- P4.294 提交：`1dbc24c test: add p4 sfd 170 reksai target fixture`
- P4.295 提交：`7ae660a test: add p4 sfd 170a reksai target fixture`
- P4.296 提交：`677448b test: add p4 sfd soraka target fixture`
- P4.297 提交：`fab4478 test: add p4 gai beast target fixture`
...
- P4.302 提交：`e284e77 test: add p4 move unit source rejection`
...
- P4.307 提交：`96d3fd0 test: add p4 move unit optional cost rejection`
- P4.308 提交：`7dace64 test: add p4 move unit unsupported zone rejection`
- P4.309 提交：`c453a15 test: add p4 move unit origin mismatch rejection`
- P4.310 提交：`0f7b425 test: add p4 move unit pending stack rejection`
- P4.311 提交：`5282588 test: add p4 move unit hand source rejection`
- P4.312 提交：`81a96cf test: add p4 standby hide source rejection`
- P4.313 提交：`71a8da7 test: add p4 standby hide destination rejection`
- P4.314 提交：`bd73989 test: add p4 standby hide optional cost rejection`
- P4.315 提交：`e37e460 test: add p4 standby hide window rejection`
- P4.316 提交：`1e53df4 test: add p4 standby hide pending stack rejection`
- P4.317 提交：`308b2df fix: reject p4 standby hide card identity mismatch`
- P4.318 提交：`482f1e9 test: add p4 standby reveal card identity rejection`
- P4.319 提交：`aed9c2a test: add p4 standby reveal source zone rejection`
- P4.320 提交：`079ed50 test: add p4 standby reveal faceup source rejection`
- P4.321 提交：`68918b5 test: add p4 standby reveal target rejection`
- P4.322 提交：`289ebb6 test: add p4 standby reveal optional cost rejection`
- P4.323 提交：`f6b992e test: add p4 standby reveal destination rejection`
- P4.324 提交：`aff8265 test: add p4 standby reaction target rejection`
- P4.325 提交：`671f7c8 test: add p4 ambush target rejection`
- P4.326 提交：`f6db7ea test: add p4 ambush destination rejection`
- P4.327 提交：`3b7d4f2 test: add p4 ambush priority rejection`
- P4.328 提交：`b47727e test: add p4 move unit precise destination rejection`
- P4.329 提交：`723c778 test: add p4 move unit precise origin rejection`
- P4.330 提交：`80c8010 test: add p4 assemble equipment priority rejection`
- P4.331 提交：`710d35f test: add p4 assemble equipment attached rejection`
- P4.332 提交：`7e5c4a2 test: add p4 declare battle priority rejection`
- P4.333 提交：`30e6694 test: add p4 move unit combatant rejection`
- P4.334 提交：`90e9e89 test: add p4 move unit attached equipment rejection`
- P4.335 提交：`6bc3824 test: add p4 ambush source zone rejection`
- P4.336 提交：`6eeabcf test: add p4 ambush card identity rejection`
- P4.337 提交：`b8e61ff test: add p4 ambush optional cost rejection`
- P4.338 提交：`1a3cb02 test: add p4 standby opponent source rejection`
...
- P4.343 提交：`b5c7dad test: add p4 standby reaction non-keyword rejection`
- P4.344 提交：`4e2c379 test: add p4 standby reaction missing cost rejection`
- P4.345 提交：`239799c test: add p4 standby reaction optional cost rejection`
- P4.346 提交：`28e30ae test: add p4 standby reaction face up rejection`
- P4.347 提交：`eb2fbcc test: add p4 standby reaction source zone rejection`
- P4.348 提交：`a3c8db5 test: add p4 standby reaction card identity rejection`
- P4.349 提交：`ecd9a06 test: add p4 standby reaction destination rejection`
- P4.350 提交：`18ed0c3 test: add p4 declare battle empty attackers rejection`
- P4.351 提交：`cc34df0 test: add p4 declare battle empty defenders rejection`
- P4.352 提交：`5ec5a7b test: add p4 declare battle missing battlefield rejection`
- P4.353 提交：`346e212 test: add p4 assemble equipment missing target rejection`
- P4.354 提交：`4a41422 test: add p4 assemble equipment missing source rejection`
- P4.355 提交：`88e84d1 test: add p4 assemble equipment hand source rejection`
- P4.356 提交：`a889ac9 test: add p4 assemble equipment opponent source rejection`
- P4.357 提交：`78c5e44 test: add p4 assemble equipment non equipment source rejection`
- P4.358 提交：`bf1053e test: add p4 assemble equipment non unit target rejection`
- P4.359 提交：`5495fec test: add p4 assemble equipment optional cost rejection`
- P4.360 提交：`756d070 test: add p4 assemble equipment missing optional cost rejection`
- P4.361 提交：`d0e2ffe test: add p4 declare battle optional cost rejection`
- P4.362 提交：`ac53092 test: add p4 declare battle missing optional cost rejection`
- P4.363 提交：`3b2eedf test: add p4 declare battle attacker zone rejection`
- P4.364 提交：`de3d071 test: add p4 declare battle defender zone rejection`
- P4.365 提交：`c4a5fd7 test: add p4 declare battle opponent attacker rejection`
...
- P4.370 提交：`6de5862 test: add p4 declare battle non active player rejection`
- P4.371 提交：`a40d55f test: add p4 declare battle non main phase rejection`
- P4.372 提交：`d6f7f65 test: add p4 declare battle unknown attacker rejection`
- P4.373 提交：`de3aeb0 test: add p4 declare battle unknown defender rejection`
- P4.374 提交：`96e7c15 test: add p4 declare battle unknown battlefield rejection`
- P4.375 提交：`099b336 test: add p4 assemble equipment unknown target rejection`
...
- P4.385 提交：`99add57 feat: add p4 hunt conquest experience`
- P4.386 提交：`1958ac7 feat: add p4 standby reaction resolution`
- P4.387 提交：`865532d feat: add p4 ambush battlefield reaction`
...
|---|---:|---:|---:|---:|---|---|
| `temp_might` | 292 | 255 | 36 | 1 | Low/Medium | P4.5 已有 primitive plan；P4.386 已验证待命反应结算可复用 P2 `POWER_MODIFIED_UNTIL_END_OF_TURN` 写入《提莫》自身 +3；其他真实状态写入仍由 P2 路径与清理负责。 |
| `damage` | 148 | 141 | 7 | 0 | Low/Medium | P4.5 已有基础固定伤害 primitive plan；动态伤害和替代效果继续委托 P2。 |
| `move` | 136 | 116 | 19 | 1 | Medium | P4.300/P4.301 已接入 `MOVE_UNIT` 在当前 coarse `BASE`/`BATTLEFIELD` 区域模型中的友方单位双向移动；P4.302-P4.311 已锁定对手来源、手牌来源、来源区域不匹配、面朝下来源、非单位来源、同区域目的地、行动窗口、结算链窗口、optional cost 与 unsupported zone 拒绝；P4.333/P4.334 已锁定战斗中来源和带贴附装备来源拒绝；P4.98 仍锁定精确战场/`ROAM` 前置拒绝 fixture；P4.328/P4.329 已锁定无 `ROAM` 精确战场目的地/来源拒绝；精确多战场/游走/此处目的地仍需后续模型。 |
...
| `assemble` | 55 | 53 | 2 | 0 | High | P4.58 已把《取放自如》武装贴附/卸除作为 P2 手写代表路径纳入 P4 证据；P4.66 已新增 `ASSEMBLE_EQUIPMENT` command envelope 与 Core 显式拒绝前置模型；P4.99/P4.330/P4.331/P4.353-P4.360/P4.375/P4.376 已补装配前置和非法边界拒绝 fixture；P4.388 已把《长剑》最小 `ASSEMBLE_RED` 装配从前置拒绝提升为 accepted 代表路径，支付 1 power 并写入 `attachedToObjectId`；通用装配费用、owner/controller、灵便自动贴附、百炼 optional attach 仍属高风险边界。 |
...
| `ambush` | 18 | 18 | 0 | 0 | High | P4.9 已识别 profile；P4.387 已验证官网《阴森药剂师》无目标伏击在优先权窗口入栈并结算进入控制者战场的代表路径；广义伏击目标/多卡、完整多战场目的地和 face-down 交互仍 deferred。 |
...
| 强攻 | 37 | 2 | 0 | High | P4.6 已识别 profile 和数值；P4.67/P4.100/P4.332/P4.350-P4.374 已建立并锁定 `DECLARE_BATTLE` envelope 与拒绝边界；P4.381 已接入单攻击者/单防守者声明代表路径；P4.382 已在同一路径应用《盖伦》`强攻2` 的进攻战斗伤害数值并写入 `DAMAGE_APPLIED` payload；多攻防对象、动态强攻、得分和完整承伤顺序仍 deferred。 |
| 坚守 | 24 | 4 | 0 | High | P4.6 已识别 profile 和数值；P4.67/P4.100/P4.332/P4.350-P4.374 已建立并锁定 `DECLARE_BATTLE` envelope 与拒绝边界；P4.381 已接入单攻击者/单防守者声明代表路径；P4.382 已在同一路径应用《变异猫咪》`坚守2` 的防守战斗伤害数值并写入 `DAMAGE_APPLIED` payload；多攻防对象、动态坚守、得分和完整承伤顺序仍 deferred。 |
| 壁垒 | 26 | 0 | 0 | High | P4.6 已识别 profile；P4.67/P4.100/P4.332/P4.350-P4.374 已建立并锁定 `DECLARE_BATTLE` envelope 与拒绝边界；P4.383 已在最小单攻击者/两防守者路径中按《变异猫咪》`壁垒` 优先分配致命伤害，再把剩余伤害给后排防守者；同优先级选择、更多防守者、战场得分和完整战斗结束清理仍 deferred。 |
| 后排 | 6 | 0 | 0 | High | P4.6 已识别 profile；P4.67/P4.100/P4.332/P4.350-P4.374 已建立并锁定 `DECLARE_BATTLE` envelope 与拒绝边界；P4.383 已在最小单攻击者/两防守者路径中验证《乐芙兰》`后排` 在同控制者壁垒/非后排单位被分配致命伤害后才承受剩余进攻伤害；同优先级选择、更多防守者、战场得分和完整战斗结束清理仍 deferred。 |
...
| 待命 | 47 | 7 | 0 | High | P4.9 已识别 profile；P4.63 已新增 `HIDE_CARD` typed command；P4.68 已新增 `REVEAL_CARD` typed command；P4.69 已补对手视角正面朝下对象 snapshot redaction；P4.70 已接入 `STANDBY_A` 最小正面朝下放置代表路径；P4.94 已补同一路径费用不足拒绝 fixture；P4.312 已补同一路径来源不在手牌拒绝 fixture；P4.338 已补同一路径来源在对手手牌拒绝 fixture；P4.339 已补已知非待命牌拒绝 fixture；P4.313 已补同一路径目的地不支持拒绝 fixture；P4.314 已补同一路径费用名不支持拒绝 fixture；P4.340 已补缺少待命支付项拒绝 fixture；P4.315 已补同一路径行动窗口拒绝 fixture；P4.316 已补同一路径 stack 非空拒绝 fixture；P4.317 已补同一路径来源 `cardNo` 身份不匹配拒绝 fixture；P4.71 已接入 `STANDBY_REVEAL` 基地显露代表路径；P4.318 已补显露路径来源 `cardNo` 身份不匹配拒绝 fixture；P4.348 已补反应入栈路径来源 `cardNo` 身份不匹配拒绝 fixture；P4.319 已补显露路径来源不在玩家基地拒绝 fixture；P4.320 已补显露路径来源已公开拒绝 fixture；P4.347 已补反应入栈路径来源不在玩家基地拒绝 fixture；P4.346 已补反应入栈路径来源已公开拒绝 fixture；P4.321 已补显露路径带目标拒绝 fixture；P4.322 已补显露路径费用名不支持拒绝 fixture；P4.341 已补显露路径缺少支付项拒绝 fixture；P4.342 已补显露路径已知非待命牌拒绝 fixture；P4.343 已补反应入栈路径已知非待命牌拒绝 fixture；P4.344 已补反应入栈路径缺少支付项拒绝 fixture；P4.345 已补反应入栈路径 unsupported optional cost 拒绝 fixture；P4.323 已补显露路径目的地不支持拒绝 fixture；P4.349 已补反应入栈路径目的地不支持拒绝 fixture；P4.324 已补反应入栈带目标拒绝 fixture；P4.390 已横向审计显露/反应入栈两条带目标 deferred fixture，锁定不推进 tick、不写事件、不翻开对象、不伤害目标、不新增结算链项目；P4.72 已接入《游击战》`FREE_STANDBY_HIDE` / `STANDBY_FREE` 免费暗置代表路径；P4.96 已补 `STANDBY_FREE` 无权限拒绝 fixture；P4.102 已补《游击战》非待命废牌堆目标拒绝 fixture；P4.76 已接入 `STANDBY_REACTION` 优先权窗口无目标反应入栈代表路径；P4.95 已补同一路径无优先权窗口拒绝 fixture；P4.386 已验证《提莫》待命反应入栈后结算并触发自身本回合 +3 的代表路径；待命目标伤害执行、战场/完整隐藏区位置限制和其他待命触发仍 deferred。 |
2026-06-28 B0 注记：P4.321/P4.324 的 rejected fixtures 当前只代表 base 来源缺少可解析“此战场”上下文的 guard；battlefield-source `OGN·121/298` / `OGN·121a/298` / `SFD·230/221` / `SFD·230*/221` Teemo 同战场目标、顶五张展示、按 `待命` 数量伤害和回收展示牌已由 `ActionPromptRevealCardMetadataExposesBattlefieldStandbyReactionTargets`、`P4RevealCardCommandBattlefieldStandbyReactionTargetDamageCountsTopFiveStandbyCards` 与 `StandbyReactionSfdTeemoTests` 覆盖；base face-down Teemo 在 `SpellDuelClosed` stack priority 中从 `SpellDuelState.BattlefieldObjectId` 解析“此战场”的目标伤害路径已由 `ActionPromptRevealCardMetadataExposesBaseStandbyReactionTargetsFromSpellDuelContext` 与 `P4RevealCardCommandBaseStandbyReactionTargetDamageUsesSpellDuelBattlefieldContext` 覆盖；base face-down Teemo 在 completed-spell-duel `DECLARE_BATTLE` battle response 中从 `BattleState.BattlefieldObjectId` 解析“此战场”的目标伤害路径已由 `DeclareBattleOpensStandbyReactionBattleResponseForDefender` 与 `BaseStandbyReactionTargetDamageUsesBattleResponseBattlefieldContext` 覆盖；正面 Teemo 被声明为防守单位时的代表性同战场目标、顶五张展示、按 `待命` 数量伤害、回收展示牌、多合法目标 prompt metadata、显式目标选择，以及与官方 Fortified Position / Plunder Alley 战场防守效果目标的组合 multiplexing 已由 `StandbyDefendTeemoTests` 覆盖；其中 Plunder Alley 已按 `FRIENDLY_UNIT_AT_THIS_BATTLEFIELD` 覆盖 exhausted 非防守友方单位目标，prompt 目标槽来自 generic trigger spec。非 active battle/spell-duel base 上下文、完整待命牌族和 READY 仍未关闭。
| 回响 | 22 | 2 | 0 | Medium | P4.4 已完成 mana-only optional cost/repeat 模型；复杂额外费用、授予回响和模式重复仍后续拆分。 |
| 伏击 | 18 | 0 | 0 | High | P4.9 已识别 profile；P4.64 已新增 `PLAY_CARD mode=AMBUSH` + `destination` 前置模型；P4.97/P4.325/P4.326/P4.327/P4.335/P4.377/P4.378/P4.379/P4.336/P4.337 已把无目标前置、带目标、`BASE` 目的地、无己方战场单位、来源不在手牌、未知来源、对手手牌来源、非伏击来源、来源 `cardNo` 不匹配和 unsupported optional cost 拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.387 已把官网《阴森药剂师》无目标伏击在优先权窗口从手牌支付 3、入栈、双方让过后进入控制者战场的代表路径接入 Core，并通过 `p4-ambush-play-card-gloomy-apothecary-battlefield.fixture.json` 覆盖；可选回手目标、其他伏击牌、完整多战场目的地和隐藏信息仍 deferred。 |
| 装配 | 51 | 0 | 0 | High | P4.8 已识别 profile；P4.58 已审计并锁定《取放自如》贴附/卸除武装的代表执行路径；P4.66 已新增 `ASSEMBLE_EQUIPMENT` typed command 与 Core 显式拒绝前置模型；P4.99-P4.360/P4.375/P4.376 已补普通窗口、优先权窗口、已贴附来源、缺少/未知目标、缺少/未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture；P4.388 已接入《长剑》最小 `ASSEMBLE_RED` 装配 accepted 路径；P4.334 已补移动带贴附装备来源拒绝 fixture；通用装配费用、装备未激活文本和自动贴附仍 deferred。 |
| 灵便 | 6 | 0 | 0 | High | P4.8 已识别 profile；P4.58 的代表路径只覆盖已有反应法术《取放自如》；P4.66 已为灵便装备后续自动贴附保留 `ASSEMBLE_EQUIPMENT` envelope；P4.99-P4.360/P4.375/P4.376 已补装配前置和非法边界拒绝 fixture；P4.388 已验证《长剑》作为带 `灵便` / `武装` 标签的基地装备可通过最小装配命令贴附到己方单位；真实反应打出和打出时自动贴附仍 deferred。 |
| 百炼 | 16 | 2 | 0 | High | P4.8 已识别 profile；P4.66 已为百炼 optional attach 保留 `ASSEMBLE_EQUIPMENT` envelope，P4.99/P4.330/P4.331/P4.353/P4.375/P4.354/P4.376/P4.355/P4.356/P4.357/P4.358/P4.359/P4.360 已补前置、优先权窗口、已贴附来源、缺少目标、未知目标、缺少来源、未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture；FAQ 指明的可选装配和贴附边界仍 deferred，P4.58/P4.66 不改变该边界。 |
...
| Move | `UNL-101/219 战斗号令`：将你控制的一名单位移动至你控制的一处战场；`OGN·173/298 驭风而行`：移动一名友方单位；`OGN·043/298 魅惑妖术` / `OGN·168/298 战或逃`：将战场单位移动到基地；`SFD·235/221 亚索`：游走、单回合第三次移动得分；`OGN·121/298 提莫`：待命正面朝下来源边界；`SFD·022/221 长剑`：装备非单位来源边界；`UNL-036/219 变异猫咪`：壁垒/防守状态代表。 | P2 已有 `UNIT_MOVED_TO_BASE` / `UNIT_MOVED_TO_BATTLEFIELD` 原语；P4.65 新增 `MoveUnitCommand` / `GameCommandMapperParsesMoveUnitPayload`；P4.98 新增 `P4MoveUnitCommandRejectionFixture` / `p4-move-unit-command-premodel-rejected.fixture.json`；P4.300 新增 `P4MoveUnitCommandMovesFriendlyBaseUnitToBattlefieldInCoarseModel` / `P4MoveUnitCommandBaseToBattlefieldFixture` / `p4-move-unit-base-to-battlefield.fixture.json`；P4.301 新增 `P4MoveUnitCommandMovesFriendlyBattlefieldUnitToBaseInCoarseModel` / `P4MoveUnitCommandBattlefieldToBaseFixture` / `p4-move-unit-battlefield-to-base.fixture.json`；P4.302 新增 `P4MoveUnitCommandRejectsOpponentControlledSource` / `P4MoveUnitCommandOpponentSourceRejectionFixture` / `p4-move-unit-opponent-source-rejected.fixture.json`；P4.303 新增 `P4MoveUnitCommandRejectsFaceDownSource` / `P4MoveUnitCommandFaceDownSourceRejectionFixture` / `p4-move-unit-face-down-source-rejected.fixture.json`；P4.304 新增 `P4MoveUnitCommandRejectsNonUnitSource` / `P4MoveUnitCommandNonUnitSourceRejectionFixture` / `p4-move-unit-non-unit-source-rejected.fixture.json`；P4.305 新增 `P4MoveUnitCommandRejectsSameZoneDestination` / `P4MoveUnitCommandSameZoneDestinationRejectionFixture` / `p4-move-unit-same-zone-destination-rejected.fixture.json`；P4.306 新增 `P4MoveUnitCommandRejectsOutsideActivePlayerOpenMainWindow` / `P4MoveUnitCommandWindowRejectionFixture` / `p4-move-unit-window-rejected.fixture.json`；P4.307 新增 `P4MoveUnitCommandRejectsOptionalCostsUntilRoamModelExists` / `P4MoveUnitCommandOptionalCostRejectionFixture` / `p4-move-unit-optional-cost-rejected.fixture.json`；P4.308 新增 `P4MoveUnitCommandRejectsUnsupportedCoarseZones` / `P4MoveUnitCommandUnsupportedZoneRejectionFixture` / `p4-move-unit-unsupported-zone-rejected.fixture.json`；P4.309 新增 `P4MoveUnitCommandRejectsSourceOutsideRequestedOrigin` / `P4MoveUnitCommandOriginMismatchRejectionFixture` / `p4-move-unit-origin-mismatch-rejected.fixture.json`；P4.310 新增 `P4MoveUnitCommandRejectsPendingStackWindow` / `P4MoveUnitCommandPendingStackRejectionFixture` / `p4-move-unit-pending-stack-rejected.fixture.json`；P4.311 新增 `P4MoveUnitCommandRejectsSourceStillInHand` / `P4MoveUnitCommandHandSourceRejectionFixture` / `p4-move-unit-hand-source-rejected.fixture.json`；P4.333 新增 `P4MoveUnitCommandRejectsCombatantSourceUntilCombatMovementExists` / `P4MoveUnitCommandCombatantSourceRejectionFixture` / `p4-move-unit-combatant-source-rejected.fixture.json`；P4.334 新增 `P4MoveUnitCommandRejectsAttachedEquipmentSourceUntilAttachmentMovementExists` / `P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture` / `p4-move-unit-attached-equipment-source-rejected.fixture.json`；P4.328 新增 `P4MoveUnitCommandRejectsPreciseBattlefieldDestinationWithoutRoamCost` / `P4MoveUnitCommandPreciseDestinationRejectionFixture` / `p4-move-unit-precise-destination-rejected.fixture.json`；P4.329 新增 `P4MoveUnitCommandRejectsPreciseBattlefieldOriginWithoutRoamCost` / `P4MoveUnitCommandPreciseOriginRejectionFixture` / `p4-move-unit-precise-origin-rejected.fixture.json`。 | P4.300/P4.301 已在 Core 接入 coarse `BASE` / `BATTLEFIELD` 友方单位双向移动并保留精确战场/`ROAM` 拒绝；P4.302-P4.311/P4.333/P4.334 已锁定来源必须由当前玩家控制、来源实际区域必须匹配 command `origin`、来源必须已经位于公开场上区域而不是手牌、为正面单位、不是装备等非单位对象，不能处于进攻/防守战斗状态，也不能带已贴附装备，目的地必须不同，只能由主动玩家在主阶段开放窗口且结算链为空时发起，当前不接受 `ROAM` 等 optional cost，且 `origin` / `destination` 只接受 `BASE` 与 `BATTLEFIELD`；P4.328/P4.329 进一步锁定无 `ROAM` 精确战场目的地/来源仍拒绝；多战场目的地、游走权限、战斗移动、装备随动、移动次数和移动触发后续建模。 |
...
| Combat keywords | `OGS·007/024 盖伦`：强攻2、坚守2；`UNL-036/219 变异猫咪`：坚守2、壁垒；`UNL-090/219 乐芙兰`：后排；`SFD·096/221 劳伦特护刃者`：游走。 | P2 已有大量 keyword-unit fixture 记录标签；P4.65 新增 `MoveUnitCommand` / `GameCommandMapperParsesMoveUnitPayload`；P4.98 新增 `P4MoveUnitCommandRejectionFixture` / `p4-move-unit-command-premodel-rejected.fixture.json`；P4.300 新增 coarse move positive fixture；P4.328/P4.329 新增无 `ROAM` 精确战场目的地/来源拒绝 fixture；P4.333 新增 `P4MoveUnitCommandRejectsCombatantSourceUntilCombatMovementExists` / `P4MoveUnitCommandCombatantSourceRejectionFixture` / `p4-move-unit-combatant-source-rejected.fixture.json`；P4.67 新增 `P4DeclareBattleCommandIsExplicitlyRejectedUntilCombatSystemExists` / `GameCommandMapperParsesDeclareBattlePayload`；P4.100 新增 `P4DeclareBattleCommandRejectionFixture` / `p4-declare-battle-command-premodel-rejected.fixture.json`；P4.332 新增 `P4DeclareBattleCommandInPriorityWindowIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandPriorityWindowRejectionFixture` / `p4-declare-battle-priority-window-rejected.fixture.json`；P4.350 新增 `P4DeclareBattleCommandWithEmptyAttackersIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandEmptyAttackersRejectionFixture` / `p4-declare-battle-empty-attackers-rejected.fixture.json`；P4.351 新增 `P4DeclareBattleCommandWithEmptyDefendersIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandEmptyDefendersRejectionFixture` / `p4-declare-battle-empty-defenders-rejected.fixture.json`；P4.352 新增 `P4DeclareBattleCommandWithMissingBattlefieldIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandMissingBattlefieldRejectionFixture` / `p4-declare-battle-missing-battlefield-rejected.fixture.json`；P4.374 新增 `P4DeclareBattleCommandWithUnknownBattlefieldIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandUnknownBattlefieldRejectionFixture` / `p4-declare-battle-unknown-battlefield-rejected.fixture.json`；P4.361 新增 `P4DeclareBattleCommandWithUnsupportedOptionalCostIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandUnsupportedOptionalCostRejectionFixture` / `p4-declare-battle-unsupported-optional-cost-rejected.fixture.json`；P4.362 新增 `P4DeclareBattleCommandWithMissingOptionalCostIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandMissingOptionalCostRejectionFixture` / `p4-declare-battle-missing-optional-cost-rejected.fixture.json`；P4.363 新增 `P4DeclareBattleCommandWithAttackerOutsideBattlefieldIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandAttackerOutsideBattlefieldRejectionFixture` / `p4-declare-battle-attacker-outside-battlefield-rejected.fixture.json`；P4.364 新增 `P4DeclareBattleCommandWithDefenderOutsideBattlefieldIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandDefenderOutsideBattlefieldRejectionFixture` / `p4-declare-battle-defender-outside-battlefield-rejected.fixture.json`；P4.365 新增 `P4DeclareBattleCommandWithOpponentAttackerIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandOpponentAttackerRejectionFixture` / `p4-declare-battle-opponent-attacker-rejected.fixture.json`；P4.366 新增 `P4DeclareBattleCommandWithCurrentPlayerDefenderIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandCurrentPlayerDefenderRejectionFixture` / `p4-declare-battle-current-player-defender-rejected.fixture.json`；P4.367 新增 `P4DeclareBattleCommandWithDuplicateAttackerIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandDuplicateAttackerRejectionFixture` / `p4-declare-battle-duplicate-attacker-rejected.fixture.json`；P4.368 新增 `P4DeclareBattleCommandWithDuplicateDefenderIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandDuplicateDefenderRejectionFixture` / `p4-declare-battle-duplicate-defender-rejected.fixture.json`；P4.369 新增 `P4DeclareBattleCommandWithAttackerAlsoDefenderIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandAttackerDefenderOverlapRejectionFixture` / `p4-declare-battle-attacker-defender-overlap-rejected.fixture.json`；P4.370 新增 `P4DeclareBattleCommandByNonActivePlayerIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandNonActivePlayerRejectionFixture` / `p4-declare-battle-non-active-player-rejected.fixture.json`；P4.371 新增 `P4DeclareBattleCommandOutsideMainPhaseIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandNonMainPhaseRejectionFixture` / `p4-declare-battle-non-main-phase-rejected.fixture.json`；P4.372 新增 `P4DeclareBattleCommandWithUnknownAttackerIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandUnknownAttackerRejectionFixture` / `p4-declare-battle-unknown-attacker-rejected.fixture.json`；P4.373 新增 `P4DeclareBattleCommandWithUnknownDefenderIsRejectedUntilCombatSystemExists` / `P4DeclareBattleCommandUnknownDefenderRejectionFixture` / `p4-declare-battle-unknown-defender-rejected.fixture.json`。 | P4.6 已建立 combat keyword profile；P4.300 已把基础 `MOVE_UNIT` coarse 区域移动接入可玩路径，P4.98/P4.328/P4.329 继续锁定精确战场移动拒绝，P4.333 已锁定战斗中来源移动拒绝；P4.67/P4.100/P4.332/P4.350/P4.351/P4.352/P4.361/P4.362/P4.363/P4.364/P4.365/P4.366/P4.367/P4.368/P4.369/P4.370/P4.371/P4.372/P4.373/P4.374 已锁定战斗声明普通窗口、优先权窗口、空攻击者/空防守者列表、缺少战场 id、未知战场 id、unsupported optional cost、缺少战斗费用、攻击者非战场来源、防守者非战场来源、对手控制攻击者、当前玩家控制防守者、重复攻击者、重复防守者、攻防列表交叉、非主动玩家声明战斗、非主阶段声明战斗、未知攻击者和未知防守者拒绝；完整战斗和真实跨战场游走仍 deferred。 |
| Resource keywords | `UNL-100/219 贪食魔沼蛙`：狩猎3；`UNL-047/219 踏苔蜥`：狩猎2、等级3；`UNL-075/219 风行狐`：狩猎2、等级3；`UNL-040/219 无极学徒`：狩猎、等级6；`UNL-113/219 易`：狩猎2、等级6；`UNL-113a/219 易`：狩猎2、等级6；`OGN·012/298 诺克萨斯新兵`：鼓舞费用；`OGN·016/298 危险二人组`：鼓舞目标临时战力；`OGN·020/298 垃圾场小霸王`：鼓舞弃 2 抽 2；`OGN·217/298 崔法利求战者`：鼓舞自增益；`OGN·218/298 先锋队长`：鼓舞创建两名随从；`OGN·013/298 呸呸魄罗`：法盾；`SFD·085/221 奥恩`：法盾2；`OGN·256/298 妖异狐火`：多目标法盾税代表法术；`OGN·053/298 秘奥义！慈悲度魂落`：友方法盾目标 no-tax 代表法术；`UNL-030/219 蔚`：法盾与“支付2和红色”激活技能文本；`UNL-026/219 泽拉斯`：红色+横置对一名单位造成 3 点伤害。 | P2 已有 keyword-unit fixture 记录标签或 no-optional 分支；P4.12 新增 `p4-play-incinerate-spellshield-tax`；P4.104 新增 `p4-play-incinerate-spellshield-tax-insufficient-rejected`；P4.14 新增 `p4-play-noxian-recruit-encourage-cost-reduction`；P4.15 新增 `p4-play-moss-stepper-level3-spellshield`；P4.16 新增 `p4-play-windrunner-fox-level3-roam`；P4.17 新增 `p4-play-wuji-apprentice-level6-draw`；P4.21 新增 `p4-play-trifarian-gloryseeker-encourage-self-boon`；P4.22 新增 `p4-play-dangerous-duo-encourage-target-temp-might`；P4.23 新增 `p4-play-junkyard-bully-encourage-discard-draw`；P4.24 新增 `p4-play-vanguard-captain-encourage-create-minions`；P4.28 新增 `p4-play-unl-yi-level6-spellshield-roam`；P4.29 新增 `p4-play-unl-yi-alt-a-level6-spellshield-roam`；P4.59 新增 `p4-play-spirit-fire-multiple-spellshield-tax`；P4.61 新增 `p4-play-secret-art-mercy-friendly-spellshield-no-tax`；P4.62 新增 `GameCommandMapperParsesActivateAbilityPayload`；P4.389 新增 `P4ActivatedAbilityCatalogExposesRepresentativeSkillDefinitions`；P4.73/P4.74 新增 `P4ActivateAbilityCommandAddsViDoublePowerSkillToStack` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillWithTargets` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillWhenPowerIsMissing` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillFromNonViSource` / `P4ActivateAbilityCommandResolvesViDoublePowerSkillOnStack` / `P4ActivateAbilityCommandUsesCardIdentityAfterViIsPlayed` / `p4-activate-vi-double-power-skill` / `p4-play-then-activate-vi-double-power-skill`；P4.87-P4.92 新增 `P4ActivateAbilityCommandRejectsViDoublePowerSkillFromOpponentSource` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillOpponentSourceFixture` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillWhenSourceIsNotField` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillSourceNotFieldFixture` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillTargetFixture` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillWithOptionalCosts` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillOptionalCostFixture` / `p4-activate-vi-double-power-skill-opponent-source-rejected` / `p4-activate-vi-double-power-skill-source-not-field-rejected` / `p4-activate-vi-double-power-skill-target-rejected` / `p4-activate-vi-double-power-skill-optional-cost-rejected` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillPowerMissingFixture` / `p4-activate-vi-double-power-skill-power-missing-rejected` / `P4ActivateAbilityCommandRejectsViDoublePowerSkillNonViSourceFixture` / `p4-activate-vi-double-power-skill-non-vi-source-rejected`；P4.77-P4.86/P4.93 新增 `P4ActivateAbilityCommandAddsXerathDamageSkillWithSpellshieldTaxToStack` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSpellshieldTaxManaIsMissing` / `P4ActivateAbilityCommandRejectsXerathDamageSkillSpellshieldTaxInsufficientFixture` / `P4ActivateAbilityCommandResolvesXerathDamageSkillWithSpellshieldTax` / `P4ActivateAbilityCommandDoesNotTaxXerathDamageSkillForFriendlySpellshieldTarget` / `P4ActivateAbilityCommandResolvesXerathDamageSkillWithoutTaxForFriendlySpellshield` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSourceIsExhausted` / `P4ActivateAbilityCommandRejectsXerathDamageSkillFromExhaustedSourceFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTargetIsMissing` / `P4ActivateAbilityCommandRejectsXerathDamageSkillMissingTargetFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTooManyTargetsAreProvided` / `P4ActivateAbilityCommandRejectsXerathDamageSkillTooManyTargetsFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWithOptionalCosts` / `P4ActivateAbilityCommandRejectsXerathDamageSkillOptionalCostFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillFromNonXerathSource` / `P4ActivateAbilityCommandRejectsXerathDamageSkillNonXerathSourceFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTargetIsNotUnit` / `P4ActivateAbilityCommandRejectsXerathDamageSkillNonUnitTargetFixture` / `P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSourceIsNotBattlefield` / `P4ActivateAbilityCommandRejectsXerathDamageSkillSourceNotBattlefieldFixture` / `p4-activate-xerath-damage-skill-spellshield-tax` / `p4-activate-xerath-damage-skill-spellshield-tax-insufficient-rejected` / `p4-activate-xerath-damage-skill-friendly-spellshield-no-tax` / `p4-activate-xerath-damage-skill-exhausted-source-rejected` / `p4-activate-xerath-damage-skill-missing-target-rejected` / `p4-activate-xerath-damage-skill-too-many-targets-rejected` / `p4-activate-xerath-damage-skill-optional-cost-rejected` / `p4-activate-xerath-damage-skill-non-xerath-source-rejected` / `p4-activate-xerath-damage-skill-non-unit-target-rejected` / `p4-activate-xerath-damage-skill-source-not-battlefield-rejected`。 | P4.7 已建立 resource keyword profile；P4.12 已执行法术选择敌方场上法盾对象的 mana 目标税，P4.104 已把《焚烧》敌方法盾目标税费用不足拒绝边界纳入 fixture 和资源关键词聚合回放；P4.14 已执行《诺克萨斯新兵》鼓舞费用 -2 代表路径；P4.15 已执行《踏苔蜥》`等级3` 入场 +1 与法盾代表路径；P4.16 已执行《风行狐》`等级3` 入场 +1 与游走代表路径；P4.17 已执行《无极学徒》`等级6` 打出抽 1 代表路径；P4.21 已执行《崔法利求战者》鼓舞自增益代表路径；P4.22 已执行《危险二人组》鼓舞目标临时战力代表路径；P4.23 已执行《垃圾场小霸王》鼓舞弃 2 抽 2 代表路径；P4.24 已执行《先锋队长》鼓舞创建两名 1 战力随从代表路径；P4.28 已执行《易》`等级6` 法盾/游走代表路径；P4.29 已执行《易》A 版本 `等级6` 法盾/游走代表路径；P4.59 已执行《妖异狐火》同时选择 `法盾` 与 `法盾2` 敌方场上单位时的目标税聚合；P4.61 已执行《秘奥义！慈悲度魂落》选择己方 `法盾` 单位时 `spellshieldTaxMana = 0` 的友方目标边界；P4.73 已执行《蔚》`PAY_2_RED_DOUBLE_POWER` 无目标付费技能入栈并结算自身本回合战力翻倍，P4.74 已补场上对象 `cardNo` 身份校验并拒绝非《蔚》来源伪造 ability id，P4.87-P4.92 已锁定同一技能的对手控制来源、来源不在场上、带目标、额外费用、费用不足和非《蔚》来源拒绝边界且不改状态，并由资源关键词聚合回放覆盖；P4.77 已执行《泽拉斯》`PAY_RED_EXHAUST_DAMAGE_3` 带目标技能，对敌方 `法盾` 单位支付 1 mana 目标税 + 1 power、横置来源并结算 3 点伤害；P4.78 已执行同一技能选择己方 `法盾` 单位时 `spellshieldTaxMana = 0` 且仍支付 1 power/横置/造成 3 点伤害的边界；P4.79-P4.86/P4.93 已锁定同一技能的敌方法盾目标税费用不足、已横置来源、缺目标、多目标、额外费用、非《泽拉斯》来源、非单位目标和来源不在战场拒绝、对手控制来源拒绝边界且不改状态，并由资源关键词聚合回放覆盖；狩猎征服/据守经验、其他等级条件、其他鼓舞效果、除《蔚》《泽拉斯》已登记代表外的更多技能目标税和授予/静态法盾仍 deferred。 |
| Equipment keywords | `SFD·033/221 多兰之盾`：装配绿色；`SFD·022/221 长剑`：灵便、装配红色；`SFD·008/221 哨兵好手`：百炼；`SFD·085/221 奥恩`：法盾2、百炼；`SFD·011/221 取放自如`：选择一名单位和其控制者的一件武装，为该单位贴附或卸除该武装，抽一张牌。 | P2 已有装备打出和 no-optional 百炼 fixture，记录装备/武装/灵便/百炼标签；P4.58 复用 `p2-preflight-play-take-up-attach-weapon-draw` 与 `p2-preflight-play-take-up-detach-weapon-draw` 作为武装贴附/卸除代表执行证据；P4.66 新增 `GameCommandMapperParsesAssembleEquipmentPayload`；P4.388 新增 `P4AssembleEquipmentCommandAttachesLongSwordToFriendlyUnit` / `P4AssembleEquipmentCommandLongSwordAttachFixture` / `p4-assemble-equipment-long-sword-attach.fixture.json`；P4.330-P4.360/P4.375/P4.376 已补优先权窗口、已贴附来源、缺少/未知目标、缺少/未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture；P4.334 新增 `P4MoveUnitCommandRejectsAttachedEquipmentSourceUntilAttachmentMovementExists` / `P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture` / `p4-move-unit-attached-equipment-source-rejected.fixture.json`。 | P4.8 已建立 equipment keyword profile；P4.58 已锁定《取放自如》贴附/卸除代表路径；P4.66 已建立 `ASSEMBLE_EQUIPMENT` command envelope；P4.388 已把《长剑》最小装配命令接入 accepted 路径；P4.330-P4.360/P4.375/P4.376 已把优先权窗口、已贴附来源、缺少/未知目标、缺少/未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝边界纳入 conformance fixture；P4.334 已锁定带贴附装备单位不能通过当前 coarse `MOVE_UNIT` 离区；通用装配费用、灵便自动贴附、百炼 optional attach、owner/controller、装备随动和未激活文本仍 deferred。 |
...
| Interaction remaining | `OGN·121/298 提莫`：待命；`OGN·199/298 控潮者`：待命；`OGN·264/298 游击战`：待命免费暗置权限；`UNL-021/219 阴森药剂师`：伏击；`UNL-176a/219 蔚`：伏击。 | P2 已有普通打出/静态 fixture；`回响` 已有 P4.4 mana-only 执行路径；P4.63 新增 `GameCommandMapperParsesHideCardPayload`；P4.64 新增 `P4AmbushPlayCardModeIsExplicitlyRejectedUntilBattlefieldReactionPlayExists` / `GameCommandMapperParsesAmbushPlayCardDestination`；P4.97 新增 `P4AmbushPlayCardModeRejectionFixture` / `p4-ambush-play-card-premodel-rejected.fixture.json`；P4.325 新增 `P4AmbushPlayCardModeWithTargetIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModeWithTargetRejectionFixture` / `p4-ambush-play-card-target-rejected.fixture.json`；P4.326 新增 `P4AmbushPlayCardModeWithBaseDestinationIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModeWithBaseDestinationRejectionFixture` / `p4-ambush-play-card-base-destination-rejected.fixture.json`；P4.327 新增 `P4AmbushPlayCardModeInPriorityWindowIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModePriorityWindowRejectionFixture` / `p4-ambush-play-card-priority-window-rejected.fixture.json`；P4.377 新增 `P4AmbushPlayCardModeUnknownSourceIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModeUnknownSourceRejectionFixture` / `p4-ambush-play-card-unknown-source-rejected.fixture.json`；P4.378 新增 `P4AmbushPlayCardModeOpponentHandSourceIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModeOpponentHandSourceRejectionFixture` / `p4-ambush-play-card-opponent-hand-source-rejected.fixture.json`；P4.379 新增 `P4AmbushPlayCardModeNonAmbushHandSourceIsRejectedUntilBattlefieldReactionPlayExists` / `P4AmbushPlayCardModeNonAmbushHandSourceRejectionFixture` / `p4-ambush-play-card-non-ambush-source-rejected.fixture.json`；P4.68 新增 `GameCommandMapperParsesRevealCardPayload`；P4.69 新增 `SnapshotsRedactOpponentFaceDownObjects`；P4.70 新增 `P4HideCardCommandPlacesStandbyCardFaceDown` / `P4HideCardCommandRejectsInsufficientStandbyCost` / `p4-hide-card-standby-face-down.fixture.json`；P4.94 新增 `P4HideCardCommandRejectsInsufficientStandbyCostFixture` / `p4-hide-card-standby-insufficient-cost-rejected.fixture.json`；P4.312 新增 `P4HideCardCommandRejectsSourceOutsideHand` / `P4HideCardCommandSourceOutsideHandRejectionFixture` / `p4-hide-card-standby-source-outside-hand-rejected.fixture.json`；P4.338 新增 `P4HideCardCommandRejectsOpponentHandSource` / `P4HideCardCommandOpponentHandSourceRejectionFixture` / `p4-hide-card-standby-opponent-hand-source-rejected.fixture.json`；P4.339 新增 `P4HideCardCommandRejectsKnownNonStandbyCard` / `P4HideCardCommandKnownNonStandbyCardRejectionFixture` / `p4-hide-card-known-non-standby-rejected.fixture.json`；P4.313 新增 `P4HideCardCommandRejectsUnsupportedDestination` / `P4HideCardCommandUnsupportedDestinationRejectionFixture` / `p4-hide-card-standby-unsupported-destination-rejected.fixture.json`；P4.314 新增 `P4HideCardCommandRejectsUnsupportedOptionalCost` / `P4HideCardCommandUnsupportedOptionalCostRejectionFixture` / `p4-hide-card-standby-unsupported-optional-cost-rejected.fixture.json`；P4.340 新增 `P4HideCardCommandRejectsMissingStandbyCost` / `P4HideCardCommandMissingStandbyCostRejectionFixture` / `p4-hide-card-standby-missing-cost-rejected.fixture.json`；P4.315 新增 `P4HideCardCommandRejectsOutsideActivePlayerOpenMainWindow` / `P4HideCardCommandWindowRejectionFixture` / `p4-hide-card-standby-window-rejected.fixture.json`；P4.316 新增 `P4HideCardCommandRejectsPendingStackWindow` / `P4HideCardCommandPendingStackRejectionFixture` / `p4-hide-card-standby-pending-stack-rejected.fixture.json`；P4.317 新增 `P4HideCardCommandRejectsSourceCardNoMismatch` / `P4HideCardCommandSourceCardNoMismatchRejectionFixture` / `p4-hide-card-standby-cardno-mismatch-rejected.fixture.json`；P4.71 新增 `P4RevealCardCommandRevealsStandbyCardInBase` / `p4-reveal-card-standby-base.fixture.json`；P4.318 新增 `P4RevealCardCommandRejectsSourceCardNoMismatch` / `P4RevealCardCommandSourceCardNoMismatchRejectionFixture` / `p4-reveal-card-standby-cardno-mismatch-rejected.fixture.json`；P4.319 新增 `P4RevealCardCommandRejectsSourceOutsidePlayerBase` / `P4RevealCardCommandSourceOutsidePlayerBaseRejectionFixture` / `p4-reveal-card-standby-source-outside-base-rejected.fixture.json`；P4.320 新增 `P4RevealCardCommandRejectsSourceNotFaceDown` / `P4RevealCardCommandSourceNotFaceDownRejectionFixture` / `p4-reveal-card-standby-source-not-face-down-rejected.fixture.json`；P4.321 新增 `P4RevealCardCommandRejectsTargetsUntilStandbyDamageExists` / `P4RevealCardCommandTargetRejectionFixture` / `p4-reveal-card-standby-target-rejected.fixture.json`；P4.322 新增 `P4RevealCardCommandRejectsUnsupportedOptionalCost` / `P4RevealCardCommandUnsupportedOptionalCostRejectionFixture` / `p4-reveal-card-standby-unsupported-optional-cost-rejected.fixture.json`；P4.341 新增 `P4RevealCardCommandRejectsMissingRevealCost` / `P4RevealCardCommandMissingRevealCostRejectionFixture` / `p4-reveal-card-standby-missing-cost-rejected.fixture.json`；P4.342 新增 `P4RevealCardCommandRejectsKnownNonStandbyCard` / `P4RevealCardCommandKnownNonStandbyCardRejectionFixture` / `p4-reveal-card-known-non-standby-rejected.fixture.json`；P4.323 新增 `P4RevealCardCommandRejectsUnsupportedDestination` / `P4RevealCardCommandUnsupportedDestinationRejectionFixture` / `p4-reveal-card-standby-unsupported-destination-rejected.fixture.json`；P4.324 新增 `P4RevealCardCommandRejectsReactionTargetsUntilStandbyDamageExists` / `P4RevealCardCommandReactionTargetRejectionFixture` / `p4-reveal-card-standby-reaction-target-rejected.fixture.json`；P4.72 新增 `P4HideCardCommandUsesGuerrillaWarfareFreeStandbyPermission` / `P4HideCardCommandRejectsFreeStandbyWithoutGuerrillaWarfarePermission` / `p4-guerrilla-warfare-free-standby-hide.fixture.json`；P4.96 新增 `P4HideCardCommandRejectsFreeStandbyWithoutGuerrillaWarfarePermissionFixture` / `p4-hide-card-standby-free-without-permission-rejected.fixture.json`；P4.102 新增 `P4GuerrillaWarfareNonStandbyTargetRejectionFixture` / `p4-guerrilla-warfare-non-standby-target-rejected.fixture.json`；P4.76 新增 `P4RevealCardCommandPlaysStandbyReactionToStack` / `P4RevealCardCommandRejectsReactionPlayWithoutPriorityWindow` / `p4-reveal-card-standby-reaction-stack.fixture.json`；P4.95 新增 `P4RevealCardCommandRejectsReactionPlayWithoutPriorityWindowFixture` / `p4-reveal-card-standby-reaction-without-priority-rejected.fixture.json`；P4.347 新增 `P4RevealCardCommandRejectsReactionSourceOutsidePlayerBase` / `P4RevealCardCommandReactionSourceOutsidePlayerBaseRejectionFixture` / `p4-reveal-card-standby-reaction-source-outside-base-rejected.fixture.json`。 | P4.9 已建立 interaction keyword profile；P4.70 已执行 `HIDE_CARD destination=STANDBY optionalCosts=["STANDBY_A"]` 最小待命正面朝下放置；P4.94 已把同一路径 mana 不足拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.312 已把同一路径来源不在手牌拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.338 已把同一路径对手手牌来源拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.339 已把已知非待命牌进入暗置路径的拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.313 已把同一路径目的地不支持拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.314 已把同一路径非待命费用名拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.340 已把缺少待命支付项的拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.315 已把同一路径行动窗口拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.316 已把同一路径 stack 非空拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.317 已把同一路径来源 `cardNo` 身份不匹配拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.71 已执行 `REVEAL_CARD mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 基地显露；P4.318 已把显露路径来源 `cardNo` 身份不匹配拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.319 已把显露路径来源不在玩家基地拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.320 已把显露路径来源已公开拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.321 已把显露路径带目标拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.322 已把显露路径费用名不支持拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.341 已把显露路径缺少支付项的拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.342 已把已知非待命牌进入显露路径的拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.323 已把显露路径目的地不支持拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.324 已把反应入栈带目标拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.72 已执行《游击战》授予 `FREE_STANDBY_HIDE:{playerId}` 后的 `HIDE_CARD optionalCosts=["STANDBY_FREE"]` 免费暗置；P4.96 已把 `STANDBY_FREE` 无权限拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.102 已把《游击战》非待命废牌堆目标拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.76 已执行 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 的无目标反应入栈代表路径；P4.95 已把同一反应路径无优先权窗口拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.347 已把同一反应路径来源不在命令玩家基地拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.64 已建立 `PLAY_CARD mode=AMBUSH` + `destination` envelope 并显式拒绝执行，P4.97 已把该伏击拒绝边界纳入 conformance fixture 和互动关键词聚合回放，P4.325 已把伏击带目标拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.326 已把伏击 BASE 目的地拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.327 已把伏击优先权窗口拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.377 已把伏击未知来源拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.378 已把伏击对手手牌来源拒绝边界纳入 conformance fixture 和互动关键词聚合回放；P4.379 已把伏击非伏击手牌来源拒绝边界纳入 conformance fixture 和互动关键词聚合回放；待命触发/完整隐藏区/目标伤害和伏击 reaction battlefield play 仍 deferred。 |
2026-06-28 B0 Interaction 注记：上表的“目标伤害 deferred”当前只适用于非 active battle/spell-duel base 上下文、其他待命牌族等未覆盖广度；battlefield-source OGN/SFD Teemo、base/spell-duel Teemo、base/battle-response Teemo 与 face-up defender Teemo 的同战场代表目标、顶五张展示、按 `待命` 数量伤害和展示牌回收已由 direct runtime regressions 覆盖，face-up defender Teemo 另覆盖多合法目标 prompt metadata、显式目标选择，以及 official Fortified Position / Plunder Alley 战场防守效果目标 + Teemo 防守触发伤害目标的组合 multiplexing；Plunder target scope 已从 declared defender representative 扩到同战场友方单位 representative。
2026-06-28 B0 Interaction 注记：`OGN·199/298 控潮者` 的待命反应代表换位路径已接入；base face-down source 的 `REVEAL_CARD mode=STANDBY_REACTION` 现在可携带 0/1 个 `FRIENDLY_UNIT` 目标，入栈结算后复用通用 source/target 位置交换并保留精确 `ObjectLocations.BattlefieldObjectId`。完整待命牌族、替代费用和其他 reaction window breadth 仍 deferred。
...
P4.387 更新：Interaction remaining 行中的伏击 deferred 现在只指广义伏击目标、其他伏击牌、完整多战场目的地和隐藏信息；官网《阴森药剂师》无目标 `AMBUSH` 在优先权窗口入栈并结算入控制者战场的代表路径已接入，并由 `p4-ambush-play-card-gloomy-apothecary-battlefield.fixture.json` 覆盖。

P4.388 更新：Equipment keywords 行在 P4.387 基础上追加 `P4AssembleEquipmentCommandAttachesLongSwordToFriendlyUnit`、`P4AssembleEquipmentCommandLongSwordAttachFixture` 和 `p4-assemble-equipment-long-sword-attach.fixture.json`，把官网《长剑》`ASSEMBLE_EQUIPMENT optionalCosts=["ASSEMBLE_RED"]` 从前置拒绝提升为最小 accepted 装配代表路径；该路径支付 1 power、保留装备在基地列表中、写入 `attachedToObjectId` 并发出 `EQUIPMENT_ATTACHED`，但不泛化灵便自动贴附、百炼 optional attach、owner/controller、装备随动或未激活文本系统。
...
P4.99 更新：Equipment keywords 行在 P4.98 基础上曾追加装备 `ASSEMBLE_EQUIPMENT` 前置拒绝 fixture；P4.388 已将该普通窗口《长剑》场景升级为 `P4AssembleEquipmentCommandLongSwordAttachFixture` / `p4-assemble-equipment-long-sword-attach.fixture.json` accepted 代表路径，其他装配非法边界继续保持拒绝。

P4.330 更新：Equipment keywords 行在 P4.99 基础上追加 `P4AssembleEquipmentCommandInPriorityWindowIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandPriorityWindowRejectionFixture` 和 `p4-assemble-equipment-priority-window-rejected.fixture.json`，把装备 `ASSEMBLE_EQUIPMENT` 在优先权窗口/stack 非空时仍显式拒绝且保持结算链不变的边界纳入 conformance fixture 和装备关键词聚合回放。

P4.331 更新：Equipment keywords 行在 P4.330 基础上追加 `P4AssembleEquipmentCommandWithAlreadyAttachedSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandAlreadyAttachedSourceRejectionFixture` 和 `p4-assemble-equipment-already-attached-rejected.fixture.json`，把已贴附装备来源再次执行 `ASSEMBLE_EQUIPMENT` 当前仍显式拒绝且保留原 `attachedToObjectId` 的边界纳入 conformance fixture 和装备关键词聚合回放。

P4.353 更新：Equipment keywords 行在 P4.331 基础上追加 `P4AssembleEquipmentCommandWithMissingTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingTargetRejectionFixture` 和 `p4-assemble-equipment-missing-target-rejected.fixture.json`，把装备 `ASSEMBLE_EQUIPMENT` 缺少 `targetObjectId` 时当前仍显式拒绝且不支付费用、不移动装备、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.354 更新：Equipment keywords 行在 P4.353 基础上追加 `P4AssembleEquipmentCommandWithMissingSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingSourceRejectionFixture` 和 `p4-assemble-equipment-missing-source-rejected.fixture.json`，把装备 `ASSEMBLE_EQUIPMENT` 缺少 `sourceObjectId` 时当前仍显式拒绝且不支付费用、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.355 更新：Equipment keywords 行在 P4.354 基础上追加 `P4AssembleEquipmentCommandWithHandSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandHandSourceRejectionFixture` 和 `p4-assemble-equipment-hand-source-rejected.fixture.json`，把装备来源仍在手牌时的 `ASSEMBLE_EQUIPMENT` 当前显式拒绝且不支付费用、不移动手牌/基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.356 更新：Equipment keywords 行在 P4.355 基础上追加 `P4AssembleEquipmentCommandWithOpponentSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandOpponentSourceRejectionFixture` 和 `p4-assemble-equipment-opponent-source-rejected.fixture.json`，把对手基地中的装备来源执行 `ASSEMBLE_EQUIPMENT` 当前显式拒绝且不支付费用、不移动任一玩家基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.357 更新：Equipment keywords 行在 P4.356 基础上追加 `P4AssembleEquipmentCommandWithNonEquipmentSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandNonEquipmentSourceRejectionFixture` 和 `p4-assemble-equipment-non-equipment-source-rejected.fixture.json`，把单位等非装备来源执行 `ASSEMBLE_EQUIPMENT` 当前显式拒绝且不支付费用、不移动基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.358 更新：Equipment keywords 行在 P4.357 基础上追加 `P4AssembleEquipmentCommandWithNonUnitTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandNonUnitTargetRejectionFixture` 和 `p4-assemble-equipment-non-unit-target-rejected.fixture.json`，把装备等非单位目标执行 `ASSEMBLE_EQUIPMENT` 当前显式拒绝且不支付费用、不移动基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.359 更新：Equipment keywords 行在 P4.358 基础上追加 `P4AssembleEquipmentCommandWithUnsupportedOptionalCostIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnsupportedOptionalCostRejectionFixture` 和 `p4-assemble-equipment-unsupported-optional-cost-rejected.fixture.json`，把 `ASSEMBLE_EQUIPMENT optionalCosts=["ECHO"]` 当前显式拒绝且不支付费用、不移动基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.360 更新：Equipment keywords 行在 P4.359 基础上追加 `P4AssembleEquipmentCommandWithMissingOptionalCostIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingOptionalCostRejectionFixture` 和 `p4-assemble-equipment-missing-optional-cost-rejected.fixture.json`，把 `ASSEMBLE_EQUIPMENT optionalCosts=[]` 当前显式拒绝且不支付费用、不移动基地对象、不设置贴附、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。
...
P4.332 更新：Combat keywords 行在 P4.100 基础上追加 `P4DeclareBattleCommandInPriorityWindowIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandPriorityWindowRejectionFixture` 和 `p4-declare-battle-priority-window-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 在优先权窗口/stack 非空时仍显式拒绝且保持结算链不变的边界纳入 conformance fixture 和战斗关键词聚合回放。

P4.350 更新：Combat keywords 行在 P4.332 基础上追加 `P4DeclareBattleCommandWithEmptyAttackersIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandEmptyAttackersRejectionFixture` 和 `p4-declare-battle-empty-attackers-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 空攻击者列表当前仍显式拒绝且不设置攻防状态、不改变战力、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.351 更新：Combat keywords 行在 P4.350 基础上追加 `P4DeclareBattleCommandWithEmptyDefendersIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandEmptyDefendersRejectionFixture` 和 `p4-declare-battle-empty-defenders-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 空防守者列表当前仍显式拒绝且不设置攻防状态、不改变战力、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.352 更新：Combat keywords 行在 P4.351 基础上追加 `P4DeclareBattleCommandWithMissingBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandMissingBattlefieldRejectionFixture` 和 `p4-declare-battle-missing-battlefield-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 缺少战场 id 时当前仍显式拒绝且不设置攻防状态、不改变战力、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.361 更新：Combat keywords 行在 P4.352 基础上追加 `P4DeclareBattleCommandWithUnsupportedOptionalCostIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnsupportedOptionalCostRejectionFixture` 和 `p4-declare-battle-unsupported-optional-cost-rejected.fixture.json`，把战斗 `DECLARE_BATTLE optionalCosts=["ECHO"]` 当前仍显式拒绝且不设置攻防状态、不改变战力、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.362 更新：Combat keywords 行在 P4.361 基础上追加 `P4DeclareBattleCommandWithMissingOptionalCostIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandMissingOptionalCostRejectionFixture` 和 `p4-declare-battle-missing-optional-cost-rejected.fixture.json`，把战斗 `DECLARE_BATTLE optionalCosts=[]` 当前仍显式拒绝且不设置攻防状态、不改变战力、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.363 更新：Combat keywords 行在 P4.362 基础上追加 `P4DeclareBattleCommandWithAttackerOutsideBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandAttackerOutsideBattlefieldRejectionFixture` 和 `p4-declare-battle-attacker-outside-battlefield-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 攻击者来自基地等非战场区域时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.364 更新：Combat keywords 行在 P4.363 基础上追加 `P4DeclareBattleCommandWithDefenderOutsideBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandDefenderOutsideBattlefieldRejectionFixture` 和 `p4-declare-battle-defender-outside-battlefield-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 防守者来自基地等非战场区域时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.365 更新：Combat keywords 行在 P4.364 基础上追加 `P4DeclareBattleCommandWithOpponentAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandOpponentAttackerRejectionFixture` 和 `p4-declare-battle-opponent-attacker-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 当前玩家尝试把对手控制的场上单位声明为攻击者时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.366 更新：Combat keywords 行在 P4.365 基础上追加 `P4DeclareBattleCommandWithCurrentPlayerDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandCurrentPlayerDefenderRejectionFixture` 和 `p4-declare-battle-current-player-defender-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 当前玩家尝试把自己控制的场上单位声明为防守者时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.367 更新：Combat keywords 行在 P4.366 基础上追加 `P4DeclareBattleCommandWithDuplicateAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandDuplicateAttackerRejectionFixture` 和 `p4-declare-battle-duplicate-attacker-rejected.fixture.json`，把战斗 `DECLARE_BATTLE` 同一攻击者对象在 `attackerObjectIds` 中重复出现时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。
...
P4.371 更新：Combat keywords 行在 P4.370 基础上追加 `P4DeclareBattleCommandOutsideMainPhaseIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandNonMainPhaseRejectionFixture` 和 `p4-declare-battle-non-main-phase-rejected.fixture.json`，把主动玩家在非主阶段尝试声明战斗时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.372 更新：Combat keywords 行在 P4.371 基础上追加 `P4DeclareBattleCommandWithUnknownAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownAttackerRejectionFixture` 和 `p4-declare-battle-unknown-attacker-rejected.fixture.json`，把攻击者对象 id 不存在时当前仍显式拒绝且不创建缺失对象、不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.373 更新：Combat keywords 行在 P4.372 基础上追加 `P4DeclareBattleCommandWithUnknownDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownDefenderRejectionFixture` 和 `p4-declare-battle-unknown-defender-rejected.fixture.json`，把防守者对象 id 不存在时当前仍显式拒绝且不创建缺失对象、不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.374 更新：Combat keywords 行在 P4.373 基础上追加 `P4DeclareBattleCommandWithUnknownBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownBattlefieldRejectionFixture` 和 `p4-declare-battle-unknown-battlefield-rejected.fixture.json`，把 `battlefieldId` 非空但不存在时当前仍显式拒绝且不设置攻防状态、不改变战力、不移动对象、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和战斗关键词聚合回放。

P4.381 更新：Combat keywords 行在 P4.374 基础上追加 `P4DeclareBattleCommandSingleCombatantsFixture` 和 `p4-declare-battle-single-combatants.fixture.json`，把 `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 从前置拒绝提升为最小 accepted 代表路径：普通主阶段开放窗口、stack 为空、攻击者由命令玩家控制且在战场、防守者由对手控制且在战场时推进 1 tick、写入 `BATTLE_DECLARED` 并设置 `isAttacking` / `isDefending`；P4.382 已在同一代表路径上追加强攻/坚守战斗伤害，壁垒/后排承伤、多个攻防对象和非法/复杂声明仍保持 P4 显式拒绝或 deferred。

P4.382 更新：Combat keywords 行在 P4.381 基础上将同一 `p4-declare-battle-single-combatants.fixture.json` 升级为最小战斗伤害代表路径；`P4DeclareBattleCommandDealsCombatDamageForRepresentativePath` 直接测试和 `P4DeclareBattleCommandSingleCombatantsFixture` 现在验证进攻方《盖伦》以基础 5 + `强攻2` 造成 7 点战斗伤害，防守方《变异猫咪》以基础 1 + `坚守2` 造成 3 点战斗伤害，并在致命伤害清理中将《变异猫咪》移入 P2 废牌堆；壁垒/后排承伤顺序、多个攻防对象、战场得分和战斗结束清理仍 deferred。

P4.383 更新：Combat keywords 行在 P4.382 基础上追加 `P4DeclareBattleCommandAssignsDamageToBulwarkBeforeBackRowForRepresentativePath`、`P4DeclareBattleCommandBulwarkBackRowAssignmentFixture` 和 `p4-declare-battle-bulwark-back-row-assignment.fixture.json`，把 `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-VOLIBEAR"] defenderObjectIds=["P2-BATTLEFIELD-LEBLANC","P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 接入最小两防守者承伤代表路径：即使命令先列出后排《乐芙兰》，进攻伤害也先为 `壁垒`《变异猫咪》分配 3 点致命伤害，再把剩余 7 点分配给 `后排`《乐芙兰》；普通多防守者选择、同优先级选择、得分和完整战斗结束清理仍 deferred。

P4.375 更新：Equipment keywords 行在 P4.374 基础上追加 `P4AssembleEquipmentCommandWithUnknownTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnknownTargetRejectionFixture` 和 `p4-assemble-equipment-unknown-target-rejected.fixture.json`，把 `ASSEMBLE_EQUIPMENT targetObjectId` 不存在时当前仍显式拒绝且不创建缺失目标、不支付费用、不移动装备、不设置 `attachedToObjectId`、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.376 更新：Equipment keywords 行在 P4.375 基础上追加 `P4AssembleEquipmentCommandWithUnknownSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnknownSourceRejectionFixture` 和 `p4-assemble-equipment-unknown-source-rejected.fixture.json`，把 `ASSEMBLE_EQUIPMENT sourceObjectId` 不存在时当前仍显式拒绝且不创建缺失来源、不支付费用、不移动目标、不设置 `attachedToObjectId`、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和装备关键词聚合回放。

P4.377 更新：Interaction remaining 行在 P4.376 基础上追加 `P4AmbushPlayCardModeUnknownSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeUnknownSourceRejectionFixture` 和 `p4-ambush-play-card-unknown-source-rejected.fixture.json`，把 `PLAY_CARD mode=AMBUSH sourceObjectId` 不存在时当前仍显式拒绝且不创建缺失手牌来源、不支付费用、不改变战场、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.378 更新：Interaction remaining 行在 P4.377 基础上追加 `P4AmbushPlayCardModeOpponentHandSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeOpponentHandSourceRejectionFixture` 和 `p4-ambush-play-card-opponent-hand-source-rejected.fixture.json`，把 `PLAY_CARD mode=AMBUSH sourceObjectId` 指向对手手牌对象时当前仍显式拒绝且不支付费用、不移动任一手牌对象、不改变战场、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.379 更新：Interaction remaining 行在 P4.378 基础上追加 `P4AmbushPlayCardModeNonAmbushHandSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeNonAmbushHandSourceRejectionFixture` 和 `p4-ambush-play-card-non-ambush-source-rejected.fixture.json`，把 `PLAY_CARD mode=AMBUSH sourceObjectId` 指向已知没有伏击关键词的手牌单位时当前仍显式拒绝且不支付费用、不移动手牌对象、不改变战场、不创建结算链的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.386 更新：Interaction remaining 行在 P4.385 基础上追加 `P4RevealCardCommandResolvesStandbyReactionTeemoSelfPowerPlusThree`、`P4RevealCardCommandStandbyReactionTeemoSelfPowerFixture` 和 `p4-reveal-card-standby-reaction-teemo-self-power.fixture.json`，把 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 的无目标待命反应入栈后，结算为官网《提莫》自身本回合战力 +3 的代表路径纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放；待命目标伤害、完整隐藏区和其他待命触发仍 deferred。
...
P4.274 更新：Basic action 行在 P4.273 基础上追加 `P4Sfd089RumbleTargetRejectedFixture` 和 `p4-play-sfd-089-rumble-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·089《兰博》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.275 更新：Basic action 行在 P4.274 基础上追加 `P4Sfd089aRumbleTargetRejectedFixture` 和 `p4-play-sfd-089a-rumble-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·089a《兰博》异画 A 普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.276 更新：Basic action 行在 P4.275 基础上追加 `P4YordleExplorerTargetRejectedFixture` 和 `p4-play-yordle-explorer-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·100《约德尔探险家》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.277 更新：Basic action 行在 P4.276 基础上追加 `P4BlackMarketBrokerTargetRejectedFixture` 和 `p4-play-black-market-broker-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·121《黑市掮客》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.278 更新：Basic action 行在 P4.277 基础上追加 `P4HuntingSeaCrewTargetRejectedFixture` 和 `p4-play-hunting-sea-crew-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·137《猎海小队》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.279 更新：Basic action 行在 P4.278 基础上追加 `P4GhostlyCentaurTargetRejectedFixture` 和 `p4-play-ghostly-centaur-target-rejected.fixture.json`，把已有直接测试覆盖的 UNL-068《幽魂半人马》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.280 更新：Basic action 行在 P4.279 基础上追加 `P4CorruptEnforcerTargetRejectedFixture` 和 `p4-play-corrupt-enforcer-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·123《腐化执法官》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.281 更新：Basic action 行在 P4.280 基础上追加 `P4MightyFaerieTargetRejectedFixture` 和 `p4-play-mighty-faerie-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·125《大力仙灵》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.282 更新：Basic action 行在 P4.281 基础上追加 `P4JarMeddardaTargetRejectedFixture` 和 `p4-play-jar-meddarda-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·142《贾尔·米达尔达》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.283 更新：Basic action 行在 P4.282 基础上追加 `P4SfdVexTargetRejectedFixture` 和 `p4-play-sfd-vex-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·146《薇古丝》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.284 更新：Basic action 行在 P4.283 基础上追加 `P4ProminentPatronTargetRejectedFixture` 和 `p4-play-prominent-patron-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·152《显赫金主》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.285 更新：Basic action 行在 P4.284 基础上追加 `P4RoyalAttendantTargetRejectedFixture` 和 `p4-play-royal-attendant-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·039《皇家随从》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.286 更新：Basic action 行在 P4.285 基础上追加 `P4Sfd049ApheliosTargetRejectedFixture` 和 `p4-play-sfd-049-aphelios-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·049《厄斐琉斯》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.287 更新：Basic action 行在 P4.286 基础上追加 `P4Sfd058OrnnTargetRejectedFixture` 和 `p4-play-sfd-058-ornn-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·058《奥恩》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.288 更新：Basic action 行在 P4.287 基础上追加 `P4Sfd058aOrnnTargetRejectedFixture` 和 `p4-play-sfd-058a-ornn-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·058a《奥恩》异画 A 普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.289 更新：Basic action 行在 P4.288 基础上追加 `P4Sfd079BardTargetRejectedFixture` 和 `p4-play-sfd-079-bard-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·079《巴德》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.290 更新：Basic action 行在 P4.289 基础上追加 `P4BigSwindlerTargetRejectedFixture` 和 `p4-play-big-swindler-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·081《大老千》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.291 更新：Basic action 行在 P4.290 基础上追加 `P4SfdJayceTargetRejectedFixture` 和 `p4-play-sfd-jayce-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·084《杰斯》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.292 更新：Basic action 行在 P4.291 基础上追加 `P4ZauniteThugTargetRejectedFixture` 和 `p4-play-zaunite-thug-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·160《祖安混混》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.293 更新：Basic action 行在 P4.292 基础上追加 `P4GlascBartenderTargetRejectedFixture` 和 `p4-play-glasc-bartender-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·165《戈拉斯克调酒师》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.294 更新：Basic action 行在 P4.293 基础上追加 `P4Sfd170ReksaiTargetRejectedFixture` 和 `p4-play-sfd-170-reksai-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·170《雷克塞》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.295 更新：Basic action 行在 P4.294 基础上追加 `P4Sfd170aReksaiTargetRejectedFixture` 和 `p4-play-sfd-170a-reksai-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·170a《雷克塞》异画 A 普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.296 更新：Basic action 行在 P4.295 基础上追加 `P4SfdSorakaTargetRejectedFixture` 和 `p4-play-sfd-soraka-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·173《索拉卡》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.297 更新：Basic action 行在 P4.296 基础上追加 `P4GaiBeastTargetRejectedFixture` 和 `p4-play-gai-beast-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·175《垓兽》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.298 更新：Basic action 行在 P4.297 基础上追加 `P4Sfd180FioraTargetRejectedFixture` 和 `p4-play-sfd-180-fiora-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·180《菲奥娜》普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。

P4.299 更新：Basic action 行在 P4.298 基础上追加 `P4Sfd180aFioraTargetRejectedFixture` 和 `p4-play-sfd-180a-fiora-target-rejected.fixture.json`，把已有直接测试覆盖的 SFD·180a《菲奥娜》异画 A 普通手牌打出带目标拒绝边界纳入 conformance fixture 和基础动作聚合回放。
...
P4.303 更新：Move / Basic action 行在 P4.302 基础上追加 `P4MoveUnitCommandRejectsFaceDownSource`、`P4MoveUnitCommandFaceDownSourceRejectionFixture` 和 `p4-move-unit-face-down-source-rejected.fixture.json`，把 `MOVE_UNIT` 来源必须为正面单位的隐藏信息边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.304 更新：Move / Basic action 行在 P4.303 基础上追加 `P4MoveUnitCommandRejectsNonUnitSource`、`P4MoveUnitCommandNonUnitSourceRejectionFixture` 和 `p4-move-unit-non-unit-source-rejected.fixture.json`，把 `MOVE_UNIT` 来源必须为单位而不能是装备等非单位对象的边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。
...
P4.308 更新：Move / Basic action 行在 P4.307 基础上追加 `P4MoveUnitCommandRejectsUnsupportedCoarseZones`、`P4MoveUnitCommandUnsupportedZoneRejectionFixture` 和 `p4-move-unit-unsupported-zone-rejected.fixture.json`，把 `MOVE_UNIT` 当前只接受 `BASE` / `BATTLEFIELD` coarse 区域、拒绝 `HAND` 等 unsupported zone 的边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.309 更新：Move / Basic action 行在 P4.308 基础上追加 `P4MoveUnitCommandRejectsSourceOutsideRequestedOrigin`、`P4MoveUnitCommandOriginMismatchRejectionFixture` 和 `p4-move-unit-origin-mismatch-rejected.fixture.json`，把 `MOVE_UNIT` 来源对象实际所在区域必须匹配 command `origin` 的边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.310 更新：Move / Basic action 行在 P4.309 基础上追加 `P4MoveUnitCommandRejectsPendingStackWindow`、`P4MoveUnitCommandPendingStackRejectionFixture` 和 `p4-move-unit-pending-stack-rejected.fixture.json`，把 `MOVE_UNIT` 在 stack 非空的优先权窗口中拒绝且保持结算链不变的边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.311 更新：Move / Basic action 行在 P4.310 基础上追加 `P4MoveUnitCommandRejectsSourceStillInHand`、`P4MoveUnitCommandHandSourceRejectionFixture` 和 `p4-move-unit-hand-source-rejected.fixture.json`，把 `MOVE_UNIT` 来源对象仍在手牌、不能伪装为场上来源的边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.333 更新：Move / Combat / Basic action 行在 P4.311 基础上追加 `P4MoveUnitCommandRejectsCombatantSourceUntilCombatMovementExists`、`P4MoveUnitCommandCombatantSourceRejectionFixture` 和 `p4-move-unit-combatant-source-rejected.fixture.json`，把 `MOVE_UNIT` 来源对象已处于进攻/防守状态时当前拒绝且不清除战斗状态的边界纳入 direct engine 测试、conformance fixture、战斗关键词聚合和基础动作聚合回放。

P4.334 更新：Move / Equipment / Basic action 行在 P4.333 基础上追加 `P4MoveUnitCommandRejectsAttachedEquipmentSourceUntilAttachmentMovementExists`、`P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture` 和 `p4-move-unit-attached-equipment-source-rejected.fixture.json`，把 `MOVE_UNIT` 来源单位已有装备贴附时当前拒绝且不移动单位/装备、不改写 `attachedToObjectId` 的边界纳入 direct engine 测试、conformance fixture、装备关键词聚合和基础动作聚合回放。

P4.335 更新：Interaction remaining 行在 P4.327 基础上追加 `P4AmbushPlayCardModeSourceOutsideHandIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeSourceOutsideHandRejectionFixture` 和 `p4-ambush-play-card-source-outside-hand-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前来源已不在手牌时显式拒绝且不移动基地对象、不支付费用的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.336 更新：Interaction remaining 行在 P4.335 基础上追加 `P4AmbushPlayCardModeSourceCardNoMismatchIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeSourceCardNoMismatchRejectionFixture` 和 `p4-ambush-play-card-cardno-mismatch-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前已知来源对象 `cardNo` 与命令 `cardNo` 不一致时显式拒绝且不移动手牌、不支付费用的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.337 更新：Interaction remaining 行在 P4.336 基础上追加 `P4AmbushPlayCardModeWithOptionalCostIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeOptionalCostRejectionFixture` 和 `p4-ambush-play-card-optional-cost-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前携带 unsupported optional cost 名称时显式拒绝且不支付费用、不移动手牌的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.338 更新：Interaction remaining 行在 P4.337 基础上追加 `P4HideCardCommandRejectsOpponentHandSource`、`P4HideCardCommandOpponentHandSourceRejectionFixture` 和 `p4-hide-card-standby-opponent-hand-source-rejected.fixture.json`，把待命 `HIDE_CARD destination=STANDBY optionalCosts=["STANDBY_A"]` 当前来源对象位于对手手牌时拒绝且不移动任一手牌对象、不支付费用的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.339 更新：Interaction remaining 行在 P4.338 基础上追加 `P4HideCardCommandRejectsKnownNonStandbyCard`、`P4HideCardCommandKnownNonStandbyCardRejectionFixture` 和 `p4-hide-card-known-non-standby-rejected.fixture.json`，把已知单位《竞技场理事》没有待命关键词时仍尝试 `HIDE_CARD destination=STANDBY optionalCosts=["STANDBY_A"]` 的拒绝边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.340 更新：Interaction remaining 行在 P4.339 基础上追加 `P4HideCardCommandRejectsMissingStandbyCost`、`P4HideCardCommandMissingStandbyCostRejectionFixture` 和 `p4-hide-card-standby-missing-cost-rejected.fixture.json`，把待命 `HIDE_CARD destination=STANDBY optionalCosts=[]` 当前缺少 `STANDBY_A` / `STANDBY_FREE` 支付项时拒绝且不移动手牌、不支付费用的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。
...
P4.344 更新：本状态在 P4.343 基础上追加 `P4RevealCardCommandRejectsReactionMissingRevealCost`、`P4RevealCardCommandReactionMissingRevealCostRejectionFixture` 和 `p4-reveal-card-standby-reaction-missing-cost-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=[]` 当前缺少 `STANDBY_REVEAL_0` 支付项时拒绝且不翻开来源、不移动基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.345 更新：本状态在 P4.344 基础上追加 `P4RevealCardCommandRejectsReactionUnsupportedOptionalCost`、`P4RevealCardCommandReactionUnsupportedOptionalCostRejectionFixture` 和 `p4-reveal-card-standby-reaction-unsupported-optional-cost-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["ECHO"]` 当前携带 unsupported optional cost 时拒绝且不翻开来源、不移动基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.346 更新：本状态在 P4.345 基础上追加 `P4RevealCardCommandRejectsReactionSourceNotFaceDown`、`P4RevealCardCommandReactionSourceNotFaceDownRejectionFixture` 和 `p4-reveal-card-standby-reaction-source-not-face-down-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 当前来源已公开时拒绝且不移动基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.347 更新：本状态在 P4.346 基础上追加 `P4RevealCardCommandRejectsReactionSourceOutsidePlayerBase`、`P4RevealCardCommandReactionSourceOutsidePlayerBaseRejectionFixture` 和 `p4-reveal-card-standby-reaction-source-outside-base-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 当前来源不在命令玩家基地时拒绝且不翻开对手基地对象、不移动任一基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.348 更新：本状态在 P4.347 基础上追加 `P4RevealCardCommandRejectsReactionSourceCardNoMismatch`、`P4RevealCardCommandReactionSourceCardNoMismatchRejectionFixture` 和 `p4-reveal-card-standby-reaction-cardno-mismatch-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 当前来源 `cardNo` 与命令声明不匹配时拒绝且不翻开来源、不移动基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。

P4.349 更新：本状态在 P4.348 基础上追加 `P4RevealCardCommandRejectsReactionUnsupportedDestination`、`P4RevealCardCommandReactionUnsupportedDestinationRejectionFixture` 和 `p4-reveal-card-standby-reaction-unsupported-destination-rejected.fixture.json`，把待命 `REVEAL_CARD mode=STANDBY_REACTION destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 当前非 `STACK` 目的地时拒绝且不翻开来源、不移动基地对象、不创建新结算链项目的边界纳入 direct engine 测试、conformance fixture 和互动关键词聚合回放。
...
P4.329 更新：Move / Combat / Basic action 行在 P4.328 基础上追加 `P4MoveUnitCommandRejectsPreciseBattlefieldOriginWithoutRoamCost`、`P4MoveUnitCommandPreciseOriginRejectionFixture` 和 `p4-move-unit-precise-origin-rejected.fixture.json`，把 `MOVE_UNIT origin=BATTLEFIELD:P1-MAIN destination=BASE optionalCosts=[]` 当前仍拒绝的精确战场来源边界纳入 direct engine 测试、conformance fixture 和基础动作聚合回放。

P4.312 更新：Interaction remaining 行在 P4.311 基础上追加 `P4HideCardCommandRejectsSourceOutsideHand`、`P4HideCardCommandSourceOutsideHandRejectionFixture` 和 `p4-hide-card-standby-source-outside-hand-rejected.fixture.json`，把待命 `HIDE_CARD` / `STANDBY_A` 来源不在手牌拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.313 更新：Interaction remaining 行在 P4.312 基础上追加 `P4HideCardCommandRejectsUnsupportedDestination`、`P4HideCardCommandUnsupportedDestinationRejectionFixture` 和 `p4-hide-card-standby-unsupported-destination-rejected.fixture.json`，把待命 `HIDE_CARD` / `STANDBY_A` 目的地不支持拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.314 更新：Interaction remaining 行在 P4.313 基础上追加 `P4HideCardCommandRejectsUnsupportedOptionalCost`、`P4HideCardCommandUnsupportedOptionalCostRejectionFixture` 和 `p4-hide-card-standby-unsupported-optional-cost-rejected.fixture.json`，把待命 `HIDE_CARD` 非待命费用名拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.315 更新：Interaction remaining 行在 P4.314 基础上追加 `P4HideCardCommandRejectsOutsideActivePlayerOpenMainWindow`、`P4HideCardCommandWindowRejectionFixture` 和 `p4-hide-card-standby-window-rejected.fixture.json`，把待命 `HIDE_CARD` 行动窗口拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.316 更新：Interaction remaining 行在 P4.315 基础上追加 `P4HideCardCommandRejectsPendingStackWindow`、`P4HideCardCommandPendingStackRejectionFixture` 和 `p4-hide-card-standby-pending-stack-rejected.fixture.json`，把待命 `HIDE_CARD` stack 非空拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.317 更新：Interaction remaining 行在 P4.316 基础上追加 `P4HideCardCommandRejectsSourceCardNoMismatch`、`P4HideCardCommandSourceCardNoMismatchRejectionFixture` 和 `p4-hide-card-standby-cardno-mismatch-rejected.fixture.json`，把待命 `HIDE_CARD` 来源 `cardNo` 身份不匹配拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.318 更新：Interaction remaining 行在 P4.317 基础上追加 `P4RevealCardCommandRejectsSourceCardNoMismatch`、`P4RevealCardCommandSourceCardNoMismatchRejectionFixture` 和 `p4-reveal-card-standby-cardno-mismatch-rejected.fixture.json`，把待命 `REVEAL_CARD` 正面朝下来源 `cardNo` 身份不匹配拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.319 更新：Interaction remaining 行在 P4.318 基础上追加 `P4RevealCardCommandRejectsSourceOutsidePlayerBase`、`P4RevealCardCommandSourceOutsidePlayerBaseRejectionFixture` 和 `p4-reveal-card-standby-source-outside-base-rejected.fixture.json`，把待命 `REVEAL_CARD` 来源不在命令玩家基地的区域/控制者拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.320 更新：Interaction remaining 行在 P4.319 基础上追加 `P4RevealCardCommandRejectsSourceNotFaceDown`、`P4RevealCardCommandSourceNotFaceDownRejectionFixture` 和 `p4-reveal-card-standby-source-not-face-down-rejected.fixture.json`，把待命 `REVEAL_CARD` 来源已公开、不能再次显露的正面性拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.321 更新：Interaction remaining 行在 P4.320 基础上追加 `P4RevealCardCommandRejectsTargetsUntilStandbyDamageExists`、`P4RevealCardCommandTargetRejectionFixture` 和 `p4-reveal-card-standby-target-rejected.fixture.json`，把待命 `REVEAL_CARD` 当前带目标时的 target damage 分支拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.322 更新：Interaction remaining 行在 P4.321 基础上追加 `P4RevealCardCommandRejectsUnsupportedOptionalCost`、`P4RevealCardCommandUnsupportedOptionalCostRejectionFixture` 和 `p4-reveal-card-standby-unsupported-optional-cost-rejected.fixture.json`，把待命 `REVEAL_CARD` 当前不接受 `ECHO` 等非 `STANDBY_REVEAL_0` 费用名的拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.323 更新：Interaction remaining 行在 P4.322 基础上追加 `P4RevealCardCommandRejectsUnsupportedDestination`、`P4RevealCardCommandUnsupportedDestinationRejectionFixture` 和 `p4-reveal-card-standby-unsupported-destination-rejected.fixture.json`，把待命 `REVEAL_CARD` 当前不接受 `HAND` 等非 `BASE` / `STACK` 目的地的拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.324 更新：Interaction remaining 行在 P4.323 基础上追加 `P4RevealCardCommandRejectsReactionTargetsUntilStandbyDamageExists`、`P4RevealCardCommandReactionTargetRejectionFixture` 和 `p4-reveal-card-standby-reaction-target-rejected.fixture.json`，把待命 `REVEAL_CARD` 反应入栈路径当前带目标时的 target damage 分支拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.325 更新：Interaction remaining 行在 P4.324 基础上追加 `P4AmbushPlayCardModeWithTargetIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeWithTargetRejectionFixture` 和 `p4-ambush-play-card-target-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前携带目标时的前置拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.326 更新：Interaction remaining 行在 P4.325 基础上追加 `P4AmbushPlayCardModeWithBaseDestinationIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeWithBaseDestinationRejectionFixture` 和 `p4-ambush-play-card-base-destination-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前携带 `destination=BASE` 时的前置拒绝边界纳入 conformance fixture 和互动关键词聚合回放。

P4.327 更新：Interaction remaining 行在 P4.326 基础上追加 `P4AmbushPlayCardModeInPriorityWindowIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModePriorityWindowRejectionFixture` 和 `p4-ambush-play-card-priority-window-rejected.fixture.json`，把伏击 `PLAY_CARD mode=AMBUSH` 当前处于优先权窗口且已有待结算项目时的前置拒绝边界纳入 conformance fixture 和互动关键词聚合回放。
...
- profile status 为 `recognized-deferred`：只表示 P3 parser、官方文本和 P2 registry/tag 已对齐；P4.12 已把法术选择敌方场上对象的法盾目标税接入费用计划，P4.59 已补多目标法术对 `法盾` 与 `法盾2` 的税值聚合，P4.61 已补友方法盾目标 no-tax 边界，P4.62 已补 `ACTIVATE_ABILITY` command 前置模型，P4.389 已补《蔚》/《泽拉斯》代表技能 registry 桥接，P4.73 已补《蔚》无目标付费技能入栈/结算代表路径，P4.74 已补场上对象 `cardNo` 身份校验，P4.77 已补《泽拉斯》带目标技能对敌方法盾单位的目标税、横置和伤害结算代表路径，P4.93 已补同一技能敌方法盾目标税 mana 不足时拒绝且不改状态的边界，P4.78 已补同一技能选择己方法盾单位时不缴目标税的边界，P4.79 已补同一技能来源已横置时拒绝且不改状态的边界，P4.80 已补同一技能缺少目标时拒绝且不改状态的边界，P4.81 已补同一技能提供两个目标时拒绝且不改状态的边界，P4.82 已补同一技能携带未支持 optional cost 时拒绝且不改状态的边界，P4.83 已补非《泽拉斯》来源伪造同一 ability id 时拒绝且不改状态的边界，P4.84 已补同一技能选择非单位目标时拒绝且不改状态，P4.85 已补同一技能来源不在战场时拒绝且不改状态，P4.86 已补同一技能来源由对手控制时拒绝且不改状态，并把 P4.79-P4.86/P4.93 拒绝 fixtures 纳入资源关键词聚合回放，P4.14 已把《诺克萨斯新兵》本回合已打出其他卡牌的鼓舞费用减免接入费用计划，P4.15 已把《踏苔蜥》`等级3` 入场 +1 战力与法盾接入单位入场计划，P4.16 已把《风行狐》`等级3` 入场 +1 战力与游走接入单位入场计划，P4.17 已把《无极学徒》`等级6` 打出抽 1 接入单位结算计划，P4.21 已把《崔法利求战者》同回合鼓舞自增益接入单位结算计划，P4.22 已把《危险二人组》同回合鼓舞目标临时战力接入结算计划，P4.23 已把《垃圾场小霸王》同回合鼓舞弃 2 抽 2 接入结算计划，P4.24 已把《先锋队长》同回合鼓舞创建两名 1 战力随从接入结算计划，P4.28/P4.29 已把《易》及 A 版本 `等级6` 法盾/游走接入单位入场计划，但经验获得/消耗、其他等级条件、其他鼓舞效果、除《蔚》《泽拉斯》已登记代表外的更多技能目标税执行和授予/静态法盾仍未完整执行。
...
| 战斗关键词：强攻、坚守、壁垒、后排、游走 | `CardCombatKeywordRules`、`P4CombatKeywordProfilesMapOfficialTextToRegistryTags`、`P4MoveUnitCommandIsExplicitlyRejectedUntilRoamMovementExists`、`P4MoveUnitCommandRejectionFixture`、`P4MoveUnitCommandRejectsPreciseBattlefieldDestinationWithoutRoamCost`、`P4MoveUnitCommandPreciseDestinationRejectionFixture`、`P4MoveUnitCommandRejectsPreciseBattlefieldOriginWithoutRoamCost`、`P4MoveUnitCommandPreciseOriginRejectionFixture`、`P4MoveUnitCommandRejectsCombatantSourceUntilCombatMovementExists`、`P4MoveUnitCommandCombatantSourceRejectionFixture`、`GameCommandMapperParsesMoveUnitPayload`、`p4-move-unit-command-premodel-rejected`、`p4-move-unit-precise-destination-rejected`、`p4-move-unit-precise-origin-rejected`、`p4-move-unit-combatant-source-rejected`、`P4DeclareBattleCommandIsExplicitlyRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandRejectionFixture`、`P4DeclareBattleCommandInPriorityWindowIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandPriorityWindowRejectionFixture`、`P4DeclareBattleCommandWithEmptyAttackersIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandEmptyAttackersRejectionFixture`、`P4DeclareBattleCommandWithEmptyDefendersIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandEmptyDefendersRejectionFixture`、`P4DeclareBattleCommandWithMissingBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandMissingBattlefieldRejectionFixture`、`P4DeclareBattleCommandWithUnknownBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownBattlefieldRejectionFixture`、`P4DeclareBattleCommandWithUnsupportedOptionalCostIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnsupportedOptionalCostRejectionFixture`、`P4DeclareBattleCommandWithMissingOptionalCostIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandMissingOptionalCostRejectionFixture`、`P4DeclareBattleCommandWithAttackerOutsideBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandAttackerOutsideBattlefieldRejectionFixture`、`P4DeclareBattleCommandWithDefenderOutsideBattlefieldIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandDefenderOutsideBattlefieldRejectionFixture`、`P4DeclareBattleCommandWithOpponentAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandOpponentAttackerRejectionFixture`、`P4DeclareBattleCommandWithCurrentPlayerDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandCurrentPlayerDefenderRejectionFixture`、`P4DeclareBattleCommandWithDuplicateAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandDuplicateAttackerRejectionFixture`、`P4DeclareBattleCommandWithDuplicateDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandDuplicateDefenderRejectionFixture`、`P4DeclareBattleCommandWithAttackerAlsoDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandAttackerDefenderOverlapRejectionFixture`、`P4DeclareBattleCommandByNonActivePlayerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandNonActivePlayerRejectionFixture`、`P4DeclareBattleCommandOutsideMainPhaseIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandNonMainPhaseRejectionFixture`、`P4DeclareBattleCommandWithUnknownAttackerIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownAttackerRejectionFixture`、`P4DeclareBattleCommandWithUnknownDefenderIsRejectedUntilCombatSystemExists`、`P4DeclareBattleCommandUnknownDefenderRejectionFixture`、`GameCommandMapperParsesDeclareBattlePayload`、`p4-declare-battle-command-premodel-rejected`、`p4-declare-battle-priority-window-rejected`、`p4-declare-battle-empty-attackers-rejected`、`p4-declare-battle-empty-defenders-rejected`、`p4-declare-battle-missing-battlefield-rejected`、`p4-declare-battle-unknown-battlefield-rejected`、`p4-declare-battle-unsupported-optional-cost-rejected`、`p4-declare-battle-missing-optional-cost-rejected`、`p4-declare-battle-attacker-outside-battlefield-rejected`、`p4-declare-battle-defender-outside-battlefield-rejected`、`p4-declare-battle-opponent-attacker-rejected`、`p4-declare-battle-current-player-defender-rejected`、`p4-declare-battle-duplicate-attacker-rejected`、`p4-declare-battle-duplicate-defender-rejected`、`p4-declare-battle-attacker-defender-overlap-rejected`、`p4-declare-battle-non-active-player-rejected`、`p4-declare-battle-non-main-phase-rejected`、`p4-declare-battle-unknown-attacker-rejected`、`p4-declare-battle-unknown-defender-rejected`、6 条 keyword-unit fixture | Partial：P4.65 已建立 `MOVE_UNIT` command envelope；P4.98 已补精确战场 + `ROAM` 拒绝 fixture，P4.328/P4.329 已补无 `ROAM` 精确战场目的地/来源拒绝 fixture，P4.333 已补战斗中来源移动拒绝 fixture；P4.67 已建立 `DECLARE_BATTLE` command envelope 且显式拒绝执行；P4.100/P4.332/P4.350/P4.351/P4.352/P4.361/P4.362/P4.363/P4.364/P4.365/P4.366/P4.367/P4.368/P4.369/P4.370/P4.371/P4.372/P4.373/P4.374 已补 `DECLARE_BATTLE` 普通窗口、优先权窗口、空攻击者、空防守者、缺少战场 id、未知战场 id、unsupported optional cost、缺少战斗费用、攻击者非战场来源、防守者非战场来源、对手控制攻击者、当前玩家控制防守者、重复攻击者、重复防守者、攻防列表交叉、非主动玩家声明战斗、非主阶段声明战斗、未知攻击者和未知防守者拒绝 fixture 并纳入战斗关键词聚合；完整战斗伤害/承伤/游走真实移动 deferred。 |
| P4.381/P4.382 战斗声明与伤害 delta | `P4DeclareBattleCommandDealsCombatDamageForRepresentativePath`、`P4DeclareBattleCommandSingleCombatantsFixture`、`p4-declare-battle-single-combatants` | Partial：单攻单防代表路径 accepted，并已应用强攻/坚守数值战斗伤害和致命清理；复杂声明、得分和完整战斗结束清理仍 deferred。 |
| P4.383 壁垒/后排承伤 delta | `P4DeclareBattleCommandAssignsDamageToBulwarkBeforeBackRowForRepresentativePath`、`P4DeclareBattleCommandBulwarkBackRowAssignmentFixture`、`p4-declare-battle-bulwark-back-row-assignment` | Partial：单攻击者/两防守者代表路径 accepted，进攻伤害按 `壁垒` 优先、`后排` 延后的 deterministic 顺序分配并做致命清理；普通多防守者选择、同优先级选择、得分和完整战斗结束清理仍 deferred。 |
...
| 资源关键词：狩猎、等级、鼓舞、法盾 | `CardResourceKeywordRules`、`P4ResourceKeywordProfilesMapOfficialTextToRegistryTags`、`P4SpellshieldTaxAddsManaForEnemySpellTarget`、`P4SpellshieldTaxAggregatesMultipleEnemySpellTargets`、`P4SpellshieldTaxDoesNotApplyToFriendlySpellTarget`、`GameCommandMapperParsesActivateAbilityPayload`、`P4ActivatedAbilityCatalogExposesRepresentativeSkillDefinitions`、`P4ActivateAbilityCommandAddsViDoublePowerSkillToStack`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillWithTargets`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillWhenPowerIsMissing`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillFromNonViSource`、`P4ActivateAbilityCommandResolvesViDoublePowerSkillOnStack`、`P4ActivateAbilityCommandUsesCardIdentityAfterViIsPlayed`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillWithOptionalCosts`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillTargetFixture`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillOptionalCostFixture`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillPowerMissingFixture`、`P4ActivateAbilityCommandRejectsViDoublePowerSkillNonViSourceFixture`、`P4ActivateAbilityCommandAddsXerathDamageSkillWithSpellshieldTaxToStack`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSpellshieldTaxManaIsMissing`、`P4ActivateAbilityCommandRejectsXerathDamageSkillSpellshieldTaxInsufficientFixture`、`P4ActivateAbilityCommandResolvesXerathDamageSkillWithSpellshieldTax`、`P4ActivateAbilityCommandDoesNotTaxXerathDamageSkillForFriendlySpellshieldTarget`、`P4ActivateAbilityCommandResolvesXerathDamageSkillWithoutTaxForFriendlySpellshield`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSourceIsExhausted`、`P4ActivateAbilityCommandRejectsXerathDamageSkillFromExhaustedSourceFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTargetIsMissing`、`P4ActivateAbilityCommandRejectsXerathDamageSkillMissingTargetFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTooManyTargetsAreProvided`、`P4ActivateAbilityCommandRejectsXerathDamageSkillTooManyTargetsFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWithOptionalCosts`、`P4ActivateAbilityCommandRejectsXerathDamageSkillOptionalCostFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillFromNonXerathSource`、`P4ActivateAbilityCommandRejectsXerathDamageSkillNonXerathSourceFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenTargetIsNotUnit`、`P4ActivateAbilityCommandRejectsXerathDamageSkillNonUnitTargetFixture`、`P4ActivateAbilityCommandRejectsXerathDamageSkillWhenSourceIsNotBattlefield`、`P4ActivateAbilityCommandRejectsXerathDamageSkillSourceNotBattlefieldFixture`、`CoreRuleEngineRejectsMultipleSpellshieldTaxWhenManaIsInsufficient`、`P4EncourageCostReductionPaysReducedManaAfterAnotherCardThisTurn`、`P4EncourageSelfBoonGrantsBoonAfterAnotherCardThisTurn`、`P4EncourageTargetTempMightRequiresPriorCardAndTarget`、`P4EncourageDiscardDrawRequiresPriorCardAndTwoHandTargets`、`P4EncourageMinionCreationRequiresPriorCard`、`P4LevelThresholdAppliesMossStepperPowerAndSpellshieldAtThreeExperience`、`P4LevelThresholdAppliesWindrunnerFoxPowerAndRoamAtThreeExperience`、`P4LevelThresholdDrawsCardForWujiApprenticeAtSixExperience`、`P4LevelThresholdAppliesYiSpellshieldAndRoamAtSixExperience`、`P4LevelThresholdAppliesYiAltASpellshieldAndRoamAtSixExperience`、`p4-play-incinerate-spellshield-tax`、`p4-play-spirit-fire-multiple-spellshield-tax`、`p4-play-secret-art-mercy-friendly-spellshield-no-tax`、`p4-activate-vi-double-power-skill`、`p4-play-then-activate-vi-double-power-skill`、`p4-activate-vi-double-power-skill-target-rejected`、`p4-activate-vi-double-power-skill-optional-cost-rejected`、`p4-activate-vi-double-power-skill-power-missing-rejected`、`p4-activate-vi-double-power-skill-non-vi-source-rejected`、`p4-activate-vi-double-power-skill-opponent-source-rejected`、`p4-activate-vi-double-power-skill-source-not-field-rejected`、`p4-activate-xerath-damage-skill-spellshield-tax`、`p4-activate-xerath-damage-skill-spellshield-tax-insufficient-rejected`、`p4-activate-xerath-damage-skill-friendly-spellshield-no-tax`、`p4-activate-xerath-damage-skill-exhausted-source-rejected`、`p4-activate-xerath-damage-skill-missing-target-rejected`、`p4-activate-xerath-damage-skill-too-many-targets-rejected`、`p4-activate-xerath-damage-skill-optional-cost-rejected`、`p4-activate-xerath-damage-skill-non-xerath-source-rejected`、`p4-activate-xerath-damage-skill-non-unit-target-rejected`、`p4-activate-xerath-damage-skill-source-not-battlefield-rejected`、`p4-play-noxian-recruit-encourage-cost-reduction`、`p4-play-trifarian-gloryseeker-encourage-self-boon`、`p4-play-dangerous-duo-encourage-target-temp-might`、`p4-play-junkyard-bully-encourage-discard-draw`、`p4-play-vanguard-captain-encourage-create-minions`、`p4-play-moss-stepper-level3-spellshield`、`p4-play-windrunner-fox-level3-roam`、`p4-play-wuji-apprentice-level6-draw`、`p4-play-unl-yi-level6-spellshield-roam`、`p4-play-unl-yi-alt-a-level6-spellshield-roam`、代表 fixture | Partial：法术选择敌方场上法盾对象的 mana 目标税可玩，P4.59 已覆盖同一法术同时选择 `法盾` 与 `法盾2` 敌方目标时的税值聚合，P4.61 已覆盖友方法术选择己方 `法盾` 目标时不缴税，P4.73/P4.74 已覆盖《蔚》无目标付费技能入栈、来源身份校验并结算自身本回合战力翻倍，P4.87-P4.92 已覆盖同一技能对手控制来源、来源不在场上、带目标、额外费用、费用不足和非《蔚》来源拒绝边界且不改状态，并由资源关键词聚合回放覆盖，P4.77 已覆盖《泽拉斯》带目标技能对敌方法盾单位的目标税、横置来源和 3 点伤害结算，P4.78 已覆盖同一技能选择己方法盾单位时 `spellshieldTaxMana = 0` 且仍支付 1 power/横置/造成 3 点伤害，P4.79-P4.86/P4.93 已覆盖同一技能敌方法盾目标税费用不足、已横置来源、缺目标、多目标、额外费用、非《泽拉斯》来源、非单位目标和来源不在战场拒绝、对手控制来源拒绝且不改状态，并由资源关键词聚合回放覆盖；《诺克萨斯新兵》鼓舞费用 -2 代表路径可玩；《崔法利求战者》鼓舞自增益代表路径可玩；《危险二人组》鼓舞目标临时战力代表路径可玩；《垃圾场小霸王》鼓舞弃 2 抽 2 代表路径可玩；《先锋队长》鼓舞创建两名 1 战力随从代表路径可玩；《踏苔蜥》`等级3` 入场 +1/法盾代表路径可玩；《风行狐》`等级3` 入场 +1/游走代表路径可玩；《无极学徒》`等级6` 打出抽 1 代表路径可玩；《易》及 A 版本 `等级6` 法盾/游走代表路径可玩；狩猎征服/据守经验、其他等级条件、其他鼓舞效果、更多技能目标税和授予/静态法盾 deferred。 |
| 互动关键词：待命、回响、伏击 | `CardInteractionKeywordRules`、`P4InteractionKeywordProfilesMapOfficialTextToRegistryTags`、`P4EchoKeywordKeepsExistingP2FixturesGreen`、`P4CenterStageEchoInsufficientManaRejectedFixture`、`P4PunishmentIllegalEchoRejectedFixture`、`P4HideCardCommandPlacesStandbyCardFaceDown`、`P4HideCardCommandRejectsInsufficientStandbyCost`、`P4HideCardCommandRejectsInsufficientStandbyCostFixture`、`P4HideCardCommandRejectsSourceOutsideHand`、`P4HideCardCommandSourceOutsideHandRejectionFixture`、`P4HideCardCommandRejectsUnsupportedDestination`、`P4HideCardCommandUnsupportedDestinationRejectionFixture`、`P4HideCardCommandRejectsUnsupportedOptionalCost`、`P4HideCardCommandUnsupportedOptionalCostRejectionFixture`、`P4HideCardCommandRejectsOutsideActivePlayerOpenMainWindow`、`P4HideCardCommandWindowRejectionFixture`、`P4HideCardCommandRejectsPendingStackWindow`、`P4HideCardCommandPendingStackRejectionFixture`、`P4HideCardCommandRejectsSourceCardNoMismatch`、`P4HideCardCommandSourceCardNoMismatchRejectionFixture`、`P4HideCardCommandUsesGuerrillaWarfareFreeStandbyPermission`、`P4HideCardCommandRejectsFreeStandbyWithoutGuerrillaWarfarePermission`、`P4HideCardCommandRejectsFreeStandbyWithoutGuerrillaWarfarePermissionFixture`、`P4GuerrillaWarfareNonStandbyTargetRejectionFixture`、`P4ExistentialDreadFriendlyAttackingTargetRejectedFixture`、`GameCommandMapperParsesHideCardPayload`、`P4RevealCardCommandRevealsStandbyCardInBase`、`P4RevealCardCommandRejectsSourceCardNoMismatch`、`P4RevealCardCommandSourceCardNoMismatchRejectionFixture`、`P4RevealCardCommandRejectsSourceOutsidePlayerBase`、`P4RevealCardCommandSourceOutsidePlayerBaseRejectionFixture`、`P4RevealCardCommandRejectsSourceNotFaceDown`、`P4RevealCardCommandSourceNotFaceDownRejectionFixture`、`P4RevealCardCommandRejectsTargetsUntilStandbyDamageExists`、`P4RevealCardCommandTargetRejectionFixture`、`P4RevealCardCommandRejectsUnsupportedOptionalCost`、`P4RevealCardCommandUnsupportedOptionalCostRejectionFixture`、`P4RevealCardCommandRejectsUnsupportedDestination`、`P4RevealCardCommandUnsupportedDestinationRejectionFixture`、`P4RevealCardCommandRejectsReactionTargetsUntilStandbyDamageExists`、`P4RevealCardCommandReactionTargetRejectionFixture`、`P4RevealCardCommandPlaysStandbyReactionToStack`、`P4RevealCardCommandRejectsReactionPlayWithoutPriorityWindow`、`P4RevealCardCommandRejectsReactionPlayWithoutPriorityWindowFixture`、`GameCommandMapperParsesRevealCardPayload`、`SnapshotsRedactOpponentFaceDownObjects`、`P4AmbushPlayCardModeIsExplicitlyRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeRejectionFixture`、`P4AmbushPlayCardModeWithTargetIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeWithTargetRejectionFixture`、`P4AmbushPlayCardModeWithBaseDestinationIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeWithBaseDestinationRejectionFixture`、`P4AmbushPlayCardModeInPriorityWindowIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModePriorityWindowRejectionFixture`、`P4AmbushPlayCardModeUnknownSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeUnknownSourceRejectionFixture`、`P4AmbushPlayCardModeOpponentHandSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeOpponentHandSourceRejectionFixture`、`P4AmbushPlayCardModeNonAmbushHandSourceIsRejectedUntilBattlefieldReactionPlayExists`、`P4AmbushPlayCardModeNonAmbushHandSourceRejectionFixture`、`GameCommandMapperParsesAmbushPlayCardDestination`、`p4-play-center-stage-echo-insufficient-mana-rejected`、`p4-play-punishment-illegal-echo-rejected`、`p4-hide-card-standby-face-down`、`p4-hide-card-standby-insufficient-cost-rejected`、`p4-hide-card-standby-source-outside-hand-rejected`、`p4-hide-card-standby-unsupported-destination-rejected`、`p4-hide-card-standby-unsupported-optional-cost-rejected`、`p4-hide-card-standby-window-rejected`、`p4-hide-card-standby-pending-stack-rejected`、`p4-hide-card-standby-cardno-mismatch-rejected`、`p4-guerrilla-warfare-free-standby-hide`、`p4-hide-card-standby-free-without-permission-rejected`、`p4-guerrilla-warfare-non-standby-target-rejected`、`p4-play-existential-dread-friendly-attacking-target-rejected`、`p4-reveal-card-standby-base`、`p4-reveal-card-standby-cardno-mismatch-rejected`、`p4-reveal-card-standby-source-outside-base-rejected`、`p4-reveal-card-standby-source-not-face-down-rejected`、`p4-reveal-card-standby-target-rejected`、`p4-reveal-card-standby-unsupported-optional-cost-rejected`、`p4-reveal-card-standby-unsupported-destination-rejected`、`p4-reveal-card-standby-reaction-target-rejected`、`p4-reveal-card-standby-reaction-stack`、`p4-reveal-card-standby-reaction-without-priority-rejected`、`p4-ambush-play-card-premodel-rejected`、`p4-ambush-play-card-target-rejected`、`p4-ambush-play-card-base-destination-rejected`、`p4-ambush-play-card-priority-window-rejected`、`p4-ambush-play-card-unknown-source-rejected`、`p4-ambush-play-card-opponent-hand-source-rejected`、`p4-ambush-play-card-non-ambush-source-rejected`、3 条 remaining fixture | Partial：mana-only 回响可玩，P4.132 已补《台前作秀》支付 `ECHO` 但 mana 不足拒绝 fixture，P4.133 已补非回响法术《惩戒》携带 `ECHO` 拒绝 fixture，P4.70 已执行待命 `HIDE_CARD` + `STANDBY_A` 最小正面朝下放置，P4.94 已补同一路径费用不足拒绝 fixture，P4.312 已补同一路径来源不在手牌拒绝 fixture，P4.313 已补同一路径目的地不支持拒绝 fixture，P4.314 已补同一路径非待命费用名拒绝 fixture，P4.315 已补同一路径行动窗口拒绝 fixture，P4.316 已补同一路径 stack 非空拒绝 fixture，P4.317 已补同一路径来源 `cardNo` 身份不匹配拒绝 fixture，P4.72 已执行《游击战》`FREE_STANDBY_HIDE` / `STANDBY_FREE` 免费待命暗置路径，P4.96 已补 `STANDBY_FREE` 无权限拒绝 fixture，P4.102 已补《游击战》非待命废牌堆目标拒绝 fixture，P4.121 已补《存在焦虑》选择正在进攻的友方单位时拒绝 fixture，P4.71 已执行待命 `REVEAL_CARD` + `STANDBY_REVEAL_0` 基地显露，P4.318 已把显露路径来源 `cardNo` 身份不匹配拒绝边界纳入 fixture，P4.319 已把显露路径来源不在玩家基地拒绝边界纳入 fixture，P4.320 已把显露路径来源已公开拒绝边界纳入 fixture，P4.321 已把显露路径带目标拒绝边界纳入 fixture，P4.322 已把显露路径费用名不支持拒绝边界纳入 fixture，P4.323 已把显露路径目的地不支持拒绝边界纳入 fixture，P4.324 已把反应入栈带目标拒绝边界纳入 fixture，P4.76 已执行待命 `STANDBY_REACTION` / `STACK` 无目标反应入栈路径，P4.95 已补同一路径无优先权窗口拒绝 fixture，P4.69 已补对手视角正面朝下对象 redaction，P4.64 已建立伏击 `PLAY_CARD mode=AMBUSH` + `destination` envelope 且显式拒绝执行，P4.97 已补该伏击拒绝 fixture，P4.325 已补伏击带目标拒绝 fixture，P4.326 已补伏击 BASE 目的地拒绝 fixture，P4.327 已补伏击优先权窗口拒绝 fixture，P4.377 已补伏击未知来源拒绝 fixture，P4.378 已补伏击对手手牌来源拒绝 fixture，待命触发/完整隐藏区/目标伤害与伏击 reaction battlefield play deferred。 |
| 装备关键词：装配、灵便、百炼 | `CardEquipmentKeywordRules`、`CardEquipmentAttachmentProfile`、`P4EquipmentKeywordProfilesMapOfficialTextToRegistryTags`、`P4EquipmentAttachmentProfileMapsTakeUpToRepresentativeAttachDetach`、`P4AssembleEquipmentCommandAttachesLongSwordToFriendlyUnit`、`P4AssembleEquipmentCommandLongSwordAttachFixture`、`P4AssembleEquipmentCommandInPriorityWindowIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandPriorityWindowRejectionFixture`、`P4AssembleEquipmentCommandWithAlreadyAttachedSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandAlreadyAttachedSourceRejectionFixture`、P4.353-P4.360/P4.375/P4.376 装配非法边界测试与 fixture、`P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture`、`GameCommandMapperParsesAssembleEquipmentPayload`、`p4-assemble-equipment-long-sword-attach`、装配拒绝边界 fixtures、`p4-move-unit-attached-equipment-source-rejected`、5 条 no-attach fixture、2 条《取放自如》attach/detach fixture | Partial：P4.58 已覆盖《取放自如》武装贴附/卸除代表执行；P4.66 已建立 `ASSEMBLE_EQUIPMENT` command envelope，P4.388 已将《长剑》普通窗口 `ASSEMBLE_RED` 装配升级为 accepted 代表路径；P4.330 已补优先权窗口/stack 非空拒绝 fixture，P4.331 已补已贴附来源拒绝 fixture，P4.353-P4.360/P4.375/P4.376 已补缺少/未知目标、缺少/未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture，P4.334 已补带贴附装备来源移动拒绝，并纳入装备关键词聚合；通用装配费用、灵便自动贴附、百炼 optional attach、owner/controller、装备随动 deferred。 |
...
| 战斗关键词 | P4.6 只有 profile；P4.65/P4.67 已建立移动与战斗声明 command envelope 并显式拒绝执行；P4.98/P4.100/P4.332/P4.333/P4.350/P4.351/P4.352/P4.361/P4.362/P4.363/P4.364/P4.365/P4.366/P4.367/P4.368/P4.369/P4.370/P4.371/P4.372/P4.373/P4.374 已分别把 `MOVE_UNIT`、`DECLARE_BATTLE` 普通窗口、`DECLARE_BATTLE` 优先权窗口、战斗中来源移动、空攻击者、空防守者、缺少战场 id、未知战场 id、战斗声明 unsupported optional cost、缺少战斗费用、攻击者非战场来源、防守者非战场来源、对手控制攻击者、当前玩家控制防守者、重复攻击者、重复防守者、攻防列表交叉、非主动玩家声明战斗、非主阶段声明战斗、未知攻击者和未知防守者拒绝边界纳入 fixture；完整强攻/坚守/壁垒/后排战斗承伤与游走移动仍是明确缺口。 |
...
| 装备关键词 | P4.58 覆盖《取放自如》武装贴附/卸除代表路径；P4.66 建立 `ASSEMBLE_EQUIPMENT` command envelope 且显式拒绝执行；P4.99/P4.330/P4.331/P4.353/P4.375/P4.354/P4.376/P4.355/P4.356/P4.357/P4.358/P4.359/P4.360 已把 `ASSEMBLE_EQUIPMENT` 前置、优先权窗口、已贴附来源、缺少目标、未知目标、缺少来源、未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝边界纳入 fixture；装配/灵便/百炼的完整贴附、费用和未激活文本仍 deferred。 |
| 基础动作模板 | draw/damage/destroy/stun/temp might primitive plan 已覆盖；P4.98/P4.333/P4.334 已把 `MOVE_UNIT` 前置拒绝、战斗中来源拒绝和带贴附装备来源拒绝边界纳入 fixture；move/recall/recycle/banish/boon/experience 的部分代表路径仍 delegated to P2 或小批次执行。 |
...
本阶段继续 completion audit：P4 仍不能标记 goal complete。`游走` 与多张基础移动牌都需要精确战场位置、移动权限、移动次数统计和移动触发模型；当前 `PlayerZones.Battlefields` 仍是公开对象列表，不能表达完整的“此处/其他战场”结算。因此 P4.65 只补 `MOVE_UNIT` command 前置模型，P4.300 才在该 envelope 上接入 coarse `BASE`/`BATTLEFIELD` 友方单位移动。
...
- P4.65 时 `CoreRuleEngine` 对 `MoveUnitCommand` 显式返回 `UNSUPPORTED_COMMAND`，避免该 typed command 落入 `PlaceholderRuleEngine` 后被误接受；P4.300/P4.301 后仅接受 `BASE` / `BATTLEFIELD` 间的 coarse 区域移动，精确战场位置和 optional costs 继续拒绝。
...
- P4.302-P4.311 新增 `P4MoveUnitCommandRejectsOpponentControlledSource` / `P4MoveUnitCommandRejectsFaceDownSource` / `P4MoveUnitCommandRejectsNonUnitSource` / `P4MoveUnitCommandRejectsSameZoneDestination` / `P4MoveUnitCommandRejectsOutsideActivePlayerOpenMainWindow` / `P4MoveUnitCommandRejectsPendingStackWindow` / `P4MoveUnitCommandRejectsOptionalCostsUntilRoamModelExists` / `P4MoveUnitCommandRejectsUnsupportedCoarseZones` / `P4MoveUnitCommandRejectsSourceOutsideRequestedOrigin` / `P4MoveUnitCommandRejectsSourceStillInHand` 及对应 fixtures，验证 `MOVE_UNIT` 不能移动对手控制来源、正面朝下来源、装备等非单位来源、同区域目的地、错误行动窗口、stack 非空优先权窗口、未支持 optional cost、`HAND` 等 unsupported zone、实际区域与 command `origin` 不匹配的来源，或仍在手牌中的来源，拒绝时保持 tick、事件、对象位置、战力/标签和 stack 不变。
- P4.328 新增 `P4MoveUnitCommandRejectsPreciseBattlefieldDestinationWithoutRoamCost` 和 `p4-move-unit-precise-destination-rejected.fixture.json`，验证无 `ROAM` 的 `BATTLEFIELD:P1-MAIN` 精确目的地也继续拒绝，直到多战场移动模型完成。
- P4.329 新增 `P4MoveUnitCommandRejectsPreciseBattlefieldOriginWithoutRoamCost` 和 `p4-move-unit-precise-origin-rejected.fixture.json`，验证无 `ROAM` 的 `BATTLEFIELD:P1-MAIN` 精确来源也继续拒绝，直到多战场移动模型完成。
...
- P4.66 当时新增的普通窗口前置拒绝验证已在 P4.388 升级为 `P4AssembleEquipmentCommandAttachesLongSwordToFriendlyUnit`：用 `SFD·022/221 长剑` 的 `灵便` / `装配红色` 文本作为代表，验证最小装配路径会支付 1 power、保留装备在基地列表、设置 `AttachedToObjectId` 并发出 `EQUIPMENT_ATTACHED`。
- P4.388 新增 `P4AssembleEquipmentCommandLongSwordAttachFixture` 和 `p4-assemble-equipment-long-sword-attach.fixture.json`，把同一路径纳入 conformance fixture 与装备关键词聚合回放。
...
本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.66 已有直接 engine 测试覆盖 `ASSEMBLE_EQUIPMENT` 在真实装备装配/贴附模型完成前被显式拒绝；P4.388 已把该普通窗口《长剑》场景升级为最小 accepted 装配路径，保留本节只作为历史脉络。

- P4.99 曾锁定 `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 的前置拒绝；P4.388 后该 exact 场景改由 `p4-assemble-equipment-long-sword-attach.fixture.json` 覆盖 accepted 路径。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放《长剑》accepted fixture 与周边拒绝边界；通用装备贴附、未激活文本、owner/controller 或灵便/百炼可选贴附仍 deferred。

## P4.330 Equipment Assemble Priority Window Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.99 已锁定主阶段开放窗口中的 `ASSEMBLE_EQUIPMENT` 显式拒绝；本批次补优先权窗口/stack 非空状态下的同一拒绝边界，避免后续灵便或反应式装备路径未完成前误接入真实装配。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 在 `NEUTRAL_CLOSED` / `priorityPlayerId=P1` / stack 非空窗口中当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动装备、不设置 `attachedToObjectId`、不改变既有 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandInPriorityWindowIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、timing/priority、base、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-priority-window-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandPriorityWindowRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为优先权窗口拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 priority-window rejection fixture；本批次不进入完整装备系统。

## P4.331 Equipment Already Attached Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.330 已覆盖优先权窗口；本批次锁定已贴附装备作为 `ASSEMBLE_EQUIPMENT` 来源时仍保持拒绝且不改写既有贴附关系，避免完整装备系统完成前误清除或迁移 `AttachedToObjectId`。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 在来源装备已 `attachedToObjectId=P1-UNIT-ASSEMBLE-OLD-TARGET` 时当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动装备、不改写原贴附目标、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，已贴附来源处理、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithAlreadyAttachedSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、base、双方单位战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-already-attached-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandAlreadyAttachedSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为已贴附来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 already-attached rejection fixture；本批次不进入完整装备系统。

## P4.353 Assemble Equipment Missing Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.99/P4.330/P4.331 已锁定装配命令前置、优先权窗口和已贴附来源拒绝；本批次补缺少目标对象边界，避免完整装备系统完成前误接受没有合法装配目标的命令。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId="" optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动装备、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法目标选择、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithMissingTargetIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、base、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-missing-target-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandMissingTargetRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为缺少目标拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 missing-target rejection fixture；本批次不进入完整装备系统。

## P4.354 Assemble Equipment Missing Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.353 已锁定缺少目标对象；本批次补缺少来源对象边界，避免完整装备系统完成前误接受没有合法装备来源的命令。

- `ASSEMBLE_EQUIPMENT sourceObjectId="" targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法装备来源、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithMissingSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、base、目标单位战力和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-missing-source-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandMissingSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为缺少来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 missing-source rejection fixture；本批次不进入完整装备系统。

## P4.355 Assemble Equipment Hand Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.354 已锁定缺少来源对象；本批次补来源装备仍在手牌时的拒绝边界，避免完整装备系统完成前把手牌装备直接装配到场上单位，绕过装备打出、费用、未激活文本和贴附模型。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-HAND-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌或基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，装备打出后来源区域、合法装配来源、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithHandSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、手牌、基地、目标战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-hand-source-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandHandSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为手牌来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 hand-source rejection fixture；本批次不进入完整装备系统。

## P4.356 Assemble Equipment Opponent Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.355 已锁定手牌来源；本批次补对手基地中的装备来源边界，避免完整装备系统完成前把对手公开装备对象当作当前玩家的合法装配来源，绕过来源控制者、owner/controller 和装备未激活文本模型。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P2-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动任一玩家基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法来源控制者、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithOpponentSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、双方基地、目标战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-opponent-source-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandOpponentSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为对手来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 opponent-source rejection fixture；本批次不进入完整装备系统。

## P4.357 Assemble Equipment Non-Equipment Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.356 已锁定对手装备来源；本批次补单位等非装备对象作为来源的拒绝边界，避免完整装备系统完成前把普通单位误当作可装配来源，绕过装备类型、费用、未激活文本和贴附模型。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-UNIT-ASSEMBLE-NON-EQUIPMENT-SOURCE targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法装备来源类型、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithNonEquipmentSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、基地对象、来源/目标战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-non-equipment-source-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandNonEquipmentSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为非装备来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 non-equipment-source rejection fixture；本批次不进入完整装备系统。

## P4.358 Assemble Equipment Non-Unit Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.357 已锁定非装备来源；本批次补装备等非单位对象作为目标的拒绝边界，避免完整装备系统完成前把公开装备对象误当作合法贴附目标，绕过单位目标、装备未激活文本和贴附模型。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-EQUIPMENT-ASSEMBLE-NON-UNIT-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法单位目标、装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithNonUnitTargetIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、基地对象、来源/目标贴附状态和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-non-unit-target-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandNonUnitTargetRejectionFixture`，把 `SFD·022/221 长剑` 与 `SFD·033/221 多兰之盾` 的装备/灵便/装配文本作为非单位目标拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 non-unit-target rejection fixture；本批次不进入完整装备系统。

## P4.359 Assemble Equipment Unsupported Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.358 已锁定非单位目标；本批次补非装配费用名的拒绝边界，避免完整装备系统完成前把 `ECHO` 等其他关键词费用误当作装配费用入口。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ECHO"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithUnsupportedOptionalCostIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、基地对象、目标战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-unsupported-optional-cost-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandUnsupportedOptionalCostRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为非装配费用名拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 unsupported-optional-cost rejection fixture；本批次不进入完整装备系统。

## P4.360 Assemble Equipment Missing Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.359 已锁定 unsupported optional cost；本批次补省略装配费用名的拒绝边界，避免完整装备系统完成前把无费用声明的装配命令误当作合法贴附入口。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，合法装配费用、灵便自动贴附、百炼 optional attach、owner/controller 和装备未激活文本仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithMissingOptionalCostIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、基地对象、目标战力、attachedTo 和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-missing-optional-cost-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandMissingOptionalCostRejectionFixture`，把 `SFD·022/221 长剑` 的装备/灵便/装配文本作为缺少装配费用拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 missing-optional-cost rejection fixture；本批次不进入完整装备系统。
...
## P4.332 Declare Battle Priority Window Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.100 已锁定主阶段开放窗口中的 `DECLARE_BATTLE` 显式拒绝；本批次补优先权窗口/stack 非空状态下的同一拒绝边界，避免完整战斗系统完成前误设置攻防状态或污染结算链。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 在 `NEUTRAL_CLOSED` / `priorityPlayerId=P1` / stack 非空窗口中当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不改变既有 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandInPriorityWindowIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、timing/priority、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-priority-window-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandPriorityWindowRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明优先权窗口拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 priority-window rejection fixture；本批次不进入完整战斗系统。

## P4.350 Declare Battle Empty Attackers Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.100/P4.332 已锁定 `DECLARE_BATTLE` 当前显式拒绝；本批次补空攻击者列表边界，避免完整战斗声明模型完成前误接受无攻击者战斗。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=[] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，多战场位置、攻击者合法性、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithEmptyAttackersIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-empty-attackers-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandEmptyAttackersRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明空攻击者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 empty-attackers rejection fixture；本批次不进入完整战斗系统。

## P4.351 Declare Battle Empty Defenders Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.350 已锁定空攻击者列表；本批次补空防守者列表边界，避免完整战斗声明模型完成前误接受无防守者战斗。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=[] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，多战场位置、防守者合法性、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithEmptyDefendersIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-empty-defenders-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandEmptyDefendersRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明空防守者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 empty-defenders rejection fixture；本批次不进入完整战斗系统。

## P4.352 Declare Battle Missing Battlefield Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.350/P4.351 已锁定空攻击者和空防守者列表；本批次补缺少战场 id 边界，避免完整战斗声明模型完成前误接受没有合法战场的战斗。

- `DECLARE_BATTLE battlefieldId="" attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，多战场位置、战场合法性、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithMissingBattlefieldIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-missing-battlefield-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandMissingBattlefieldRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明缺少战场 id 拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 missing-battlefield rejection fixture；本批次不进入完整战斗系统。

## P4.361 Declare Battle Unsupported Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.352 已锁定缺少战场 id；本批次补非战斗费用名边界，避免完整战斗系统完成前把 `ECHO` 等其他关键词费用误当作战斗声明费用入口。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["ECHO"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，合法战斗费用、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithUnsupportedOptionalCostIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-unsupported-optional-cost-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandUnsupportedOptionalCostRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明非战斗费用名拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 unsupported-optional-cost rejection fixture；本批次不进入完整战斗系统。

## P4.362 Declare Battle Missing Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.361 已锁定 unsupported optional cost；本批次补省略战斗费用名边界，避免完整战斗系统完成前把无费用声明的战斗命令误当作合法战斗声明入口。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，合法战斗费用、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithMissingOptionalCostIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-missing-optional-cost-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandMissingOptionalCostRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明缺少战斗费用拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 missing-optional-cost rejection fixture；本批次不进入完整战斗系统。

## P4.363 Declare Battle Attacker Outside Battlefield Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.362 已锁定缺少战斗费用；本批次补攻击者区域边界，避免完整战斗系统完成前把基地单位误设置为攻击者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BASE-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，攻击者合法区域、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithAttackerOutsideBattlefieldIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、基地、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-attacker-outside-battlefield-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandAttackerOutsideBattlefieldRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明攻击者非战场来源拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 attacker-outside-battlefield rejection fixture；本批次不进入完整战斗系统。

## P4.364 Declare Battle Defender Outside Battlefield Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.363 已锁定攻击者区域边界；本批次补防守者区域边界，避免完整战斗系统完成前把基地单位误设置为防守者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BASE-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，防守者合法区域、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithDefenderOutsideBattlefieldIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、基地、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-defender-outside-battlefield-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandDefenderOutsideBattlefieldRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明防守者非战场来源拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 defender-outside-battlefield rejection fixture；本批次不进入完整战斗系统。

## P4.365 Declare Battle Opponent Attacker Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.364 已锁定防守者区域边界；本批次补攻击者控制者边界，避免完整战斗系统完成前把对手单位误设置为当前玩家的攻击者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] defenderObjectIds=["P1-BATTLEFIELD-GAREN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，攻击者控制者合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithOpponentAttackerIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-opponent-attacker-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandOpponentAttackerRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明对手控制攻击者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 opponent-attacker rejection fixture；本批次不进入完整战斗系统。

## P4.366 Declare Battle Current Player Defender Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.365 已锁定攻击者控制者边界；本批次补防守者控制者边界，避免完整战斗系统完成前把当前玩家自己的单位误设置为防守者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P1-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，防守者控制者合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithCurrentPlayerDefenderIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-current-player-defender-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandCurrentPlayerDefenderRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明当前玩家控制防守者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 current-player-defender rejection fixture；本批次不进入完整战斗系统。

## P4.367 Declare Battle Duplicate Attacker Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.367 补攻击者列表唯一性边界，避免完整战斗系统完成前把同一个对象重复设置为多个攻击者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN", "P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，攻击者列表唯一性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithDuplicateAttackerIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-duplicate-attacker-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandDuplicateAttackerRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明重复攻击者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 duplicate-attacker rejection fixture；本批次不进入完整战斗系统。

## P4.368 Declare Battle Duplicate Defender Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.368 补防守者列表唯一性边界，避免完整战斗系统完成前把同一个对象重复设置为多个防守者。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN", "P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，防守者列表唯一性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithDuplicateDefenderIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-duplicate-defender-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandDuplicateDefenderRejectionFixture`，把《盖伦》/《变异猫咪》战斗声明重复防守者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 duplicate-defender rejection fixture；本批次不进入完整战斗系统。

## P4.369 Declare Battle Attacker Defender Overlap Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.369 补攻击者/防守者集合交叉边界，避免完整战斗系统完成前把同一个对象同时设置为攻击中与防守中。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P1-BATTLEFIELD-GAREN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，攻击者/防守者集合交叉、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
...
## P4.371 Declare Battle Non Main Phase Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.371 补非主阶段声明战斗边界，避免完整战斗系统完成前在回合结束等非主阶段设置任何攻防状态。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 在 `phase=TURN_END` / `timingState=NEUTRAL_CLOSED` 时当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，阶段合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandOutsideMainPhaseIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、phase/timing、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-non-main-phase-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandNonMainPhaseRejectionFixture`，把《盖伦》/《变异猫咪》非主阶段声明战斗拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 non-main-phase rejection fixture；本批次不进入完整战斗系统。

## P4.372 Declare Battle Unknown Attacker Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.372 补未知攻击者对象边界，避免完整战斗系统完成前由不存在的对象 id 创建或污染攻防状态。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-MISSING"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不创建 `P1-BATTLEFIELD-MISSING`、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，攻击者身份、阶段合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithUnknownAttackerIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、缺失对象不存在、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-unknown-attacker-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandUnknownAttackerRejectionFixture`，把《盖伦》/《变异猫咪》未知攻击者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 unknown-attacker rejection fixture；本批次不进入完整战斗系统。

## P4.373 Declare Battle Unknown Defender Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.373 补未知防守者对象边界，避免完整战斗系统完成前由不存在的对象 id 创建或污染防守状态。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MISSING"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不创建 `P2-BATTLEFIELD-MISSING`、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，防守者身份、阶段合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithUnknownDefenderIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、缺失对象不存在、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-unknown-defender-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandUnknownDefenderRejectionFixture`，把《盖伦》/《变异猫咪》未知防守者拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 unknown-defender rejection fixture；本批次不进入完整战斗系统。

## P4.374 Declare Battle Unknown Battlefield Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.374 补未知战场 id 边界，避免完整战斗系统完成前接受非空但不存在的 `battlefieldId` 并污染攻防状态。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MISSING attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不设置 `IsAttacking` / `IsDefending`、不改变战力、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `DECLARE_BATTLE` 入口处显式拒绝，战场身份、阶段合法性、多战场位置、进攻/防守声明、强攻/坚守修正、壁垒/后排承伤顺序和战斗结算模型仍 deferred。
- 新增 direct engine 测试 `P4DeclareBattleCommandWithUnknownBattlefieldIsRejectedUntilCombatSystemExists`，锁定错误码、错误信息、双方 battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-declare-battle-unknown-battlefield-rejected.fixture.json` 和回放测试 `P4DeclareBattleCommandUnknownBattlefieldRejectionFixture`，把《盖伦》/《变异猫咪》未知战场 id 拒绝边界纳入 conformance 证据。
- `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 unknown-battlefield rejection fixture；本批次不进入完整战斗系统。

## P4.375 Assemble Equipment Unknown Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.375 补未知装配目标边界，避免完整装备系统完成前由不存在的 `targetObjectId` 创建目标、支付费用或贴附装备。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-MISSING optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不创建 `P1-UNIT-ASSEMBLE-MISSING`、不支付费用、不移动装备、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，装配费用、目标身份、灵便自动贴附、百炼 optional attach、owner/controller 与装备未激活文本模型仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithUnknownTargetIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、基地对象、缺失目标不存在、装备贴附状态和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-unknown-target-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandUnknownTargetRejectionFixture`，把 `SFD·022/221 长剑` 的灵便/装配文本作为未知目标拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 unknown-target rejection fixture；本批次不进入完整装备系统。

## P4.376 Assemble Equipment Unknown Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.376 补未知装配来源边界，避免完整装备系统完成前由不存在的 `sourceObjectId` 创建装备、支付费用或影响合法目标。

- `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD-MISSING targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不创建 `P1-EQUIPMENT-LONG-SWORD-MISSING`、不支付费用、不移动目标、不设置 `attachedToObjectId`、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `ASSEMBLE_EQUIPMENT` 入口处显式拒绝，装配费用、来源身份、灵便自动贴附、百炼 optional attach、owner/controller 与装备未激活文本模型仍 deferred。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandWithUnknownSourceIsRejectedUntilEquipmentSystemExists`，锁定错误码、错误信息、合法目标、缺失来源不存在、目标战力和 stack 均保持原样。
- 新增 fixture `p4-assemble-equipment-unknown-source-rejected.fixture.json` 和回放测试 `P4AssembleEquipmentCommandUnknownSourceRejectionFixture`，把 `SFD·022/221 长剑` 的灵便/装配文本作为未知来源拒绝证据。
- `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 unknown-source rejection fixture；本批次不进入完整装备系统。

## P4.377 Ambush Unknown Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.377 补伏击未知来源边界，避免真实伏击反应战场打出完成前由不存在的 `sourceObjectId` 创建手牌来源、支付费用或改变战场。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-GLOOMY-APOTHECARY-MISSING cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不创建缺失手牌来源、不支付费用、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应窗口、真实手牌来源、战场目的地合法性、目标结算和单位打出至战场模型仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeUnknownSourceIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码、错误信息、手牌/基地/战场、缺失来源不存在和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-unknown-source-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeUnknownSourceRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本作为未知来源拒绝证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 unknown-source rejection fixture；本批次不进入伏击真实反应战场打出。

## P4.378 Ambush Opponent Hand Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.378 补伏击对手手牌来源边界，避免真实伏击反应战场打出完成前把对手隐藏区对象当作命令玩家的手牌来源。

- `PLAY_CARD sourceObjectId=P2-HAND-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动任一手牌对象、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应窗口、命令玩家手牌来源、战场目的地合法性、目标结算和单位打出至战场模型仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeOpponentHandSourceIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码、错误信息、双方手牌、战场、来源身份和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-opponent-hand-source-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeOpponentHandSourceRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本作为对手手牌来源拒绝证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 opponent-hand-source rejection fixture；本批次不进入伏击真实反应战场打出。

## P4.379 Ambush Non-Ambush Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.379 补伏击非伏击手牌来源边界，避免真实伏击反应战场打出完成前把只含急速、没有伏击权限的手牌单位当作伏击来源。

- `PLAY_CARD sourceObjectId=P1-HAND-OGN-LEGION-REARGUARD cardNo=OGN·010/298 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌对象、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应窗口、伏击权限、命令玩家手牌来源、战场目的地合法性、目标结算和单位打出至战场模型仍 deferred。
...
- 当前仍是 P4 blocker：`DECLARE_BATTLE` 仍整体显式拒绝，强攻/坚守/壁垒/后排还没有战斗结算中的数值与承伤行为；`MOVE_UNIT` 只支持 coarse `BASE` / `BATTLEFIELD`，真实跨战场/精确战场游走仍拒绝；`狩猎` 的征服/据守经验触发、战斗/移动触发经验、待命触发/目标伤害、伏击真实反应战场打出、除《蔚》《泽拉斯》已登记代表外的更多技能目标税仍未进入可玩路径。
...
## P4.381 Minimal Declare Battle Slice

本阶段只把一个低风险战斗声明代表路径接入 Core，不进入完整战斗结算系统。P4 仍不能标记 active goal complete。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 现在在普通主阶段开放窗口、stack 为空、P1 为主动玩家、攻击者是 P1 正面战场单位、防守者是 P2 正面战场单位时 accepted。
- P4.381 当时的 accepted 路径推进 1 tick、写入 `BATTLE_DECLARED` 事件，并只设置 `P1-BATTLEFIELD-GAREN.isAttacking=true` 与 `P2-BATTLEFIELD-MUTANT-KITTEN.isDefending=true`；P4.382 已在同一代表路径上补充强攻/坚守伤害和致命清理。
- 新增 fixture `p4-declare-battle-single-combatants.fixture.json` 和回放测试 `P4DeclareBattleCommandSingleCombatantsFixture`；P4.382 后直接测试名升级为 `P4DeclareBattleCommandDealsCombatDamageForRepresentativePath`。
- P4.332/P4.350-P4.374 已有的优先权窗口、空攻防列表、缺少/未知战场、unsupported/missing optional cost、非法攻防来源/控制者、重复/交叉/未知对象、非主动玩家和非主阶段拒绝边界继续保持 green；本批次没有扩大到多攻防对象或真实战斗结算。
- 预计剩余批次从 P4.380 的约 `12` 批降到约 `11` 批：下一批优先做战斗伤害/强攻/坚守数值代表切片，后续仍有真实游走、狩猎/经验触发、待命触发/目标伤害、伏击真实反应打出、除《蔚》《泽拉斯》已登记代表外的技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。

## P4.382 Combat Damage Representative Slice

本阶段在 P4.381 的单攻单防代表路径上继续一小步：声明后立即应用最小战斗伤害、强攻/坚守数值和致命伤害清理。P4 仍不能标记 active goal complete。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-GAREN"] defenderObjectIds=["P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 仍是唯一 accepted 战斗声明形态；P4.332/P4.350-P4.374 的复杂/非法声明拒绝边界继续保持 green。
- 进攻方《盖伦》基础战力 5，标签 `强攻2`，本批次输出 `DAMAGE_APPLIED combatRole=ATTACKER basePower=5 keywordBonus=2 combatPower=7 damage=7`；防守方《变异猫咪》基础战力 1，标签 `坚守2`，输出 `DAMAGE_APPLIED combatRole=DEFENDER basePower=1 keywordBonus=2 combatPower=3 damage=3`。
- 致命伤害清理复用 Core 既有 `ApplyLethalDamageCleanup` / `TryDestroyTarget` 原语，将《变异猫咪》移入 P2 废牌堆并写入 `UNIT_DESTROYED reason=LETHAL_DAMAGE`；不创建结算链、不支付费用、不移动攻击者。
- 同一 fixture `p4-declare-battle-single-combatants.fixture.json` 被升级为 P4.382 代表证据；直接测试重命名为 `P4DeclareBattleCommandDealsCombatDamageForRepresentativePath`。
- 仍 deferred：壁垒/后排承伤顺序、多攻击者/多防守者、跨战场/游走战斗移动、战斗结束攻防状态清理、征服/据守/得分和狩猎触发经验。
- 预计剩余批次从 P4.381 的约 `11` 批降到约 `10` 批：下一批优先做壁垒/后排承伤最小代表或真实游走，之后仍有狩猎/经验触发、待命触发/目标伤害、伏击真实反应打出、除《蔚》《泽拉斯》已登记代表外的技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。

## P4.383 Bulwark / Back Row Assignment Slice

本阶段在 P4.382 的战斗伤害代表路径上继续一小步：只为一个低风险单攻击者/两防守者场景加入 `壁垒` 优先、`后排` 延后的 deterministic 承伤顺序。P4 仍不能标记 active goal complete。

- `DECLARE_BATTLE battlefieldId=BATTLEFIELD:P1-MAIN attackerObjectIds=["P1-BATTLEFIELD-VOLIBEAR"] defenderObjectIds=["P2-BATTLEFIELD-LEBLANC","P2-BATTLEFIELD-MUTANT-KITTEN"] optionalCosts=["COMBAT_ASSIGNMENT"]` 现在在普通主阶段开放窗口 accepted；普通多防守者如果没有 `壁垒` / `后排` 排序关键词仍保持拒绝。
- 命令故意先列出 `后排`《乐芙兰》，再列出 `壁垒`《变异猫咪》；Core 会重排进攻伤害：先给《变异猫咪》分配 `assignmentRole=BULWARK_FIRST damage=3`，再把剩余 `assignmentRole=BACK_ROW_LAST damage=7` 给《乐芙兰》。
- 防守方仍按代表路径同步造成战斗伤害：《变异猫咪》基础 1 + `坚守2` 对《沃利贝尔》造成 3 点，《乐芙兰》造成 4 点；《沃利贝尔》保留 7 点伤害但不被摧毁。
- 致命清理复用既有 `ApplyLethalDamageCleanup` / `TryDestroyTarget` 原语，将《乐芙兰》和《变异猫咪》移入 P2 废牌堆；不创建结算链、不支付费用、不处理得分。
- 新增 fixture `p4-declare-battle-bulwark-back-row-assignment.fixture.json`、直接测试 `P4DeclareBattleCommandAssignsDamageToBulwarkBeforeBackRowForRepresentativePath` 和回放测试 `P4DeclareBattleCommandBulwarkBackRowAssignmentFixture`，并纳入 `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen`。
- 仍 deferred：多个攻击者、三个以上防守者、同优先级玩家选择、普通多防守者手动分配、跨战场/游走战斗移动、战斗结束攻防状态清理、征服/据守/得分和狩猎触发经验。
- 预计剩余批次从 P4.382 的约 `10` 批降到约 `9` 批：下一批优先做真实游走或狩猎/战斗触发经验，之后仍有待命触发/目标伤害、伏击真实反应打出、除《蔚》《泽拉斯》已登记代表外的技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。
...
## P4.274 SFD 089 Rumble Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·089《兰博》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展机械单位静态 +1 或据守打出机器人能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-089-RUMBLE cardNo=SFD·089/221 targetObjectIds=["P1-BASE-SFD-089-RUMBLE-TARGET-001"]` 为 SFD·089《兰博》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-089-rumble-target-rejected.fixture.json` 和回放测试 `P4Sfd089RumbleTargetRejectedFixture`，把 SFD·089《兰博》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，机械单位静态 +1 和据守机器人路径仍 deferred。

## P4.275 SFD 089a Rumble Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·089a《兰博》异画 A 普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展机械单位静态 +1 或据守打出机器人能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-089A-RUMBLE cardNo=SFD·089a/221 targetObjectIds=["P1-BASE-SFD-089A-RUMBLE-TARGET-001"]` 为 SFD·089a《兰博》异画 A 的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-089a-rumble-target-rejected.fixture.json` 和回放测试 `P4Sfd089aRumbleTargetRejectedFixture`，把 SFD·089a《兰博》异画 A 普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，机械单位静态 +1 和据守机器人路径仍 deferred。

## P4.276 Yordle Explorer Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·100《约德尔探险家》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展符能费用统计或抽牌触发能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-YORDLE-EXPLORER cardNo=SFD·100/221 targetObjectIds=["P1-BASE-YORDLE-EXPLORER-TARGET-001"]` 为 SFD·100《约德尔探险家》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-yordle-explorer-target-rejected.fixture.json` 和回放测试 `P4YordleExplorerTargetRejectedFixture`，把 SFD·100《约德尔探险家》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，符能费用统计和抽牌触发路径仍 deferred。

## P4.277 Black Market Broker Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·121《黑市掮客》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展牌面朝下打出记忆或金币装备指示物能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-BLACK-MARKET-BROKER cardNo=SFD·121/221 targetObjectIds=["P1-BASE-BLACK-MARKET-BROKER-TARGET-001"]` 为 SFD·121《黑市掮客》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-black-market-broker-target-rejected.fixture.json` 和回放测试 `P4BlackMarketBrokerTargetRejectedFixture`，把 SFD·121《黑市掮客》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，牌面朝下打出记忆和金币装备指示物路径仍 deferred。

## P4.278 Hunting Sea Crew Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·137《猎海小队》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展移动检测或本回合战力 +2 能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-HUNTING-SEA-CREW cardNo=SFD·137/221 targetObjectIds=["P1-BASE-HUNTING-SEA-CREW-TARGET-001"]` 为 SFD·137《猎海小队》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-hunting-sea-crew-target-rejected.fixture.json` 和回放测试 `P4HuntingSeaCrewTargetRejectedFixture`，把 SFD·137《猎海小队》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，移动检测和本回合战力 +2 路径仍 deferred。

## P4.279 Ghostly Centaur Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 UNL-068《幽魂半人马》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展友方单位被摧毁记忆或本回合战力 +2 能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-GHOSTLY-CENTAUR cardNo=UNL-068/219 targetObjectIds=["P1-BASE-GHOSTLY-CENTAUR-TARGET-001"]` 为 UNL-068《幽魂半人马》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 6 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-ghostly-centaur-target-rejected.fixture.json` 和回放测试 `P4GhostlyCentaurTargetRejectedFixture`，把 UNL-068《幽魂半人马》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，友方单位被摧毁记忆和本回合战力 +2 路径仍 deferred。

## P4.280 Corrupt Enforcer Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·123《腐化执法官》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展移动到战场弃牌或战斗胜利抽牌能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-CORRUPT-ENFORCER cardNo=SFD·123/221 targetObjectIds=["P1-BASE-CORRUPT-ENFORCER-TARGET-001"]` 为 SFD·123《腐化执法官》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-corrupt-enforcer-target-rejected.fixture.json` 和回放测试 `P4CorruptEnforcerTargetRejectedFixture`，把 SFD·123《腐化执法官》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，移动到战场弃牌和战斗胜利抽牌路径仍 deferred。

## P4.281 Mighty Faerie Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·125《大力仙灵》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展移动触发、可选紫色支付或移动另一名友方单位能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-MIGHTY-FAERIE cardNo=SFD·125/221 targetObjectIds=["P1-BASE-MIGHTY-FAERIE-TARGET-001"]` 为 SFD·125《大力仙灵》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-mighty-faerie-target-rejected.fixture.json` 和回放测试 `P4MightyFaerieTargetRejectedFixture`，把 SFD·125《大力仙灵》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，移动触发、可选紫色支付和移动另一名友方单位路径仍 deferred。

## P4.282 Jar Meddarda Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·142《贾尔·米达尔达》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展被己方法术选为目标后的记忆或抽牌触发能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-JAR-MEDDARDA cardNo=SFD·142/221 targetObjectIds=["P1-BASE-JAR-MEDDARDA-TARGET-001"]` 为 SFD·142《贾尔·米达尔达》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-jar-meddarda-target-rejected.fixture.json` 和回放测试 `P4JarMeddardaTargetRejectedFixture`，把 SFD·142《贾尔·米达尔达》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，被己方法术选为目标的记忆和抽牌触发路径仍 deferred。

## P4.283 SFD Vex Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·146《薇古丝》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展战斗中法术费用修正能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-VEX-COMBAT cardNo=SFD·146/221 targetObjectIds=["P1-BASE-SFD-VEX-COMBAT-TARGET-001"]` 为 SFD·146《薇古丝》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-vex-target-rejected.fixture.json` 和回放测试 `P4SfdVexTargetRejectedFixture`，把 SFD·146《薇古丝》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，战斗中检测、友方法术减费、敌方法术加费和费用下限路径仍 deferred。

## P4.284 Prominent Patron Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·152《显赫金主》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展据守时打出休眠金币装备指示物能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-PROMINENT-PATRON cardNo=SFD·152/221 targetObjectIds=["P1-BASE-PROMINENT-PATRON-TARGET-001"]` 为 SFD·152《显赫金主》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 6 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-prominent-patron-target-rejected.fixture.json` 和回放测试 `P4ProminentPatronTargetRejectedFixture`，把 SFD·152《显赫金主》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，据守检测和两个休眠金币装备指示物路径仍 deferred。

## P4.285 Royal Attendant Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·039《皇家随从》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展打出后传奇活跃/休眠选择能力。
...
本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·049《厄斐琉斯》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展武装贴附后的模式选择、符文活跃、召符文或增益能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-049-APHELIOS cardNo=SFD·049/221 targetObjectIds=["P1-BASE-SFD-049-APHELIOS-TARGET-001"]` 为 SFD·049《厄斐琉斯》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-049-aphelios-target-rejected.fixture.json` 和回放测试 `P4Sfd049ApheliosTargetRejectedFixture`，把 SFD·049《厄斐琉斯》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，武装贴附触发、本回合模式记忆、符文活跃、召符文和给予增益路径仍 deferred。

## P4.287 SFD 058 Ornn Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·058《奥恩》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展打出/据守时的顶部四张牌查看、装备展示抽取或回收能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-058-ORNN cardNo=SFD·058/221 targetObjectIds=["P1-BASE-SFD-058-ORNN-TARGET-001"]` 为 SFD·058《奥恩》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-058-ornn-target-rejected.fixture.json` 和回放测试 `P4Sfd058OrnnTargetRejectedFixture`，把 SFD·058《奥恩》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，顶部查看、装备展示抽取和回收路径仍 deferred。

## P4.288 SFD 058a Ornn Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·058a《奥恩》异画 A 普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展打出/据守时的顶部四张牌查看、装备展示抽取或回收能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-058A-ORNN cardNo=SFD·058a/221 targetObjectIds=["P1-BASE-SFD-058A-ORNN-TARGET-001"]` 为 SFD·058a《奥恩》异画 A 的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-058a-ornn-target-rejected.fixture.json` 和回放测试 `P4Sfd058aOrnnTargetRejectedFixture`，把 SFD·058a《奥恩》异画 A 普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，顶部查看、装备展示抽取和回收路径仍 deferred。

## P4.289 SFD 079 Bard Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·079《巴德》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展可选传奇休眠额外费用或开放战场移动能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-BARD cardNo=SFD·079/221 targetObjectIds=["P1-BASE-SFD-BARD-TARGET-001"]` 为 SFD·079《巴德》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-079-bard-target-rejected.fixture.json` 和回放测试 `P4Sfd079BardTargetRejectedFixture`，把 SFD·079《巴德》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，传奇休眠额外费用和开放战场移动路径仍 deferred。

## P4.290 Big Swindler Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·081《大老千》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展玩家选择或休眠金币装备指示物能力。

- `PLAY_CARD sourceObjectId=P1-UNIT-BIG-SWINDLER cardNo=SFD·081/221 targetObjectIds=["P1-BASE-BIG-SWINDLER-TARGET-001"]` 为 SFD·081《大老千》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-big-swindler-target-rejected.fixture.json` 和回放测试 `P4BigSwindlerTargetRejectedFixture`，把 SFD·081《大老千》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，玩家选择和休眠金币装备指示物路径仍 deferred。

## P4.291 SFD Jayce Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·084《杰斯》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展友方装备目标、摧毁或本回合装备免费打出窗口。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-JAYCE cardNo=SFD·084/221 targetObjectIds=["P1-BASE-SFD-JAYCE-TARGET-001"]` 为 SFD·084《杰斯》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-jayce-target-rejected.fixture.json` 和回放测试 `P4SfdJayceTargetRejectedFixture`，把 SFD·084《杰斯》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，友方装备目标、摧毁和本回合装备免费打出窗口路径仍 deferred。

## P4.292 Zaunite Thug Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·160《祖安混混》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展友方装备额外费用、支付记忆或装备摧毁路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-ZAUNITE-THUG cardNo=SFD·160/221 targetObjectIds=["P1-BASE-ZAUNITE-THUG-TARGET-001"]` 为 SFD·160《祖安混混》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-zaunite-thug-target-rejected.fixture.json` 和回放测试 `P4ZauniteThugTargetRejectedFixture`，把 SFD·160《祖安混混》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，友方装备额外费用、支付记忆和装备摧毁路径仍 deferred。

## P4.293 Glasc Bartender Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·165《戈拉斯克调酒师》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展绝念触发、废牌堆单位选择、费用限制或免费打出路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-GLASC-BARTENDER cardNo=SFD·165/221 targetObjectIds=["P1-BASE-GLASC-BARTENDER-TARGET-001"]` 为 SFD·165《戈拉斯克调酒师》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-glasc-bartender-target-rejected.fixture.json` 和回放测试 `P4GlascBartenderTargetRejectedFixture`，把 SFD·165《戈拉斯克调酒师》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，绝念触发、废牌堆单位选择、费用限制和免费打出路径仍 deferred。

## P4.294 SFD 170 Rek'Sai Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·170《雷克塞》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展进攻触发、顶部展示、免费打出、回收或单位目的地选择路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-170-REKSAI cardNo=SFD·170/221 targetObjectIds=["P1-BASE-SFD-170-REKSAI-TARGET-001"]` 为 SFD·170《雷克塞》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-170-reksai-target-rejected.fixture.json` 和回放测试 `P4Sfd170ReksaiTargetRejectedFixture`，把 SFD·170《雷克塞》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，进攻触发、顶部展示、免费打出、回收和单位目的地选择路径仍 deferred。

## P4.295 SFD 170a Rek'Sai Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·170a《雷克塞》异画 A 普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位异画 A 入场边界提升为可回放 fixture，不扩展进攻触发、顶部展示、免费打出、回收或单位目的地选择路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-170A-REKSAI cardNo=SFD·170a/221 targetObjectIds=["P1-BASE-SFD-170A-REKSAI-TARGET-001"]` 为 SFD·170a《雷克塞》的当前 0 目标英雄单位异画 A 入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 5 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-170a-reksai-target-rejected.fixture.json` 和回放测试 `P4Sfd170aReksaiTargetRejectedFixture`，把 SFD·170a《雷克塞》异画 A 普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位异画 A 打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，进攻触发、顶部展示、免费打出、回收和单位目的地选择路径仍 deferred。

## P4.296 SFD Soraka Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·173《索拉卡》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展战斗伤害顺序、同处友方单位摧毁替代、移除伤害、休眠或召回路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-SORAKA cardNo=SFD·173/221 targetObjectIds=["P1-BASE-SFD-SORAKA-TARGET-001"]` 为 SFD·173《索拉卡》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 4 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-soraka-target-rejected.fixture.json` 和回放测试 `P4SfdSorakaTargetRejectedFixture`，把 SFD·173《索拉卡》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，战斗伤害顺序、同处友方单位摧毁替代、移除伤害、休眠和召回路径仍 deferred。

## P4.297 Gai Beast Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·175《垓兽》普通手牌打出带目标时拒绝；本批次只把该 0 目标单位入场边界提升为可回放 fixture，不扩展其他单位本回合战力 +2、主牌堆展示记忆或获得资源路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-GAI-BEAST cardNo=SFD·175/221 targetObjectIds=["P1-BASE-GAI-BEAST-TARGET-001"]` 为 SFD·175《垓兽》的当前 0 目标单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 6 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-gai-beast-target-rejected.fixture.json` 和回放测试 `P4GaiBeastTargetRejectedFixture`，把 SFD·175《垓兽》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，其他单位本回合战力修正、主牌堆展示记忆和获得资源路径仍 deferred。

## P4.298 SFD 180 Fiora Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·180《菲奥娜》普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位入场边界提升为可回放 fixture，不扩展强力状态变化、可选黄色支付或活跃路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-180-FIORA cardNo=SFD·180/221 targetObjectIds=["P1-BASE-SFD-180-FIORA-TARGET-001"]` 为 SFD·180《菲奥娜》的当前 0 目标英雄单位入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-180-fiora-target-rejected.fixture.json` 和回放测试 `P4Sfd180FioraTargetRejectedFixture`，把 SFD·180《菲奥娜》普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，强力状态变化、可选黄色支付和活跃路径仍 deferred。

## P4.299 SFD 180a Fiora Target Rejection Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。已有直接 engine 测试覆盖 SFD·180a《菲奥娜》异画 A 普通手牌打出带目标时拒绝；本批次只把该 0 目标英雄单位异画 A 入场边界提升为可回放 fixture，不扩展强力状态变化、可选黄色支付或活跃路径。

- `PLAY_CARD sourceObjectId=P1-UNIT-SFD-180A-FIORA cardNo=SFD·180a/221 targetObjectIds=["P1-BASE-SFD-180A-FIORA-TARGET-001"]` 为 SFD·180a《菲奥娜》的当前 0 目标英雄单位异画 A 入场路径提供显式单位目标，不满足目标数量要求；命令返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付 3 点费用、不移动手牌、不入场单位，也不创建 stack item。
- 新增 fixture `p4-play-sfd-180a-fiora-target-rejected.fixture.json` 和回放测试 `P4Sfd180aFioraTargetRejectedFixture`，把 SFD·180a《菲奥娜》异画 A 普通手牌打出带目标拒绝边界纳入 conformance 证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 0 目标英雄单位异画 A 打出拒绝 fixture；本批次没有改变 `CoreRuleEngine` 主实现，强力状态变化、可选黄色支付和活跃路径仍 deferred。

## P4.300 Coarse Move Unit Command Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。此前 `MOVE_UNIT` 已有协议 envelope 和精确游走拒绝 fixture；本批次只在现有 `PlayerZones.Base` / `PlayerZones.Battlefields` 能表达的粗粒度公开区域中接入最小执行路径，不进入多战场坐标、游走跨战场、移动次数或触发系统。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-BASE-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 现在要求 P1 处于自己主阶段开放窗口、来源是 P1 控制的正面单位，成功后推进 1 tick，把对象从 `Base` 移到 `Battlefields` 尾部，写 `UNIT_MOVED_TO_BATTLEFIELD`，不支付费用、不改变战力、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandMovesFriendlyBaseUnitToBattlefieldInCoarseModel`，并保留 `P4MoveUnitCommandRejectsPreciseBattlefieldLocationsUntilRoamMovementExists`：`BATTLEFIELD:P1-LEFT` / `BATTLEFIELD:P1-RIGHT` 仍返回 `UNSUPPORTED_COMMAND` 且不改状态。
- 新增 fixture `p4-move-unit-base-to-battlefield.fixture.json` 和回放测试 `P4MoveUnitCommandBaseToBattlefieldFixture`，把 `UNL-101/219 战斗号令` 的移动到战场文本作为基础移动证据纳入 conformance。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 positive movement fixture；`p4-move-unit-command-premodel-rejected.fixture.json` 继续保护精确战场/`ROAM` 游走路径。

## P4.301 Reverse Coarse Move Unit Fixture Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300 已让 `MOVE_UNIT` 在 coarse `BASE`/`BATTLEFIELD` 区域模型中具备最小执行路径；本批次只把反向区域移动固化为测试与 fixture，不扩大到游走跨战场、移动触发或战斗移动。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-BATTLEFIELD-001 origin=BATTLEFIELD destination=BASE optionalCosts=[]` 现在要求 P1 处于自己主阶段开放窗口、来源是 P1 控制的正面单位，成功后推进 1 tick，把对象从 `Battlefields` 移到 `Base` 尾部，写 `UNIT_MOVED_TO_BASE`，不支付费用、不改变战力/横置状态、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandMovesFriendlyBattlefieldUnitToBaseInCoarseModel`，锁定反向移动会保留对象战力与 `IsExhausted` 状态。
...
## P4.303 Move Unit Face-Down Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse 区域双向移动，P4.302 已锁定来源控制者；本批次只锁定来源正面性与隐藏信息边界，避免 `MOVE_UNIT` 公开移动路径误移动待命等正面朝下对象。

- `MOVE_UNIT sourceObjectId=P1-FACEDOWN-STANDBY-MOVE-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 由 P1 发起时，因来源对象仍为 `IsFaceDown = true` 而返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不翻开隐藏信息、不改变战力、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsFaceDownSource`，锁定错误码和错误信息 `MOVE_UNIT source must be a face-up unit.`。
- 新增 fixture `p4-move-unit-face-down-source-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandFaceDownSourceRejectionFixture`，把 `OGN·121/298 提莫` 的待命正面朝下文本作为隐藏信息边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 face-down-source rejection fixture；精确战场/`ROAM` 游走路径、移动触发和完整隐藏区仍 deferred。

## P4.304 Move Unit Non-Unit Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse 区域双向移动，P4.302/P4.303 已锁定来源控制者与正面性；本批次只锁定来源对象类型，避免装备等非单位对象误走单位移动路径。

- `MOVE_UNIT sourceObjectId=P1-EQUIPMENT-MOVE-SOURCE-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 由 P1 发起时，因来源对象没有 `CARD_TYPE:UNIT` 标签而返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不改变装备标签、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsNonUnitSource`，锁定错误码和错误信息 `MOVE_UNIT source must be a face-up unit.`。
- 新增 fixture `p4-move-unit-non-unit-source-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandNonUnitSourceRejectionFixture`，把 `SFD·022/221 长剑` 的装备/武装/灵便文本作为非单位来源边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 non-unit-source rejection fixture；装备装配/灵便/百炼仍由 P4.66/P4.99 的 `ASSEMBLE_EQUIPMENT` 前置边界保护，完整装备系统仍 deferred。

## P4.305 Move Unit Same Zone Destination Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse 区域双向移动，P4.302-P4.304 已锁定来源控制者、正面性和单位类型；本批次只锁定目的地必须不同，避免无效移动被当作合法行动推进 tick。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-SAME-ZONE-001 origin=BASE destination=BASE optionalCosts=[]` 由 P1 发起时，因 origin/destination 是同一个 coarse 区域而返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不改变战力、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsSameZoneDestination`，锁定错误码和错误信息 `MOVE_UNIT requires a different destination zone.`。
- 新增 fixture `p4-move-unit-same-zone-destination-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandSameZoneDestinationRejectionFixture`，把 `UNL-101/219 战斗号令` 的移动到战场文本作为不同目的地区域边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 same-zone rejection fixture；精确战场/`ROAM` 游走、多战场目的地和移动触发仍 deferred。

## P4.306 Move Unit Window Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse 区域双向移动，P4.302-P4.305 已锁定来源和目的地护栏；本批次只锁定行动窗口，避免非主动玩家在对手开放窗口使用移动命令。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-WINDOW-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 由 P1 在 P2 主动玩家主阶段开放窗口发起时返回 `PHASE_NOT_ALLOWED`，不推进 tick、不写事件、不移动对象、不改变战力、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsOutsideActivePlayerOpenMainWindow`，锁定错误码和错误信息 `MOVE_UNIT is only available during the active player's open main window.`。
...
## P4.308 Move Unit Unsupported Zone Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动，P4.302-P4.307 已锁定来源、目的地、行动窗口与 optional cost 护栏；本批次只锁定协议区域边界，避免 `HAND` 等非当前公开场上区域误进入移动路径。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-ZONE-001 origin=HAND destination=BATTLEFIELD optionalCosts=[]` 当前返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不改变战力/标签、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsUnsupportedCoarseZones`，锁定错误码和错误信息 `MOVE_UNIT requires BASE or BATTLEFIELD origin and destination zones.`。
- 新增 fixture `p4-move-unit-unsupported-zone-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandUnsupportedZoneRejectionFixture`，把 `UNL-101/219 战斗号令` 的基础移动文本作为当前 `BASE`/`BATTLEFIELD` coarse 区域边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 unsupported-zone rejection fixture；手牌/废牌堆等非场上区域移动、精确战场/`ROAM` 游走、多战场目的地、移动权限和移动触发仍 deferred。

## P4.309 Move Unit Origin Mismatch Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动，P4.302-P4.308 已锁定来源、目的地、行动窗口、optional cost 和 unsupported zone 护栏；本批次只锁定来源实际区域必须匹配 command `origin`，避免客户端把基地对象伪装成战场来源。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-ORIGIN-001 origin=BATTLEFIELD destination=BASE optionalCosts=[]` 当前返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不改变战力/标签、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsSourceOutsideRequestedOrigin`，锁定错误码和错误信息 `Source unit is not controlled by the player in the requested origin zone.`。
- 新增 fixture `p4-move-unit-origin-mismatch-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandOriginMismatchRejectionFixture`，把 `UNL-101/219 战斗号令` “你控制的一名单位”及移动来源语义作为 command origin 边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 origin-mismatch rejection fixture；精确战场/`ROAM` 游走、多战场目的地、移动权限和移动触发仍 deferred。

## P4.310 Move Unit Pending Stack Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动，P4.302-P4.309 已锁定来源、目的地、行动窗口、optional cost、unsupported zone 和 origin mismatch 护栏；本批次只锁定 stack 非空的优先权窗口不能执行当前 coarse 移动。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-STACK-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 在 `timingState=NEUTRAL_CLOSED`、`priorityPlayerId=P1` 且已有 `STACK-0-P2-SPELL-PROBE` 待结算时返回 `PHASE_NOT_ALLOWED`，不推进 tick、不写事件、不移动对象、不改变战力/标签、不改变 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsPendingStackWindow`，锁定错误码和错误信息 `MOVE_UNIT is only available during the active player's open main window.`，并确认 pending stack item 保持原样。
- 新增 fixture `p4-move-unit-pending-stack-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandPendingStackRejectionFixture`，把 `UNL-101/219 战斗号令` 的基础移动文本作为 stack window 边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 pending-stack rejection fixture；反应窗口移动、战斗中移动、精确战场/`ROAM` 游走、多战场目的地、移动权限和移动触发仍 deferred。

## P4.311 Move Unit Hand Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动，P4.302-P4.310 已锁定来源、目的地、行动窗口、optional cost、unsupported zone、origin mismatch 和 pending stack 护栏；本批次只锁定仍在手牌中的来源对象不能执行当前 coarse 移动。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-HAND-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 在来源对象仍位于 P1 手牌时返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动手牌、不改变战力/标签、不创建 stack item。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsSourceStillInHand`，锁定错误码和错误信息 `Source unit is not controlled by the player in the requested origin zone.`，并确认 hand/base/battlefield 都保持原样。
- 新增 fixture `p4-move-unit-hand-source-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandHandSourceRejectionFixture`，把 `UNL-101/219 战斗号令` 的基础移动文本作为来源必须已在公开场上区域的边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 hand-source rejection fixture；手牌打出到战场、真实跨战场游走、多战场目的地、移动权限和移动触发仍 deferred。

## P4.333 Move Unit Combatant Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动；本批次只收紧已进入战斗状态的来源对象，避免完整战斗移动/清理模型完成前把进攻或防守单位移出战场后残留非法攻防状态。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-COMBATANT-001 origin=BATTLEFIELD destination=BASE optionalCosts=[]` 在来源对象 `isAttacking=true` 时返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动对象、不清除 `isAttacking` / `isDefending`、不改变战力、不创建 stack item。
- `CoreRuleEngine.ResolveMoveUnit` 本批次新增最小 guard：来源对象若已 `IsAttacking` 或 `IsDefending`，当前 coarse 移动拒绝并返回 `MOVE_UNIT source must not be in combat.`；不进入完整战斗系统。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsCombatantSourceUntilCombatMovementExists`，锁定错误码、错误信息、battlefields、攻防状态、战力和 stack 均保持原样。
- 新增 fixture `p4-move-unit-combatant-source-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandCombatantSourceRejectionFixture`，把 `OGN·173/298 驭风而行` 和 `UNL-036/219 变异猫咪` 作为移动/防守状态代表证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 与 `P4CombatKeywordProfilesKeepExistingKeywordUnitFixturesGreen` 现在实际回放该 combatant-source rejection fixture；战斗移动、战斗清理、精确战场/`ROAM` 游走和移动触发仍 deferred。

## P4.334 Move Unit Attached Equipment Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 区域双向移动；本批次只收紧带贴附装备的来源单位，避免完整装备随动/贴附层级模型完成前把单位移动到新区域但装备对象仍留在原区。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-ATTACHED-001 origin=BASE destination=BATTLEFIELD optionalCosts=[]` 在有 `P1-MOVE-EQUIPMENT-ATTACHED-001.attachedToObjectId=P1-MOVE-UNIT-ATTACHED-001` 时返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不移动单位或装备、不改写 `attachedToObjectId`、不改变战力、不创建 stack item。
- `CoreRuleEngine.ResolveMoveUnit` 本批次新增最小 guard：如果任一卡牌对象的 `AttachedToObjectId` 指向来源单位，当前 coarse 移动拒绝并返回 `MOVE_UNIT attached equipment movement is not implemented in P4 yet.`；不进入完整装备系统。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsAttachedEquipmentSourceUntilAttachmentMovementExists`，锁定错误码、错误信息、base/battlefield、贴附关系、战力和 stack 均保持原样。
- 新增 fixture `p4-move-unit-attached-equipment-source-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture`，把 `OGN·173/298 驭风而行`、`SFD·022/221 长剑` 和 `SFD·011/221 取放自如` 作为移动/装备/贴附代表证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 与 `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 现在实际回放该 attached-equipment-source rejection fixture；装备随动、装备未激活文本、owner/controller、精确战场/`ROAM` 游走和移动触发仍 deferred。

## P4.335 Ambush Source Outside Hand Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.64/P4.97/P4.325-P4.327 已锁定伏击 `PLAY_CARD mode=AMBUSH` 的前置、带目标、BASE 目的地和优先权窗口拒绝；本批次只补来源区域边界，确保基地中已有对象不会在伏击真实反应战场打出模型完成前被再次当作手牌来源接受。

- `PLAY_CARD sourceObjectId=P1-BASE-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN targetObjectIds=[]` 在来源对象已位于 P1 基地时当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有新增执行分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应战场打出、手牌来源校验顺序和单位进入战场仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeSourceOutsideHandIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认 rune pool、hand/base/battlefield 和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-source-outside-hand-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeSourceOutsideHandRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本和手牌来源边界作为 P4 当前证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 source-outside-hand rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.336 Ambush Source Card Identity Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.335 已锁定来源区域；本批次只补来源身份边界，确保已知为另一张官方伏击牌的手牌对象不会用不同 `cardNo` 的命令绕过当前伏击前置拒绝。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-VI cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN targetObjectIds=[]` 在来源对象已知 `cardNo=UNL-176/219` 时当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有新增执行分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应战场打出、手牌来源身份校验顺序和单位进入战场仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeSourceCardNoMismatchIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认 rune pool、hand/base/battlefield、来源 `cardNo` 和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-cardno-mismatch-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeSourceCardNoMismatchRejectionFixture`，把 `UNL-021/219 阴森药剂师` 与 `UNL-176/219 蔚` 的伏击文本和来源身份边界作为 P4 当前证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 cardNo-mismatch rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.337 Ambush Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.335/P4.336 已锁定伏击来源区域与身份；本批次只补 optional cost 边界，确保 `mode=AMBUSH` 不会在伏击费用模型完成前误用回响等其他费用名进入普通手牌打出路径。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH optionalCosts=["ECHO"] destination=BATTLEFIELD:P1-MAIN targetObjectIds=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌、不改变战场、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有新增执行分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应战场打出、伏击费用模型和单位进入战场仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeWithOptionalCostIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认 rune pool、hand/base/battlefield 和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-optional-cost-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeOptionalCostRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本和 optional cost envelope 边界作为 P4 当前证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 optional-cost rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.312 Standby Hide Source Outside Hand Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.70 已接入待命 `HIDE_CARD` / `STANDBY_A` 的最小手牌暗置路径，P4.94 已锁定费用不足边界；本批次只锁定来源必须仍在控制者手牌，避免基地中已有对象被重复当作手牌来源暗置。

- `HIDE_CARD sourceObjectId=P1-BASE-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=["STANDBY_A"]` 在来源对象已位于 P1 基地时返回 `CARD_NOT_IN_HAND`，不推进 tick、不写事件、不支付费用、不移动基地对象、不翻为正面朝下、不创建 stack item。
- 新增 direct engine 测试 `P4HideCardCommandRejectsSourceOutsideHand`，锁定错误码和错误信息 `Source card is not in the player's hand.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-source-outside-hand-rejected.fixture.json` 和回放测试 `P4HideCardCommandSourceOutsideHandRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为来源区域边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 source-outside-hand rejection fixture；待命触发、目标伤害、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.338 Standby Hide Opponent Hand Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.312 已锁定待命暗置来源不能是已经在基地中的对象；本批次补对手手牌来源边界，确保当前 `HIDE_CARD` 只从命令玩家自己的手牌读取待命来源，不泄漏或移动对手隐藏区对象。

- `HIDE_CARD sourceObjectId=P2-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=["STANDBY_A"]` 在来源对象位于 P2 手牌、命令玩家为 P1 时返回 `CARD_NOT_IN_HAND`，不推进 tick、不写事件、不支付费用、不移动任一手牌对象、不创建 stack item。
- `CoreRuleEngine.ResolveHideCard` 本批次没有新增执行分支；它继续复用“来源必须在命令玩家手牌”的检查，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4HideCardCommandRejectsOpponentHandSource`，锁定错误码和错误信息 `Source card is not in the player's hand.`，并确认 P1/P2 hand/base、rune pool、来源正面状态、战力/标签/`cardNo` 和 stack 均保持原样。
- 新增 fixture `p4-hide-card-standby-opponent-hand-source-rejected.fixture.json` 和回放测试 `P4HideCardCommandOpponentHandSourceRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为命令玩家手牌归属边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 opponent-hand-source rejection fixture；待命触发、目标伤害、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.339 Standby Hide Known Non-Standby Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.70/P4.338 已锁定待命暗置的最小放置与手牌归属边界；本批次补已知非待命牌资格边界，确保 `HIDE_CARD` 只能让命令 `cardNo` 对应牌面暴露待命关键词的卡牌进入暗置路径。

- `HIDE_CARD sourceObjectId=P1-HAND-UNL-ARENA-COUNCILOR cardNo=UNL-001/219 destination=STANDBY optionalCosts=["STANDBY_A"]` 在已知单位《竞技场理事》没有待命关键词时返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不支付费用、不移动手牌、不创建正面朝下对象、不创建 stack item。
- `CoreRuleEngine.ResolveHideCard` 本批次没有新增执行分支；它继续复用 `hiddenTags` 必须包含 `待命` 的检查，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4HideCardCommandRejectsKnownNonStandbyCard`，锁定错误码和错误信息 `竞技场理事 does not expose the Standby keyword for HIDE_CARD.`，并确认 hand/base、rune pool、来源正面状态、战力/标签/费用/`cardNo` 和 stack 均保持原样。
- 新增 fixture `p4-hide-card-known-non-standby-rejected.fixture.json` 和回放测试 `P4HideCardCommandKnownNonStandbyCardRejectionFixture`，把 `UNL-001/219 竞技场理事` 的官方卡面作为非待命牌资格边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 known-non-standby rejection fixture；待命触发、目标伤害、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.313 Standby Hide Unsupported Destination Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.70/P4.312 已锁定待命 `HIDE_CARD` 的最小暗置路径、费用不足和来源区域边界；本批次只锁定当前 P4 command envelope 只能用 `destination=STANDBY` 表达待命暗置。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=BASE optionalCosts=["STANDBY_A"]` 返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不创建 stack item。
- 新增 direct engine 测试 `P4HideCardCommandRejectsUnsupportedDestination`，锁定错误码和错误信息 `Unsupported standby hide cost for 提莫.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-unsupported-destination-rejected.fixture.json` 和回放测试 `P4HideCardCommandUnsupportedDestinationRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置目的地边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 unsupported-destination rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.314 Standby Hide Unsupported Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.70/P4.312/P4.313 已锁定待命 `HIDE_CARD` 的最小暗置路径、来源区域和目的地边界；本批次只锁定当前 P4 待命暗置只接受已实现的待命费用名，避免 `ECHO` 等其他 keyword optional cost 误进入隐藏牌路径。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=["ECHO"]` 返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不创建 stack item。
- 新增 direct engine 测试 `P4HideCardCommandRejectsUnsupportedOptionalCost`，锁定错误码和错误信息 `Unsupported standby hide cost for 提莫.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-unsupported-optional-cost-rejected.fixture.json` 和回放测试 `P4HideCardCommandUnsupportedOptionalCostRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置费用名边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 unsupported-optional-cost rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.340 Standby Hide Missing Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.314 已锁定 `ECHO` 等非待命费用名不能进入待命暗置路径；本批次补费用存在性边界，确保当前 `HIDE_CARD` 不会把待命暗置成本隐式化。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=[]` 返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不创建 stack item。
- `CoreRuleEngine.ResolveHideCard` 本批次没有新增执行分支；它继续要求待命暗置只接受单个 `STANDBY_A`，或在已有《游击战》权限时接受单个 `STANDBY_FREE`，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4HideCardCommandRejectsMissingStandbyCost`，锁定错误码和错误信息 `Unsupported standby hide cost for 提莫.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-missing-cost-rejected.fixture.json` 和回放测试 `P4HideCardCommandMissingStandbyCostRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置费用存在性边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 missing-cost rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.315 Standby Hide Window Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.70/P4.312-P4.314 已锁定待命 `HIDE_CARD` 的最小暗置路径、来源、目的地和费用名边界；本批次只锁定当前 P4 待命暗置只能在主动玩家主阶段开放窗口执行，避免非主动玩家在对手窗口暗置。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=["STANDBY_A"]` 在 `activePlayerId=P2`、`playerId=P1` 的主阶段开放窗口返回 `PHASE_NOT_ALLOWED`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不创建 stack item。
- 新增 direct engine 测试 `P4HideCardCommandRejectsOutsideActivePlayerOpenMainWindow`，锁定错误码和错误信息 `HIDE_CARD is only available during the active player's open main window.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-window-rejected.fixture.json` 和回放测试 `P4HideCardCommandWindowRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置行动窗口边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 window rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.316 Standby Hide Pending Stack Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.315 已锁定非主动玩家不能在对手开放主阶段暗置；本批次继续锁定同一 `HIDE_CARD` 窗口护栏中的 stack 非空边界，避免结算链优先权窗口执行待命暗置。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TEEMO cardNo=OGN·121/298 destination=STANDBY optionalCosts=["STANDBY_A"]` 在 `timingState=NEUTRAL_CLOSED`、`priorityPlayerId=P1` 且已有 `STACK-0-P2-SPELL-PROBE` 待结算时返回 `PHASE_NOT_ALLOWED`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不改变 stack item。
- 新增 direct engine 测试 `P4HideCardCommandRejectsPendingStackWindow`，锁定错误码和错误信息 `HIDE_CARD is only available during the active player's open main window.`，并确认 rune pool、hand/base、对象正面状态、战力/标签和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-pending-stack-rejected.fixture.json` 和回放测试 `P4HideCardCommandPendingStackRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置 stack 窗口边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 pending-stack rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.317 Standby Hide Source Card Identity Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。`REVEAL_CARD` 已有来源对象 `cardNo` 与命令 `cardNo` 一致性校验；本批次把同一身份护栏补到 `HIDE_CARD`，避免已知来源对象被伪造成另一张待命牌。

- `HIDE_CARD sourceObjectId=P1-HAND-OGN-TIDE-CALLER cardNo=OGN·121/298 destination=STANDBY optionalCosts=["STANDBY_A"]` 在来源对象已记录 `cardNo=OGN·199/298` 时返回 `INVALID_TARGET`，不推进 tick、不写事件、不支付费用、不移动手牌、不翻为正面朝下、不创建 stack item。
- `CoreRuleEngine.ResolveHideCard` 现在只在来源对象已有 `CardNo` 且与 registry 中的命令 `cardNo` 不一致时拒绝；来源对象尚未记录 `CardNo` 的既有 P4.70 最小暗置路径保持不变。
- 新增 direct engine 测试 `P4HideCardCommandRejectsSourceCardNoMismatch`，锁定错误码和错误信息 `Source card identity does not match HIDE_CARD cardNo.`，并确认 rune pool、hand/base、对象正面状态、战力/标签、`CardNo` 和 stack 保持原样。
- 新增 fixture `p4-hide-card-standby-cardno-mismatch-rejected.fixture.json` 和回放测试 `P4HideCardCommandSourceCardNoMismatchRejectionFixture`，把 `OGN·199/298 控潮者` 与 `OGN·121/298 提莫` 的待命文本作为 P4 当前暗置来源身份边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 cardNo-mismatch rejection fixture；待命触发、战场/完整隐藏区和伏击共用隐藏信息仍 deferred。

## P4.318 Standby Reveal Source Card Identity Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。`REVEAL_CARD` 已有来源对象 `cardNo` 与命令 `cardNo` 一致性校验；本批次把该已有护栏提升为 direct engine 测试和 conformance fixture，避免正面朝下待命对象显露时被伪造成另一张待命牌。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TIDE-CALLER cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 在来源对象已记录 `cardNo=OGN·199/298` 时返回 `INVALID_TARGET`，不推进 tick、不写事件、不翻开对象、不移动基地对象、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只在来源对象已有 `CardNo` 且与 registry 中的命令 `cardNo` 不一致时拒绝，来源对象未记录 `CardNo` 的 P4.71 基地显露路径和身份匹配的 P4.76 反应入栈路径保持不变。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsSourceCardNoMismatch`，锁定错误码和错误信息 `Source card identity does not match REVEAL_CARD cardNo.`，并确认 rune pool、base、对象正面状态、战力/费用/标签、`CardNo` 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-cardno-mismatch-rejected.fixture.json` 和回放测试 `P4RevealCardCommandSourceCardNoMismatchRejectionFixture`，把 `OGN·199/298 控潮者` 与 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露来源身份边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal cardNo-mismatch rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.319 Standby Reveal Source Zone Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.71/P4.76 已要求 `REVEAL_CARD` 来源位于命令玩家自己的基地；本批次把该来源区域/控制者边界提升为 direct engine 测试和 conformance fixture，避免玩家翻开对手基地中的正面朝下待命对象。

- `REVEAL_CARD sourceObjectId=P2-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 由 P1 发起、但来源对象位于 P2 基地时返回 `INVALID_TARGET`，不推进 tick、不写事件、不翻开对象、不移动任何基地对象、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续先检查 `intent.PlayerId` 对应 `PlayerZones.Base` 是否包含来源对象，再进入 face-down、`cardNo` 和待命关键词校验。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsSourceOutsidePlayerBase`，锁定错误码和错误信息 `Source card is not in the player's base.`，并确认 P1/P2 base、对象正面状态、战力/费用/标签、`CardNo` 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-source-outside-base-rejected.fixture.json` 和回放测试 `P4RevealCardCommandSourceOutsidePlayerBaseRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露来源区域/控制者边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal source-zone rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.320 Standby Reveal Source Face-Up Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.71/P4.76 已要求 `REVEAL_CARD` 来源对象必须是正面朝下；本批次把来源已公开时的拒绝边界提升为 direct engine 测试和 conformance fixture，避免已经公开的基地待命对象被再次“显露”。

- `REVEAL_CARD sourceObjectId=P1-REVEALED-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 在来源对象位于 P1 基地但 `isFaceDown = false` 时返回 `INVALID_TARGET`，不推进 tick、不写事件、不改变公开对象、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续在来源区域通过后检查 `CardObjectState.IsFaceDown`，只有正面朝下对象才能进入身份和待命关键词校验。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsSourceNotFaceDown`，锁定错误码和错误信息 `Source card is not face down.`，并确认 base、对象正面状态、战力/费用/标签、`CardNo` 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-source-not-face-down-rejected.fixture.json` 和回放测试 `P4RevealCardCommandSourceNotFaceDownRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露来源正面性边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal face-up source rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.321 Standby Reveal Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.71 只接入无目标 `STANDBY_REVEAL` 基地显露；本批次把“带目标显露”保持在显式拒绝状态，避免目标伤害分支在待命触发/完整隐藏区完成前误入可玩路径。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"] targetObjectIds=["P2-BATTLEFIELD-UNIT-001"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不伤害目标、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只接受无目标 `STANDBY_REVEAL` / `BASE` 和无目标 `STANDBY_REACTION` / `STACK`，目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsTargetsUntilStandbyDamageExists`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、目标 damage 保持 0、rune pool 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-target-rejected.fixture.json` 和回放测试 `P4RevealCardCommandTargetRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露目标分支边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal target rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.322 Standby Reveal Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.71/P4.76 只接受 `STANDBY_REVEAL_0` 作为当前待命显露/反应入栈费用名；本批次把 `ECHO` 等非待命费用名保持在显式拒绝状态，避免费用模型被错误复用。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=["ECHO"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不支付费用、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只接受 `optionalCosts=["STANDBY_REVEAL_0"]` 的无目标基地显露和无目标反应入栈，其他费用名仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsUnsupportedOptionalCost`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、rune pool 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-unsupported-optional-cost-rejected.fixture.json` 和回放测试 `P4RevealCardCommandUnsupportedOptionalCostRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露费用名边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal optional-cost rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.341 Standby Reveal Missing Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.322 已锁定 `ECHO` 等非待命显露费用名不能进入显露路径；本批次补费用存在性边界，确保当前 `REVEAL_CARD` 不会把待命显露 0 费支付项隐式化。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=BASE optionalCosts=[]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不支付费用、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只接受 `optionalCosts=["STANDBY_REVEAL_0"]` 的无目标基地显露和无目标反应入栈，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsMissingRevealCost`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、rune pool 和 stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-missing-cost-rejected.fixture.json` 和回放测试 `P4RevealCardCommandMissingRevealCostRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露费用存在性边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal missing-cost rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.342 Standby Reveal Known Non-Standby Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.341 已锁定显露路径必须显式携带 `STANDBY_REVEAL_0`；本批次补已知非待命牌资格边界，确保 `REVEAL_CARD` 只能让命令 `cardNo` 对应牌面暴露待命关键词的对象进入显露路径。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-UNL-ARENA-COUNCILOR cardNo=UNL-001/219 mode=STANDBY_REVEAL destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 在已知单位《竞技场理事》没有待命关键词时返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不支付费用、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续复用 `revealedTags` 必须包含 `待命` 的检查，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsKnownNonStandbyCard`，锁定错误码和错误信息 `竞技场理事 does not expose the Standby keyword for REVEAL_CARD.`，并确认来源仍在 base 且正面朝下、战力/费用/标签/`cardNo`、rune pool 和 stack 保持原样。
...
## P4.344 Standby Reaction Missing Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.76 已接入 `STANDBY_REACTION` / `STACK` 无目标 0 费用反应入栈；本批次补同一反应入口的支付项存在性边界，避免省略 `STANDBY_REVEAL_0` 的命令被误认为合法反应。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=[]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不移动基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续要求 `STANDBY_REVEAL_0` 作为待命显露/反应入栈的唯一已验证支付项，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionMissingRevealCost`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-missing-cost-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionMissingRevealCostRejectionFixture`，把 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈支付项存在性边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction missing-cost rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.345 Standby Reaction Unsupported Optional Cost Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.344 已锁定反应入栈必须显式携带 `STANDBY_REVEAL_0`；本批次补同一反应入口的费用名边界，避免 `ECHO` 等其他 optional cost 被误接入待命反应。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=["ECHO"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不移动基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续只接受 `STANDBY_REVEAL_0` 作为待命显露/反应入栈的已验证支付项，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionUnsupportedOptionalCost`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-unsupported-optional-cost-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionUnsupportedOptionalCostRejectionFixture`，把 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈费用名边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction unsupported optional cost rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.346 Standby Reaction Face-Up Source Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.76 已接入从正面朝下待命对象反应入栈；本批次补同一反应入口的来源正面性边界，避免已公开基地对象再次作为待命反应来源。

- `REVEAL_CARD sourceObjectId=P1-FACEUP-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 当前返回 `INVALID_TARGET`，不推进 tick、不写事件、不移动基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续要求待命显露/反应入栈来源对象 `IsFaceDown = true`，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionSourceNotFaceDown`，锁定错误码和错误信息 `Source card is not face down.`，并确认来源仍在 base 且公开状态、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-source-not-face-down-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionSourceNotFaceDownRejectionFixture`，把 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈来源正面性边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction source-not-face-down rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.347 Standby Reaction Source Outside Base Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.76 已接入命令玩家从自己基地的正面朝下待命对象反应入栈；本批次补同一反应入口的来源区域/控制者边界，避免玩家在优先权窗口翻开对手基地中的正面朝下对象。

- `REVEAL_CARD sourceObjectId=P2-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 由 P1 发起、但来源对象位于 P2 基地时返回 `INVALID_TARGET`，不推进 tick、不写事件、不翻开对象、不移动任一基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续要求待命显露/反应入栈来源对象位于命令玩家自己的基地，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionSourceOutsidePlayerBase`，锁定错误码和错误信息 `Source card is not in the player's base.`，并确认 P1/P2 base、对象正面状态、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-source-outside-base-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionSourceOutsidePlayerBaseRejectionFixture`，把 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈来源区域/控制者边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction source-outside-base rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.348 Standby Reaction Card Identity Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.318 已锁定待命基地显露入口不能伪造已知来源对象身份；本批次把同一身份护栏补到 `STANDBY_REACTION` 反应入栈入口，避免优先权窗口中把一张已知正面朝下待命牌伪装成另一张待命牌。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TIDE-CALLER cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 在来源对象已记录 `cardNo=OGN·199/298` 时返回 `INVALID_TARGET`，不推进 tick、不写事件、不翻开对象、不移动基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续要求待命显露/反应入栈命令声明的 `cardNo` 与已知来源对象身份一致，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionSourceCardNoMismatch`，锁定错误码和错误信息 `Source card identity does not match REVEAL_CARD cardNo.`，并确认来源仍在 base 且正面朝下、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-cardno-mismatch-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionSourceCardNoMismatchRejectionFixture`，把 `OGN·199/298 控潮者` 与 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈来源身份边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction cardNo mismatch rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.349 Standby Reaction Destination Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.76 已接入 `STANDBY_REACTION` 到 `STACK` 的无目标反应入栈路径；本批次补同一入口的目的地边界，避免反应模式误走基地显露或其他非入栈目的地。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=BASE optionalCosts=["STANDBY_REVEAL_0"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不移动基地对象、不支付费用、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有新增执行分支；它继续只接受无目标 `STANDBY_REACTION` / `STACK`，待命触发、战场/完整隐藏区和目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionUnsupportedDestination`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、战力/费用/标签/`cardNo`、rune pool 和既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-unsupported-destination-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionUnsupportedDestinationRejectionFixture`，把 `OGN·121/298 提莫` 的官方待命文本作为 P4 当前反应入栈目的地边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction unsupported destination rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。
...
- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REVEAL destination=HAND optionalCosts=["STANDBY_REVEAL_0"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不移动对象、不创建 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只接受无目标 `STANDBY_REVEAL` / `BASE` 和无目标 `STANDBY_REACTION` / `STACK`，其他目的地仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsUnsupportedDestination`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、hand/rune pool/stack 保持原样。
- 新增 fixture `p4-reveal-card-standby-unsupported-destination-rejected.fixture.json` 和回放测试 `P4RevealCardCommandUnsupportedDestinationRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前显露目的地边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal destination rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.324 Standby Reaction Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.76 只接入无目标 `STANDBY_REACTION` 反应入栈；本批次把反应路径带目标继续保持显式拒绝，避免提莫展示/伤害/回收分支在待命触发和完整隐藏区完成前进入可玩路径。

- `REVEAL_CARD sourceObjectId=P1-FACEDOWN-OGN-TEEMO cardNo=OGN·121/298 mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"] targetObjectIds=["P2-BATTLEFIELD-UNIT-001"]` 当前返回 `UNSUPPORTED_CARD_BEHAVIOR`，不推进 tick、不写事件、不翻开来源、不伤害目标、不创建新的 stack item。
- `CoreRuleEngine.ResolveRevealCard` 本批次没有实现新分支；它继续只接受无目标 `STANDBY_REACTION` / `STACK`，反应目标伤害仍 deferred。
- 新增 direct engine 测试 `P4RevealCardCommandRejectsReactionTargetsUntilStandbyDamageExists`，锁定错误码和错误信息 `Unsupported standby reveal mode for 提莫.`，并确认来源仍在 base 且正面朝下、目标 damage 保持 0、既有 stack item 保持原样。
- 新增 fixture `p4-reveal-card-standby-reaction-target-rejected.fixture.json` 和回放测试 `P4RevealCardCommandReactionTargetRejectionFixture`，把 `OGN·121/298 提莫` 的待命文本作为 P4 当前反应显露目标分支边界证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 reveal reaction target rejection fixture；待命触发、战场/完整隐藏区、目标伤害和伏击共用隐藏信息仍 deferred。

## P4.325 Ambush Target Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.64/P4.97 已锁定 `PLAY_CARD mode=AMBUSH` 前置模型显式拒绝；本批次补同一伏击入口携带目标时的拒绝边界，避免在伏击真实反应战场打出和目标结算完成前误走普通手牌打出或目标伤害路径。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN targetObjectIds=["P2-BATTLEFIELD-UNIT-001"]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌、不伤害目标、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应窗口、战场目的地合法性、单位打出至战场和目标结算仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeWithTargetIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认手牌、双方战场、目标 damage、rune pool 和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-target-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeWithTargetRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本作为 P4 当前带目标伏击前置拒绝证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该伏击 target rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.326 Ambush Base Destination Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.64 已为 `PLAY_CARD mode=AMBUSH` 增加 `destination` envelope；本批次锁定 `destination=BASE` 仍必须拒绝，避免伏击请求在真实战场反应打出模型完成前退化为普通入基地。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH destination=BASE targetObjectIds=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌、不进入基地、不创建 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应窗口、战场目的地合法性和单位打出至战场仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeWithBaseDestinationIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认手牌、基地、战场、rune pool 和 stack 均保持原样。
- 新增 fixture `p4-ambush-play-card-base-destination-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModeWithBaseDestinationRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本作为 P4 当前 BASE 目的地伏击前置拒绝证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该伏击 destination rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.327 Ambush Priority Window Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。伏击的真实语义依赖优先权窗口和结算链上下文；本批次锁定即使当前已有待结算项目且 P1 持有优先权，`PLAY_CARD mode=AMBUSH` 仍在反应战场打出模型完成前显式拒绝。

- `PLAY_CARD sourceObjectId=P1-HAND-UNL-GLOOMY-APOTHECARY cardNo=UNL-021/219 mode=AMBUSH destination=BATTLEFIELD:P1-MAIN targetObjectIds=[]` 在 `NEUTRAL_CLOSED` / `priorityPlayerId=P1` / stack 非空窗口中当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不支付费用、不移动手牌、不进入基地/战场、不改变既有 stack item。
- `CoreRuleEngine.ResolveAsync` 本批次没有实现新分支；它继续在 `PLAY_CARD mode=AMBUSH` 入口处显式拒绝，伏击反应战场打出和单位进入战场仍 deferred。
- 新增 direct engine 测试 `P4AmbushPlayCardModeInPriorityWindowIsRejectedUntilBattlefieldReactionPlayExists`，锁定错误码和错误信息 `PLAY_CARD mode AMBUSH is not implemented in P4 yet.`，并确认 timing/priority、手牌、基地、战场、rune pool 和既有 stack item 均保持原样。
- 新增 fixture `p4-ambush-play-card-priority-window-rejected.fixture.json` 和回放测试 `P4AmbushPlayCardModePriorityWindowRejectionFixture`，把 `UNL-021/219 阴森药剂师` 的伏击文本和核心优先权规则作为 P4 当前优先权窗口伏击前置拒绝证据。
- `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该伏击 priority-window rejection fixture；本批次没有改变 `CoreRuleEngine` 主实现，也不进入伏击真实反应战场打出、face-down 共用隐藏信息、目标结算或战场目的地结算。

## P4.328 Move Unit Precise Destination Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.300/P4.301 已接入 coarse `BASE`/`BATTLEFIELD` 双向移动，P4.98 已锁定精确战场 + `ROAM` 前置拒绝；本批次只把无 `ROAM` 的精确战场目的地单独固化，避免普通移动牌在多战场模型完成前指定 `BATTLEFIELD:P1-MAIN` 等具体位置。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-PRECISE-DESTINATION-001 origin=BASE destination=BATTLEFIELD:P1-MAIN optionalCosts=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不移动对象、不改变战力/标签、不创建 stack item。
- `CoreRuleEngine.ResolveMoveUnit` 本批次没有实现新执行分支；它继续只接受 coarse `BASE` / `BATTLEFIELD`，遇到带冒号的精确位置时返回 `MOVE_UNIT precise battlefield locations are not implemented in P4 yet.`。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsPreciseBattlefieldDestinationWithoutRoamCost`，锁定错误码、错误信息、base/battlefields、rune pool、对象战力/标签和 stack 均保持原样。
- 新增 fixture `p4-move-unit-precise-destination-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandPreciseDestinationRejectionFixture`，把 `UNL-101/219 战斗号令` 的基础移动文本作为精确目的地边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 precise destination rejection fixture；真实多战场目的地、游走权限、移动次数和移动触发仍 deferred。

## P4.329 Move Unit Precise Origin Rejection Slice

本阶段继续 completion audit：P4 仍不能标记 goal complete。P4.328 已锁定精确目的地；本批次补对称的精确来源边界，确保当前 coarse `MOVE_UNIT` 不会把 `BATTLEFIELD:P1-MAIN` 等具体战场来源误当作普通 `BATTLEFIELD` 来源处理。

- `MOVE_UNIT sourceObjectId=P1-MOVE-UNIT-PRECISE-ORIGIN-001 origin=BATTLEFIELD:P1-MAIN destination=BASE optionalCosts=[]` 当前返回 `UNSUPPORTED_COMMAND`，不推进 tick、不写事件、不移动对象、不改变战力/横置状态/标签、不创建 stack item。
- `CoreRuleEngine.ResolveMoveUnit` 本批次没有实现新执行分支；它继续只接受 coarse `BASE` / `BATTLEFIELD`，遇到带冒号的精确来源时返回 `MOVE_UNIT precise battlefield locations are not implemented in P4 yet.`。
- 新增 direct engine 测试 `P4MoveUnitCommandRejectsPreciseBattlefieldOriginWithoutRoamCost`，锁定错误码、错误信息、base/battlefields、rune pool、对象战力/横置状态/标签和 stack 均保持原样。
- 新增 fixture `p4-move-unit-precise-origin-rejected.fixture.json` 和回放测试 `P4MoveUnitCommandPreciseOriginRejectionFixture`，把 `OGN·173/298 驭风而行` 的基础移动文本作为精确来源边界证据。
- `P4BasicActionProfilesKeepExistingRepresentativeFixturesGreen` 现在实际回放该 precise origin rejection fixture；真实多战场来源、游走权限、移动次数和移动触发仍 deferred。
...
- `REVEAL_CARD` 已有 P4.68 command envelope；P4.71 已执行 `STANDBY_REVEAL` / `BASE` 最小显露，P4.76 已执行 `STANDBY_REACTION` / `STACK` 无目标反应入栈，P4.95 已补同一路径无优先权窗口拒绝 fixture，P4.318 已补显露已知来源 `cardNo` 身份不匹配拒绝 fixture，P4.348 已补反应入栈已知来源 `cardNo` 身份不匹配拒绝 fixture，P4.319 已补显露来源不在命令玩家基地拒绝 fixture，P4.347 已补反应入栈来源不在命令玩家基地拒绝 fixture，P4.320 已补显露来源已公开拒绝 fixture，P4.346 已补反应入栈来源已公开拒绝 fixture，P4.321 已补带目标拒绝 fixture，P4.322 已补显露 unsupported optional cost 拒绝 fixture，P4.345 已补反应 unsupported optional cost 拒绝 fixture，P4.341 已补显露 missing reveal cost 拒绝 fixture，P4.344 已补反应 missing reveal cost 拒绝 fixture，P4.342 已补显露已知非待命牌拒绝 fixture，P4.343 已补反应入栈已知非待命牌拒绝 fixture，P4.323 已补显露 unsupported destination 拒绝 fixture，P4.349 已补反应 unsupported destination 拒绝 fixture，P4.324 已补反应入栈带目标拒绝 fixture；目标结算、触发和完整隐藏区仍 deferred。
...
- `ASSEMBLE_EQUIPMENT` 已有 P4.66 command envelope 与 Core 显式拒绝前置模型，P4.99/P4.330/P4.331/P4.353/P4.375/P4.354/P4.376/P4.355/P4.356/P4.357/P4.358/P4.359/P4.360 已补普通窗口、优先权窗口、已贴附来源、缺少目标、未知目标、缺少来源、未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用 conformance fixtures，可供后续装配/灵便/百炼小批次复用；当前不贴附装备。
- `DECLARE_BATTLE` 已有 P4.67 command envelope 与 Core 显式拒绝前置模型，P4.100/P4.332/P4.350/P4.351/P4.352/P4.361/P4.362/P4.363/P4.364/P4.365/P4.366/P4.367/P4.368/P4.369/P4.370/P4.371/P4.372/P4.373/P4.374 已补普通窗口、优先权窗口、空攻击者、空防守者列表、缺少战场 id、未知战场 id、unsupported optional cost、缺少战斗费用、攻击者非战场来源、防守者非战场来源、对手控制攻击者、当前玩家控制防守者、重复攻击者、重复防守者、攻防列表交叉、非主动玩家声明战斗、非主阶段声明战斗、未知攻击者和未知防守者拒绝 conformance fixtures，可供后续强攻/坚守/壁垒/后排战斗小批次复用；当前不开战。
...
- 游走的多战场合法移动和移动触发得分；P4.300/P4.301 只完成 coarse `BASE`/`BATTLEFIELD` 基础移动，P4.328/P4.329 仅锁定精确目的地/来源拒绝
...
| P4.73 completion audit + 蔚激活技能最小入栈执行 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增《蔚》`PAY_2_RED_DOUBLE_POWER` 无目标付费技能入栈/结算 fixture、正向入栈测试、目标拒绝测试和资源不足拒绝测试，P4.389 已登记《蔚》《泽拉斯》代表技能，其他技能目标税仍 deferred。 |
...
| P4.274 completion audit + SFD·089 兰博普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·089《兰博》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.275 completion audit + SFD·089a 兰博异画 A 普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·089a《兰博》异画 A 普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.276 completion audit + SFD·100 约德尔探险家普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·100《约德尔探险家》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.277 completion audit + SFD·121 黑市掮客普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·121《黑市掮客》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.278 completion audit + SFD·137 猎海小队普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·137《猎海小队》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.279 completion audit + UNL-068 幽魂半人马普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 UNL-068《幽魂半人马》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.280 completion audit + SFD·123 腐化执法官普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·123《腐化执法官》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.281 completion audit + SFD·125 大力仙灵普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·125《大力仙灵》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.282 completion audit + SFD·142 贾尔·米达尔达普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·142《贾尔·米达尔达》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.283 completion audit + SFD·146 薇古丝普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·146《薇古丝》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.284 completion audit + SFD·152 显赫金主普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·152《显赫金主》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.285 completion audit + SFD·039 皇家随从普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·039《皇家随从》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.286 completion audit + SFD·049 厄斐琉斯普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·049《厄斐琉斯》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.287 completion audit + SFD·058 奥恩普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·058《奥恩》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.288 completion audit + SFD·058a 奥恩异画 A 普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·058a《奥恩》异画 A 普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.289 completion audit + SFD·079 巴德普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·079《巴德》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.290 completion audit + SFD·081 大老千普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·081《大老千》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.291 completion audit + SFD·084 杰斯普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·084《杰斯》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.292 completion audit + SFD·160 祖安混混普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·160《祖安混混》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.293 completion audit + SFD·165 戈拉斯克调酒师普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·165《戈拉斯克调酒师》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.294 completion audit + SFD·170 雷克塞普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·170《雷克塞》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.295 completion audit + SFD·170a 雷克塞异画 A 普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·170a《雷克塞》异画 A 普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.296 completion audit + SFD·173 索拉卡普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·173《索拉卡》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.297 completion audit + SFD·175 垓兽普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·175《垓兽》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
| P4.298 completion audit + SFD·180 菲奥娜普通打出带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 SFD·180《菲奥娜》普通手牌打出带目标时拒绝且不推进 tick/事件/符文池/手牌/主牌堆/基地目标/stack、不入场单位的 fixture，并把该 fixture 纳入基础动作聚合回放。 |
...
| P4.303 completion audit + MOVE_UNIT 面朝下来源拒绝 fixture 切片 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 P1 不能移动正面朝下待命来源对象的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
...
| P4.308 completion audit + MOVE_UNIT unsupported zone 拒绝 fixture 切片 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增当前 coarse `MOVE_UNIT` 只接受 `BASE` / `BATTLEFIELD`、拒绝 `HAND` 等 unsupported zone 的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.309 completion audit + MOVE_UNIT origin mismatch 拒绝 fixture 切片 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增来源对象实际在基地但 command 声明 `origin=BATTLEFIELD` 时拒绝且不改状态的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.310 completion audit + MOVE_UNIT pending stack 拒绝 fixture 切片 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 stack 非空且优先权窗口中不能执行 `MOVE_UNIT` 的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.311 completion audit + MOVE_UNIT hand source 拒绝 fixture 切片 | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增来源对象仍在手牌时不能伪装为 `BASE` / `BATTLEFIELD` 场上来源移动的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.312 completion audit + 待命暗置来源不在手牌拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增基地中已有待命对象不能再次作为手牌来源执行 `HIDE_CARD` / `STANDBY_A` 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.313 completion audit + 待命暗置目的地不支持拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `HIDE_CARD` / `STANDBY_A` 当前只接受 `destination=STANDBY` 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.314 completion audit + 待命暗置非待命费用名拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `HIDE_CARD destination=STANDBY optionalCosts=["ECHO"]` 当前拒绝且不推进 tick/事件/费用/手牌/基地/stack 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.315 completion audit + 待命暗置行动窗口拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增非主动玩家不能在对手开放主阶段执行 `HIDE_CARD` / `STANDBY_A` 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.316 completion audit + 待命暗置 pending stack 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 stack 非空且优先权窗口中不能执行 `HIDE_CARD` / `STANDBY_A` 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.317 completion audit + 待命暗置来源 `cardNo` 身份不匹配拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；`HIDE_CARD` 现在拒绝已知来源对象伪造另一张待命牌 `cardNo`，并新增 direct engine 测试和 conformance fixture，纳入互动关键词聚合回放。 |
| P4.318 completion audit + 待命显露来源 `cardNo` 身份不匹配拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；复用 `REVEAL_CARD` 已有来源身份护栏，新增 direct engine 测试和 conformance fixture，纳入互动关键词聚合回放。 |
| P4.319 completion audit + 待命显露来源不在玩家基地拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增玩家不能翻开对手基地正面朝下待命对象的 direct engine 测试和 conformance fixture，纳入互动关键词聚合回放。 |
| P4.320 completion audit + 待命显露来源已公开拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增基地中已公开对象不能再次执行 `REVEAL_CARD` 的 direct engine 测试和 conformance fixture，纳入互动关键词聚合回放。 |
| P4.321 completion audit + 待命显露带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD` 当前带目标时拒绝的 direct engine 测试和 conformance fixture，锁定目标伤害分支仍 deferred 且不改状态。 |
| P4.322 completion audit + 待命显露 unsupported optional cost 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD` 当前携带 `ECHO` 等非 `STANDBY_REVEAL_0` 费用名时拒绝的 direct engine 测试和 conformance fixture，锁定不翻开、不支付、不入栈。 |
| P4.323 completion audit + 待命显露 unsupported destination 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD` 当前携带 `HAND` 等非 `BASE` / `STACK` 目的地时拒绝的 direct engine 测试和 conformance fixture，锁定不翻开、不移动、不入栈。 |
| P4.324 completion audit + 待命反应入栈带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD` 反应入栈路径当前带目标时拒绝的 direct engine 测试和 conformance fixture，锁定不翻开、不伤害、不新增 stack item。 |
| P4.325 completion audit + 伏击带目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH` 当前携带目标时拒绝的 direct engine 测试和 conformance fixture，锁定不支付、不移动手牌、不伤害目标、不改战场、不新增 stack item。 |
| P4.326 completion audit + 伏击 BASE 目的地拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH destination=BASE` 当前拒绝的 direct engine 测试和 conformance fixture，锁定不支付、不移动手牌、不进入基地、不改战场、不新增 stack item。 |
| P4.327 completion audit + 伏击优先权窗口拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH` 在优先权窗口且 stack 非空时仍拒绝的 direct engine 测试和 conformance fixture，锁定不支付、不移动手牌、不改场面、不新增/改变 stack item。 |
| P4.328 completion audit + MOVE_UNIT 精确目的地拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `MOVE_UNIT origin=BASE destination=BATTLEFIELD:P1-MAIN optionalCosts=[]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.329 completion audit + MOVE_UNIT 精确来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `MOVE_UNIT origin=BATTLEFIELD:P1-MAIN destination=BASE optionalCosts=[]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入基础动作聚合回放。 |
| P4.330 completion audit + ASSEMBLE_EQUIPMENT 优先权窗口拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 在优先权窗口/stack 非空时当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.331 completion audit + ASSEMBLE_EQUIPMENT 已贴附来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增已贴附装备来源再次执行 `ASSEMBLE_EQUIPMENT` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.332 completion audit + DECLARE_BATTLE 优先权窗口拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 在优先权窗口/stack 非空时当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.333 completion audit + MOVE_UNIT 战斗中来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `MOVE_UNIT` 来源对象已进攻/防守时当前拒绝的 Core guard、direct engine 测试和 conformance fixture，并纳入战斗关键词与基础动作聚合回放。 |
| P4.334 completion audit + MOVE_UNIT 带贴附装备来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `MOVE_UNIT` 来源单位已有装备贴附时当前拒绝的 Core guard、direct engine 测试和 conformance fixture，并纳入装备关键词与基础动作聚合回放。 |
| P4.335 completion audit + 伏击来源不在手牌拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH` 来源对象已在基地、不在手牌时当前拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.336 completion audit + 伏击来源 `cardNo` 身份不匹配拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH` 已知来源对象 `cardNo` 与命令 `cardNo` 不一致时当前拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.337 completion audit + 伏击 unsupported optional cost 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `PLAY_CARD mode=AMBUSH optionalCosts=["ECHO"]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.338 completion audit + 待命对手手牌来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 P1 不能用 P2 手牌对象作为 `HIDE_CARD / STANDBY_A` 来源的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.339 completion audit + 待命已知非关键词牌拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增已知单位《竞技场理事》没有待命关键词时不能通过 `HIDE_CARD / STANDBY_A` 暗置的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
...
| P4.344 completion audit + 待命反应缺少支付项拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION` 反应入栈路径省略 `STANDBY_REVEAL_0` 时拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.345 completion audit + 待命反应 unsupported optional cost 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION optionalCosts=["ECHO"]` 反应入栈路径携带 unsupported optional cost 时拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.346 completion audit + 待命反应来源已公开拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION` 反应入栈路径选择已公开基地来源时拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.347 completion audit + 待命反应来源不在基地拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION` 反应入栈路径选择不在命令玩家基地中的来源时拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.348 completion audit + 待命反应来源身份不匹配拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION` 反应入栈路径选择 `cardNo` 身份不匹配来源时拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.349 completion audit + 待命反应目的地拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION destination=BASE` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.350 completion audit + DECLARE_BATTLE 空攻击者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 空攻击者列表当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.351 completion audit + DECLARE_BATTLE 空防守者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 空防守者列表当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.352 completion audit + DECLARE_BATTLE 缺少战场 id 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 缺少 `battlefieldId` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.353 completion audit + ASSEMBLE_EQUIPMENT 缺少目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 缺少 `targetObjectId` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.354 completion audit + ASSEMBLE_EQUIPMENT 缺少来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 缺少 `sourceObjectId` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.355 completion audit + ASSEMBLE_EQUIPMENT 手牌来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 来源装备仍在手牌时当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.356 completion audit + ASSEMBLE_EQUIPMENT 对手来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 来源装备位于对手基地时当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.357 completion audit + ASSEMBLE_EQUIPMENT 非装备来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 来源对象不是装备时当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.358 completion audit + ASSEMBLE_EQUIPMENT 非单位目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT` 目标对象不是单位时当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.359 completion audit + ASSEMBLE_EQUIPMENT unsupported optional cost 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT optionalCosts=["ECHO"]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.360 completion audit + ASSEMBLE_EQUIPMENT 缺少装配费用拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `ASSEMBLE_EQUIPMENT optionalCosts=[]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.361 completion audit + DECLARE_BATTLE unsupported optional cost 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE optionalCosts=["ECHO"]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.362 completion audit + DECLARE_BATTLE 缺少战斗费用拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE optionalCosts=[]` 当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.363 completion audit + DECLARE_BATTLE 攻击者非战场拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 攻击者来自基地等非战场区域时当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.364 completion audit + DECLARE_BATTLE 防守者非战场拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `DECLARE_BATTLE` 防守者来自基地等非战场区域时当前拒绝的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.365 completion audit + DECLARE_BATTLE 对手控制攻击者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增当前玩家不能把对手控制的场上单位声明为攻击者的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.366 completion audit + DECLARE_BATTLE 当前玩家控制防守者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增当前玩家不能把自己控制的场上单位声明为防守者的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
...
| P4.371 completion audit + DECLARE_BATTLE 非主阶段拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增非主阶段不能声明战斗的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.372 completion audit + DECLARE_BATTLE 未知攻击者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增未知攻击者对象 id 不能声明战斗的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.373 completion audit + DECLARE_BATTLE 未知防守者拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增未知防守者对象 id 不能声明战斗的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.374 completion audit + DECLARE_BATTLE 未知战场 id 拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增未知 battlefieldId 不能声明战斗的 direct engine 测试和 conformance fixture，并纳入战斗关键词聚合回放。 |
| P4.375 completion audit + ASSEMBLE_EQUIPMENT 未知目标拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增未知 targetObjectId 不能执行装配的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
| P4.376 completion audit + ASSEMBLE_EQUIPMENT 未知来源拒绝 fixture | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增未知 sourceObjectId 不能执行装配的 direct engine 测试和 conformance fixture，并纳入装备关键词聚合回放。 |
...
| P4.386 standby reaction trigger resolution | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增 `REVEAL_CARD / STANDBY_REACTION` 中官网《提莫》作为反应牌入栈后结算自身 +3 的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.387 ambush battlefield reaction representative path | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增官网《阴森药剂师》无目标 `PLAY_CARD / AMBUSH` 在优先权窗口入栈、支付 3、双方让过后进入控制者战场的 direct engine 测试和 conformance fixture，并纳入互动关键词聚合回放。 |
| P4.388 Long Sword assemble attachment representative path | Done | 100% | 审计确认 P4 仍不能标记 goal complete；新增官网《长剑》最小 `ASSEMBLE_EQUIPMENT / ASSEMBLE_RED` 装配路径，支付 1 power 并把基地未贴附武装写入 `attachedToObjectId`，通用装配/灵便自动贴附/百炼/P5 装备系统继续 deferred。 |
...
## P4.386 Standby Reaction Resolution Slice

本批次只接入一个低风险待命反应结算代表路径，不展开完整隐藏区或目标伤害分支：

- 使用官网《提莫》`OGN·197/298`：`{{待命}}` 后“当你打出我时，让我本回合内 `S` +3”。
- 既有 `REVEAL_CARD mode=STANDBY_REACTION destination=STACK optionalCosts=["STANDBY_REVEAL_0"]` 继续负责把正面朝下待命对象公开、移出基地并加入结算链。
- 双方让过后，`ResolveStackItemEffect` 复用 `TEEMO_PLAY_UNIT_SELF_POWER_PLUS_3` 的既有 P2/P4 行为：源对象作为 1 战力、带 `CARD_TYPE:UNIT` / `待命` / `约德尔人` 的单位回到控制者基地，并写入 `POWER_MODIFIED_UNTIL_END_OF_TURN`，最终战力 4、本回合修正 +3。
- 新增 direct engine 测试 `P4RevealCardCommandResolvesStandbyReactionTeemoSelfPowerPlusThree`，新增 fixture `p4-reveal-card-standby-reaction-teemo-self-power.fixture.json`，并纳入 `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 聚合。
- 本批次仍不实现待命目标伤害、完整隐藏区位置限制、提莫展示/回收分支、伏击真实反应战场打出或复杂触发队列。

## P4.387 Ambush Battlefield Reaction Slice

本批次只接入一个低风险伏击代表路径，不展开广义伏击牌、目标分支或完整多战场坐标：

- 使用官网《阴森药剂师》`UNL-021/219`：`{{伏击}}（你可以选择将我作为{{反应}}牌，打出到有己方单位的战场。）`，以及“当你打出我时，你可以选择让一名战场上的友方单位返回其所属的手牌。”
- `CoreRuleEngine.ResolvePlayCard` 对 `mode=AMBUSH` 只接受白名单 `UNL-021/219`、无目标、无 optional cost、`destination=BATTLEFIELD:{playerId}-MAIN`、来源在命令玩家手牌、来源对象带 `伏击` tag、当前主阶段有待结算 stack item 且命令玩家持有优先权。
- 当前 coarse battlefield 模型没有持久在线战场坐标，因此“有己方单位的战场”用控制者 `Battlefields` 区域中已有一个正面 `CARD_TYPE:UNIT` 作为最小代理；缺少该代理时保留 `p4-ambush-play-card-priority-window-rejected.fixture.json` 拒绝边界。
- accepted 路径支付 3 mana、移除手牌来源、创建带 `destination` 的 `StackItemState`；双方让过后，结算时将源单位写入控制者 `Battlefields` 并发布 `UNIT_PLAYED_TO_BATTLEFIELD`。
- 新增 direct engine 测试 `P4AmbushPlayCardModeInPriorityWindowPlaysGloomyApothecaryToBattlefield`，新增 fixture `p4-ambush-play-card-gloomy-apothecary-battlefield.fixture.json`，并纳入 `P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen` 聚合。
- 本批次仍不实现《阴森药剂师》可选回手目标、其他伏击牌、伏击目标结算、完整多战场 occupancy、伏击隐藏信息或与 P5 装备/触发系统的联动。

## P4.388 Long Sword Assemble Attachment Slice

本批次只接入一个低风险装备装配代表路径，不展开完整装备系统：

- 使用官网《长剑》`SFD·022/221`：`{{灵便}}` 与 `{{装配}}{{红色}}`。
- `CoreRuleEngine.ResolveAssembleEquipment` 只接受当前玩家在普通主阶段开放窗口、stack 为空时发起的 `ASSEMBLE_EQUIPMENT sourceObjectId=P1-EQUIPMENT-LONG-SWORD targetObjectId=P1-UNIT-ASSEMBLE-TARGET optionalCosts=["ASSEMBLE_RED"]` 这一类最小路径。
- 来源必须是当前玩家基地中的公开、未贴附装备对象，带 `CARD_TYPE:EQUIPMENT` / `武装` / `灵便` 标签，并且 `cardNo` 为空或等于 `SFD·022/221`；目标必须是当前玩家控制的公开场上单位对象。
- accepted 路径支付 1 power、推进 1 tick、写入 `COST_PAID` 与 `EQUIPMENT_ATTACHED`，并把来源对象 `attachedToObjectId` 设置为目标对象 id；装备仍保留在当前 coarse `Base` 列表中，等待后续完整装备区域/随动模型。
- 新增 direct engine 测试 `P4AssembleEquipmentCommandAttachesLongSwordToFriendlyUnit`，新增 fixture `p4-assemble-equipment-long-sword-attach.fixture.json`，并纳入 `P4EquipmentKeywordProfilesKeepExistingNoAttachFixturesGreen` 聚合。
- 本批次仍不实现灵便作为反应牌打出时自动贴附、通用装配颜色/费用、百炼 optional attach、装备 owner/controller、贴附层级、装备随动、未激活文本或 P5/P6 批量迁移。

## P4.389 Activated Ability Registry Bridge Slice

本批次只做低风险技能 registry 桥接，不新增泛化技能或装备技能执行：

- 新增 `P4ActivatedAbilityCatalog` 与 `P4ActivatedAbilityDefinition`，把已验证的 `UNL-030/219 蔚` / `PAY_2_RED_DOUBLE_POWER` 和 `UNL-026/219 泽拉斯` / `PAY_RED_EXHAUST_DAMAGE_3` 登记为可枚举定义。
- `CoreRuleEngine.ResolveActivateAbility` 先按 `abilityId` 查 registry；未知技能继续返回 `ACTIVATE_ABILITY is not implemented in P4 yet.`，已登记代表技能继续走既有《蔚》/《泽拉斯》安全路径。
- 《泽拉斯》路径的 `RequiredTargetCount`、`PowerCost`、`DamageAmount`、`EffectKind` 和 `AppliesSpellshieldTargetTax` 改从 definition 读取；《蔚》路径的来源 `cardNo`、mana/power 费用和 `EffectKind` 同样改从 definition 读取。
- 新增 direct test `P4ActivatedAbilityCatalogExposesRepresentativeSkillDefinitions`，锁定两个代表技能的来源卡号、费用、目标数、横置费用、伤害数值和法盾目标税标志。
- 本批次不新增其他技能、不进入装备技能、不处理经验激活技能或 P5 触发/替换系统；更多技能目标税仍只允许后续逐个代表卡小批次接入。

## P4.390 Standby Target Damage Deferred Audit Slice

本批次只做待命目标伤害的显式 deferred 审计，不新增隐藏区、展示/回收或目标伤害执行：

- 复用官网《提莫》`OGN·121/298` 待命文本作为代表卡面证据，继续锁定 `REVEAL_CARD` 的目标分支必须在真实待命目标伤害系统完成前拒绝。
- 新增横向 conformance 审计 `P4StandbyTargetDamageDeferredFixturesCoverRevealAndReactionBranches`，同时回放 `p4-reveal-card-standby-target-rejected.fixture.json` 与 `p4-reveal-card-standby-reaction-target-rejected.fixture.json`。
- 审计断言两条 fixture 均为 `RULE_AUDITED`、保留官网卡表与规则证据，并在执行后保持 `finalTick = 0`、无事件、来源仍正面朝下、目标伤害仍为 0。
- 对 `STANDBY_REACTION` / `STACK` 分支额外锁定既有 pending stack item 不变且不会新增待命 stack item；对 `STANDBY_REVEAL` / `BASE` 分支锁定 stack 为空。
- `CoreRuleEngine.ResolveRevealCard` 本批次不新增执行分支；待命目标伤害执行、完整隐藏区和更复杂待命触发继续 deferred。

## P4.391 Activated Ability Deferred Surface Audit Slice

本批次只做未登记技能的范围审计，不把更多 ability id 接入可玩路径：

- `P4ActivatedAbilityCatalog.GetAll()` 继续只暴露已验证的《蔚》`PAY_2_RED_DOUBLE_POWER` 与《泽拉斯》`PAY_RED_EXHAUST_DAMAGE_3` 两条可执行 definition。
- 新增 `P4DeferredActivatedAbilitySurface` 与 `GetDeferredSurfaces()`，记录《龙魂贤者》反应获得资源、《绵绵魄罗》打出法盾战鹰、《烈娜塔·戈拉斯克》抽牌/得分技能、《猩红玫瑰》活跃单位技能和《黑影》迅捷眩晕技能。
- 新增 catalog 审计测试 `P4ActivatedAbilityCatalogAuditsDeferredSkillSurfacesAgainstOfficialText`，逐条核对 deferred surface 的官网卡面文本、P3 activated ability parser 输出和未进入 executable registry 的边界。
