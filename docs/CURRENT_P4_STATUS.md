...
2026-06-28 B0 Interaction 注记：上表的“目标伤害 deferred”当前只适用于非 active battle/spell-duel base 上下文、其他待命牌族等未覆盖广度；battlefield-source Teemo、base/spell-duel Teemo 与 base/battle-response Teemo 的同战场目标、顶五张展示、按 `待命` 数量伤害和展示牌回收已由 direct runtime regressions 覆盖。
