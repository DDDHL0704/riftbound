...
- P4.387 提交：本提交 `feat: add p4 ambush battlefield reaction`
...
| 装配 | 51 | 0 | 0 | High | P4.8 已识别 profile；P4.58 已审计并锁定《取放自如》贴附/卸除武装的代表执行路径；P4.66 已新增 `ASSEMBLE_EQUIPMENT` typed command 与 Core 显式拒绝前置模型；P4.99 已补同一路径拒绝 fixture；P4.330 已补同一路径优先权窗口拒绝 fixture；P4.331 已补已贴附来源拒绝 fixture；P4.353/P4.375/P4.354/P4.376 已补缺少目标、未知目标、缺少来源和未知来源拒绝 fixture；P4.355-P4.360 已补手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture；P4.334 已补移动带贴附装备来源拒绝 fixture；装配费用、装备未激活文本和自动贴附仍 deferred。 |
| 灵便 | 6 | 0 | 0 | High | P4.8 已识别 profile；P4.58 的代表路径只覆盖已有反应法术《取放自如》；P4.66 已为灵便装备后续自动贴附保留 `ASSEMBLE_EQUIPMENT` envelope，P4.99/P4.330/P4.331/P4.353/P4.375/P4.354/P4.376/P4.355/P4.356/P4.357/P4.358/P4.359/P4.360 已补前置、优先权窗口、已贴附来源、缺少目标、未知目标、缺少来源、未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture；真实反应打出和自动贴附仍 deferred。 |
...
| Equipment keywords | `SFD·033/221 多兰之盾`：装配绿色；`SFD·022/221 长剑`：灵便、装配红色；`SFD·008/221 哨兵好手`：百炼；`SFD·085/221 奥恩`：法盾2、百炼；`SFD·011/221 取放自如`：选择一名单位和其控制者的一件武装，为该单位贴附或卸除该武装，抽一张牌。 | P2 已有装备打出和 no-optional 百炼 fixture，记录装备/武装/灵便/百炼标签；P4.58 复用 `p2-preflight-play-take-up-attach-weapon-draw` 与 `p2-preflight-play-take-up-detach-weapon-draw` 作为武装贴附/卸除代表执行证据；P4.66 新增 `P4AssembleEquipmentCommandIsExplicitlyRejectedUntilEquipmentSystemExists` / `GameCommandMapperParsesAssembleEquipmentPayload`；P4.99 新增 `P4AssembleEquipmentCommandRejectionFixture` / `p4-assemble-equipment-command-premodel-rejected.fixture.json`；P4.330 新增 `P4AssembleEquipmentCommandInPriorityWindowIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandPriorityWindowRejectionFixture` / `p4-assemble-equipment-priority-window-rejected.fixture.json`；P4.331 新增 `P4AssembleEquipmentCommandWithAlreadyAttachedSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandAlreadyAttachedSourceRejectionFixture` / `p4-assemble-equipment-already-attached-rejected.fixture.json`；P4.353 新增 `P4AssembleEquipmentCommandWithMissingTargetIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandMissingTargetRejectionFixture` / `p4-assemble-equipment-missing-target-rejected.fixture.json`；P4.375 新增 `P4AssembleEquipmentCommandWithUnknownTargetIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandUnknownTargetRejectionFixture` / `p4-assemble-equipment-unknown-target-rejected.fixture.json`；P4.354 新增 `P4AssembleEquipmentCommandWithMissingSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandMissingSourceRejectionFixture` / `p4-assemble-equipment-missing-source-rejected.fixture.json`；P4.376 新增 `P4AssembleEquipmentCommandWithUnknownSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandUnknownSourceRejectionFixture` / `p4-assemble-equipment-unknown-source-rejected.fixture.json`；P4.355 新增 `P4AssembleEquipmentCommandWithHandSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandHandSourceRejectionFixture` / `p4-assemble-equipment-hand-source-rejected.fixture.json`；P4.356 新增 `P4AssembleEquipmentCommandWithOpponentSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandOpponentSourceRejectionFixture` / `p4-assemble-equipment-opponent-source-rejected.fixture.json`；P4.357 新增 `P4AssembleEquipmentCommandWithNonEquipmentSourceIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandNonEquipmentSourceRejectionFixture` / `p4-assemble-equipment-non-equipment-source-rejected.fixture.json`；P4.358 新增 `P4AssembleEquipmentCommandWithNonUnitTargetIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandNonUnitTargetRejectionFixture` / `p4-assemble-equipment-non-unit-target-rejected.fixture.json`；P4.359 新增 `P4AssembleEquipmentCommandWithUnsupportedOptionalCostIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandUnsupportedOptionalCostRejectionFixture` / `p4-assemble-equipment-unsupported-optional-cost-rejected.fixture.json`；P4.360 新增 `P4AssembleEquipmentCommandWithMissingOptionalCostIsRejectedUntilEquipmentSystemExists` / `P4AssembleEquipmentCommandMissingOptionalCostRejectionFixture` / `p4-assemble-equipment-missing-optional-cost-rejected.fixture.json`；P4.334 新增 `P4MoveUnitCommandRejectsAttachedEquipmentSourceUntilAttachmentMovementExists` / `P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture` / `p4-move-unit-attached-equipment-source-rejected.fixture.json`。 | P4.8 已建立 equipment keyword profile；P4.58 已锁定《取放自如》贴附/卸除代表路径；P4.66 已建立 `ASSEMBLE_EQUIPMENT` command envelope 并显式拒绝执行；P4.99/P4.330/P4.331/P4.353/P4.375/P4.354/P4.376/P4.355/P4.356/P4.357/P4.358/P4.359/P4.360 已把普通窗口、优先权窗口、已贴附来源、缺少目标、未知目标、缺少来源、未知来源、手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝边界纳入 conformance fixture；P4.334 已锁定带贴附装备单位不能通过当前 coarse `MOVE_UNIT` 离区；装配费用、灵便自动贴附、百炼 optional attach、owner/controller、装备随动和未激活文本仍 deferred。 |
...
| 装备关键词：装配、灵便、百炼 | `CardEquipmentKeywordRules`、`CardEquipmentAttachmentProfile`、`P4EquipmentKeywordProfilesMapOfficialTextToRegistryTags`、`P4EquipmentAttachmentProfileMapsTakeUpToRepresentativeAttachDetach`、`P4AssembleEquipmentCommandIsExplicitlyRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandRejectionFixture`、`P4AssembleEquipmentCommandInPriorityWindowIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandPriorityWindowRejectionFixture`、`P4AssembleEquipmentCommandWithAlreadyAttachedSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandAlreadyAttachedSourceRejectionFixture`、`P4AssembleEquipmentCommandWithMissingTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingTargetRejectionFixture`、`P4AssembleEquipmentCommandWithUnknownTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnknownTargetRejectionFixture`、`P4AssembleEquipmentCommandWithMissingSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingSourceRejectionFixture`、`P4AssembleEquipmentCommandWithUnknownSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnknownSourceRejectionFixture`、`P4AssembleEquipmentCommandWithHandSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandHandSourceRejectionFixture`、`P4AssembleEquipmentCommandWithOpponentSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandOpponentSourceRejectionFixture`、`P4AssembleEquipmentCommandWithNonEquipmentSourceIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandNonEquipmentSourceRejectionFixture`、`P4AssembleEquipmentCommandWithNonUnitTargetIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandNonUnitTargetRejectionFixture`、`P4AssembleEquipmentCommandWithUnsupportedOptionalCostIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandUnsupportedOptionalCostRejectionFixture`、`P4AssembleEquipmentCommandWithMissingOptionalCostIsRejectedUntilEquipmentSystemExists`、`P4AssembleEquipmentCommandMissingOptionalCostRejectionFixture`、`P4MoveUnitCommandAttachedEquipmentSourceRejectionFixture`、`GameCommandMapperParsesAssembleEquipmentPayload`、`p4-assemble-equipment-command-premodel-rejected`、`p4-assemble-equipment-priority-window-rejected`、`p4-assemble-equipment-already-attached-rejected`、`p4-assemble-equipment-missing-target-rejected`、`p4-assemble-equipment-unknown-target-rejected`、`p4-assemble-equipment-missing-source-rejected`、`p4-assemble-equipment-unknown-source-rejected`、`p4-assemble-equipment-hand-source-rejected`、`p4-assemble-equipment-opponent-source-rejected`、`p4-assemble-equipment-non-equipment-source-rejected`、`p4-assemble-equipment-non-unit-target-rejected`、`p4-assemble-equipment-unsupported-optional-cost-rejected`、`p4-assemble-equipment-missing-optional-cost-rejected`、`p4-move-unit-attached-equipment-source-rejected`、5 条 no-attach fixture、2 条《取放自如》attach/detach fixture | Partial：P4.58 已覆盖《取放自如》武装贴附/卸除代表执行；P4.66 已建立 `ASSEMBLE_EQUIPMENT` command envelope 且显式拒绝执行，P4.99 已补同一路径 fixture，P4.330 已补优先权窗口/stack 非空拒绝 fixture，P4.331 已补已贴附来源拒绝 fixture，P4.353/P4.375/P4.354/P4.376 已补缺少目标、未知目标、缺少来源和未知来源拒绝 fixture，P4.355-P4.360 已补手牌来源、对手来源、非装备来源、非单位目标、unsupported optional cost 和缺少装配费用拒绝 fixture，P4.334 已补带贴附装备来源移动拒绝，并纳入装备关键词聚合；装配费用、灵便自动贴附、百炼 optional attach、owner/controller、装备随动 deferred。 |
...
- 预计剩余批次从 P4.380 的约 `12` 批降到约 `11` 批：下一批优先做战斗伤害/强攻/坚守数值代表切片，后续仍有真实游走、狩猎/经验触发、待命触发/目标伤害、伏击真实反应打出、通用 skill registry/技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。
...
- 预计剩余批次从 P4.381 的约 `11` 批降到约 `10` 批：下一批优先做壁垒/后排承伤最小代表或真实游走，之后仍有狩猎/经验触发、待命触发/目标伤害、伏击真实反应打出、通用 skill registry/技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。
...
- 预计剩余批次从 P4.382 的约 `10` 批降到约 `9` 批：下一批优先做真实游走或狩猎/战斗触发经验，之后仍有待命触发/目标伤害、伏击真实反应打出、通用 skill registry/技能目标税、装备关键词最小代表/P5 边界和最后 E2E/文档/全量验证收口。
...
P4 当前整体进度：按 P4.387 审计后预计 `387/392 = 98.7%`。已完成 P4.1-P4.387：在 P4.386 全部内容基础上，P4.387 将官网《阴森药剂师》无目标伏击反应打出接到结算链与 source-unit-to-battlefield 代表路径，仍保留可选回手目标、其他伏击牌、完整多战场目的地和隐藏信息为 deferred。当前仍不能标记 P4 goal complete：更多技能目标税/通用 skill registry、装备关键词最小代表与 P5 边界、待命目标伤害或明确 deferred、以及最后 SignalR 或等价 E2E/全量验证文档收口仍待完成。预计还需约 `5` 批。
...
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore`：pass，2553/2553
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~ConformanceFixtureRunnerTests"`：pass，2472/2472
...
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~P4AmbushPlayCardMode"`：pass，21/21
- `source scripts/dev-env.sh && dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~P4InteractionKeywordProfilesKeepExistingRepresentativeFixturesGreen"`：pass，51/51
- `jq empty tests/Riftbound.ConformanceTests/Fixtures/p4-ambush-play-card-gloomy-apothecary-battlefield.fixture.json`：pass
- `jq empty tests/Riftbound.ConformanceTests/Fixtures/p4-ambush-play-card-priority-window-rejected.fixture.json`：pass
- `git diff --check`：pass

## Next Step

进入 P4.388：优先在通用 skill registry/技能目标税、装备关键词最小代表/P5 边界、或待命目标伤害明确 deferred 中选择一个最低风险单 fixture 切片。预计 P4 还需要约 `5` 批：通用 skill registry/技能目标税、装备关键词最小代表/P5 边界、待命目标伤害或明确 deferred，以及最后 E2E/文档/全量验证收口。
