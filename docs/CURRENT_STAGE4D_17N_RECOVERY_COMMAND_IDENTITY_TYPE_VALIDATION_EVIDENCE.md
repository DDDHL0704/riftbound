2026-05-24 Stage 4D-17N recovery command identity/type validation evidence.
...
Adjacent result: passed `621/621`.
...
Backend full result: passed `5986/5986`.
