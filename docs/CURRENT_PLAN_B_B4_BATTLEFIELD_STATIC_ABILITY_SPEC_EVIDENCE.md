...
- latest focused behavior-spec/source guard/static Echo runtime representative: `5/5`;
- latest adjacent BattlefieldStatic / EchoCostReduction / PlayCard / PaymentEngine / GameHub / BoardTaskQueue / FullGame: `1317/1317`;
- MatchRecovery: `1989/1989`;
- backend full conformance: `8371/8371`.

## Non-Closure

This evidence proves two battlefield static restrictions and one battlefield static Echo cost reduction have moved to BehaviorSpec-driven routing. It does not prove the complete B4 battlefield-effect family, complex Echo costs, all movement / play timing windows, all battlefield lifecycle rules, all card-effect families, frontend smoke or READY.
