2026-05-24 Stage 4D-17A recovery rejected-command diagnostic replay evidence.
...
Adjacent result: passed `606/606`.
...
Backend full result: passed `5971/5971`.
