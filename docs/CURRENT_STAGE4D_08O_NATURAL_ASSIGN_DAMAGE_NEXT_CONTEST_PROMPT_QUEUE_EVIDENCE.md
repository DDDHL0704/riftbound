# Stage 4D-08O Natural Assign Damage Next Contest Prompt Queue Evidence
...
- `docs/CURRENT_STAGE4D_08O_NATURAL_ASSIGN_DAMAGE_NEXT_CONTEST_PROMPT_QUEUE_AUDIT.md`
- `docs/CURRENT_STAGE4D_08O_NATURAL_ASSIGN_DAMAGE_NEXT_CONTEST_PROMPT_QUEUE_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~NaturalAssignCombatDamageAdvancesNextContestedBattlefieldTask"
```
...
Runtime changed: no. Existing natural combat-damage close / next-contest advancement behavior already advanced to BF-NEXT spell-duel focus.
