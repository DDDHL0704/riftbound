...
| 后端 full test 当前 HEAD 全绿 | 4C-87 入账后 focused ShieldWall regression 2/2、MoveFriendly / MoveUnit / FriendlyBattlefieldUnit regression 63/63、backend full 3771/3771 均通过 | 本轮满足，最终验收前仍需重跑 |
