...
当前第二百五十四批是启动技能已开放代表路径错误文案运行时收口批。`CoreRuleEngine` 在 Vi、Xerath 与战场授予经验技能的时点、目标、来源、身份、横置和资源 guard 中返回中文玩家文案；启动技能与战场授予经验相关回归通过 58/58，后端 full test 当前 HEAD 通过 3153/3153，前端 build 通过。此前第二百三十二批 Chrome 插件房间 `smoke-battlefield-held-score-1778247059745` 已覆盖战场得分 UI 代表路径。
