...
| 后端 full test 当前 HEAD 全绿 | 4C-91 入账后 focused Royal Guard / Sand Soldier regression 10/10、source-unit / token / target / stack / priority / payment regression 1880/1880、backend full 3771/3771 均通过 | 本轮满足，最终验收前仍需重跑 |
