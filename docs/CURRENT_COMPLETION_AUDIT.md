...
2026-05-16 4D-03BI Active goal prompt-to-artifact checklist refresh 补充：A 侧已刷新 `docs/CURRENT_ACTIVE_GOAL_PROMPT_ARTIFACT_CHECKLIST.md`，入口为 `docs/CURRENT_STAGE4D_03BI_ACTIVE_GOAL_CHECKLIST_REFRESH_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03BI_ACTIVE_GOAL_CHECKLIST_REFRESH_EVIDENCE.md`。该 checklist 现在对齐当前 4D-03BH：latest HEAD `a07197c6`，后端 full 4501/4501，matrix 仍为 1009 snapshot entries / 811 functional units、0 full-official，并明确 frontend build / Chrome smoke / formal 18-step 仍是 historical pass，READY 前需要最终代码状态 fresh-run。本批只改善 active-goal artifact mapping，不改 runtime / tests / frontend / matrix，不关闭 P0/P1、frontend final validation、full-card matrix 或 READY；项目仍 **NOT READY**。
