...
- `git log --oneline -8`：4D-03CY 本批开始前最新提交为 `ba36fa0e test: 固定 resource skill source-card parity`；最新 runtime 提交仍为 `95a4d603 feat: implement lux resource skill`，其后为 03CS-B 至 03CX 的 test/docs-only verifier commits。
