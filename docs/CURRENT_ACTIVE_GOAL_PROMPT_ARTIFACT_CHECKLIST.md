...
当前 latest matrix mapping：4D-03HM-E `Post03HmCardMatrixReadinessPaymentCostSkullcrackBattlefieldStunTargetingStackBlockerClosureCandidateManifest` / `E_CARD_MATRIX_READINESS_POST_03HL_PAYMENT_COST_SKULLCRACK_BATTLEFIELD_STUN_TARGETING_STACK_BLOCKER_CLOSURE_CANDIDATE` records the payment-cost Skullcrack battlefield-stun targeting-stack blocker closure candidate；it follows 4D-03HL-E `Post03HlCardMatrixReadinessPaymentCostBattleOrFlightMoveToBaseTargetingStackBlockerClosureCandidateManifest`, 4D-03HK-E `Post03HkCardMatrixReadinessPaymentCostHeimerdingerSharedSourceUnitBlockerClosureCandidateManifest`, and 4D-03HJ-E `Post03HjCardMatrixReadinessPaymentCostVexSpellshieldStunTargetingStackBlockerClosureCandidateManifest` as previous/input evidence. This latest slice reduces NEEDS_ENGINE_SUPPORT 305 -> 304, payment-or-targeting-stack-timing 493 -> 492, payment-and-targeting-stack-timing 203 -> 202, leaves automated evidence=328, FAQ=92, fullOfficialTrue=0, ready=false, and keeps READY open.
