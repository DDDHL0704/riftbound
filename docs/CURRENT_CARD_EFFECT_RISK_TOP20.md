...
- 4C-29 / 4C-30 / 4C-31 / 4C-32 / 4C-33 / 4C-34 / 4C-35 / 4C-36 / 4C-37 / 4C-38 / 4C-39 / 4C-40 / 4C-41 / 4C-42 只验证 Gust return-to-owner-hand、Hunt the Weak destroy-target、Reprimand return-to-owner-hand、Ride the Wind ready/move-to-base、Charm move-to-base、Isolate move-to-base no-draw、Vengeance destroy-target、Hostile Takeover control-ready、Berserk Impulse opponent top-unit play、Edge of Night play-equipment / assemble-purple、Zhonya's Hourglass play-equipment guard、Sea Monster Hook play-equipment guard、Giant Arm Kato play-keyword-unit guard 与 Time Gate play-equipment guard 的代表切片；完整 target legality、movement/control-zone、movement/roam、replacement / prevention / cleanup、visibility / reveal / recycle、control-change、equipment layer、activated ability、top-five/free-play/recycle、Spellshield target tax、keyword grant、+power until EOT、next spell Echo、optional echo payment/repeat、duration cleanup、FAQ adjudication 与全 card-family matrix 仍未完成。
- 正式 18 步 E2E 未最终收口。
