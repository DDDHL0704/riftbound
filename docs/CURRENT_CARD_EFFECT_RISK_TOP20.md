...
后续批量顺序建议：Draven keyword-unit combat text / `FU-104211dbbc`、Rek'Sai attack reveal / movement `FU-422b450261` 仍为高压候选；Sett / `FU-6308c2db01` 继续等待 `LEGEND_ACTION_DOMAIN` shared-oracle design batch。
