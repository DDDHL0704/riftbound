...
- 4C-29 / 4C-30 只验证 Gust return-to-owner-hand 与 Hunt the Weak destroy-target 的 public battlefield unit power <= 3 target-guard 代表切片；完整 target legality、replacement / prevention / cleanup、visibility 与全 card-family matrix 仍未完成。
- 正式 18 步 E2E 未最终收口。
