...
后续批量顺序建议：`UNL-150a/219` / `FU-4d8ee1696b` 可单独评估 parity coverage；Ezreal / `FU-2dca1ad450` 仍是 combat-damage movement 高压候选；Sett / `FU-6308c2db01` 继续等待 `LEGEND_ACTION_DOMAIN` shared-oracle design batch。
