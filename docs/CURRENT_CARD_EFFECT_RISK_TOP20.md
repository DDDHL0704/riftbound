...
- 4C-29 / 4C-30 / 4C-31 / 4C-32 只验证 Gust return-to-owner-hand、Hunt the Weak destroy-target、Reprimand return-to-owner-hand 与 Ride the Wind ready/move-to-base 的 target-guard 代表切片；完整 target legality、movement/control-zone、movement/roam、replacement / prevention / cleanup、visibility 与全 card-family matrix 仍未完成。
- 正式 18 步 E2E 未最终收口。
