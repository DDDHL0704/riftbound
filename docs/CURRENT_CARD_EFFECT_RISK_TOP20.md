...
- 4C-29 / 4C-30 / 4C-31 / 4C-32 / 4C-33 / 4C-34 / 4C-35 / 4C-36 / 4C-37 只验证 Gust return-to-owner-hand、Hunt the Weak destroy-target、Reprimand return-to-owner-hand、Ride the Wind ready/move-to-base、Charm move-to-base、Isolate move-to-base no-draw、Vengeance destroy-target、Hostile Takeover control-ready 与 Berserk Impulse opponent top-unit play 的 target-guard 代表切片；完整 target legality、movement/control-zone、movement/roam、replacement / prevention / cleanup、visibility / reveal / recycle、control-change、FAQ adjudication 与全 card-family matrix 仍未完成。
- 正式 18 步 E2E 未最终收口。
