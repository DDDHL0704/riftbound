...
| follow-on candidates | Vex / `FU-9f7cb73dc4` remains lower-coupling single-entry candidate；Sett / `FU-6308c2db01` remains legend-domain/shared-oracle design candidate。 |
