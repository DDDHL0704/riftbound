...
Status: focused B0/B1 same-battlefield other-friendly filtered static-aura official-deck replay slice accepted; project remains **NOT READY**.
...
Focused same-battlefield other-friendly filtered static-aura validation passed:
...
```text
Passed: 2206, Failed: 0, Skipped: 0, Total: 2206
```
...
```text
Passed: 8722, Failed: 0, Skipped: 0, Total: 8722
```
