...
Status: focused B0/B1 source-combat static-aura official-deck replay slice accepted; project remains **NOT READY**.
...
Focused source-combat static-aura validation passed:
...
```text
Passed: 2106, Failed: 0, Skipped: 0, Total: 2106
```
...
```text
Passed: 8718, Failed: 0, Skipped: 0, Total: 8718
```
