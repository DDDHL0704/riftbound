...
Status: focused B0 Darius same-battlefield static-aura replay accepted; project remains **NOT READY**.
...
```text
Passed: 8853, Failed: 0, Skipped: 0, Total: 8853
```
