...
Status: focused B0/B1 same-battlefield static-aura official-deck replay slice accepted; project remains **NOT READY**.
...
```text
Passed: 720, Failed: 0, Skipped: 0, Total: 720
```
...
```text
Passed: 8713, Failed: 0, Skipped: 0, Total: 8713
```
