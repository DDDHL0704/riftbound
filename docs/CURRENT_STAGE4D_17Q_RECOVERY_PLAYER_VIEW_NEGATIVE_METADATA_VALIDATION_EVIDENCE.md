2026-05-24 Stage 4D-17Q recovery player-view negative metadata validation evidence.
...
Adjacent result: passed `624/624`.
...
Backend full result: passed `5989/5989`.
