2026-05-24 Stage 4D-17S recovery command completed tick validation evidence.
...
Adjacent result: passed `626/626`.
...
Backend full result: passed `5991/5991`.
