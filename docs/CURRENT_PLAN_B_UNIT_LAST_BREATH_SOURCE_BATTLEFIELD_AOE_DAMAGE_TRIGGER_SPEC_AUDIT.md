...
- This preserves the current trigger id battlefield context marker; a future generic trigger context payload can reduce id encoding, but recovery compatibility is intentionally unchanged in this slice.
