# Stage 4D-17FT Recovery Command Rejected Raw Payload Validation Evidence
...
dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~RecoveryValidatorRejectsPayloadCommandWithoutRawCommand"
```
