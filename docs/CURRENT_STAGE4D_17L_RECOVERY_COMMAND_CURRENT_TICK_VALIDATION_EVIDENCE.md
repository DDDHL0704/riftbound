2026-05-24 Stage 4D-17L recovery command current-tick validation evidence.
...
Adjacent result: passed `619/619`.
...
Backend full result: passed `5984/5984`.
