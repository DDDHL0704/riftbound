...
- Focused 坏坏魄罗 behavior-spec/source-guard tests: `3/3` passing.
- Adjacent unit-conquest / `P79BattlefieldHeldActivateConquest...` representatives: `18/18` passing.
- `MatchRecovery`: `1989/1989` passing.
- Backend full conformance: `8481/8481` passing.
