...
- Focused behavior-spec/source-guard tests: `3/3` passing.
- Adjacent `P79BattlefieldHeldActivateConquest...` representatives: `6/6` passing.
- `MatchRecovery`: `1989/1989` passing.
- Backend full conformance: `8474/8474` passing.
