...
- Focused `ContinuousEffect` filter: `192/192`
- Focused `MatchRecoveryTests` filter: `1210/1210`
- Adjacent recovery/official-opening/Postgres recovery-store filter: `1791/1791`
- Backend full via `Riftbound.slnx`: `7156/7156`
- Touched-file scoped whitespace format passed.
- Mechanical checks passed: `git diff --check`, anchored conflict-marker scan, matrix JSON parse and Stage 4D-18FZ stale/typo scan.
