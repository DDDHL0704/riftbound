...
| `p2-preflight-play-eclipse-power-minus-4` | `RULE_AUDITED` | `CATALOG` UNL-063/219；`CORE-260330` p14-p15 rules 142-143；p39-p42 rules 355-356；p31-p33 rules 318-324 | 已验证官方法术《月蚀》支付 3 点费用、指定一名单位、加入结算链、双方让过后令目标本回合内战力 -4；洞察路径暂缓到牌堆顶部查看/回收选择模型。 |
