2026-05-24 Stage 4D-17F recovery duplicate command identity validation evidence.
...
Adjacent result: passed `613/613`.
...
Backend full result: passed `5978/5978`.
