2026-05-24 Stage 4D-17R recovery command completed event sequence validation evidence.
...
Adjacent result: passed `625/625`.
...
Backend full result: passed `5990/5990`.
