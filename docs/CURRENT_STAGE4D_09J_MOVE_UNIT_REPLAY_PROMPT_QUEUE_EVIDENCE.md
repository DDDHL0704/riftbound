# Stage 4D-09J Move-Unit Replay Prompt Queue Evidence
...
- `docs/CURRENT_STAGE4D_09J_MOVE_UNIT_REPLAY_PROMPT_QUEUE_AUDIT.md`
- `docs/CURRENT_STAGE4D_09J_MOVE_UNIT_REPLAY_PROMPT_QUEUE_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~MoveUnitIntoOccupiedEnemyBattlefieldRejectsAcceptedCommandReplayWithoutMutation|FullyQualifiedName~MoveUnitStalePromptReplayAfterSpellDuelStartsRejectsWithoutMutation"
```
...
Result: no trailing whitespace found in the Stage 4D 05J through 09J audit / evidence docs.
