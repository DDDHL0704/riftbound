# Stage 4D-09U Hide Card Replay Prompt Queue Evidence
...
- `docs/CURRENT_STAGE4D_09U_HIDE_CARD_REPLAY_PROMPT_QUEUE_AUDIT.md`
- `docs/CURRENT_STAGE4D_09U_HIDE_CARD_REPLAY_PROMPT_QUEUE_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~P4HideCardCommandRejectsAcceptedReplayWithoutMutation|FullyQualifiedName~HideCardStalePromptReplayAfterCardMovesToBaseRejectsWithoutMutation"
```
...
Result: no trailing whitespace found in the Stage 4D 05J through 09U audit / evidence docs.
