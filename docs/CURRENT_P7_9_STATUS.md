...
| P7.9.7 | In progress | Battlefield domain foundation: battlefield object destinations, hold/conquer/static/resource-token event model, selected battlefield targets, top-deck reveal branches, and representative effects. Battlefield slices migrated `16/54` battlefield FUs. | Focused conformance + GameHub tests. |
| P7.9.8 | Planned | Battlefield functional-unit batches until all remaining `38` battlefield units are implemented or split into smaller committed slices. | Functional-unit coverage tests. |
...
- P7.9.5 status: done.
- P7.9.6 status: done.
- P7.9.7 status: in progress; battlefield foundation slices 1-15 done.
...
- P7.9.7 battlefield foundation slices: `15` done.
- Current functional-unit implementation: `773/811 = 95.3%`.
- Current manual deferred boundary: `38/811 = 4.7%`.
- Remaining manual domains:
  - `战场`: `38` functional units / `41` entries
