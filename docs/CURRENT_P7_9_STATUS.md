...
| P7.9.7 | In progress | Battlefield domain foundation: battlefield object destinations, hold/conquer/static/resource-token event model, selected battlefield targets, top-deck reveal branches, and representative effects. Battlefield slices migrated `20/54` battlefield FUs. | Focused conformance + GameHub tests. |
| P7.9.8 | Planned | Battlefield functional-unit batches until all remaining `34` battlefield units are implemented or split into smaller committed slices. | Functional-unit coverage tests. |
...
- P7.9.5 status: done.
- P7.9.6 status: done.
- P7.9.7 status: in progress; battlefield foundation slices 1-19 done.
...
- P7.9.7 battlefield foundation slices: `19` done.
- Current functional-unit implementation: `777/811 = 95.8%`.
- Current manual deferred boundary: `34/811 = 4.2%`.
- Remaining manual domains:
  - `战场`: `34` functional units / `37` entries
