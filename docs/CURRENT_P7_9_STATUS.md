...
| P7.9.7 | In progress | Battlefield domain foundation: battlefield object destinations, hold/conquer/static/resource-token event model, selected battlefield targets, top-deck reveal branches, and representative effects. Battlefield slices migrated `12/54` battlefield FUs. | Focused conformance + GameHub tests. |
| P7.9.8 | Planned | Battlefield functional-unit batches until all remaining `42` battlefield units are implemented or split into smaller committed slices. | Functional-unit coverage tests. |
...
- P7.9.5 status: done.
- P7.9.6 status: done.
- P7.9.7 status: in progress; battlefield foundation slices 1-11 done.
...
- P7.9.7 battlefield foundation slices: `11` done.
- Current functional-unit implementation: `769/811 = 94.8%`.
- Current manual deferred boundary: `42/811 = 5.2%`.
- Remaining manual domains:
  - `战场`: `42` functional units / `45` entries
