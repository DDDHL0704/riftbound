# Stage 4D-18EA Recovery Timing Temporary Payment Resource Remaining Power Trait Map Value Audit
...
- focused new remaining-power trait-map value test `1/1`
- focused `TemporaryPaymentResource` filter `126/126`
- focused recovery filter `1159/1159`
- adjacent recovery/official-opening/Postgres recovery-store filter `1740/1740`
- backend full `7105/7105`
