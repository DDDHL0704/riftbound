...
67. 下一步：4D-03BR-B 已把 target-bearing / typed / experience / Spellshield-tax activated ability representatives 扩成 executable target/tax matrix；4D-03BS / 4D-03BT 已固定下一步 fresh-dispatch boundary 与 executable closure gate；4D-03BU 已把 resource skill official breadth 的 32 / 19 / 13 split 转成 executable verifier；4D-03BV / 4D-03BW 已把 13 个 deferred candidates 拆成 executable future legend bridge 与 non-legend runtime / verifier family manifest；4D-03BX 已把 4 个 non-legend runtime / verifier candidates 单独收窄为 future implementation boundary；4D-03BY 已把 9 个 legend bridge candidates 单独收窄为 future bridge / verifier boundary；4D-03BZ 已把两条 future B gate 转成 executable next-dispatch guard；4D-03CA 已把 non-legend gate 拆成 Jhin / Honeyfruit / Blue Sentinel / Lux 四条 lane；4D-03CB 已把 Jhin lane 单独收窄为 future B implementation / verifier boundary；4D-03CC 已把 Honeyfruit lane 单独收窄为 future B implementation / verifier boundary；4D-03CD 已把 Blue Sentinel lane 单独收窄为 future B implementation / verifier boundary；4D-03CE 已把 Lux lane 单独收窄为 future B implementation / verifier boundary；4D-03CF 已把 Diana legend bridge 单独收窄为 future B bridge / verifier boundary；4D-03CG 已把 Ornn legend bridge 单独收窄为 future B bridge / verifier boundary；4D-03CH 已把 KaiSa legend bridge 单独收窄为 future B bridge / verifier boundary；4D-03CI 已把 Darius legend bridge 单独收窄为 future B bridge / verifier boundary；4D-03CJ 已把四个 legend bridge handoff 聚合为 exact 9-card executable aggregate guard；4D-03CK 已把该 aggregate guard 转成 future B-side legend bridge implementation acceptance contract；4D-03CL 已把 acceptance contract 转成 executable prompt / command / audit / rollback guard。后续仍需继续扩展 typed payment engine 到剩余 target-bearing activated abilities、rune/legend/battlefield/keyword 全路径，支持完整 `[A]` / `[C]` resource skills、替代费用、减费/加费、额外/可选费用。
