2026-05-24 Stage 4D-17O recovery command diagnostic presence validation evidence.
...
Adjacent result: passed `622/622`.
...
Backend full result: passed `5987/5987`.
