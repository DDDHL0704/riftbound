2026-05-24 Stage 4D-17B recovery rejected-command span/tick validation evidence.
...
Adjacent result: passed `607/607`.
...
Backend full result: passed `5972/5972`.
