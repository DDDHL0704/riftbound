2026-05-24 Stage 4D-17M recovery command stream order validation evidence.
...
Adjacent result: passed `620/620`.
...
Backend full result: passed `5985/5985`.
