# Stage 4D-05V Reveal Card Replay Evidence
...
- `docs/CURRENT_STAGE4D_05V_REVEAL_CARD_REPLAY_AUDIT.md`
- `docs/CURRENT_STAGE4D_05V_REVEAL_CARD_REPLAY_EVIDENCE.md`

## Validation

```bash
source scripts/dev-env.sh && dotnet test tests/Riftbound.ConformanceTests/Riftbound.ConformanceTests.csproj --no-restore --filter "FullyQualifiedName~P4RevealCardCommandRejectsAcceptedBaseReplayWithoutMutation"
```
