# Stage 4D-07S Base Move Contest Spell Duel Evidence
...
- `docs/CURRENT_STAGE4D_07S_BASE_MOVE_CONTEST_SPELL_DUEL_AUDIT.md`
- `docs/CURRENT_STAGE4D_07S_BASE_MOVE_CONTEST_SPELL_DUEL_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~BaseToBattlefieldMoveIntoOccupiedEnemyBattlefieldStartsSpellDuelAfterCleanupGate"
```
...
Runtime changed: no. Existing base-to-contested-battlefield movement already emits movement, contested and spell-duel-start payloads in the asserted order.
