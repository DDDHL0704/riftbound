...
- `PLAY_CARD` 已通过最小 card behavior registry 支撑两张官方伤害法术和《渊海狩咒》的条件伤害；下一步补 richer expected canonical diff，再逐批迁移更多低复杂度官方卡牌。
...
20. 下一步：补 richer expected canonical diff，再逐批迁移更多低复杂度官方卡牌。
