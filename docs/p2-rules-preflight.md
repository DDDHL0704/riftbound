...
- `p2-preflight-play-ascended-believer-no-spell-vanilla-unit.fixture.json` / `p2-preflight-play-sly-salamander-no-experience-vanilla-unit.fixture.json` / `p2-preflight-play-rampaging-soul-no-discard-spirit-unit.fixture.json` / `p2-preflight-play-ogn-fiora-not-powerful-vanilla-unit.fixture.json` 已验证官方单位/英雄单位 `UNL-004/219` 《晋升信徒》、`UNL-108/219` 《狡猾的蝾螈》、`OGN·019/298` 《肆虐狂魂》和 `OGN·232/298` 《菲奥娜》在条件未满足时的单位源牌入场路径；《肆虐狂魂》记录 `灵体` 属性标签，其余三张成为无额外标签单位对象，法术费用记忆、经验获得记忆、弃牌记忆、强力阈值、条件战力修正和关键词授予路径暂缓，带目标打出由直接拒绝测试覆盖。
- `p2-preflight-play-balanced-disciple-no-other-power-vanilla-unit.fixture.json` / `p2-preflight-play-crescent-guard-no-spell-vanilla-unit.fixture.json` / `p2-preflight-play-noxian-recruit-no-encourage-trifarian-unit.fixture.json` / `p2-preflight-play-dangerous-duo-no-encourage-mechanical-unit.fixture.json` / `p2-preflight-play-trifarian-gloryseeker-no-encourage-unit.fixture.json` 已验证官方单位 `UNL-097/219` 《均衡门徒》、`UNL-122/219` 《新月禁卫》、`OGN·012/298` 《诺克萨斯新兵》、`OGN·016/298` 《危险二人组》和 `OGN·217/298` 《崔法利求战者》在条件/鼓舞未满足时的单位源牌入场路径；属性标签记录为对象标签，其余无属性者成为无额外标签单位对象，其他单位战力计数、法术记忆、额外费用、活跃入场、鼓舞费用减少、鼓舞战力修正和增益路径暂缓，带目标打出由直接拒绝测试覆盖。
- `p2-preflight-play-undead-legion-hand-spirit-unit.fixture.json` / `p2-preflight-play-junkyard-bully-no-encourage-mechanical-unit.fixture.json` / `p2-preflight-play-vanguard-captain-no-encourage-elite-unit.fixture.json` / `p2-preflight-play-ogn-darius-no-encourage-trifarian-unit.fixture.json` / `p2-preflight-play-ogn-darius-alt-a-no-encourage-trifarian-unit.fixture.json` 已验证官方单位/英雄单位 `UNL-025/219` 《不死军团》、`OGN·020/298` 《垃圾场小霸王》、`OGN·218/298` 《先锋队长》和 `OGN·243/298` / `OGN·243a/298` 《德莱厄斯》在鼓舞未触发或普通手牌打出时的单位源牌入场路径；属性标签记录为对象标签，废牌堆鼓舞打出、额外/有色费用、鼓舞弃牌抽牌、随从指示物、活跃入场、战场静态战力修正和战场目的地路径暂缓，带目标打出由直接拒绝测试覆盖。
...
- `p2-preflight-play-petal-pixie-faerie-unit.fixture.json` / `p2-preflight-play-soul-shepherd-vanilla-unit.fixture.json` / `p2-preflight-play-savage-jawfish-vanilla-unit.fixture.json` / `p2-preflight-play-scarlet-pigeon-bird-unit.fixture.json` / `p2-preflight-play-loyal-poro-unit.fixture.json` 已验证官方单位 `UNL-076/219` 《花瓣仙子》、`UNL-077/219` 《牧魂人》、`UNL-129/219` 《凶残颚鱼》、`UNL-154/219` 《猩红飞鸽》和 `UNL-156/219` 《忠忠魄罗》的单位源牌入场路径；属性标签记录为对象标签，其余无属性者成为无额外标签单位对象，战场瞬息单位计数、指示物全局战力修正、友方单位摧毁经验、共同进攻战力修正、绝念、落单检测和抽牌路径暂缓，带目标打出由直接拒绝测试覆盖。
...
- `PLAY_CARD` 已通过最小 card behavior registry 支撑 P2 preflight 的代表性官方卡牌/模式路径，当前为 `608/811 = 75.0%`。已覆盖能力族包括费用、目标范围、模式选择、伤害、抽牌/燃尽、摧毁/回手/移动、战力修正、关键词/对象标签、装备对象、单位源牌入场、指示物、符文召出、可选/强制额外费用和部分替代效果；完整 fixture 列表、事件词表和逐项进度以本文件的 fixture 表与第 6 节进度清单为准，规则证据以 `docs/rules-evidence-index.md` 和 fixture 内 `rulesEvidence` 为准。
...
| `p2-preflight-play-ironclad-vanguard-keyword-unit` | P1 打出官方单位《铁甲先锋》 | 支付 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 6 战力、带 `约德尔人` 与 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象。绝念打出两名机器人指示物路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·021/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-ogn-draven-score-static-zero` | P1 在 0 分时打出官方英雄单位《德莱文》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。控制者分数加入自身战力的静态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·028/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-sfd-fiora-one-on-one-vanilla-unit` | P1 打出官方英雄单位《菲奥娜》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。一对一战斗检测和战斗内战力翻倍路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·110/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sfd-fiora-alt-a-one-on-one-vanilla-unit` | P1 打出官方英雄单位《菲奥娜》异画 A | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。一对一战斗检测和战斗内战力翻倍路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·110a/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-sfd-141-irelia-spell-cost-static` | P1 打出官方英雄单位《艾瑞莉娅》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。以其为目标的法术费用减少路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·141/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sfd-141a-irelia-spell-cost-static` | P1 打出官方英雄单位《艾瑞莉娅》异画 A | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。以其为目标的法术费用减少路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·141a/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-dragon-caller-cost-static` | P1 打出官方单位《唤龙使者》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。龙单位费用减少且最低为 1 的静态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·140/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-rude-pirate-no-optional-discard` | P1 打出官方单位《粗鲁的海盗》，不选择额外弃牌减费 | 支付基础 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、带 `海盗` 标签的 `CARD_TYPE:UNIT` 单位对象。额外弃置手牌减费路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·002/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-waterbender-vanilla-unit` | P1 打出官方单位《驭水者》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。独自进攻或防守一处战场时的战力 +2 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·055/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-wise-elder-no-boon-static` | P1 打出官方单位《睿智长者》且未拥有增益 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。拥有增益时额外战力 +1 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·065/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-eager-apprentice-spell-cost-static` | P1 打出官方单位《踊跃的学徒》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。位于战场时法术费用减少 1 且最低为 1 的静态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·084/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-arena-service-crew-equipment-trigger-static` | P1 打出官方单位《竞技场勤务小队》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。打出装备时变为活跃状态的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·091/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-raging-drake-next-spell-cost-static` | P1 打出官方单位《狂暴龙怪》 | 支付 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、带 `龙` 标签的 `CARD_TYPE:UNIT` 单位对象。本回合内下一张法术费用减少 5 的持续效果路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·031/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-adaptive-robot-conquer-boon-static` | P1 打出官方单位《自适应机器人》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象。征服战场后可摧毁装备给予增益的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·056/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-eclipse-vanguard-stun-trigger-static` | P1 打出官方单位《星蚀先锋》 | 支付 7 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 7 战力、带 `鸟类` 标签的 `CARD_TYPE:UNIT` 单位对象。眩晕敌方单位后变为活跃且本回合 +1 的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·059/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-poro-herder-no-poro-static` | P1 打出官方单位《魄罗牧者》，场上没有魄罗属性单位 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。魄罗条件满足后的增益和抽牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·061/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-ravenbloom-student-spell-trigger-static` | P1 打出官方单位《拉文布鲁姆学生》 | 支付 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。打出法术时本回合内战力 +1 的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·103/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-resonant-soul-destroy-trigger-static` | P1 打出官方单位《残响之魂》 | 支付 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象。每回合首次友方单位被摧毁时抽一张牌的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·118/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-bilgewater-bully-no-boon-roam-static` | P1 打出官方单位《比尔吉沃特恶霸》且未拥有增益 | 支付 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 6 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。拥有增益时获得游走的静态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·125/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sharpshooter-pirate-attack-trigger-static` | P1 打出官方单位《神射海盗》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `海盗` 标签的 `CARD_TYPE:UNIT` 单位对象。进攻时对同一处战场敌方单位造成 1 点伤害的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·130/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-dune-drake-attack-ready-enemy-static` | P1 打出官方单位《沙丘亚龙》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、带 `龙` 标签的 `CARD_TYPE:UNIT` 单位对象。进攻有准备状态敌方单位的战场时本回合内 +2 的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·131/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-ember-monk-standby-trigger-static` | P1 打出官方单位《余火修士》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。打出一张牌面朝下的待命牌时本回合内 +2 的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·167/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-hidden-tracker-follow-move-static` | P1 打出官方单位《隐秘追踪者》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。同位置友方单位向别处移动时可跟随移动的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·177/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-undercover-agent-last-breath-static` | P1 打出官方单位《卧底特工》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。绝念弃置两张手牌然后抽两张牌的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·178/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-traveling-merchant-move-trigger-static` | P1 打出官方单位《旅行商人》 | 支付 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。移动时弃置一张手牌然后抽一张牌的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·185/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-ogn-kogmaw-last-breath-static` | P1 打出官方英雄单位《克格莫》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 1 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。绝念对所处战场所有单位各造成 4 点伤害的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·190/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-noxian-drummer-trifarian-move-trigger-static` | P1 打出官方单位《诺克萨斯鼓手》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象。移动到战场时在该战场打出 1 战力随从的触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·222/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-tidecaller-standby-swap-static` | P1 打出官方单位《控潮者》 | 支付 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、带 `待命` 标签的 `CARD_TYPE:UNIT` 单位对象。待命/反应打出和可选位置交换路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·199/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-ogn-jinx-discard-trigger-static` | P1 打出官方英雄单位《金克丝》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。弃牌触发活跃和本回合 +1 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·202/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-ghost-matron-spirit-revive-static` | P1 打出官方单位《幽灵主母》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象。可选从废牌堆打出低费用单位的路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·226/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-albus-ferros-no-boon-call-rune-static` | P1 打出官方单位《阿不思·菲罗斯》 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。消耗任意数量增益并按数量召出休眠符文的路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·230/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-ogn-karthus-spirit-last-breath-static` | P1 打出官方英雄单位《卡尔萨斯》 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象。控制者所有绝念效果额外触发一次的静态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·236/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-dunehorn-beast-low-hand-active-static` | P1 打出官方单位《穿沙角兽》 | 支付 7 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 7 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。低手牌活跃进场和据守抽两张牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·027/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-gloompath-guard-spirit-hold-static` | P1 打出官方单位《幽径守卫》 | 支付 6 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 6 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象。据守时可让废牌堆单位或装备返回手牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·035/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-apprentice-blacksmith-move-reveal-static` | P1 打出官方单位《学徒铁匠》 | 支付 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。移动触发展示主牌堆顶部、装备抽取和非装备回收路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·041/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-mountain-ape-elder-boon-ready-static` | P1 打出官方单位《山猿老祖》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。获得增益时变为活跃状态路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·047/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sfd-089-rumble-mechanical-static` | P1 打出官方英雄单位《兰博》 | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、带 `机械` 与 `约德尔人` 标签的 `CARD_TYPE:UNIT` 单位对象。机械单位静态 +1 和据守打出 3 战力机器人路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·089/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
...
| `p2-preflight-play-ogn-jinx-alt-a-discard-trigger-static` | P1 打出官方英雄单位《金克丝》异画 A | 支付 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、无额外标签的 `CARD_TYPE:UNIT` 单位对象。弃牌触发活跃和本回合 +1 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·202a/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-ascended-believer-no-spell-vanilla-unit` | P1 打出官方单位《晋升信徒》，本回合未打出 4 费以上法术 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 1 战力 `CARD_TYPE:UNIT` 单位对象。法术费用记忆和条件战力 +4 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-004/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sly-salamander-no-experience-vanilla-unit` | P1 打出官方单位《狡猾的蝾螈》，本回合未获得经验 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象。经验获得记忆、条件战力 +1 和游走授予路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-108/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-rampaging-soul-no-discard-spirit-unit` | P1 打出官方单位《肆虐狂魂》，本回合未弃置手牌 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象。弃牌记忆、强攻和游走授予路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·019/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-ogn-fiora-not-powerful-vanilla-unit` | P1 打出官方英雄单位《菲奥娜》，尚未成为强力单位 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象。强力阈值、法盾/游走/坚守授予和后续战力变化触发路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·232/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-balanced-disciple-no-other-power-vanilla-unit` | P1 打出官方单位《均衡门徒》，其他单位总战力低于 5 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象。其他单位战力计数和条件抽牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-097/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-crescent-guard-no-spell-vanilla-unit` | P1 打出官方单位《新月禁卫》，本回合未打出法术 | 支付 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象。法术记忆、紫色额外费用和活跃入场路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-122/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-noxian-recruit-no-encourage-trifarian-unit` | P1 打出官方单位《诺克萨斯新兵》，鼓舞未触发 | 支付基础 4 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象。鼓舞费用减少路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·012/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-dangerous-duo-no-encourage-mechanical-unit` | P1 打出官方单位《危险二人组》，鼓舞未触发 | 支付 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象。鼓舞触发、目标选择和本回合战力 +2 路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·016/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-trifarian-gloryseeker-no-encourage-unit` | P1 打出官方单位《崔法利求战者》，鼓舞未触发 | 支付 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象。鼓舞触发和增益路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·217/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-junkyard-bully-no-encourage-mechanical-unit` | P1 打出官方单位《垃圾场小霸王》，鼓舞未触发 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象。鼓舞弃置两张手牌并抽两张牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·020/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-vanguard-captain-no-encourage-elite-unit` | P1 打出官方单位《先锋队长》，鼓舞未触发 | 支付基础 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `精锐` 标签的 `CARD_TYPE:UNIT` 单位对象。鼓舞额外打出两名随从和战场目的地路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` OGN·218/298; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
| `p2-preflight-play-petal-pixie-faerie-unit` | P1 打出官方单位《花瓣仙子》 | 支付基础 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 2 战力、带 `仙灵` 标签的 `CARD_TYPE:UNIT` 单位对象。战场瞬息单位计数和静态战力修正路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-076/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-soul-shepherd-vanilla-unit` | P1 打出官方单位《牧魂人》 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象。指示物单位全局静态战力修正路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-077/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-savage-jawfish-vanilla-unit` | P1 打出官方单位《凶残颚鱼》 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象。友方单位摧毁记忆和经验获得路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-129/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-scarlet-pigeon-bird-unit` | P1 打出官方单位《猩红飞鸽》 | 支付基础 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `鸟类` 标签的 `CARD_TYPE:UNIT` 单位对象。共同进攻检测和战斗内战力修正路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-154/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-loyal-poro-unit` | P1 打出官方单位《忠忠魄罗》 | 支付基础 3 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 3 战力、带 `魄罗` 标签的 `CARD_TYPE:UNIT` 单位对象。绝念、落单检测和抽牌路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-156/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
...
| `p2-preflight-play-xerath-activated-skill-unit` | P1 打出官方英雄单位《泽拉斯》 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象。红色费用、横置、伤害和战场限制技能路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-026/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-dragon-soul-sage-activated-skill-unit` | P1 打出官方单位《龙魂贤者》 | 支付基础 2 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 1 战力 `CARD_TYPE:UNIT` 单位对象。反应时机、横置和获得费用资源技能路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-093/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-fluft-poro-activated-skill-unit` | P1 打出官方单位《绵绵魄罗》 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 5 战力、带 `魄罗` 标签的 `CARD_TYPE:UNIT` 单位对象。横置、战鹰指示物、法盾目标税和战场限制技能路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` UNL-160/219; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356; p92-p105 keyword rules 800+ |
| `p2-preflight-play-sfd-088-renata-glasc-activated-skill-unit` | P1 打出官方英雄单位《烈娜塔·戈拉斯克》 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象。蓝色费用、横置、抽牌、得分和战场限制技能路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·088/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
| `p2-preflight-play-sfd-088-renata-glasc-alt-a-activated-skill-unit` | P1 打出官方英雄单位《烈娜塔·戈拉斯克》A 版本 | 支付基础 5 点费用，0 目标入栈；双方让过后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象。蓝色费用、横置、抽牌、得分和战场限制技能路径暂缓，带目标打出由直接拒绝测试覆盖。 | `CATALOG` SFD·088a/221; `CORE-260330` p4-p8 rules 107-129; p14-p15 rules 142-143; p39-p42 rules 355-356 |
...
505. 已完成：迁移《铁甲先锋》`SFD·021/221` 当前 preflight 的属性单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 6 战力、带 `约德尔人` 与 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象；绝念打出两名机器人指示物路径暂缓，带目标打出由直接测试拒绝。
...
530. 已完成：迁移《晋升信徒》`UNL-004/219` 当前 preflight 的条件未满足单位入场路径，本回合未打出 4 费以上法术时支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 1 战力 `CARD_TYPE:UNIT` 单位对象；法术费用记忆和条件战力 +4 路径暂缓，带目标打出由直接测试拒绝。
531. 已完成：迁移《狡猾的蝾螈》`UNL-108/219` 当前 preflight 的条件未满足单位入场路径，本回合未获得经验时支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；经验获得记忆、条件战力 +1 和游走授予路径暂缓，带目标打出由直接测试拒绝。
532. 已完成：迁移《肆虐狂魂》`OGN·019/298` 当前 preflight 的条件未满足属性单位入场路径，本回合未弃置手牌时支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象；弃牌记忆、强攻和游走授予路径暂缓，带目标打出由直接测试拒绝。
533. 已完成：迁移《菲奥娜》`OGN·232/298` 当前 preflight 的条件未满足英雄单位入场路径，尚未成为强力单位时支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；强力阈值、法盾/游走/坚守授予和后续战力变化触发路径暂缓，带目标打出由直接测试拒绝。
534. 已完成：迁移《均衡门徒》`UNL-097/219` 当前 preflight 的条件未满足单位入场路径，其他单位总战力低于 5 时支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；其他单位战力计数和条件抽牌路径暂缓，带目标打出由直接测试拒绝。
535. 已完成：迁移《新月禁卫》`UNL-122/219` 当前 preflight 的条件未满足单位入场路径，本回合未打出法术时支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；法术记忆、紫色额外费用和活跃入场路径暂缓，带目标打出由直接测试拒绝。
536. 已完成：迁移《诺克萨斯新兵》`OGN·012/298` 当前 preflight 的鼓舞未触发单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象；鼓舞费用减少路径暂缓，带目标打出由直接测试拒绝。
537. 已完成：迁移《危险二人组》`OGN·016/298` 当前 preflight 的鼓舞未触发单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象；鼓舞目标选择和本回合战力 +2 路径暂缓，带目标打出由直接测试拒绝。
538. 已完成：迁移《崔法利求战者》`OGN·217/298` 当前 preflight 的鼓舞未触发单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象；鼓舞增益路径暂缓，带目标打出由直接测试拒绝。
...
540. 已完成：迁移《垃圾场小霸王》`OGN·020/298` 当前 preflight 的鼓舞未触发单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象；鼓舞弃牌和抽牌路径暂缓，带目标打出由直接测试拒绝。
541. 已完成：迁移《先锋队长》`OGN·218/298` 当前 preflight 的鼓舞未触发单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `精锐` 标签的 `CARD_TYPE:UNIT` 单位对象；鼓舞额外打出两名随从和战场目的地路径暂缓，带目标打出由直接测试拒绝。
...
554. 已完成：迁移《花瓣仙子》`UNL-076/219` 当前 preflight 的单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力、带 `仙灵` 标签的 `CARD_TYPE:UNIT` 单位对象；战场瞬息单位计数和静态战力修正路径暂缓，带目标打出由直接测试拒绝。
555. 已完成：迁移《牧魂人》`UNL-077/219` 当前 preflight 的单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；指示物单位全局静态战力修正路径暂缓，带目标打出由直接测试拒绝。
556. 已完成：迁移《凶残颚鱼》`UNL-129/219` 当前 preflight 的单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；友方单位摧毁记忆和经验获得路径暂缓，带目标打出由直接测试拒绝。
557. 已完成：迁移《猩红飞鸽》`UNL-154/219` 当前 preflight 的单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `鸟类` 标签的 `CARD_TYPE:UNIT` 单位对象；共同进攻检测和战斗内战力修正路径暂缓，带目标打出由直接测试拒绝。
558. 已完成：迁移《忠忠魄罗》`UNL-156/219` 当前 preflight 的单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `魄罗` 标签的 `CARD_TYPE:UNIT` 单位对象；绝念、落单检测和抽牌路径暂缓，带目标打出由直接测试拒绝。
...
579. 已完成：迁移《泽拉斯》`UNL-026/219` 当前 preflight 的主动技能文本英雄单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；红色费用、横置、伤害和战场限制技能路径暂缓，带目标打出由直接测试拒绝。
580. 已完成：迁移《龙魂贤者》`UNL-093/219` 当前 preflight 的主动技能文本单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 1 战力 `CARD_TYPE:UNIT` 单位对象；反应时机、横置和获得费用资源技能路径暂缓，带目标打出由直接测试拒绝。
581. 已完成：迁移《绵绵魄罗》`UNL-160/219` 当前 preflight 的主动技能文本属性单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力、带 `魄罗` 标签的 `CARD_TYPE:UNIT` 单位对象；横置、战鹰指示物、法盾目标税和战场限制技能路径暂缓，带目标打出由直接测试拒绝。
582. 已完成：迁移《烈娜塔·戈拉斯克》`SFD·088/221` 当前 preflight 的主动技能文本英雄单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；蓝色费用、横置、抽牌、得分和战场限制技能路径暂缓，带目标打出由直接测试拒绝。
583. 已完成：迁移《烈娜塔·戈拉斯克》`SFD·088a/221` 当前 preflight 的主动技能文本英雄单位异画 A 入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；蓝色费用、横置、抽牌、得分和战场限制技能路径暂缓，带目标打出由直接测试拒绝。
...
589. 已完成：迁移《德莱文》`OGN·028/298` 当前 preflight 的 0 分静态战力单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；控制者分数加入自身战力路径暂缓，带目标打出由直接测试拒绝。
...
592. 已完成：迁移《菲奥娜》`SFD·110/221` 当前 preflight 的英雄单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；一对一战斗检测和战斗内战力翻倍路径暂缓，带目标打出由直接测试拒绝。
593. 已完成：迁移《菲奥娜》`SFD·110a/221` 当前 preflight 的英雄单位异画 A 入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；一对一战斗检测和战斗内战力翻倍路径暂缓，带目标打出由直接测试拒绝。
...
595. 已完成：迁移《艾瑞莉娅》`SFD·141/221` 当前 preflight 的法术减费静态文本英雄单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；以其为目标的法术费用减少路径暂缓，带目标打出由直接测试拒绝。
596. 已完成：迁移《艾瑞莉娅》`SFD·141a/221` 当前 preflight 的法术减费静态文本英雄单位异画 A 入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；以其为目标的法术费用减少路径暂缓，带目标打出由直接测试拒绝。
...
598. 已完成：迁移《唤龙使者》`OGN·140/298` 当前 preflight 的龙单位减费静态文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；龙单位费用减少且最低为 1 的静态路径暂缓，带目标打出由直接测试拒绝。
599. 已完成：迁移《粗鲁的海盗》`OGN·002/298` 当前 preflight 的不选择额外弃置减费单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力、带 `海盗` 标签的 `CARD_TYPE:UNIT` 单位对象；额外弃置手牌减费路径暂缓，带目标打出由直接测试拒绝。
600. 已完成：迁移《驭水者》`OGN·055/298` 当前 preflight 的独自战斗静态文本单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力 `CARD_TYPE:UNIT` 单位对象；独自进攻或防守一处战场时战力 +2 路径暂缓，带目标打出由直接测试拒绝。
601. 已完成：迁移《睿智长者》`OGN·065/298` 当前 preflight 的无增益静态文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；拥有增益时额外战力 +1 路径暂缓，带目标打出由直接测试拒绝。
602. 已完成：迁移《踊跃的学徒》`OGN·084/298` 当前 preflight 的战场法术减费静态文本单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；位于战场时法术费用减少 1 且最低为 1 路径暂缓，带目标打出由直接测试拒绝。
603. 已完成：迁移《竞技场勤务小队》`OGN·091/298` 当前 preflight 的装备打出触发文本单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；装备打出触发活跃路径暂缓，带目标打出由直接测试拒绝。
604. 已完成：迁移《狂暴龙怪》`OGN·031/298` 当前 preflight 的下一张法术减费触发文本单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力、带 `龙` 标签的 `CARD_TYPE:UNIT` 单位对象；本回合内下一张法术费用减少 5 路径暂缓，带目标打出由直接测试拒绝。
605. 已完成：迁移《自适应机器人》`OGN·056/298` 当前 preflight 的征服增益触发文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `机械` 标签的 `CARD_TYPE:UNIT` 单位对象；征服、装备摧毁和增益触发路径暂缓，带目标打出由直接测试拒绝。
606. 已完成：迁移《星蚀先锋》`OGN·059/298` 当前 preflight 的眩晕触发文本单位入场路径，支付基础 7 点费用、0 目标入栈，结算后源牌进入控制者基地成为 7 战力、带 `鸟类` 标签的 `CARD_TYPE:UNIT` 单位对象；眩晕触发活跃和本回合战力 +1 路径暂缓，带目标打出由直接测试拒绝。
607. 已完成：迁移《魄罗牧者》`OGN·061/298` 当前 preflight 的无魄罗条件单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；魄罗条件满足后的增益和抽牌路径暂缓，带目标打出由直接测试拒绝。
608. 已完成：迁移《拉文布鲁姆学生》`OGN·103/298` 当前 preflight 的法术打出触发文本单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力 `CARD_TYPE:UNIT` 单位对象；打出法术时本回合内战力 +1 路径暂缓，带目标打出由直接测试拒绝。
609. 已完成：迁移《残响之魂》`OGN·118/298` 当前 preflight 的每回合首次友方单位被摧毁抽牌触发文本单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象；友方单位被摧毁触发抽牌路径暂缓，带目标打出由直接测试拒绝。
610. 已完成：迁移《比尔吉沃特恶霸》`OGN·125/298` 当前 preflight 的无增益游走静态文本单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 6 战力 `CARD_TYPE:UNIT` 单位对象；拥有增益时获得游走路径暂缓，带目标打出由直接测试拒绝。
611. 已完成：迁移《神射海盗》`OGN·130/298` 当前 preflight 的进攻伤害触发文本单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `海盗` 标签的 `CARD_TYPE:UNIT` 单位对象；进攻时对同处战场敌方单位造成 1 点伤害路径暂缓，带目标打出由直接测试拒绝。
612. 已完成：迁移《沙丘亚龙》`OGN·131/298` 当前 preflight 的进攻准备状态敌方单位战力修正触发文本单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力、带 `龙` 标签的 `CARD_TYPE:UNIT` 单位对象；进攻有准备状态敌方单位的战场时本回合内 +2 路径暂缓，带目标打出由直接测试拒绝。
613. 已完成：迁移《余火修士》`OGN·167/298` 当前 preflight 的牌面朝下待命牌打出触发文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；打出牌面朝下待命牌时本回合内 +2 路径暂缓，带目标打出由直接测试拒绝。
614. 已完成：迁移《隐秘追踪者》`OGN·177/298` 当前 preflight 的同位置友方单位移动跟随触发文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力 `CARD_TYPE:UNIT` 单位对象；跟随移动路径暂缓，带目标打出由直接测试拒绝。
615. 已完成：迁移《卧底特工》`OGN·178/298` 当前 preflight 的绝念弃牌抽牌触发文本单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；绝念弃置两张手牌然后抽两张牌路径暂缓，带目标打出由直接测试拒绝。
616. 已完成：迁移《旅行商人》`OGN·185/298` 当前 preflight 的移动弃牌抽牌触发文本单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力 `CARD_TYPE:UNIT` 单位对象；移动时弃牌抽牌路径暂缓，带目标打出由直接测试拒绝。
617. 已完成：迁移《克格莫》`OGN·190/298` 当前 preflight 的绝念范围伤害触发文本英雄单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 1 战力 `CARD_TYPE:UNIT` 单位对象；绝念对所处战场所有单位各造成 4 点伤害路径暂缓，带目标打出由直接测试拒绝。
618. 已完成：迁移《诺克萨斯鼓手》`OGN·222/298` 当前 preflight 的移动到战场随从打出触发文本单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `崔法利` 标签的 `CARD_TYPE:UNIT` 单位对象；移动到战场打出 1 战力随从路径暂缓，带目标打出由直接测试拒绝。
619. 已完成：迁移《控潮者》`OGN·199/298` 当前 preflight 的待命与可选位置交换文本单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力、带 `待命` 标签的 `CARD_TYPE:UNIT` 单位对象；待命/反应打出和位置交换路径暂缓，带目标打出由直接测试拒绝。
620. 已完成：迁移《金克丝》`OGN·202/298` 当前 preflight 的弃牌触发文本英雄单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；弃牌触发活跃和本回合战力 +1 路径暂缓，带目标打出由直接测试拒绝。
621. 已完成：迁移《幽灵主母》`OGN·226/298` 当前 preflight 的废牌堆单位打出文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象；可选从废牌堆打出低费用单位路径暂缓，带目标打出由直接测试拒绝。
622. 已完成：迁移《阿不思·菲罗斯》`OGN·230/298` 当前 preflight 的消耗增益召符文文本单位入场路径，支付基础 4 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力 `CARD_TYPE:UNIT` 单位对象；消耗任意数量增益并召出休眠符文路径暂缓，带目标打出由直接测试拒绝。
623. 已完成：迁移《卡尔萨斯》`OGN·236/298` 当前 preflight 的绝念额外触发静态文本英雄单位入场路径，支付基础 3 点费用、0 目标入栈，结算后源牌进入控制者基地成为 3 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象；绝念效果额外触发一次路径暂缓，带目标打出由直接测试拒绝。
624. 已完成：迁移《穿沙角兽》`SFD·027/221` 当前 preflight 的低手牌活跃入场与据守抽牌文本单位入场路径，支付基础 7 点费用、0 目标入栈，结算后源牌进入控制者基地成为 7 战力 `CARD_TYPE:UNIT` 单位对象；低手牌活跃进场和据守抽两张牌路径暂缓，带目标打出由直接测试拒绝。
625. 已完成：迁移《幽径守卫》`SFD·035/221` 当前 preflight 的据守废牌堆回手文本单位入场路径，支付基础 6 点费用、0 目标入栈，结算后源牌进入控制者基地成为 6 战力、带 `灵体` 标签的 `CARD_TYPE:UNIT` 单位对象；据守时废牌堆单位或装备返回手牌路径暂缓，带目标打出由直接测试拒绝。
626. 已完成：迁移《学徒铁匠》`SFD·041/221` 当前 preflight 的移动展示牌堆文本单位入场路径，支付基础 2 点费用、0 目标入栈，结算后源牌进入控制者基地成为 2 战力 `CARD_TYPE:UNIT` 单位对象；移动触发展示主牌堆顶部、装备抽取和非装备回收路径暂缓，带目标打出由直接测试拒绝。
627. 已完成：迁移《山猿老祖》`SFD·047/221` 当前 preflight 的增益活跃触发文本单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；获得增益后活跃路径暂缓，带目标打出由直接测试拒绝。
628. 已完成：迁移《兰博》`SFD·089/221` 当前 preflight 的机械静态战力与据守机器人文本英雄单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 4 战力、带 `机械` / `约德尔人` 标签的 `CARD_TYPE:UNIT` 单位对象；机械单位静态 +1 和据守打出 3 战力机器人路径暂缓，带目标打出由直接测试拒绝。
...
633. 已完成：迁移《金克丝》`OGN·202a/298` 当前 preflight 的弃牌触发文本英雄单位入场路径，支付基础 5 点费用、0 目标入栈，结算后源牌进入控制者基地成为 5 战力 `CARD_TYPE:UNIT` 单位对象；弃牌触发活跃和本回合战力 +1 路径暂缓，带目标打出由直接测试拒绝。
...
644. 下一步：按“同能力族小批次”节奏迁移更多低复杂度官方卡牌，优先继续从单位入场、0 目标抽牌/召符文/创建指示物、单目标伤害、单目标回手/移动、本回合战力修正/标签添加和简单装备对象中选择 `3-5` 张同机制卡牌；批末统一全量验证并提交。
