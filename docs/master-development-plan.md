...
- 普通主阶段误提交 `PASS_PRIORITY` / `PASS_FOCUS` 已能以 `PHASE_NOT_ALLOWED` 拒绝且不会结束回合；有结算链项目时的 FEPR 让过、优先权转移、双方让过后的最新项目结算，以及结算链未空时新的最新项目控制者获得优先权已落地；法术对决中焦点让过、焦点转移和双方让过后关闭窗口已落地；连续燃尽导致对手立即获胜已落地；已覆盖此前伤害、抽牌、费用修正、战力修正、摧毁、移动、活跃/休眠、符文召出、回收、燃尽和回手路径，并新增《造化弄人》友方单位再敌方单位按序回手、《存在焦虑》回响重复先眩晕进攻敌方单位再因已眩晕改为回手、《冥想》休眠友方单位作为额外费用后额外抽牌、《月神恩赐》弃置手牌后抽牌、《亡者复生》己方废牌堆目标回手、《游击战》最多两张己方废牌堆待命牌回手、《暗影的召唤》友方单位获得 `瞬息` 标签后抽 2 张牌、《逝水如镜》战场单位获得 `瞬息` 标签、《背水一战》友方单位本回合内按当前战力翻倍并获得 `瞬息` 标签、《痛苦之酬》战场单位 3 点伤害并打出休眠“金币”装备指示物到基地、《化为灰烬》装备获得 `瞬息` 标签、《印爆术》摧毁装备并让其控制者抽 2 张牌、《决斗》友方和敌方单位按自身战力互伤、《巨人之战》任意两名单位按自身战力互伤、《反转时间线》所有玩家弃置手牌后各抽四张、《绅士决斗》先友方战力 +3 再互伤、《行军号令》回响重复互伤、《牺牲》摧毁友方强力单位作为强制额外费用后先抽 2 张牌再召休眠符文、《断魂一扼》摧毁友方单位后按其当前战力增益另一名友方单位并抽 1 张牌、《顺劈》授予本回合 `OVERWHELM_3` 且进攻方目标 +3 战力、《血性冲刺》支付回响后重复授予 `OVERWHELM_2` 与进攻方目标 +2 战力、《怒吼清算》弃手牌回响重复授予 `OVERWHELM_4` 与进攻方目标 +4 战力、《强能冲拳》授予 `OVERWHELM_2` 与 `ROAM` 且进攻方目标 +2 战力、《格挡》授予 `STEADFAST_3` 与 `BARRIER` 且防守方目标 +3 战力、《加农炮幕》只伤害战斗中的敌方单位、《产量激增》全额费用与控制“机械”属性单位减费后打出 3 战力“机器人”到基地并抽牌、《共同献身》BASE 模式打出四名 1 战力“随从”到基地、《羽毛旋风》战鹰模式打出四名 1 战力带 `法盾` 标签“战鹰”到基地、《危险温度》只让己方“机械”属性单位本回合内战力 +1、《虹吸能量》当前单战场区域友方战场单位 +1 且敌方战场单位 -1 不低于 1、《月之降临》当前单战场区域敌方战场单位 -2、《点沙成兵》支付回响后重复打出两名 2 战力“黄沙士兵”到基地、《废物利用》不选择装备目标时跳过可选摧毁并抽 1 张牌、《占山为王》没有已控制战场时只抽基础 1 张牌、《完美谢幕》未支付回响时覆盖抽牌、战场单位伤害、基地单位伤害和战场单位 -4 战力四个模式、《高原血统》本回合内摧毁替代为休眠召回拥有者基地、《战术撤退》本回合内下次摧毁替代为移除伤害、休眠召回基地、《视死如归》友方单位本回合内战力 +3 基础路径、《决斗架势》友方单位本回合内战力 +1 基础路径、《动物之友》按己方单位中动物标签种类动态计算本回合内战力修正路径、《矢志不退》按敌方战场单位数量动态计算友方战场单位战力修正路径、《月蚀》本回合内战力 -4 基础路径和洞察顶部牌回收路径、《曼舞手雷》不进入再次打出分支时对基地单位造成 2 点伤害路径、《天顶之刃》不选择可选移动时眩晕敌方战场单位路径、《强手裂颅》友方战场单位和敌方战场单位双目标眩晕路径、《英勇冲锋》友方战场单位本回合内 +1 后眩晕敌方战场单位路径、《巧取豪夺》目标控制者不选择抽牌时对敌方单位造成 6 点伤害分支，以及目标控制者选择让来源控制者抽两张牌以避免伤害分支、《致命华彩》敌方单位 3 点非致命伤害路径、《逝水如镜》战场单位获得 `瞬息` 标签路径、《背水一战》友方单位本回合内按当前战力翻倍并获得 `瞬息` 标签路径、《痛苦之酬》战场单位 3 点伤害并打出休眠“金币”装备指示物到基地路径、《化为灰烬》装备获得 `瞬息` 标签路径、《印爆术》摧毁装备并让其控制者抽 2 张牌路径、《火箭轰击》摧毁装备模式路径、《狂风绝息斩》先让友方单位变为活跃状态再按其当前战力伤害敌方战场单位路径、《聚合变异》按另一友方单位当前战力补足第一目标战力路径、《清理门户》双方各自选择并摧毁己方单位路径、《国王诏令》当前 2P 下其他玩家选择非控制者单位并摧毁路径、《飓风席卷》当前 2P 下每名玩家可选单位返回所属者手牌路径、《持卫的裁决》敌方战场单位放到拥有者主牌堆顶/底路径、《预判攻势》主牌堆顶部二选一抽取并回收另一张路径、《卡牌骗术》主牌堆顶部三选一抽取并回收其余两张路径、《龙虎双雄》不支付回响时主牌堆顶部三选一单位牌抽取并回收其余两张路径及不选择单位牌回收全部已查看牌路径、《增援》不选择单位牌时回收顶部五张已查看牌路径、《暗中破坏》对手手牌非单位牌回收路径、《莲花陷阱》本回合内受到后续伤害翻倍路径、《反击风暴》本回合内下一次伤害抵挡并抽牌路径、《诺克萨斯断头台》本回合内下次受到伤害触发摧毁路径、《帝国谕令》当前场上单位受伤即摧毁代表路径、《精灵召唤》3 战力“精灵”基地打出代表路径、《精灵迸发》两名 3 战力“精灵”基地打出代表路径、《顽皮触手》总战力不高于 8 的敌方战场单位移动到基地代表路径、《诱饵》不支付回响时移动敌方单位到另一敌方单位所在位置路径、《妖异狐火》总战力不高于 4 的多目标摧毁路径、《禁军之墙》任意数量友方战场单位移动到基地路径、《魅惑妖术》敌方战场单位移动到基地代表路径、《升龙踢》未启用等级 6 时敌方战场单位移动到基地代表路径、《隔绝》敌方战场单位移动到基地且无落单敌方单位时不抽牌基础路径、《风箱炎息》不支付有色回响时 1-3 名单位各 1 点伤害路径、《烈火风暴》敌方战场单位范围 3 点伤害路径、《新月打击》敌方战场主目标 4 点伤害加其他敌方战场单位各 1 点伤害路径、《护驾！》不支付黄色可选费用时打出一名 2 战力“黄沙士兵”到基地路径；一百四十八条卡牌/模式参数已进入最小 card behavior registry。下一步迁移更多低复杂度官方卡牌。
...
新窗口接手时，先读 `docs/START_HERE.md`，再回到本节确认当前只推进 P2 核心规则 preflight，不进入最终 UI、全卡牌迁移或复杂 AI。
