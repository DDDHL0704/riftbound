...
状态：P7 已完成；P7.9 已完成 P7.9.6 传奇规则域，并在 P7.9.7 进入战场规则域四十一个功能单元：`DECLARE_BATTLE` 支持服务端已知战场卡对象目的地，ActionPrompt 下发战场对象候选；`OGN·296/298` 以此处单位为目标的法术/技能伤害 +1、`UNL-211/219` 高费法术触发洞察并回收顶部牌、`UNL-205/219` 玩家打出法术时强化其控制的战场单位、`OGN·292/298` 每回合首次以法术指定此处友方单位时抽一张牌、`SFD·213/221` 首个友方装备每回合费用减少 1、`SFD·211/221` 友方回响费用减少 1，以及已落地的 `UNL-207/219`、`UNL-208/219`、`UNL-209/219`、`UNL-210/219`、`UNL-212/219`、`UNL-217/219`、`OGN·275/298`、`OGN·276/298` / `OGN·276a/298`、`OGN·277/298`、`OGN·279/298`、`OGN·280/298`、`OGN·281/298`、`OGN·282/298`、`OGN·283/298`、`OGN·284/298`、`OGN·285/298`、`OGN·287/298`、`OGN·288/298`、`OGN·290/298`、`OGN·291/298`、`OGN·293/298` / `OGN·293a/298`、`OGN·294/298`、`OGN·295/298`、`OGN·297/298`、`OGN·298/298`、`SFD·210/221`、`SFD·212/221`、`SFD·214/221`、`SFD·215/221`、`SFD·216/221`、`SFD·217/221`、`SFD·218/221`、`SFD·219/221`、`SFD·220/221`、`SFD·221/221` 已由后端结算。当前实现 `798/811` 功能单元，manual deferred 剩余 `13/811`，全部集中在战场。当前短交接和批次计划见 `docs/CURRENT_P7_9_STATUS.md`。
...
4. 战场规则域：
   ...
   - P7.9.7 已迁移 `41/54` 个战场功能单元；继续关闭 P6 中剩余 `13` 个战场 manual deferred 功能单元。
5. 战斗和长尾整合：
...
4. 分批补齐战场规则域，最终关闭当前剩余 `13/811` manual deferred 功能单元。
