...
4. 战场规则域：
   ...
   - P7.9.7 已迁移 `17/54` 个战场功能单元；继续关闭 P6 中剩余 `37` 个战场 manual deferred 功能单元。
5. 战斗和长尾整合：
...
4. 分批补齐战场规则域，最终关闭当前剩余 `37/811` manual deferred 功能单元。
