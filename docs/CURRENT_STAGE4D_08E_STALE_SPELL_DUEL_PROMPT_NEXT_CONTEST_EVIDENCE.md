# Stage 4D-08E Stale Spell Duel Prompt Next Contest Evidence
...
- `docs/CURRENT_STAGE4D_08E_STALE_SPELL_DUEL_PROMPT_NEXT_CONTEST_AUDIT.md`
- `docs/CURRENT_STAGE4D_08E_STALE_SPELL_DUEL_PROMPT_NEXT_CONTEST_EVIDENCE.md`

## Validation

```bash
/Users/dinghaolin/.dotnet/dotnet test Riftbound.slnx --no-restore --filter "FullyQualifiedName~SpellDuelFocusStalePromptReplayAfterNextContestStartsRejectsWithoutMutation"
```
...
Runtime changed: no. Existing prompt-snapshot guards already reject stale BF-A spell-duel prompts after BF-B starts.
