...
2026-05-14 4D-02I test-only slice 补充：Battle response held-score payment-resource context 已验收，入口为 `docs/CURRENT_STAGE4D_02I_BATTLE_RESPONSE_PAYMENT_RESOURCE_CONTEXT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02I_BATTLE_RESPONSE_PAYMENT_RESOURCE_CONTEXT_EVIDENCE.md`；focused 431/431、adjacent 608/608、backend full 4199/4199、`git diff --check` 通过。该补充只证明 payment-resource declaration context preservation representative，不代表 full official combat lifecycle、P0-004、P0-005、P1 或 READY 关闭。

2026-05-14 4D-02J test-only slice 补充：Battle response held-score temporary payment-resource context 已验收，入口为 `docs/CURRENT_STAGE4D_02J_BATTLE_RESPONSE_TEMP_PAYMENT_RESOURCE_CONTEXT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02J_BATTLE_RESPONSE_TEMP_PAYMENT_RESOURCE_CONTEXT_EVIDENCE.md`；focused 432/432、adjacent 608/608、backend full 4200/4200、`git diff --check` 通过。该补充只证明 temporary payment-resource declaration context preservation representative，不代表 full official combat lifecycle、P0-004、P0-005、P1 或 READY 关闭。

2026-05-14 4D-02K handoff / baseline 补充：Battle response actual activation + Brush context 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_02K_BATTLE_RESPONSE_ACTIVATION_BRUSH_CONTEXT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02K_BATTLE_RESPONSE_ACTIVATION_BRUSH_CONTEXT_BASELINE_EVIDENCE.md`；focused baseline 432/432、adjacent baseline 608/608、backend full 4200/4200、`git diff --check` 通过。该基线只建立 actual response activation 中 declaration context preservation 的实现前护栏，不代表功能完成，不关闭 P0-004、P0-005、P1 或 READY。

2026-05-14 4D-02K test-only slice 补充：Battle response actual activation + Brush context 已验收，入口为 `docs/CURRENT_STAGE4D_02K_BATTLE_RESPONSE_ACTIVATION_BRUSH_CONTEXT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02K_BATTLE_RESPONSE_ACTIVATION_BRUSH_CONTEXT_EVIDENCE.md`；focused 433/433、adjacent 608/608、backend full 4201/4201、`git diff --check` 通过。该补充只证明 actual response activation 中 Brush declaration context preservation representative，不代表 full official combat lifecycle、P0-004、P0-005、P1 或 READY 关闭。

2026-05-14 4D-02J handoff / baseline 补充：Battle response held-score temporary payment-resource context 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_02J_BATTLE_RESPONSE_TEMP_PAYMENT_RESOURCE_CONTEXT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02J_BATTLE_RESPONSE_TEMP_PAYMENT_RESOURCE_CONTEXT_BASELINE_EVIDENCE.md`；focused baseline 431/431、adjacent baseline 608/608、backend full 4199/4199、`git diff --check` 通过。该基线只建立 temporary payment-resource declaration context preservation 的实现前护栏，不代表功能完成，不关闭 P0-004、P0-005、P1 或 READY。

2026-05-14 4D-02H test-only slice 补充：Battle response Brush replacement context 已验收，入口为 `docs/CURRENT_STAGE4D_02H_BATTLE_RESPONSE_BRUSH_REPLACEMENT_CONTEXT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02H_BATTLE_RESPONSE_BRUSH_REPLACEMENT_CONTEXT_EVIDENCE.md`；focused 430/430、adjacent 608/608、backend full 4198/4198、`git diff --check` 通过。该补充只证明 Brush replacement declaration context preservation representative，不代表 full official combat lifecycle、P0-004、P0-005、P1 或 READY 关闭。

2026-05-14 4D-02I handoff / baseline 补充：Battle response held-score payment-resource context 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_02I_BATTLE_RESPONSE_PAYMENT_RESOURCE_CONTEXT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02I_BATTLE_RESPONSE_PAYMENT_RESOURCE_CONTEXT_BASELINE_EVIDENCE.md`；focused baseline 430/430、adjacent baseline 608/608、backend full 4198/4198、`git diff --check` 通过。该基线只建立 payment-resource declaration context preservation 的实现前护栏，不代表功能完成，不关闭 P0-004、P0-005、P1 或 READY。

2026-05-14 4D-02H handoff / baseline 补充：Battle response Brush replacement context 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_02H_BATTLE_RESPONSE_BRUSH_REPLACEMENT_CONTEXT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02H_BATTLE_RESPONSE_BRUSH_REPLACEMENT_CONTEXT_BASELINE_EVIDENCE.md`；focused baseline 429/429、adjacent baseline 608/608、backend full 4197/4197、`git diff --check` 通过。该基线只建立 Brush replacement declaration context preservation 的实现前护栏，不代表功能完成，不关闭 P0-004、P0-005、P1 或 READY。
...
2026-05-14 4D-02F focused slice 补充：Battle assignment no-result 已实现并验收，入口为 `docs/CURRENT_STAGE4D_02F_BATTLE_ASSIGNMENT_NO_RESULT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02F_BATTLE_ASSIGNMENT_NO_RESULT_EVIDENCE.md`；focused 428/428、adjacent 608/608、backend full 4196/4196、`git diff --check` 通过。该补充只证明 natural assignment no-result representative，不代表 full official combat lifecycle、P0-004、P0-005、P1 或 READY 关闭。
...
2026-05-14 4D-02B handoff / baseline 补充：下一 P0 收口切片锁定 battle-response priority lifecycle binding，入口为 `docs/CURRENT_STAGE4D_02B_BATTLE_RESPONSE_PRIORITY_LIFECYCLE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02B_BATTLE_RESPONSE_PRIORITY_LIFECYCLE_BASELINE_EVIDENCE.md`。该基线只建立实现前回归护栏，不代表 natural battle-response priority lifecycle 已实现，不关闭 P0-004、P0-005、P1 或 READY。
...
2026-05-14 4D-03AG handoff / baseline 补充：下一 PaymentEngine breadth 切片锁定 `PLAY_CARD` typed optional power costs 的 inline payment-resource prompt parity，入口为 `docs/CURRENT_STAGE4D_03AG_PAYMENT_ENGINE_PLAY_CARD_TYPED_RESOURCE_PROMPT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03AG_PAYMENT_ENGINE_PLAY_CARD_TYPED_RESOURCE_PROMPT_BASELINE_EVIDENCE.md`。该基线只建立实现前回归护栏，不代表 prompt parity 已修复，不关闭 P0-005、P1 或 READY。

2026-05-14 4D-03AF A 侧 audit 补充：PaymentEngine remaining-scope audit / baseline 已建立，入口为 `docs/CURRENT_STAGE4D_03AF_PAYMENT_ENGINE_REMAINING_SCOPE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03AF_PAYMENT_ENGINE_REMAINING_SCOPE_BASELINE_EVIDENCE.md`；focused baseline 587/587 通过。该补充只梳理 P0-005 代表性证据边界，推荐下一步补 action-window coverage verifier，不关闭 P0-005、P1 或 READY。
...
2026-05-14 4D-03V focused slice 补充：Gold token resource skill representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03V_PAYMENT_ENGINE_GOLD_TOKEN_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03V_PAYMENT_ENGINE_GOLD_TOKEN_RESOURCE_SKILL_EVIDENCE.md`；focused 288/288、adjacent 782/782、backend full 4113/4113、`git diff --check` 通过。该补充只证明 `UNL·T05` / `SFD·T03` Gold token destroy + exhaust + gain generic temporary payment-only rune resource ability，当时不实现 Renata Gold extra mana bonus；该 bonus 已由 4D-03W supersede。

2026-05-14 4D-03V handoff / baseline 补充：Gold token resource skill 下一服务端切片已建立，入口为 `docs/CURRENT_STAGE4D_03V_PAYMENT_ENGINE_GOLD_TOKEN_RESOURCE_SKILL_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03V_PAYMENT_ENGINE_GOLD_TOKEN_RESOURCE_SKILL_BASELINE_EVIDENCE.md`；focused baseline 264/264、adjacent baseline 758/758 通过。目标是 `UNL·T05` 与 `SFD·T03` 金币 equipment token 的 reaction-speed destroy + exhaust + gain generic temporary payment-only rune resource ability；当前仅为 B 侧交接和实现前回归护栏，当时不实现 Renata Gold extra mana bonus。

最新 Stage 4D 状态：4D-03 PaymentEngine focused foundation 已验收，4D-03B non-play payment focused slice 已验收，4D-03C play optional / extra payment focused slice 已验收，4D-03D `ACTIVATE_ABILITY` payment resource focused slice 已验收，4D-03E `HIDE_CARD` payment focused slice 已验收，4D-03F pending `PAY_COST` resource focused slice 已验收，4D-03G battlefield held score resource focused slice 已验收，4D-03H trigger payment resource focused slice 已验收，4D-03I Malzahar resource skill focused slice 已验收，4D-03J Malzahar lifecycle focused slice 已验收，4D-03K temporary resource inline focused slice 已验收，4D-03L Dragon Soul Sage reaction resource skill focused slice 已验收，4D-03M Renata colored activated draw focused slice 已验收，4D-03N Renata colored activated score focused slice 已验收，4D-03O Crimson Rose ready-unit focused slice 已验收，4D-03P Fluft Poro Warhawk token focused slice 已验收，4D-03Q Shadow swift stun focused slice 已验收，项目仍 **NOT READY**；4D-03Q 审计 / 证据入口：`docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_EVIDENCE.md`；focused 239/239、adjacent 779/779、backend full 4003/4003、`git diff --check` 通过；4D-03Q handoff / baseline 入口（已由 focused slice supersede，保留为回归护栏）：`docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_BASELINE_EVIDENCE.md`；4D-03P 审计 / 证据入口：`docs/CURRENT_STAGE4D_03P_PAYMENT_ENGINE_FLUFT_PORO_WARHAWK_TOKEN_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03P_PAYMENT_ENGINE_FLUFT_PORO_WARHAWK_TOKEN_EVIDENCE.md`；4D-03O 审计 / 证据入口：`docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_EVIDENCE.md`；4D-03O handoff / baseline 入口（已由 focused slice supersede，保留为回归护栏）：`docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_BASELINE_EVIDENCE.md`；4D-03N 审计 / 证据入口：`docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_EVIDENCE.md`；4D-03N handoff / baseline 入口（已由 focused slice supersede，保留为回归护栏）：`docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_BASELINE_EVIDENCE.md`；4D-03M 审计 / 证据入口：`docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_EVIDENCE.md`；4D-03M handoff / baseline 入口（已由 focused slice supersede，保留为回归护栏）：`docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_BASELINE_EVIDENCE.md`；4D-03L 审计 / 证据入口：`docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_EVIDENCE.md`；4D-03I 审计 / 证据入口：`docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_EVIDENCE.md`；4D-03H 审计 / 证据入口：`docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_EVIDENCE.md`；上一 4D-03F 实现提交信息：`feat: extend stage 4D pay cost resource actions`；上一 4D-03E 实现提交信息：`feat: extend stage 4D hide card payment plans`；上一 4D-03D 实现提交信息：`feat: extend stage 4D activate resource payment plans`；上一 4D-03C 实现提交：`be256be6 feat: extend stage 4D play optional payment plans`；上一 4D-03B 实现提交：`642bfed5 feat: extend stage 4D non-play payment plans`；上一 4D-03 foundation 提交：`8a063940 feat: add stage 4D payment engine foundation`；上一 4D-02 实现证据：`30210e38 feat: tighten stage 4D spell duel battle tasks`；上一 Stage 4D foundation checkpoint：`6a3ee038 test: add stage 4D board task queue foundation coverage`；上一 Stage 4C checkpoint：`7a2b1fa3 checkpoint: record stage 4C battlefield residual evidence alignment`；上一 active guard checkpoint：`4c06189 checkpoint: add active start battle guard tests`；上一 formal 18-step checkpoint：`3aed179 checkpoint: add formal 18 step e2e evidence`

2026-05-13 4D-03H baseline 补充：trigger payment resource handoff / baseline 已作为回归护栏保留，入口为 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_BASELINE_EVIDENCE.md`；focused baseline 55/55、adjacent baseline 233/233 通过。该基线已被下方 4D-03H focused slice 验收 supersede，仍保留为实现前回归护栏。
2026-05-13 4D-03H focused slice 补充：SFD Fiora trigger payment resource action 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_EVIDENCE.md`；focused 69/69、adjacent 242/242、backend full 3818/3818、`git diff --check` 通过。该补充只证明 concrete trigger payment resource representative，不关闭 P0-005。
2026-05-14 4D-03I focused slice 补充：Malzahar resource skill 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_EVIDENCE.md`；focused 105/105、adjacent 317/317、backend full 3840/3840、`git diff --check` 通过。该补充只证明 `OGN·113/298` `[A A]` open-main representative resource skill，不关闭 P0-005 full official。
2026-05-14 4D-03J handoff / baseline 补充：Malzahar resource skill lifecycle 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_BASELINE_EVIDENCE.md`；focused baseline 109/109、adjacent baseline 336/336 通过。该补充已被下方 4D-03J focused slice 验收 supersede，仍保留为回归护栏。
2026-05-14 4D-03J focused slice 补充：Malzahar resource skill lifecycle representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_EVIDENCE.md`；focused 116/116、adjacent 340/340、backend full 3847/3847、`git diff --check` 通过。该补充只证明 spell-duel focus + temporary payment-only ledger representative，不关闭 P0-005 full official。
2026-05-14 4D-03K focused slice 补充：temporary resource inline payment representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03K_PAYMENT_ENGINE_TEMPORARY_RESOURCE_INLINE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03K_PAYMENT_ENGINE_TEMPORARY_RESOURCE_INLINE_EVIDENCE.md`；focused 344/344、adjacent 539/539、backend full 3860/3860、`git diff --check` 通过。该补充只证明 `PLAY_CARD` / `ACTIVATE_ABILITY` / `ASSEMBLE_EQUIPMENT` inline temporary resource consumption representative，不关闭 P0-005 full official。
2026-05-14 4D-03L handoff / baseline 补充：Dragon Soul Sage reaction resource skill 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_BASELINE_EVIDENCE.md`；focused baseline 126/126、adjacent baseline 374/374 通过。该补充只建立 B 侧交接和实现前回归护栏，不关闭 P0-005。
2026-05-14 4D-03L focused slice 补充：Dragon Soul Sage reaction resource skill representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_EVIDENCE.md`；focused 140/140、adjacent 388/388、backend full 3874/3874、`git diff --check` 通过。该补充只证明 `UNL-093/219` reaction resource skill representative，不关闭 P0-005 full official。
2026-05-14 4D-03M handoff / baseline 补充：Renata Glasc colored activated draw 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_BASELINE_EVIDENCE.md`；focused baseline 144/144、adjacent baseline 316/316 通过。该补充只建立 B 侧交接和实现前回归护栏，不关闭 P0-005。
2026-05-14 4D-03M focused slice 补充：Renata Glasc colored activated draw representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_EVIDENCE.md`；focused 164/164、adjacent 335/335、backend full 3893/3893、`git diff --check` 通过。该补充只证明 `SFD·088/221` / `SFD·088a/221` typed-blue ordinary activated draw representative，不关闭 P0-005 full official。
2026-05-14 4D-03N handoff / baseline 补充：Renata Glasc colored activated score 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_BASELINE_EVIDENCE.md`；focused baseline 163/163、adjacent baseline 335/335 通过。该补充只锁定 `SFD·088/221` / `SFD·088a/221` typed-blue exhaust score representative，不关闭 P0-005 full official。
2026-05-14 4D-03N focused slice 补充：Renata Glasc colored activated score representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_EVIDENCE.md`；focused 185/185、adjacent 369/369、backend full 3914/3914、`git diff --check` 通过。该补充只证明 `SFD·088/221` / `SFD·088a/221` typed-blue exhaust ordinary activated score representative，不关闭 P0-005 full official。
2026-05-14 4D-03O handoff / baseline 补充：Crimson Rose ready-unit 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_BASELINE_EVIDENCE.md`；focused baseline 143/143、adjacent baseline 370/370 通过。该补充只锁定 `UNL-109/219` 猩红玫瑰 target-bearing equipment activated ready-unit representative，不关闭 P0-005。
2026-05-14 4D-03O focused slice 补充：Crimson Rose ready-unit representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03O_PAYMENT_ENGINE_CRIMSON_ROSE_READY_UNIT_EVIDENCE.md`；focused 169/169、adjacent 396/396、backend full 3940/3940、`git diff --check` 通过。该补充只证明 `UNL-109/219` target-bearing equipment activated ready-unit representative，不关闭 P0-005 full official。
2026-05-14 4D-03P focused slice 补充：Fluft Poro Warhawk token representative 已验收，入口为 `docs/CURRENT_STAGE4D_03P_PAYMENT_ENGINE_FLUFT_PORO_WARHAWK_TOKEN_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03P_PAYMENT_ENGINE_FLUFT_PORO_WARHAWK_TOKEN_EVIDENCE.md`；focused 189/189、adjacent 685/685、backend full 3962/3962、`git diff --check` 通过。该补充只证明 `UNL-160/219` 绵绵魄罗 battlefield-only no-target activated token representative 已接入 prompt / command / stack resolution / audit 口径，不关闭 P0-005 full official。
2026-05-14 4D-03Q handoff / baseline 补充：Shadow swift stun 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_BASELINE_EVIDENCE.md`；focused baseline 198/198、adjacent baseline 738/738 通过。该补充只锁定 `UNL-194/219` 黑影 swift combat-response stun representative，不代表功能完成，不关闭 P0-004/P0-005 full official。
2026-05-14 4D-03Q focused slice 补充：Shadow swift stun representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_EVIDENCE.md`；focused 239/239、adjacent 779/779、backend full 4003/4003、`git diff --check` 通过。该补充只证明 `UNL-194/219` 黑影 swift combat-response stun representative 已接入 prompt / command / stack resolution / audit 口径，不关闭完整 battle lifecycle、完整 activated ability family 或 P0-004/P0-005 full official。
2026-05-14 4D-03R handoff / baseline 补充：Rage Sigil typed resource 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03R_PAYMENT_ENGINE_RAGE_SIGIL_TYPED_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03R_PAYMENT_ENGINE_RAGE_SIGIL_TYPED_RESOURCE_BASELINE_EVIDENCE.md`；focused baseline 173/173、adjacent baseline 421/421 通过。该补充已被下方 focused slice 验收 supersede，仍保留为回归护栏，不关闭 P0-005 full official。
2026-05-14 4D-03R focused slice 补充：Rage Sigil typed resource representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03R_PAYMENT_ENGINE_RAGE_SIGIL_TYPED_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03R_PAYMENT_ENGINE_RAGE_SIGIL_TYPED_RESOURCE_EVIDENCE.md`；focused 191/191、adjacent 439/439、backend full 4021/4021、`git diff --check` 通过。该补充只证明 `SFD·222/221` 暴怒之印 typed red payment-only resource representative 已接入 prompt / command / temporary ledger / audit 口径，不关闭完整 Sigil family、完整 `[A]` / `[C]` resource skill family 或 P0-005 full official。
2026-05-14 4D-03S handoff / baseline 补充：SFD Sigil typed resource family 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03S_PAYMENT_ENGINE_SFD_SIGIL_TYPED_RESOURCE_FAMILY_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03S_PAYMENT_ENGINE_SFD_SIGIL_TYPED_RESOURCE_FAMILY_BASELINE_EVIDENCE.md`；focused baseline 191/191、adjacent baseline 439/439 通过。该补充只锁定剩余五张 SFD Sigil typed payment-only resource skills，不处理 OGN Sigil resource skills，不代表功能完成，不关闭 P0-005 full official。
2026-05-14 4D-03S focused slice 补充：SFD Sigil typed resource family representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03S_PAYMENT_ENGINE_SFD_SIGIL_TYPED_RESOURCE_FAMILY_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03S_PAYMENT_ENGINE_SFD_SIGIL_TYPED_RESOURCE_FAMILY_EVIDENCE.md`；focused 213/213、adjacent 461/461、backend full 4043/4043、`git diff --check` 通过。该补充只证明剩余五张 SFD Sigil typed payment-only resource skills 已接入 prompt / command / temporary ledger / audit 口径，不关闭完整 Sigil family、OGN Sigil、完整 `[A]` / `[C]` resource skill family 或 P0-005 full official。
2026-05-14 4D-03T handoff / baseline 补充：OGN Sigil typed resource family 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03T_PAYMENT_ENGINE_OGN_SIGIL_TYPED_RESOURCE_FAMILY_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03T_PAYMENT_ENGINE_OGN_SIGIL_TYPED_RESOURCE_FAMILY_BASELINE_EVIDENCE.md`；focused baseline 213/213、adjacent baseline 461/461 通过。该补充只锁定 OGN 六张 Sigil typed payment-only resource skills，不代表功能完成，不关闭 P0-005 full official。
2026-05-14 4D-03T focused slice 补充：OGN Sigil typed resource family representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03T_PAYMENT_ENGINE_OGN_SIGIL_TYPED_RESOURCE_FAMILY_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03T_PAYMENT_ENGINE_OGN_SIGIL_TYPED_RESOURCE_FAMILY_EVIDENCE.md`；focused 238/238、adjacent 486/486、backend full 4068/4068、`git diff --check` 通过。该补充只证明 OGN 六张 Sigil typed payment-only resource skills 已接入 prompt / command / temporary ledger / audit 口径，不关闭完整 `[A]` / `[C]` resource skill family 或 P0-005 full official。
2026-05-14 4D-03U handoff / baseline 补充：resource conversion equipment 下一实现切片已建立，入口为 `docs/CURRENT_STAGE4D_03U_PAYMENT_ENGINE_RESOURCE_CONVERSION_EQUIPMENT_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03U_PAYMENT_ENGINE_RESOURCE_CONVERSION_EQUIPMENT_BASELINE_EVIDENCE.md`；focused baseline 209/209、adjacent baseline 464/464 通过。该补充只锁定能量通道、远古簇碑、海克斯异常体三张 resource conversion equipment skills，不代表功能完成，不关闭 P0-005 full official。
2026-05-14 4D-03U focused slice 补充：resource conversion equipment representative 已实现并验收，入口为 `docs/CURRENT_STAGE4D_03U_PAYMENT_ENGINE_RESOURCE_CONVERSION_EQUIPMENT_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03U_PAYMENT_ENGINE_RESOURCE_CONVERSION_EQUIPMENT_EVIDENCE.md`；focused 230/230、adjacent 485/485、backend full 4089/4089、`git diff --check` 通过。该补充只证明能量通道、远古簇碑、海克斯异常体三张 resource conversion equipment skills 已接入 prompt / command / rune pool / temporary ledger / audit 口径，不关闭完整 `[A]` / `[C]` resource skill family 或 P0-005 full official。
当前已 verified representative evidence：Stage 4C-85 `炽烈符文` / `翠意符文` red / blue basic rune `RUNE_RESOURCE_DOMAIN` payment-resource route 已入账，并通过 focused / rune resource payment prompt regression / backend full / frontend build / Chrome smoke。2026-05-13 新增 formal 18-step E2E 证据：`npm run e2e:formal-18 -- --start-api` 通过，房间 `formal-18-1778623926434-15` 覆盖双 Chrome profile、官方 deck/opening/mulligan、stack pass-pass、unit move、reconnect、P2 battlefield score、surrender result。Active `START_BATTLE` guard test-only evidence 新增，focused 17/17、adjacent 94/94、backend full 3771/3771 通过。Stage 4C-86 `帝王神坛` / `SFD·207/221` / `FU-ec31812b00` representative conquer pay-one return-unit create-Sand-Soldier evidence 新增，focused 3/3、adjacent 45/45、backend full 3771/3771 通过。Stage 4C-87 `禁军之墙` / `SFD·043/221` / `FU-a7fbef72ba` representative move-friendly-battlefield-units evidence 新增，focused 2/2、adjacent 63/63、backend full 3771/3771 通过。Stage 4C-88 `玛尔扎哈` / `OGN·113/298` / `FU-0f7cbe26ce` resource-skill design gate 新增，确认不能 evidence-only 入账。Stage 4C-89 `山脉亚龙` / `OGN·142/298` / `FU-d635fc47f4` 与 `船坞潜伏者` / `OGN·175/298` / `FU-72ce6fb8a4` vanilla source-unit representative evidence 新增，focused 305/305、adjacent 1879/1879、backend full 3771/3771 通过。Stage 4C-90 `先锋扈从` / `OGS·016/024` / `FU-c1dc472304` 与 `好斗的龙犬` / `SFD·006/221` / `FU-1207daea8f` active-entry source-unit representative evidence 新增，focused 24/24、adjacent 1879/1879、backend full 3771/3771 通过。Stage 4C-91 `皇家守卫` / `SFD·157/221` / `FU-29d76f0175` source-unit + Sand Soldier token representative evidence 新增，focused 10/10、adjacent 1880/1880、backend full 3771/3771 通过。Stage 4C-92 `严厉军士` / `UNL-157/219` / `FU-5f03740098` source-unit + dynamic experience representative evidence 新增，focused 460/460、adjacent 1913/1913、backend full 3771/3771 通过。Stage 4C-93 `皇家随从` / `SFD·039/221` / `FU-92e31978af` source-unit + legend mode representative evidence 新增，focused 5/5、adjacent 1894/1894、backend full 3771/3771 通过。Stage 4C-94 `叨叨魄罗` / `UNL-224/219` / `FU-677c27eea7` source-unit + predict recycle representative evidence 新增，focused 12/12、adjacent 1830/1830、backend full 3771/3771 通过。Stage 4C-95 static effect design gate 新增，确认熔浆巨龙、娑娜、安妮、温驯的宝石龙不能 evidence-only 入账；项目仍 **NOT READY**。
Stage 4C-96 legacy guard evidence alignment 新增，将 Stage 4C-60 至 4C-69 已验证的 10 个 direct-card FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 67/67、adjacent 193/193、backend full 3771/3771 通过；项目仍 **NOT READY**。
Stage 4C-97 arena / minion / Annie evidence alignment 新增，将竞技场勤务小队、三张官方随从 token factory、黑暗之女共 5 个 FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 6/6、adjacent 87/87、backend full 3771/3771 通过；项目仍 **NOT READY**。
Stage 4C-98 battlefield residual evidence alignment 新增，将力量方尖碑、荣耀竞技场、冰霜要塞共 3 个战场规则域 FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 8/8、adjacent 87/87、backend full 3771/3771 通过；项目仍 **NOT READY**。
Stage 4D P0/P1 closure plan 新增，后续不再默认追加 evidence-only overlay；下一步从 board task queue foundation 开始，按 4D-01/P0-002+P0-003、4D-02/P0-004、4D-03/P0-005、4D-04/P1 LayerEngine/keywords/full-pass、4D-05 frontend authority、4D-06 final audit 顺序推进；本批不修改矩阵、不升级 full-official、不改变 NOT READY。
Stage 4D-01 board task queue foundation handoff 新增，只定义 P0-002/P0-003 下一服务端切片的实现交接、测试过滤器和 no-go criteria；本批不修改矩阵、不升级 full-official、不关闭 P0/P1。
Stage 4D-01 baseline evidence 新增，focused 22/22、adjacent 139/139 通过；只记录实现前测试绿线，不关闭 P0/P1。
Stage 4D-01 board task queue foundation evidence 新增，`tests/Riftbound.ConformanceTests/BoardTaskQueueFoundationTests.cs` 覆盖 handoff checklist；focused 31/31、adjacent 149/149、backend full 3780/3780 通过。该证据接受 4D-01 foundation，但不宣称 P0-002/P0-003 full-official resolved，不关闭 P0-004/P0-005/P1/READY。
Stage 4D-02 spell duel / battle handoff 与 baseline evidence 新增，见 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_BASELINE_EVIDENCE.md`；focused baseline 29/29、adjacent baseline 121/121 通过。该基线只证明既有代表路径绿色，不关闭 P0-004。
Stage 4D-02 spell duel / battle focused slice 新增，见 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_EVIDENCE.md`；新增 `SpellDuelBattleStateMachineTests` 覆盖多争夺战场、wrong-focus no-mutation、spell-duel stack task binding、cleanup 后推进下一 task、`SPELL_DUEL_TASKS` / `BATTLE_TASKS` reconnect metadata + redaction。Focused new 6/6、focused handoff 35/35、adjacent 127/127、backend full 3786/3786 通过。该切片收窄 P0-004，但不关闭 full official battle lifecycle。
Stage 4D-03 PaymentEngine handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03_PAYMENT_ENGINE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03_PAYMENT_ENGINE_BASELINE_EVIDENCE.md`；focused baseline 51/51、adjacent payment / ActionPrompt / GameHub regression 240/240 通过。该基线只证明既有代表支付路径绿色，不关闭 P0-005。
Stage 4D-03 PaymentEngine focused foundation 新增，见 `docs/CURRENT_STAGE4D_03_PAYMENT_ENGINE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03_PAYMENT_ENGINE_EVIDENCE.md`；新增 `PaymentEngineUnificationTests` 覆盖 shared payment plan commit、wrong-trait no-mutation、post-`RECYCLE_RUNE:*` rollback、play-card / assemble `COST_PAID` audit metadata。Focused 56/56、adjacent 245/245、backend full 3791/3791 通过。该切片收窄 P0-005，但不关闭 full official PaymentEngine。
Stage 4D-03B non-play payment handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03B_PAYMENT_ENGINE_NON_PLAY_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03B_PAYMENT_ENGINE_NON_PLAY_BASELINE_EVIDENCE.md`；focused baseline 18/18、adjacent baseline 318/318 通过。该基线只证明 Vi / Xerath `ACTIVATE_ABILITY`、`LEGEND_ACT` 与 battlefield held score 等非出牌代表路径当前行为绿色；不证明它们已共享 `PaymentPlan` / `TryCommitPayment`，不关闭 P0-005。
Stage 4D-03B non-play payment focused slice 新增，见 `docs/CURRENT_STAGE4D_03B_PAYMENT_ENGINE_NON_PLAY_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03B_PAYMENT_ENGINE_NON_PLAY_EVIDENCE.md`；focused 18/18、adjacent 318/318、backend full 3791/3791 通过。该切片把 Vi / Xerath `ACTIVATE_ABILITY`、`LEGEND_ACT` 与 battlefield held score 代表窗口接入 shared `PaymentPlan` / `TryCommitPayment`，但不关闭 full official PaymentEngine。
Stage 4D-03C play optional / extra payment handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03C_PAYMENT_ENGINE_PLAY_OPTIONAL_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03C_PAYMENT_ENGINE_PLAY_OPTIONAL_BASELINE_EVIDENCE.md`；focused baseline 31/31、adjacent baseline 363/363 通过。该基线只证明 `PLAY_CARD` Haste / Echo / Spellshield / experience / payment-resource 代表路径当前行为绿色；不证明它们已进一步统一到完整 quote / authorize / commit / audit 口径，不关闭 P0-005。
Stage 4D-03C play optional / extra payment focused slice 新增，见 `docs/CURRENT_STAGE4D_03C_PAYMENT_ENGINE_PLAY_OPTIONAL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03C_PAYMENT_ENGINE_PLAY_OPTIONAL_EVIDENCE.md`；focused 31/31、adjacent 363/363、backend full 3791/3791 通过。该切片把 `PLAY_CARD` Haste / Echo / Spellshield / experience / payment-resource 代表路径进一步接入 shared `PaymentPlan` audit / authorize 口径，但不关闭 full official PaymentEngine。
Stage 4D-03D activate ability payment resource handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03D_PAYMENT_ENGINE_ACTIVATE_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03D_PAYMENT_ENGINE_ACTIVATE_RESOURCE_BASELINE_EVIDENCE.md`；focused baseline 79/79、adjacent baseline 252/252 通过。该基线只证明当时 `ACTIVATE_ABILITY`、基础符文资源技能和既有 payment-resource 代表路径绿色；4D-03D 实现片只处理 Vi / Xerath `ACTIVATE_ABILITY` 的 `RECYCLE_RUNE:*` payment resource action，不关闭 P0-005。
Stage 4D-03D activate ability payment resource focused slice 新增，见 `docs/CURRENT_STAGE4D_03D_PAYMENT_ENGINE_ACTIVATE_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03D_PAYMENT_ENGINE_ACTIVATE_RESOURCE_EVIDENCE.md`；focused 84/84、adjacent 257/257、backend full 3796/3796 通过。该切片把 Vi / Xerath `ACTIVATE_ABILITY` 的 `RECYCLE_RUNE:*` payment resource action 接入 prompt quote / command commit / audit 口径，但不关闭 full official PaymentEngine。
Stage 4D-03E hide card payment handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03E_PAYMENT_ENGINE_HIDE_CARD_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03E_PAYMENT_ENGINE_HIDE_CARD_BASELINE_EVIDENCE.md`；focused baseline 84/84、adjacent baseline 286/286 通过。该基线只证明当前 `HIDE_CARD`、待命暗置 / 翻开相邻窗口、ActionPrompt、GameHub 与 shared PaymentEngine foundation 相关代表路径绿色；4D-03E 实现片只处理 `HIDE_CARD` standby payment plan 迁移，不关闭 P0-005。
Stage 4D-03E hide card payment focused slice 新增，见 `docs/CURRENT_STAGE4D_03E_PAYMENT_ENGINE_HIDE_CARD_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03E_PAYMENT_ENGINE_HIDE_CARD_EVIDENCE.md`；focused 88/88、adjacent 290/290、backend full 3800/3800 通过。该切片把 `HIDE_CARD` 标准待命、Teemo 替代待命与免费待命迁移到 shared `PaymentPlan` / `TryCommitPayment` / audit 口径，但不关闭 full official PaymentEngine。
Stage 4D-03F pending PAY_COST resource handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03F_PAYMENT_ENGINE_PAY_COST_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03F_PAYMENT_ENGINE_PAY_COST_RESOURCE_BASELINE_EVIDENCE.md`；focused baseline 51/51、adjacent baseline 229/229 通过。该基线只证明现有 payment / trigger / PAY_COST / ActionPrompt / GameHub 代表路径绿色；4D-03F 实现片只处理普通 pending `PAY_COST` 的 `RECYCLE_RUNE:*` payment resource action foundation，不关闭 P0-005。
Stage 4D-03F pending PAY_COST resource focused slice 新增，见 `docs/CURRENT_STAGE4D_03F_PAYMENT_ENGINE_PAY_COST_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03F_PAYMENT_ENGINE_PAY_COST_RESOURCE_EVIDENCE.md`；focused 55/55、adjacent 233/233、backend full 3804/3804 通过。该切片把普通 pending `PAY_COST` 的 `RECYCLE_RUNE:*` payment resource action 接入 shared `PaymentPlan` / `TryCommitPayment` / prompt quote / audit 口径，但不关闭 full official PaymentEngine。
Stage 4D-03G battlefield held score resource handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03G_PAYMENT_ENGINE_BATTLEFIELD_HELD_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03G_PAYMENT_ENGINE_BATTLEFIELD_HELD_RESOURCE_BASELINE_EVIDENCE.md`；focused baseline 21/21、adjacent baseline 219/219 通过。该基线只证明当前 battlefield held score、PaymentEngine foundation 与相邻 prompt / Hub 路径绿色；4D-03G 实现片将处理 `BATTLEFIELD_HELD_PAY_4_POWER_GAIN_SCORE` 的 `RECYCLE_RUNE:*` payment resource action，不关闭 P0-005。
Stage 4D-03G battlefield held score resource focused slice 新增，见 `docs/CURRENT_STAGE4D_03G_PAYMENT_ENGINE_BATTLEFIELD_HELD_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03G_PAYMENT_ENGINE_BATTLEFIELD_HELD_RESOURCE_EVIDENCE.md`；focused 22/22、adjacent 224/224、backend full 3809/3809 通过。该切片把 `BATTLEFIELD_HELD_PAY_4_POWER_GAIN_SCORE` 的必要 `RECYCLE_RUNE:*` payment resource action 接入 shared `PaymentPlan` / `TryCommitPayment` / audit 口径，但不关闭 full official PaymentEngine。
Stage 4D-03H trigger payment resource handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_BASELINE_EVIDENCE.md`；候选锁定 `SFD·180/221` / `SFD·180a/221` 菲奥娜“友方单位变为强力后可支付黄色使其活跃”；focused baseline 55/55、adjacent baseline 233/233 通过。该基线只证明实现前 trigger payment、PAY_COST、ActionPrompt 与 GameHub 相邻路径绿色，已被下一行 focused slice 验收 supersede，不关闭 P0-005。
Stage 4D-03I Malzahar resource skill focused slice 新增，见 `docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03I_PAYMENT_ENGINE_RESOURCE_SKILL_EVIDENCE.md`；候选锁定 `OGN·113/298` 玛尔扎哈 `[A A]` resource skill；focused 105/105、adjacent 317/317、backend full 3840/3840 通过。该切片只证明 open-main representative resource skill 已接入服务端 prompt / command / audit，不关闭完整 `[A]` / `[C]`、spell-duel / swift timing、reaction prohibition 或 P0-005 full official。
Stage 4D-03J Malzahar resource skill lifecycle handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03J_PAYMENT_ENGINE_RESOURCE_SKILL_LIFECYCLE_BASELINE_EVIDENCE.md`；focused baseline 109/109、adjacent baseline 336/336 通过。该基线只证明 spell-duel / reaction / payment 相邻路径绿色，不代表 lifecycle 实现完成，不关闭 P0-005。
Stage 4D-03K temporary resource inline focused slice 新增，见 `docs/CURRENT_STAGE4D_03K_PAYMENT_ENGINE_TEMPORARY_RESOURCE_INLINE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03K_PAYMENT_ENGINE_TEMPORARY_RESOURCE_INLINE_EVIDENCE.md`；focused 344/344、adjacent 539/539、backend full 3860/3860 通过。该切片把 Malzahar temporary ledger 接入 `PLAY_CARD`、`ACTIVATE_ABILITY` 与 `ASSEMBLE_EQUIPMENT` inline representatives，不关闭 P0-005。
Stage 4D-03L Dragon Soul Sage reaction resource skill handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_BASELINE_EVIDENCE.md`；focused baseline 126/126、adjacent baseline 374/374 通过。该基线只锁定下一服务端实现切片，不关闭 P0-005。
Stage 4D-03L Dragon Soul Sage reaction resource skill focused slice 新增，见 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03L_PAYMENT_ENGINE_REACTION_RESOURCE_SKILL_EVIDENCE.md`；focused 140/140、adjacent 388/388、backend full 3874/3874 通过。该切片把 Dragon Soul Sage reaction-speed resource skill 接入服务端 prompt / command / audit representative，不关闭 P0-005。
Stage 4D-03M Renata Glasc colored activated draw handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_BASELINE_EVIDENCE.md`；focused baseline 144/144、adjacent baseline 316/316 通过。该基线已被下一行 focused slice 验收 supersede，仍保留为实现前回归护栏，不关闭 P0-005。
Stage 4D-03M Renata Glasc colored activated draw focused slice 新增，见 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03M_PAYMENT_ENGINE_COLORED_ACTIVATED_DRAW_EVIDENCE.md`；focused 164/164、adjacent 335/335、backend full 3893/3893 通过。该切片把 Renata `支付 1 + 蓝色` 抽牌技能接入服务端 prompt / command / stack resolution representative，不关闭 Renata score 或完整 PaymentEngine。
Stage 4D-03N Renata Glasc colored activated score handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_BASELINE_EVIDENCE.md`；focused baseline 163/163、adjacent baseline 335/335 通过。该基线只锁定 Renata `支付 4 + 蓝蓝蓝蓝，横置：获得 1 分` 下一实现切片，不关闭 P0-005。
Stage 4D-03N Renata Glasc colored activated score focused slice 新增，见 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03N_PAYMENT_ENGINE_COLORED_ACTIVATED_SCORE_EVIDENCE.md`；focused 185/185、adjacent 369/369、backend full 3914/3914 通过。该切片把 Renata `支付 4 + 蓝蓝蓝蓝，横置：获得 1 分` 得分技能接入服务端 prompt / command / stack resolution representative，不关闭 target-bearing activated abilities 或完整 PaymentEngine。
Stage 4D-03Q Shadow swift stun handoff / baseline 新增，见 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_BASELINE_EVIDENCE.md`；focused baseline 198/198、adjacent baseline 738/738 通过。该基线已被 focused slice 验收 supersede，仍保留为回归护栏，不关闭 P0-004 或 P0-005。
Stage 4D-03Q Shadow swift stun focused slice 新增，见 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03Q_PAYMENT_ENGINE_SHADOW_SWIFT_STUN_EVIDENCE.md`；focused 239/239、adjacent 779/779、backend full 4003/4003、`git diff --check` 通过。该切片把 Shadow swift stun 接入服务端 prompt / command / stack resolution representative，不关闭完整 battle lifecycle、完整 activated ability family 或 P0-004/P0-005。
Stage 4D-03H trigger payment resource focused slice 新增，见 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_AUDIT.md` 与 `docs/CURRENT_STAGE4D_03H_PAYMENT_ENGINE_TRIGGER_RESOURCE_EVIDENCE.md`；focused 69/69、adjacent 242/242、backend full 3818/3818 通过。该切片把 SFD Fiora trigger payment resource action 接入 `TRIGGER_PAYMENT` / `PAY_COST` / audit 口径，但不关闭 full official PaymentEngine。
历史批次中“formal 18-step E2E 仍按 P0/P1 缺口管理”之类文字已被 formal 18-step 证据 supersede；4D-01 已收窄 P0-002 / P0-003 的 board task queue foundation，4D-02 已收窄 P0-004 focused task-scoped lifecycle，4D-03 已收窄 P0-005 PaymentEngine foundation，当前 NOT READY 根因仍是 P0-002 / P0-003 / P0-004 full-official lifecycle 残余、P0-005 full PaymentEngine breadth、P1 LayerEngine / 关键词 / 全卡 full-official 证据与最终 audit。
...
阶段 4C-58 Spirit Fire total-power target guard 审计：`docs/CURRENT_STAGE4C_BATCH58_SPIRIT_FIRE_TOTAL_POWER_TARGET_GUARD_AUDIT.md`
...
阶段 4C-61 Overcharged Energy field unit guard 审计：`docs/CURRENT_STAGE4C_BATCH61_OVERCHARGED_ENERGY_FIELD_UNIT_GUARD_AUDIT.md`
阶段 4C-61 Overcharged Energy field unit guard 证据：`docs/CURRENT_STAGE4C_BATCH61_OVERCHARGED_ENERGY_FIELD_UNIT_GUARD_EVIDENCE.md`
阶段 4C-62 Hunt ready friendly units guard 审计：`docs/CURRENT_STAGE4C_BATCH62_HUNT_READY_FRIENDLY_UNITS_GUARD_AUDIT.md`
阶段 4C-62 Hunt ready friendly units guard 证据：`docs/CURRENT_STAGE4C_BATCH62_HUNT_READY_FRIENDLY_UNITS_GUARD_EVIDENCE.md`
阶段 4C-63 AnyUnit target-scope guard 审计：`docs/CURRENT_STAGE4C_BATCH63_ANY_UNIT_TARGET_SCOPE_GUARD_AUDIT.md`
...
阶段 4C-66 Tibbers all battlefield damage 审计：`docs/CURRENT_STAGE4C_BATCH66_TIBBERS_ALL_BATTLEFIELD_DAMAGE_AUDIT.md`
阶段 4C-66 Tibbers all battlefield damage 证据：`docs/CURRENT_STAGE4C_BATCH66_TIBBERS_ALL_BATTLEFIELD_DAMAGE_EVIDENCE.md`
阶段 4C-67 Bubblebot ready friendly Mechanical 审计：`docs/CURRENT_STAGE4C_BATCH67_BUBBLEBOT_READY_FRIENDLY_MECHANICAL_AUDIT.md`
阶段 4C-67 Bubblebot ready friendly Mechanical 证据：`docs/CURRENT_STAGE4C_BATCH67_BUBBLEBOT_READY_FRIENDLY_MECHANICAL_EVIDENCE.md`
阶段 4C-68 Treasure Golem create four Gold 审计：`docs/CURRENT_STAGE4C_BATCH68_TREASURE_GOLEM_CREATE_FOUR_GOLD_AUDIT.md`
阶段 4C-68 Treasure Golem create four Gold 证据：`docs/CURRENT_STAGE4C_BATCH68_TREASURE_GOLEM_CREATE_FOUR_GOLD_EVIDENCE.md`
阶段 4C-69 Faithful Craftsman create Minion 审计：`docs/CURRENT_STAGE4C_BATCH69_FAITHFUL_CRAFTSMAN_CREATE_MINION_AUDIT.md`
...
阶段 4C-74 Sivir haste 审计：`docs/CURRENT_STAGE4C_BATCH74_SIVIR_HASTE_AUDIT.md`
阶段 4C-74 Sivir haste 证据：`docs/CURRENT_STAGE4C_BATCH74_SIVIR_HASTE_EVIDENCE.md`
阶段 4C-75 Gentleman Duel damage 审计：`docs/CURRENT_STAGE4C_BATCH75_GENTLEMAN_DUEL_DAMAGE_AUDIT.md`
阶段 4C-75 Gentleman Duel damage 证据：`docs/CURRENT_STAGE4C_BATCH75_GENTLEMAN_DUEL_DAMAGE_EVIDENCE.md`
阶段 4C-76 Long Sword equipment 审计：`docs/CURRENT_STAGE4C_BATCH76_LONG_SWORD_EQUIPMENT_AUDIT.md`
阶段 4C-76 Long Sword equipment 证据：`docs/CURRENT_STAGE4C_BATCH76_LONG_SWORD_EQUIPMENT_EVIDENCE.md`
阶段 4C-77 Syndra spell-duel echo static 审计：`docs/CURRENT_STAGE4C_BATCH77_SYNDRA_SPELL_DUEL_ECHO_STATIC_AUDIT.md`
...
阶段 4C-82 Duel mutual power damage 审计：`docs/CURRENT_STAGE4C_BATCH82_DUEL_MUTUAL_POWER_DAMAGE_AUDIT.md`
...
阶段 4C-85 Rune resource domain 审计：`docs/CURRENT_STAGE4C_BATCH85_RUNE_RESOURCE_DOMAIN_AUDIT.md`
阶段 4C-85 Rune resource domain 证据：`docs/CURRENT_STAGE4C_BATCH85_RUNE_RESOURCE_DOMAIN_EVIDENCE.md`
阶段 4C-86 Imperial Shrine conquer Sand Soldier 审计：`docs/CURRENT_STAGE4C_BATCH86_IMPERIAL_SHRINE_CONQUER_SAND_SOLDIER_AUDIT.md`
阶段 4C-86 Imperial Shrine conquer Sand Soldier 证据：`docs/CURRENT_STAGE4C_BATCH86_IMPERIAL_SHRINE_CONQUER_SAND_SOLDIER_EVIDENCE.md`
阶段 4C-87 Shield Wall move guard 审计：`docs/CURRENT_STAGE4C_BATCH87_SHIELD_WALL_MOVE_GUARD_AUDIT.md`
阶段 4C-87 Shield Wall move guard 证据：`docs/CURRENT_STAGE4C_BATCH87_SHIELD_WALL_MOVE_GUARD_EVIDENCE.md`
阶段 4C-88 Malzahar resource skill design gate：`docs/CURRENT_STAGE4C_BATCH88_MALZAHAR_RESOURCE_SKILL_DESIGN_GATE.md`
阶段 4C-89 vanilla unit 审计：`docs/CURRENT_STAGE4C_BATCH89_VANILLA_UNIT_AUDIT.md`
阶段 4C-89 vanilla unit 证据：`docs/CURRENT_STAGE4C_BATCH89_VANILLA_UNIT_EVIDENCE.md`
阶段 4C-90 active entry unit 审计：`docs/CURRENT_STAGE4C_BATCH90_ACTIVE_ENTRY_UNIT_AUDIT.md`
阶段 4C-90 active entry unit 证据：`docs/CURRENT_STAGE4C_BATCH90_ACTIVE_ENTRY_UNIT_EVIDENCE.md`
阶段 4C-91 royal guard sand soldier 审计：`docs/CURRENT_STAGE4C_BATCH91_ROYAL_GUARD_SAND_SOLDIER_AUDIT.md`
阶段 4C-91 royal guard sand soldier 证据：`docs/CURRENT_STAGE4C_BATCH91_ROYAL_GUARD_SAND_SOLDIER_EVIDENCE.md`
阶段 4C-92 stern sergeant experience 审计：`docs/CURRENT_STAGE4C_BATCH92_STERN_SERGEANT_EXPERIENCE_AUDIT.md`
阶段 4C-92 stern sergeant experience 证据：`docs/CURRENT_STAGE4C_BATCH92_STERN_SERGEANT_EXPERIENCE_EVIDENCE.md`
阶段 4C-93 royal attendant legend mode 审计：`docs/CURRENT_STAGE4C_BATCH93_ROYAL_ATTENDANT_LEGEND_MODE_AUDIT.md`
阶段 4C-93 royal attendant legend mode 证据：`docs/CURRENT_STAGE4C_BATCH93_ROYAL_ATTENDANT_LEGEND_MODE_EVIDENCE.md`
阶段 4C-94 babbling poro predict 审计：`docs/CURRENT_STAGE4C_BATCH94_BABBLING_PORO_PREDICT_AUDIT.md`
阶段 4C-94 babbling poro predict 证据：`docs/CURRENT_STAGE4C_BATCH94_BABBLING_PORO_PREDICT_EVIDENCE.md`
阶段 4C-95 static effect design gate：`docs/CURRENT_STAGE4C_BATCH95_STATIC_EFFECT_DESIGN_GATE.md`
阶段 4C-96 legacy guard evidence alignment 审计：`docs/CURRENT_STAGE4C_BATCH96_LEGACY_GUARD_EVIDENCE_ALIGNMENT_AUDIT.md`
阶段 4C-96 legacy guard evidence alignment 证据：`docs/CURRENT_STAGE4C_BATCH96_LEGACY_GUARD_EVIDENCE_ALIGNMENT_EVIDENCE.md`
阶段 4C-97 arena / minion / Annie evidence alignment 审计：`docs/CURRENT_STAGE4C_BATCH97_ARENA_MINION_ANNIE_EVIDENCE_ALIGNMENT_AUDIT.md`
阶段 4C-97 arena / minion / Annie evidence alignment 证据：`docs/CURRENT_STAGE4C_BATCH97_ARENA_MINION_ANNIE_EVIDENCE_ALIGNMENT_EVIDENCE.md`
阶段 4C-98 battlefield residual evidence alignment 审计：`docs/CURRENT_STAGE4C_BATCH98_BATTLEFIELD_RESIDUAL_EVIDENCE_ALIGNMENT_AUDIT.md`
阶段 4C-98 battlefield residual evidence alignment 证据：`docs/CURRENT_STAGE4C_BATCH98_BATTLEFIELD_RESIDUAL_EVIDENCE_ALIGNMENT_EVIDENCE.md`
formal 18-step E2E 证据：`docs/CURRENT_FORMAL_18_STEP_E2E_EVIDENCE.md`
...
| --- | --- | --- | --- | --- |
| battlefield / standby / control / held / conquer lifecycle | `CORE-260330` rules 107.2-107.3, 187-189, 315.2.b.2, 319-323, 344-348, 461-464；`JFAQ-251023` q4.1-5.4；`SOUL-OFAQ-260114` p21；`SOUL-JFAQ-260114` p4-p5 | `ObjectLocations`、`BattlefieldStates`、`BattlefieldTasks`、具体战场移动与 4D-01 destination-scoped contest task foundation 已有；完整 control freeze/release、held/conquer scoring 未完成 | B 主实现；E 证据 fixture；C 等 schema；D 文档 | 4D-02 继续推进 spell duel / battle state machine；后续补控制检查、待命移除、征服/据守得分 full-official |
| cleanup queue | `CORE-260330` rules 319-324；`JFAQ-251023` q5.1-5.2；`SOUL-OFAQ-260114` p19-p20 | `PendingTaskQueue`、`PendingCleanupTasks`、`RunStateBasedCleanupLoop`、blocking guard、cleanup repeat 与 reconnect redaction foundation 已有；未覆盖全部状态变化和替代/控制权任务 | B 主实现；E 场景证据；D 文档 | 所有 command/stack/trigger/move/enter/leave/damage/power change 统一 enqueue cleanup |
| spell duel / battle lifecycle | `CORE-260330` rules 307-313, 333-348, 454-461；`JFAQ-251023` q2.3-q2.4, q3.1-q3.3 | 4D-02 focused slice 已确认 `SpellDuelState`、`BattleState`、关联 id、焦点恢复、start battle guard、damage assignment 代表路径、多争夺战场 one-active ordering、wrong-focus no-mutation、task binding 与 reconnect redaction；完整官方 battle lifecycle 仍未 full-official | B 主实现；E 初始链/焦点/触发 fixture；C 等 typed prompt；D 文档 | 后续补完整 battle response window、initial stack、swift/reaction 链矩阵、no-result / replacement / prevention / cleanup 全组合 |
...
| `PAY_COST` / payment windows | `CORE-260330` rules 131, 135.2.e, 162-167, 356-357, 377, 403-405, 414, 416；`JFAQ-251023` q2.5；`SOUL-OFAQ-260114` p1-p4, p15, p19-p21 | `PaymentCostRules`、typed `RunePool`、代表性 `COST_PAID` 已有；阶段 2 B 已补 `PAY_COST` command/schema skeleton 与 `INVALID_PAYLOAD`；阶段 3A 已补最小 pending payment prompt/submit；阶段 4C-4 已补 `SFD·220/221` `TRIGGER_PAYMENT` 支付 / 拒付 / 支付失败 no-mutation 代表路径；阶段 4C-21 已补 `SFD·218/221`《沉没神庙》征服强力单位后的 `TRIGGER_PAYMENT` / `PAY_COST` 支付或拒付代表路径；阶段 4C-24 已补 `OGN·035/298`《薇恩》征服后的 `TRIGGER_PAYMENT` / `PAY_COST` 支付 1 回手或拒付不变更代表路径；阶段 4C-25 已补 `UNL-065/219`《冰谷弓箭手》进攻后的 `TRIGGER_PAYMENT` / `PAY_COST` 支付 1 令同处目标本回合 -1 或拒付不变更代表路径；阶段 4C-26 已补 `SFD·119/221` / `SFD·119a/221` Jax 贴附武装后的 `TRIGGER_PAYMENT` / `PAY_COST` 支付 1 抽 1 或拒付不变更代表路径；阶段 4C-28 已补 `OGN·168/298`《战或逃》普通打出费用支付后结算与 invalid target no-payment/no-mutation guard；阶段 4C-29 已补 `OGN·169/298`《罡风》普通打出费用支付后结算与 invalid target no-payment/no-mutation guard；阶段 4C-30 已补 `UNL-159/219`《狩魂》普通打出费用支付后结算与 invalid target no-payment/no-mutation guard；阶段 4C-31 已补 `OGN·172/298`《责退》普通打出费用支付后结算与 invalid target no-payment/no-mutation guard；阶段 4C-32 已补 `OGN·173/298`《驭风而行》普通打出费用支付后结算与 invalid target no-payment/no-mutation guard；阶段 4C-35 已补 `OGN·229/298`《复仇》普通打出费用后结算与 invalid target no-payment/no-mutation guard；阶段 4C-37 已补 `OGN·025/298`《暴怒冲动》普通打出费用后对手牌堆顶单位代表结算与 invalid target no-payment/no-mutation guard；阶段 4D-03 focused foundation 已建立 shared `PaymentPlan` / authorize / commit helper，并接入普通 `PAY_COST`、当前触发支付代表路径、`PLAY_CARD`、`ASSEMBLE_EQUIPMENT`，focused 56/56、adjacent payment / ActionPrompt / GameHub 245/245、backend full 3791/3791 通过；阶段 4D-03B 已把 Vi / Xerath `ACTIVATE_ABILITY`、`LEGEND_ACT` 与 battlefield held score 代表窗口接入 shared plan / commit，focused 18/18、adjacent 318/318、backend full 3791/3791 通过；阶段 4D-03C 已把 `PLAY_CARD` optional / extra / payment-resource 代表路径进一步接入 shared plan audit / authorize 口径，focused 31/31、adjacent 363/363、backend full 3791/3791 通过；阶段 4D-03D 已把 Vi / Xerath `ACTIVATE_ABILITY` payment resource action 接入 prompt quote / command commit / audit，focused 84/84、adjacent 257/257、backend full 3796/3796 通过；阶段 4D-03E 已把 `HIDE_CARD` standby payment window 接入 shared plan / commit / audit，focused 88/88、adjacent 290/290、backend full 3800/3800 通过；完整 `[A]` / `[C]`、Haste / Echo / Spellshield 全分支、替代/额外费用、全部非出牌支付窗口仍缺 | B 主实现；E 支付/拒付 fixture；C 仅同步类型/调试展示；D 文档 | 继续扩展 `[A]` / `[C]` resource skills、替代 / 额外 / 可选费用与更多 payment windows，并补齐 prompt quote parity |
| `PAY_COST` / payment windows 4D-03F/03G update | 同上 | 阶段 4D-03F 已把普通 pending `PAY_COST` 的 `RECYCLE_RUNE:*` payment resource action 接入 shared plan / prompt quote / command commit / audit，focused 55/55、adjacent 233/233、backend full 3804/3804 通过；阶段 4D-03G 已把 battlefield held score 的必要 `RECYCLE_RUNE:*` payment resource action 接入 shared `PaymentPlan` / `TryCommitPayment` / audit 口径，focused 22/22、adjacent 224/224、backend full 3809/3809 通过；两者仍不关闭 P0-005 full official | B 主实现；E 支付/拒付 fixture；C 仅同步类型/调试展示；D 文档 | 继续扩展 full PaymentEngine breadth、trigger payment resource action、`[A]` / `[C]` resource skills、全支付窗口与 prompt quote parity |
| `PAY_COST` / payment windows 4D-03H handoff | 同上；`CATALOG` SFD·180/221 与 SFD·180a/221 | 4D-03H 已建立 concrete trigger payment resource action handoff / baseline，候选为 SFD 菲奥娜“友方单位变为强力后可支付黄色使其活跃”；实现前 focused 55/55、adjacent 233/233 通过；当前只是 handoff，不证明功能完成 | B 主实现；E 支付/拒付 fixture；C 仅同步服务端 prompt；D 文档 | 实现 SFD Fiora yellow trigger payment resource action，若无法可靠判断 before/after powerful transition 则返回 NO-GO design gate |
| `PAY_COST` / payment windows 4D-03J handoff | 同上；`CATALOG` OGN·113/298；`JFAQ-251023` p4-p5 | 4D-03J 已建立 Malzahar resource skill lifecycle handoff / baseline，目标为 spell-duel / swift timing、reaction prohibition 与 payment-only lifecycle；focused baseline 109/109、adjacent baseline 336/336 通过；当前只是 handoff，不证明功能完成 | B 主实现；D/E FAQ 裁定；C 仅同步服务端 prompt | 实现 Malzahar spell-duel focus resource skill timing、reaction target prohibition 和 payment-only resource lifecycle；不能关闭完整 `[A]` / `[C]` family |
...
- 4C-27 已关闭 Treasure Hunter / 寻宝猎人 `SFD·130/221` / `FU-6144ab0271` successful move -> dormant Gold equipment token representative baseline；完整 movement / control-zone / roam lifecycle、move-trigger family、equipment token full rules、hidden / face-down trigger policy、Karthus design gate、FAQ regression 与 full-official 仍按 P0/P1 缺口管理；Renata Gold extra mana bonus 已由 4D-03W focused slice 另行覆盖。
...
- 4C-61 已记录 Overcharged Energy / 过载能量 `OGN·123/298` / cardId `31345` / `FU-b2e0e1d8da` / `OVERCHARGED_ENERGY_EXHAUST_ALL_FRIENDLY_DAMAGE_ALL_BATTLEFIELD_12` ordinary hand play / pay 7 / zero-target friendly public field-unit exhaust and public battlefield-unit damage representative guard；Core all-friendly unit exhaust 与 all-battlefield unit damage resolution 现在排除 equipment / spell / rune、face-down standby、dirty controller objects 与 base damage overreach；focused 12/12、field-unit damage regression 53/53、backend full 3722/3722、frontend build、Chrome smoke 均通过；damage prevention / replacement / cleanup、lethal triggers、multi-battlefield precision、PaymentEngine、LayerEngine、FAQ、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
...
- 4C-66 已记录 Tibbers / 提伯斯 `OGS·018/024` / cardId `31597` / `FU-c168bd394c` / `TIBBERS_PLAY_UNIT_DAMAGE_ALL_BATTLEFIELD_UNITS_3` ordinary hand play / pay 8 / zero-target stack / source-to-base unit / all public battlefield units take 3 representative evidence；本批不修改功能代码，复用既有 fixture 与 targeted tests；focused 3/3、battlefield damage regression 63/63、backend full 3754/3754、frontend build、Chrome smoke 均通过；all battlefield-wide damage cards / amounts、damage prevention / replacement / cleanup、lethal triggers、multi-battlefield precision、PaymentEngine、LayerEngine、hidden-info / redaction matrix、FAQ、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
- 4C-67 已记录 Bubblebot / 泡泡机 `SFD·062/221` / cardId `33142` / `FU-3f5a9ef0e0` / `BUBBLEBOT_PLAY_UNIT_READY_FRIENDLY_MECHANICAL` ordinary hand play / pay 3 / friendly public Mechanical target / source-to-base unit / ready target representative evidence；本批不修改功能代码，复用既有 fixture 与 targeted tests；focused 2/2、mechanical-ready regression 32/32、backend full 3754/3754、frontend build、Chrome smoke 均通过；all friendly Mechanical ready cards / modes、FriendlyUnit target-scope matrix、multi-battlefield precision、PaymentEngine、readiness replacement/prevention、LayerEngine、hidden-info / redaction matrix、FAQ、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
...
- 4C-74 已记录 Sivir / 希维尔 `SFD·143/221`、`SFD·143a/221` / cardId `33234`、`33235` / `FU-5bcc4063c2` / `SIVIR_PLAY_UNIT_NO_OPTIONAL_HASTE` 与 `SIVIR_ALT_A_PLAY_UNIT_NO_OPTIONAL_HASTE` ordinary hand no-optional Haste play-unit route 和代表 `HASTE_READY` optional-cost active-entry route；本批不修改功能代码，复用既有 fixture 与 targeted tests；focused 78/78、haste payment adjacent regression 103/103、backend full 3754/3754、frontend build、Chrome smoke 均通过；完整 PaymentEngine、万能符能计数、+2 战力 / 游走分支、LayerEngine、cleanup / replacement、control-zone movement、hidden-info / redaction matrix、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
- 4C-75 已记录 Gentleman Duel / 绅士决斗 `OGS·008/024` / cardId `31587` / `FU-265c03a141` / `GENTLEMAN_DUEL_POWER_PLUS_3_THEN_MUTUAL_POWER_DAMAGE` ordinary hand play / pay 6 / friendly then enemy unit targets / +3 friendly power until end of turn / mutual current-power damage / lethal enemy-target cleanup representative evidence；本批不修改功能代码，复用既有 fixture 与 targeted tests；focused 6/6、mutual damage cleanup adjacent regression 203/203、backend full 3754/3754、frontend build、Chrome smoke 均通过；Swift / spell-duel timing、complete FEPR target matrix、LayerEngine / duration cleanup、replacement / prevention、battle damage assignment lifecycle、hidden-info / redaction matrix、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
...
- 4C-85 已记录 Rune Resource Domain / 符文资源域 `OGN·007/298` 炽烈符文 / `FU-0ec69ae7e6` 与 `OGN·042/298` 翠意符文 / `FU-39041f4562` red / blue basic rune payment-resource route 代表证据；本批不修改功能代码，复用既有 conformance tests；focused 10/10、rune resource payment prompt adjacent regression 240/240、backend full 3754/3754、frontend build、Chrome smoke 均通过；complete rune call / tap / recycle lifecycle、complete PaymentEngine、reaction payment windows、hidden-info / redaction matrix、1009/811 与 formal 18-step E2E 仍按 P0/P1 缺口管理。
- 4C-86 已记录 Imperial Shrine / 帝王神坛 `SFD·207/221` / cardId `33306` / `FU-ec31812b00` conquer pay-one return-unit create-Sand-Soldier route 代表证据；本批不修改功能代码，复用既有 conformance / Hub tests；focused 3/3、BattlefieldConquer adjacent regression 45/45、backend full 3771/3771 通过；complete optional trigger prompt / decline、complete PaymentEngine、complete battlefield / spell-duel / battle lifecycle、multi-battlefield APNAP、FAQ p22、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-87 已记录 Shield Wall / 禁军之墙 `SFD·043/221` / cardId `33119` / `FU-a7fbef72ba` move-any-friendly-battlefield-units-to-base route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused 2/2、MoveFriendly / MoveUnit / FriendlyBattlefieldUnit adjacent regression 63/63、backend full 3771/3771 通过；complete multi-battlefield movement、standby / quick timing windows、complete FEPR、complete PaymentEngine、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-88 已记录 Malzahar / 玛尔扎哈 `OGN·113/298` / cardId `31332` / `FU-0f7cbe26ce` resource-skill design gate；其“只覆盖普通手牌打出、activated resource skill 仍需实现”的历史状态已被 4D-03I open-main representative focused slice 部分 supersede：服务端已覆盖横置、摧毁友方单位或装备、获得 2 点 payment-only 通用符能用于支付符能费用；focused 105/105、adjacent 317/317、backend full 3840/3840 通过。complete `[A]` / `[C]` family、swift / spell-duel timing、resource restriction lifecycle、reaction target prohibition、PaymentEngine breadth、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-89 已记录 Mountain Drake / 山脉亚龙 `OGN·142/298` / cardId `31366` / `FU-d635fc47f4` 与 Dockside Lurker / 船坞潜伏者 `OGN·175/298` / cardId `31405` / `FU-72ce6fb8a4` vanilla source-unit route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused 305/305、source-unit / play-card / target / stack / priority / payment adjacent regression 1879/1879、backend full 3771/3771 通过；其他 source-zone play routes、active-entry / keyword / movement / control-zone rules、complete PaymentEngine / FEPR、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-90 已记录 Vanguard Squire / 先锋扈从 `OGS·016/024` / cardId `31595` / `FU-c1dc472304` 与 Aggressive Dragonhound / 好斗的龙犬 `SFD·006/221` / cardId `33078` / `FU-1207daea8f` active-entry source-unit route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused 24/24、source-unit / play-card / target / stack / priority / payment adjacent regression 1879/1879、backend full 3771/3771 通过；其他 active-entry family、roam / battlefield movement、tap skills、attack triggers、complete PaymentEngine / FEPR、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-91 已记录 Royal Guard / 皇家守卫 `SFD·157/221` / cardId `33251` / `FU-29d76f0175` source-unit + Sand Soldier token route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused Royal Guard / Sand Soldier regression 10/10、source-unit / token / target / stack / priority / payment adjacent regression 1880/1880、backend full 3771/3771 通过；精确“此处”目的地选择、complete token factory、control-zone / battlefield destination matrix、replacement / cleanup、complete PaymentEngine / FEPR、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-92 已记录 Stern Sergeant / 严厉军士 `UNL-157/219` / cardId `34705` / `FU-5f03740098` source-unit + dynamic experience route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused Stern Sergeant / keyword source-unit regression 460/460、experience / source-unit / target / stack / priority / payment adjacent regression 1913/1913、backend full 3771/3771 通过；battle / movement triggered experience branches、experience spending abilities、complete experience economy、complete PaymentEngine / FEPR、LayerEngine、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-93 已记录 Royal Attendant / 皇家随从 `SFD·039/221` / cardId `33115` / `FU-92e31978af` source-unit + legend mode route 代表证据；本批不修改功能代码，复用既有 fixture、engine theory 与 Hub tests；focused Royal Attendant / legend mode regression 5/5、legend / source-unit / target / stack / priority / payment adjacent regression 1894/1894、backend full 3771/3771 通过；complete legend interaction domain、non-hand source-zone play routes、complete PaymentEngine / FEPR、LayerEngine、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-94 已记录 UNL Babbling Poro / 叨叨魄罗 `UNL-224/219` / cardId `34777` / `FU-677c27eea7` source-unit + predict recycle route 代表证据；本批不修改功能代码，复用既有 fixture 与 conformance tests；focused predict source-unit regression 12/12、predict / source-unit / target / stack / priority / payment adjacent regression 1830/1830、backend full 3771/3771 通过；predict no-recycle / decline branch、complete main-deck look-window privacy matrix、non-hand source-zone play routes、complete PaymentEngine / FEPR、hidden-info / redaction matrix、1009/811 与 formal READY audit 仍按 P0/P1 缺口管理。
- 4C-95 已记录 static effect design gate：熔浆巨龙 `FU-0973164d07`、娑娜 `FU-c9bce10c0e`、安妮 `FU-430074702b`、温驯的宝石龙 `FU-af793555bb` 不能 evidence-only 入账；现有 fixture 只覆盖普通 source-unit 入场，核心静态/触发/伤害修正文本仍 deferred；本批不修改矩阵，四个 FU 仍保留 IMPLEMENTED_UNTESTED / NEEDS_AUTOMATED_TEST_EVIDENCE。
- 4C-96 已记录 legacy guard evidence alignment：烈火风暴、过载能量、狩猎、大副、怒海大鲨炮、德玛西亚使节、提伯斯、泡泡机、宝藏魔像、忠实的工坊主共 10 个 Stage 4C-60 至 4C-69 已验证 FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 67/67、adjacent 193/193、backend full 3771/3771 通过；矩阵 `IMPLEMENTED_TESTED` 计数 68、`IMPLEMENTED_UNTESTED` 计数 12；fullOfficial=false，完整 FEPR / PaymentEngine / LayerEngine / hidden-info / 1009/811 仍按 P0/P1 缺口管理。
- 4C-97 已记录 arena / minion / Annie evidence alignment：竞技场勤务小队、随从（德玛西亚）、随从（诺克萨斯）、随从（祖安）、黑暗之女共 5 个已验证 FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 6/6、adjacent 87/87、backend full 3771/3771 通过；矩阵 `IMPLEMENTED_TESTED` 计数 73、`IMPLEMENTED_UNTESTED` 计数 7；fullOfficial=false，完整 equipment trigger / token factory / legend action domain、FEPR / PaymentEngine / LayerEngine / hidden-info / 1009/811 仍按 P0/P1 缺口管理。
- 4C-98 已记录 battlefield residual evidence alignment：力量方尖碑、荣耀竞技场、冰霜要塞共 3 个已验证 battlefield rule-domain FU 对齐为 representative `IMPLEMENTED_TESTED`；focused 8/8、adjacent 87/87、backend full 3771/3771 通过；矩阵 `IMPLEMENTED_TESTED` 计数 76、`IMPLEMENTED_UNTESTED` 计数 4；fullOfficial=false，完整 battlefield rule-domain matrix、battle / spell-duel / assign-combat-damage lifecycle、FEPR / PaymentEngine / LayerEngine / hidden-info / 1009/811 仍按 P0/P1 缺口管理。
...
- S3-P0-001 / 002 / 003 / 004 的“缺正式连续双浏览器主流程”历史口径已由 2026-05-13 `docs/CURRENT_FORMAL_18_STEP_E2E_EVIDENCE.md` supersede：formal 18-step 通过，包含双 headless Chrome profile、官方 deck/opening/mulligan、第一回合、stack pass-pass、unit move、reconnect、P2 battlefield score、surrender result 与 raw hidden/debug 文本断言。
- 该 formal 18-step 证据不关闭 strict battlefield contest / battle lifecycle full official；当前仍按 P0-002 / P0-003 / P0-004 / P0-005 与 P1 full-official 证据继续管理。
- LayerEngine 未统一；持续/替代/预防/层系统解释仍不能支撑正式规则助手。
- 全官方卡牌证据与执行仍未完成。
- 正式 18 步 E2E 已由 2026-05-13 formal evidence 收口；最终 READY 前仍需在 P0/P1 清零后重跑，并继续补 strict battlefield contest / battle lifecycle、复杂 prompt 与隐藏信息长链路。
