...
Stage 4D-02 spell duel / battle handoff 与 baseline evidence 新增，见 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_HANDOFF.md` 与 `docs/CURRENT_STAGE4D_02_SPELL_DUEL_BATTLE_BASELINE_EVIDENCE.md`；focused baseline 29/29、adjacent baseline 121/121 通过。该基线只证明既有代表路径绿色，不关闭 P0-004；下一步由 B / Maxwell 实现多争夺战场串联、wrong-focus no-mutation、swift/reaction task binding、reconnect redaction 和 task-scoped battle lifecycle。
历史批次中“formal 18-step E2E 仍按 P0/P1 缺口管理”之类文字已被 formal 18-step 证据 supersede；4D-01 已收窄 P0-002 / P0-003 的 board task queue foundation，当前 NOT READY 根因仍是 P0-002 / P0-003 full-official lifecycle 残余、P0-004 / P0-005、P1 LayerEngine / 关键词 / 全卡 full-official 证据与最终 audit。
...
| spell duel / battle lifecycle | `CORE-260330` rules 307-313, 333-348, 454-461；`JFAQ-251023` q2.3-q2.4, q3.1-q3.3 | 4D-02 baseline 已确认 `SpellDuelState`、`BattleState`、关联 id、焦点恢复、start battle guard 与 damage assignment 代表路径绿色；`DECLARE_BATTLE` / battle lifecycle 仍未完整 task-scoped | B 主实现；E 初始链/焦点/触发 fixture；C 等 typed prompt；D 文档 | 由 cleanup queue 创建并推进 spell duel / battle task；补多争夺战场、wrong-focus、reconnect、battle id / participant lifecycle |
