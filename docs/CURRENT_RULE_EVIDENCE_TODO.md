...
历史批次中“formal 18-step E2E 仍按 P0/P1 缺口管理”之类文字已被 formal 18-step 证据 supersede；4D-01 已收窄 P0-002 / P0-003 的 board task queue foundation，4D-02 已收窄 P0-004 focused task-scoped lifecycle，当前 NOT READY 根因仍是 P0-002 / P0-003 / P0-004 full-official lifecycle 残余、P0-005、P1 LayerEngine / 关键词 / 全卡 full-official 证据与最终 audit。
