...
P7 产品级 Web 对战已完成，最终状态以 `docs/CURRENT_P7_STATUS.md` 为准。当前新目标是 P7.9 本地产品版全卡可玩，状态入口为 `docs/CURRENT_P7_9_STATUS.md`。P7.9.6 传奇规则域已完成；P7.9.7 已进入战场规则域并完成三十二个战场对象/战斗结果功能单元，最新新增 `OGN·297/298` 此处单位获得游走。已落地能力包括战场对象 destination、hold/conquer 事件、`UNL-207/219`、`UNL-208/219`、`UNL-209/219`、`UNL-210/219`、`UNL-212/219`、`UNL-217/219`、`OGN·275/298`、`OGN·276/298` / `OGN·276a/298`、`OGN·279/298`、`OGN·280/298`、`OGN·281/298`、`OGN·282/298`、`OGN·283/298`、`OGN·284/298`、`OGN·285/298`、`OGN·287/298`、`OGN·288/298`、`OGN·290/298`、`OGN·291/298`、`OGN·293/298` / `OGN·293a/298`、`OGN·294/298`、`OGN·297/298`、`OGN·298/298`、`SFD·210/221`、`SFD·212/221`、`SFD·214/221`、`SFD·215/221`、`SFD·217/221`、`SFD·218/221`、`SFD·219/221`、`SFD·220/221` 和 `SFD·221/221`。当前实现 `789/811` 功能单元，`22/811` 功能单元仍是战场 manual deferred。P7.9 的核心任务就是继续关闭战场规则缺口，并让对应能力通过服务端 prompt 在页面可操作。
...
2. 继续 P7.9.7：在已建立的战场对象 destination、hold/conquer 事件、`UNL-207/219`、`UNL-208/219`、`UNL-209/219`、`UNL-210/219`、`UNL-212/219`、`UNL-217/219`、`OGN·275/298`、`OGN·276/298` / `OGN·276a/298`、`OGN·279/298`、`OGN·280/298`、`OGN·281/298`、`OGN·282/298`、`OGN·283/298`、`OGN·284/298`、`OGN·285/298`、`OGN·287/298`、`OGN·288/298`、`OGN·290/298`、`OGN·291/298`、`OGN·293/298` / `OGN·293a/298`、`OGN·294/298`、`OGN·297/298`、`OGN·298/298`、`SFD·210/221`、`SFD·212/221`、`SFD·214/221`、`SFD·215/221`、`SFD·217/221`、`SFD·218/221`、`SFD·219/221`、`SFD·220/221` 和 `SFD·221/221` 路径上，继续补齐 control、得分、替换、静态和激活类代表战场效果。
3. 每个战场规则小批次都要补 prompt 候选、页面操作边界、focused conformance/GameHub 测试和状态记录。
4. 战场规则域完成后，最终关闭当前剩余 `22/811` manual deferred 功能单元。
...
P7 产品级 Web 对战已完成，当前推进 P7.9 本地产品版全卡可玩：结构化 ActionPrompt、点击式 UI 操作、战场规则域补齐、最终关闭当前剩余的 22 个 manual deferred 功能单元。不要进入 P8 账号/匹配/部署/监控/风控，不要提交规则 PDF/FAQ，不要提交未跟踪的 riftbound-dotnet.sln，不要回退现有改动。
```
