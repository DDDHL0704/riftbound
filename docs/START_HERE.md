...
P7 产品级 Web 对战和 P7.9 本地产品版全卡可玩均已完成：1009/1009 官方条目 CONFORMANCE_PASS，811/811 功能单元实现，0/811 manual deferred；结构化 ActionPrompt、点击式 UI 操作、全卡图鉴详情、战斗完整性、事件日志/战报、基础回放/观战只读边界和最终 Browser smoke/full audit 已通过。除非用户明确要求，不要进入 P8 账号/匹配/部署/监控/风控；不要提交规则 PDF/FAQ，不要提交未跟踪的 riftbound-dotnet.sln，不要回退现有改动。
```
