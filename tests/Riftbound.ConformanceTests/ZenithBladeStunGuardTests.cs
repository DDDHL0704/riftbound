...
public sealed class ZenithBladeStunGuardTests
{
    ...
    [Fact]
    public void ZenithBladeMainActionPlayCardPromptTargetListOnlyExposesLegalEnemyPublicBattlefieldUnit()
    {
        var state = BuildZenithBladeState();
        ...
        Assert.Equal([ZenithBladeTargetObjectId], targetIds);
        ...
        var sourceRequirement = Assert.Single(
            sourceRequirements,
            requirement => string.Equals(requirement["sourceObjectId"] as string, ZenithBladeObjectId, StringComparison.Ordinal));
        ...
        Assert.Equal([ZenithBladeTargetObjectId], firstTargetChoiceIds);
