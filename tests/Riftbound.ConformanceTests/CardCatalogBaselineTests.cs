...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(1008, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(1, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(810, coverage.ImplementedUnits);
        Assert.Equal(1, coverage.ManualRuleRequiredUnits);
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Single(manualSpecs);
        Assert.Single(manualSpecs.Select(spec => spec.FunctionalUnitId).Distinct(StringComparer.Ordinal));
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(1008, implementedSpecs.Length);
