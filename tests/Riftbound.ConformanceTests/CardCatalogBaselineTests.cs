...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(881, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(128, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(726, coverage.ImplementedUnits);
        Assert.Equal(85, coverage.ManualRuleRequiredUnits);
        Assert.Equal(0, coverage.UnimplementedUnits);
        Assert.Equal(113, coverage.DuplicateGroups);
        Assert.Equal(85, coverage.ImplementedDuplicateGroups);
        Assert.Equal(240, coverage.ImplementedDuplicateEntries);
        Assert.Equal(28, coverage.PendingDuplicateGroups);
        Assert.Equal(71, coverage.PendingDuplicateEntries);
    ...
    public async Task P6SecondaryTemplateFamiliesReportEntryAndFunctionalUnitCoverage()
    {
        ...
        AssertFamily(report, BehaviorTemplateIds.TempMight, 292, 264, 28, 0, 230, 213, 17);
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Equal(128, manualSpecs.Length);
        Assert.Equal(
            85,
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(881, implementedSpecs.Length);
