...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(967, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(42, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(772, coverage.ImplementedUnits);
        Assert.Equal(39, coverage.ManualRuleRequiredUnits);
    ...
    public async Task P6LifecycleTriggerReplacementFamiliesReportSpecAndExecutionBoundaryCoverage()
    {
        ...
        AssertTimingSurfaceCoverage(
            ...
            TimingSurfaceNames.Trigger,
            entries: 530,
            specImplementedEntries: 502,
            manualRuleRequiredEntries: 28,
            unimplementedEntries: 0,
            functionalUnits: 423,
            specImplementedFunctionalUnits: 396,
            pendingFunctionalUnits: 27);
        AssertTimingSurfaceCoverage(
            timingRows,
            TimingSurfaceNames.Replacement,
            entries: 28,
    ...
    public async Task P6BattlefieldRuleDomainSurfacesReportManualBoundaryCoverage()
    {
        ...
        var implementedBattlefieldSpecs = battlefieldSpecs
            ...
            .ToArray();
        Assert.Equal(["OGN·275/298", "OGN·279/298", "OGN·280/298", "OGN·287/298", "OGN·294/298", "OGN·298/298", "SFD·210/221", "SFD·212/221", "SFD·215/221", "SFD·217/221", "SFD·218/221", "SFD·219/221", "SFD·220/221", "UNL-208/219", "UNL-210/219"], implementedBattlefieldSpecs.Select(spec => spec.CardNo).ToArray());
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Equal(42, manualSpecs.Length);
        Assert.Equal(
            39,
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(967, implementedSpecs.Length);
