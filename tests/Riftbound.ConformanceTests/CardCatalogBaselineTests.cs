...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(960, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(49, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(765, coverage.ImplementedUnits);
        Assert.Equal(46, coverage.ManualRuleRequiredUnits);
    ...
    public async Task P6LifecycleTriggerReplacementFamiliesReportSpecAndExecutionBoundaryCoverage()
    {
        ...
        AssertTimingSurfaceCoverage(
            ...
            TimingSurfaceNames.Trigger,
            entries: 530,
            specImplementedEntries: 496,
            manualRuleRequiredEntries: 34,
            unimplementedEntries: 0,
            functionalUnits: 423,
            specImplementedFunctionalUnits: 390,
            pendingFunctionalUnits: 33);
        AssertTimingSurfaceCoverage(
            timingRows,
            TimingSurfaceNames.Replacement,
            entries: 28,
    ...
    public async Task P6BattlefieldRuleDomainSurfacesReportManualBoundaryCoverage()
    {
        ...
        var implementedBattlefieldSpecs = battlefieldSpecs
            ...
            .ToArray();
        Assert.Equal(["OGN·275/298", "OGN·279/298", "OGN·280/298", "OGN·294/298", "OGN·298/298", "SFD·212/221", "SFD·219/221", "UNL-208/219"], implementedBattlefieldSpecs.Select(spec => spec.CardNo).ToArray());
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Equal(49, manualSpecs.Length);
        Assert.Equal(
            46,
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(960, implementedSpecs.Length);
