...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(1003, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(6, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(806, coverage.ImplementedUnits);
        Assert.Equal(5, coverage.ManualRuleRequiredUnits);
    ...
    public async Task P6SecondaryTemplateFamiliesReportEntryAndFunctionalUnitCoverage()
    {
        ...
        AssertFamily(report, BehaviorTemplateIds.Recall, 49, 48, 1, 0, 43, 42, 1);
    ...
    public async Task P6LifecycleTriggerReplacementFamiliesReportSpecAndExecutionBoundaryCoverage()
    {
        ...
        AssertTimingSurfaceCoverage(
            ...
            TimingSurfaceNames.Trigger,
            entries: 530,
            specImplementedEntries: 527,
            manualRuleRequiredEntries: 3,
            unimplementedEntries: 0,
            functionalUnits: 423,
            specImplementedFunctionalUnits: 420,
    ...
    public async Task P6BattlefieldRuleDomainSurfacesReportManualBoundaryCoverage()
    {
        ...
        var implementedBattlefieldSpecs = battlefieldSpecs
            ...
            .ToArray();
        Assert.Equal(["OGN·275/298", "OGN·276/298", "OGN·276a/298", "OGN·277/298", "OGN·279/298", "OGN·280/298", "OGN·281/298", "OGN·282/298", "OGN·283/298", "OGN·284/298", "OGN·285/298", "OGN·287/298", "OGN·288/298", "OGN·289/298", "OGN·290/298", "OGN·291/298", "OGN·292/298", "OGN·293/298", "OGN·293a/298", "OGN·294/298", "OGN·295/298", "OGN·296/298", "OGN·297/298", "OGN·298/298", "SFD·207/221", "SFD·209/221", "SFD·210/221", "SFD·211/221", "SFD·212/221", "SFD·213/221", "SFD·214/221", "SFD·215/221", "SFD·216/221", "SFD·217/221", "SFD·218/221", "SFD·219/221", "SFD·220/221", "SFD·221/221", "UNL-205/219", "UNL-207/219", "UNL-208/219", "UNL-209/219", "UNL-210/219", "UNL-211/219", "UNL-212/219", "UNL-213/219", "UNL-214/219", "UNL-215/219", "UNL-217/219", "UNL-218/219", "UNL-219/219"], implementedBattlefieldSpecs.Select(spec => spec.CardNo).ToArray());
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Equal(6, manualSpecs.Length);
        Assert.Equal(
            5,
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(1003, implementedSpecs.Length);
