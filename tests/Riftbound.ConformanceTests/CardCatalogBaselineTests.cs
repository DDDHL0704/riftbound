...
public sealed class CardCatalogBaselineTests
{
    ...
    public async Task BehaviorSpecsCoverEveryOfficialCardWithExplicitStatusAndReason()
    {
        ...
        Assert.Equal(991, report.StatusCounts[BehaviorImplementationStatuses.Implemented]);
        Assert.Equal(18, report.StatusCounts[BehaviorImplementationStatuses.ManualRuleRequired]);
    ...
    public async Task P6FunctionalUnitCoverageAuditsSameTextVariantsAndReprints()
    {
        ...
        Assert.Equal(794, coverage.ImplementedUnits);
        Assert.Equal(17, coverage.ManualRuleRequiredUnits);
    ...
    public async Task P6HighFrequencyTemplateFamiliesReportEntryAndFunctionalUnitCoverage()
    {
        ...
        AssertFamily(report, BehaviorTemplateIds.Draw, 131, 130, 1, 0, 114, 113, 1);
        AssertFamily(report, BehaviorTemplateIds.Damage, 148, 146, 2, 0, 129, 127, 2);
        AssertFamily(report, BehaviorTemplateIds.Destroy, 127, 126, 1, 0, 118, 117, 1);
    ...
    public async Task P6SecondaryTemplateFamiliesReportEntryAndFunctionalUnitCoverage()
    {
        ...
        AssertFamily(report, BehaviorTemplateIds.Recall, 49, 46, 3, 0, 43, 40, 3);
        AssertFamily(report, BehaviorTemplateIds.Move, 136, 135, 1, 0, 111, 110, 1);
        AssertFamily(report, BehaviorTemplateIds.Recycle, 63, 62, 1, 0, 51, 50, 1);
        AssertFamily(report, BehaviorTemplateIds.Banish, 11, 11, 0, 0, 9, 9, 0);
        AssertFamily(report, BehaviorTemplateIds.TempMight, 292, 290, 2, 0, 230, 228, 2);
    ...
    public async Task P6LifecycleTriggerReplacementFamiliesReportSpecAndExecutionBoundaryCoverage()
    {
        ...
        AssertTimingSurfaceCoverage(
            ...
            TimingSurfaceNames.Trigger,
            entries: 530,
            specImplementedEntries: 517,
            manualRuleRequiredEntries: 13,
            unimplementedEntries: 0,
            functionalUnits: 423,
            specImplementedFunctionalUnits: 410,
            pendingFunctionalUnits: 13);
        AssertTimingSurfaceCoverage(
            timingRows,
            TimingSurfaceNames.Replacement,
            entries: 28,
    ...
    public async Task P6BattlefieldRuleDomainSurfacesReportManualBoundaryCoverage()
    {
        ...
        var implementedBattlefieldSpecs = battlefieldSpecs
            ...
            .ToArray();
        Assert.Equal(["OGN·275/298", "OGN·276/298", "OGN·276a/298", "OGN·277/298", "OGN·279/298", "OGN·280/298", "OGN·281/298", "OGN·282/298", "OGN·283/298", "OGN·284/298", "OGN·285/298", "OGN·287/298", "OGN·288/298", "OGN·290/298", "OGN·291/298", "OGN·293/298", "OGN·293a/298", "OGN·294/298", "OGN·295/298", "OGN·297/298", "OGN·298/298", "SFD·210/221", "SFD·211/221", "SFD·212/221", "SFD·213/221", "SFD·214/221", "SFD·215/221", "SFD·216/221", "SFD·217/221", "SFD·218/221", "SFD·219/221", "SFD·220/221", "SFD·221/221", "UNL-207/219", "UNL-208/219", "UNL-209/219", "UNL-210/219", "UNL-212/219", "UNL-217/219"], implementedBattlefieldSpecs.Select(spec => spec.CardNo).ToArray());
    ...
    public async Task P6CompletionAuditKeepsEveryFunctionalUnitImplementedOrExplicitlyDeferred()
    {
        ...
        Assert.Equal(18, manualSpecs.Length);
        Assert.Equal(
            17,
        ...
        var implementedSpecs = specs
            .Where(spec => string.Equals(
                ...
                StringComparison.Ordinal))
            .ToArray();
        Assert.Equal(991, implementedSpecs.Length);
