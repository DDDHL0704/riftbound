...
public sealed class AzirSwiftSwapActivatedAbilityTests
{
    ...
    [Fact]
    public async Task AzirSwiftSwapStalePromptReplayUsesRejectedCacheWithoutMutation()
    {
        ...
        const string acceptedClientIntentId = "intent-azir-swift-swap-before-stale-prompt-replay";
        const string staleClientIntentId = "intent-azir-swift-swap-stale-prompt-replay";
        ...
        Assert.False(accepted.State.CardObjects[AzirObjectId].IsExhausted);
        ...
        Assert.Equal(P4ActivatedAbilityCatalog.AzirSwiftSwapAbilityEffectKind, acceptedStackItem.EffectKind);
        Assert.Equal(P4ActivatedAbilityCatalog.AzirCardNo, acceptedStackItem.CardNo);
        Assert.Equal([TargetObjectId], acceptedStackItem.TargetObjectIds);
        ...
        Assert.False(replay.State.CardObjects[AzirObjectId].IsExhausted);
        ...
        Assert.False(duplicateReplay.State.CardObjects[AzirObjectId].IsExhausted);
        ...
        Assert.False(conflict.State.CardObjects[AzirObjectId].IsExhausted);
