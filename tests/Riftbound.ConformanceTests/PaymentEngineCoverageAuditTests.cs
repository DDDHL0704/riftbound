...
public sealed class PaymentEngineCoverageAuditTests
{
    ...
    [Fact]
    public void PaymentEngineActiveGoalCompletionAuditMappingTracksCurrent03DHHeadEvidence()
    {
        var repositoryRoot = ResolveRepositoryRoot();
