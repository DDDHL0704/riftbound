...
- 当前推进 P7.9 本地产品版全卡可玩：P7.9.6 已完成全部传奇规则域，P7.9.7 已进入战场规则域并完成二十一个战场对象/战斗结果功能单元（`UNL-207/219` 据守移动单位到基地、`UNL-208/219` 瞬息单位获得坚守、`UNL-210/219` 孤立防守单位受到坚守 -2、`OGN·275/298` 据守打出随从、`OGN·279/298` 防守此处选择单位获得坚守2、`OGN·280/298` 据守抽牌、`OGN·282/298` 征服消耗增益抽牌、`OGN·283/298` 据守给予单位增益、`OGN·285/298` 防守此处选择单位移动到基地、`OGN·287/298` 征服回收符文、`OGN·288/298` 据守召 1 枚符文、`SFD·210/221` 征服支付 1 重置传奇、`SFD·212/221` 征服弃置主牌堆顶两张、`SFD·215/221` 防守展示顶牌并抽法术/回收、`SFD·217/221` 征服按其他受控战场抽牌、`SFD·218/221` 征服强力单位支付 1 抽牌、`SFD·219/221` 据守双方召符文、`SFD·220/221` 征服支付 1 打出休眠金币、`SFD·221/221` 征服重置装备并可卸除武装、`OGN·294/298` 此处单位静态战力 +1、`OGN·298/298` 征服弃牌抽牌、`DECLARE_BATTLE` 战场对象目的地、GameHub prompt 覆盖）。当前实现 `778/811` 个功能单元，manual deferred 剩余 `33/811`，全部集中在战场。详见 `docs/CURRENT_P7_9_STATUS.md`。
