...
- 当前推进 P7.9 本地产品版全卡可玩：P7.9.6 已完成三个传奇主动技能小批次、一个 Jinx 自动触发小批次和一个 Rumble 静态传奇小批次，传奇规则域现在覆盖 11 个传奇功能单元 / 32 个官方条目；当前实现 `724/811` 个功能单元，manual deferred 剩余 `87/811`，全部集中在传奇/战场。详见 `docs/CURRENT_P7_9_STATUS.md`。
